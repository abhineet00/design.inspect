(()=>{var Me={active:!1,hoverEl:null,selectedEl:null,pseudo:"none",view:"design",edits:new Map,panelPos:{x:null,y:16},collapsed:!1,editing:!1,dragging:!1,changeLog:[],promptDiff:!1,docked:!1,responsive:!1},Ee=new Set,p={get:()=>Me,set(o){Object.assign(Me,o),Ee.forEach(e=>e(Me))},subscribe(o){return Ee.add(o),()=>Ee.delete(o)}};var jt=0,Le="data-inspect-id";function le(o){let e=o.getAttribute(Le);return e||(e="ic-"+ ++jt,o.setAttribute(Le,e)),e}function Ve(o){return`[${Le}="${o}"]`}function R(o,e=2){if(o==null||Number.isNaN(o))return 0;let t=Math.pow(10,e);return Math.round(o*t)/t}function s(o,e={},t=[]){let n=document.createElement(o);for(let[r,i]of Object.entries(e))r==="class"?n.className=i:r==="style"&&typeof i=="object"?Object.assign(n.style,i):r==="html"?n.innerHTML=i:r==="text"?n.textContent=i:r.startsWith("on")&&typeof i=="function"?n.addEventListener(r.slice(2).toLowerCase(),i):i!==!1&&i!=null&&n.setAttribute(r,i===!0?"":i);for(let r of[].concat(t))r==null||r===!1||n.appendChild(typeof r=="string"?document.createTextNode(r):r);return n}function F(o){if(!o||o.nodeType!==1)return"";let e=o.tagName.toLowerCase();return o.id?e+="#"+o.id:o.classList.length&&(e+="."+o.classList[0]),e}function ne(o){if(o==null)return{value:0,unit:"px"};let e=String(o).trim().match(/^(-?[\d.]+)\s*([a-z%]*)$/i);return e?{value:parseFloat(e[1]),unit:e[2]||"px"}:{value:o,unit:""}}function D(o){if(!o)return{hex:"#000000",alpha:1};if(o.startsWith("#"))return{hex:o,alpha:1};let e=o.match(/rgba?\(([^)]+)\)/i);if(!e)return{hex:"#000000",alpha:1};let t=e[1].split(",").map(a=>a.trim()),[n,r,i]=t.map(a=>parseInt(a,10)),l=t[3]!=null?parseFloat(t[3]):1;return{hex:"#"+[n,r,i].map(a=>Math.max(0,Math.min(255,a||0)).toString(16).padStart(2,"0")).join(""),alpha:l}}function re(o,e=1){let t=o.replace("#",""),n=t.length===3?t.split("").map(d=>d+d).join(""):t.padEnd(6,"0"),r=parseInt(n.slice(0,2),16),i=parseInt(n.slice(2,4),16),l=parseInt(n.slice(4,6),16);return e>=1?`rgb(${r}, ${i}, ${l})`:`rgba(${r}, ${i}, ${l}, ${R(e,3)})`}function U(o){return!!(o&&o.closest&&o.closest("[data-inspect-ui]"))}var ae=class{constructor(e){this.el=s("div",{"data-inspect-ui":"",style:{position:"fixed",inset:"0",pointerEvents:"none",zIndex:"2147483640"}}),this.margin=this._box("rgba(246, 178, 107, 0.28)"),this.padding=this._box("rgba(147, 196, 125, 0.30)"),this.content=s("div",{style:this._boxStyle("transparent","#4c8dff")}),this.selected=s("div",{style:this._boxStyle("transparent","#7c5cff")}),this.badge=s("div",{"data-inspect-ui":"",style:{position:"fixed",font:"500 12px/1.4 'Quicksand', -apple-system, 'Segoe UI', Roboto, sans-serif",color:"rgba(255,255,255,0.6)",background:"rgba(0,0,0,0.82)",border:"1px solid rgba(255,255,255,0.12)",padding:"4px 9px",borderRadius:"8px",whiteSpace:"nowrap",pointerEvents:"none",boxShadow:"0 6px 20px rgba(0,0,0,.45)",backdropFilter:"blur(6px)"}}),this.el.append(this.margin,this.padding,this.content,this.selected,this.badge),e.appendChild(this.el),this.hideHover(),this.hideSelected()}_box(e){return s("div",{style:{position:"fixed",background:e,pointerEvents:"none"}})}_boxStyle(e,t){return{position:"fixed",background:e,outline:`1px solid ${t}`,outlineOffset:"-1px",pointerEvents:"none"}}_place(e,t){Object.assign(e.style,{left:t.left+"px",top:t.top+"px",width:Math.max(0,t.width)+"px",height:Math.max(0,t.height)+"px",display:"block"})}highlight(e){if(!e)return this.hideHover();let t=getComputedStyle(e),n=e.getBoundingClientRect(),r=Oe(t,"margin"),i=Oe(t,"padding");this._place(this.margin,{left:n.left-r.left,top:n.top-r.top,width:n.width+r.left+r.right,height:n.height+r.top+r.bottom}),this._place(this.content,n),this._place(this.padding,n);let l=F(e);this.badge.innerHTML=`<span style="color:#58aeff">${zt(l)}</span><span style="opacity:.5">&nbsp;&nbsp;${R(n.width)} \xD7 ${R(n.height)}</span>`,this.badge.style.display="block";let d=n.top>24?n.top-22:n.bottom+6;this.badge.style.left=Math.max(4,n.left)+"px",this.badge.style.top=d+"px"}select(e){if(!e)return this.hideSelected();this._place(this.selected,e.getBoundingClientRect())}hideHover(){[this.margin,this.padding,this.content,this.badge].forEach(e=>e.style.display="none")}hideSelected(){this.selected.style.display="none"}destroy(){this.el.remove()}};function Oe(o,e){let t=n=>parseFloat(o.getPropertyValue(`${e}-${n}`))||0;return{top:t("top"),right:t("right"),bottom:t("bottom"),left:t("left")}}function zt(o){return String(o).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}var de=class{constructor(e,t){this.overlay=e,this.onSelect=t,this._onMove=this._onMove.bind(this),this._onClick=this._onClick.bind(this),this._onKey=this._onKey.bind(this),this._onScroll=this._onScroll.bind(this)}start(){document.addEventListener("mousemove",this._onMove,!0),document.addEventListener("click",this._onClick,!0),document.addEventListener("keydown",this._onKey,!0),window.addEventListener("scroll",this._onScroll,!0),window.addEventListener("resize",this._onScroll,!0),document.documentElement.style.cursor="crosshair"}stop(){document.removeEventListener("mousemove",this._onMove,!0),document.removeEventListener("click",this._onClick,!0),document.removeEventListener("keydown",this._onKey,!0),window.removeEventListener("scroll",this._onScroll,!0),window.removeEventListener("resize",this._onScroll,!0),document.documentElement.style.cursor="",this.overlay.hideHover(),p.set({hoverEl:null})}_target(e){let t=document.elementFromPoint(e.clientX,e.clientY);return!t||U(t)||t===document.documentElement||t===document.body?null:t}_onMove(e){if(p.get().editing||p.get().dragging)return;let t=document.elementFromPoint(e.clientX,e.clientY);if(!(t&&U(t))){if(!t||t===document.documentElement||t===document.body)return this.overlay.hideHover();t!==p.get().hoverEl&&(p.set({hoverEl:t}),this.overlay.highlight(t))}}_onClick(e){if(U(e.target)||p.get().editing||p.get().dragging)return;let t=this._target(e);t&&(e.preventDefault(),e.stopPropagation(),this.onSelect(t))}_onKey(e){e.key==="Escape"&&(e.preventDefault(),p.set({active:!1}))}_onScroll(){let{hoverEl:e,selectedEl:t}=p.get();e&&this.overlay.highlight(e),t&&this.overlay.select(t)}};function It(o){return o&&!/[^a-zA-Z0-9_-]/.test(o)&&!/^(is-|has-|js-)/.test(o)?!0:o&&!/[^a-zA-Z0-9_-]/.test(o)}function Ht(o){let e=1,t=o;for(;t=t.previousElementSibling;)t.tagName===o.tagName&&e++;return e}function Rt(o){let e=o.tagName.toLowerCase();if(o.id&&document.querySelectorAll("#"+CSS.escape(o.id)).length===1)return"#"+o.id;let t=Array.from(o.classList).filter(It).slice(0,2);return t.length?e+"."+t.map(r=>r).join("."):`${e}:nth-of-type(${Ht(o)})`}function Y(o,e=4){if(!o||o.nodeType!==1)return"";let t=[],n=o;for(;n&&n.nodeType===1&&n!==document.documentElement;){let r=Rt(n);if(t.unshift(r),r.startsWith("#"))break;try{if(document.querySelectorAll(t.join(" > ")).length===1)break}catch{}if(n=n.parentElement,t.length>=e)break}return t.join(" > ")}function G(o){o.time=Date.now();let e=p.get().changeLog,t=e[e.length-1],n=o.type==="css"&&t&&t.type==="css"&&t.id===o.id&&t.prop===o.prop&&t.pseudo===o.pseudo,r=o.type==="text"&&t&&t.type==="text"&&t.id===o.id;n||r?(t.to=o.to,t.time=o.time):e.push(o),p.set({changeLog:e})}function Ae(){return p.get().changeLog}function Xe(){let o=p.get().changeLog;o.length=0,p.set({changeLog:o})}function We(o){let e=p.get().changeLog,t=e.filter(n=>!(n.type==="move"&&n.id===o));e.length=0,e.push(...t),p.set({changeLog:e})}function Je(o){return o.type==="text"?`text \u2192 "${Ft(o.to,34)}"`:o.type==="move"?o.position?`moved ${o.position}`:"reordered among siblings":o.type==="delete"?"removed from the page":`${o.prop}: ${o.to}`}function _e(o=!1){let e=Ae();if(!e.length)return"";let t=new Map;for(let i of e){let l=i.selector||i.label;t.has(l)||t.set(l,{label:i.label,selector:i.selector,css:new Map,text:null,movedTo:null,deleted:!1});let d=t.get(l);if(i.type==="css"){let a=i.pseudo&&i.pseudo!=="none"?`${i.prop} (:${i.pseudo})`:i.prop,c=d.css.get(a);d.css.set(a,{from:c?c.from:i.from,to:i.to})}else i.type==="text"?d.text={from:d.text?d.text.from:i.from,to:i.to}:i.type==="move"?d.movedTo=i.position||"to a new position":i.type==="delete"&&(d.deleted=!0)}let n=`Apply the following design changes to my web page, then return the updated HTML/CSS.

`,r=1;for(let i of t.values()){if(n+=`${r}. Element \`${i.selector||i.label}\`:
`,i.deleted){n+=`   - remove this element from the page
`,r++;continue}for(let[l,d]of i.css)n+=o?`   - change ${l} from ${d.from||"default"} to ${d.to}
`:`   - set ${l} to ${d.to}
`;i.text!=null&&(n+=o?`   - change its text from "${i.text.from}" to "${i.text.to}"
`:`   - change its text to: "${i.text.to}"
`),i.movedTo&&(n+=`   - move it ${i.movedTo} (relative to its siblings)
`),r++}return n+=`
Keep everything else unchanged.`,n.trim()}function Ft(o,e){return o=String(o),o.length>e?o.slice(0,e)+"\u2026":o}var ie=[],Se=[];function q(o){ie.push(o),ie.length>200&&ie.shift(),Se.length=0}function je(){let o=ie.pop();return o?(o.undo(),Se.push(o),o):null}function ce(){let o=Se.pop();return o?(o.redo(),ie.push(o),o):null}var ze=[{name:"System UI",stack:"system-ui, -apple-system, 'Segoe UI', Roboto, sans-serif"},{name:"Sans Serif",stack:"-apple-system, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif"},{name:"Serif",stack:"Georgia, 'Times New Roman', Times, serif"},{name:"Monospace",stack:"ui-monospace, 'SF Mono', Menlo, Consolas, 'Liberation Mono', monospace"},{name:"Arial",stack:"Arial, Helvetica, sans-serif"},{name:"Georgia",stack:"Georgia, serif"},{name:"Times New Roman",stack:"'Times New Roman', Times, serif"},{name:"Courier New",stack:"'Courier New', Courier, monospace"},{name:"Verdana",stack:"Verdana, Geneva, sans-serif"},{name:"Trebuchet MS",stack:"'Trebuchet MS', Helvetica, sans-serif"}],m=(o,e="sans-serif")=>({name:o,cat:e}),J=[m("Inter"),m("Roboto"),m("Open Sans"),m("Lato"),m("Montserrat"),m("Poppins"),m("Raleway"),m("Nunito"),m("Work Sans"),m("Rubik"),m("DM Sans"),m("Manrope"),m("Mulish"),m("Quicksand"),m("Josefin Sans"),m("Karla"),m("Figtree"),m("Outfit"),m("Space Grotesk"),m("Oswald"),m("Archivo"),m("Playfair Display","serif"),m("Merriweather","serif"),m("Lora","serif"),m("PT Serif","serif"),m("Roboto Slab","serif"),m("Bitter","serif"),m("Cormorant Garamond","serif"),m("Libre Baskerville","serif"),m("EB Garamond","serif"),m("Bebas Neue"),m("Anton"),m("Abril Fatface","serif"),m("Roboto Mono","monospace"),m("Space Mono","monospace"),m("JetBrains Mono","monospace"),m("IBM Plex Mono","monospace"),m("Fira Code","monospace"),m("Source Code Pro","monospace"),m("Dancing Script","cursive"),m("Caveat","cursive"),m("Pacifico","cursive"),m("Lobster","cursive"),m("Sacramento","cursive")],tt=new Map(J.map(o=>[o.name,o]));function Bt(o){return tt.has(o)}function Ie(o){let e=ze.find(n=>n.name===o);if(e)return e.stack;let t=tt.get(o);return t?`'${t.name}', ${t.cat}`:o}function ot(o){return Ie(o)}function He(o){return"family="+o.trim().replace(/\s+/g,"+")}function Ut(o){return o.toLowerCase().replace(/[^a-z0-9]+/g,"-")}function nt(o,e){if(document.getElementById(e))return;let t=document.createElement("link");t.rel="stylesheet",t.href=o,t.id=e,t.setAttribute("data-inspect-ui",""),document.head.appendChild(t)}var $e=new Set;function rt(o){!Bt(o)||$e.has(o)||($e.add(o),nt(`https://fonts.googleapis.com/css2?${He(o)}:wght@300;400;500;600;700&display=swap`,"inspect-font-"+Ut(o)))}var et=!1;function it(){if(et)return;et=!0;let o=J.map(t=>He(t.name)).join("&"),e=[...new Set(J.map(t=>t.name).join("").split(""))].join("");nt(`https://fonts.googleapis.com/css2?${o}&text=${encodeURIComponent(e)}&display=swap`,"inspect-font-previews")}function st(o){let e=[];for(let t of J)(o.includes(`'${t.name}'`)||o.includes(`"${t.name}"`))&&e.push(`@import url('https://fonts.googleapis.com/css2?${He(t.name)}:wght@300;400;500;600;700&display=swap');`);return e}var lt="inspect-css-live-styles";function Kt(){let o=document.getElementById(lt);return o||(o=document.createElement("style"),o.id=lt,o.setAttribute("data-inspect-ui",""),document.head.appendChild(o)),o}function at(){let{edits:o}=p.get();return[...o.entries()].map(([e,t])=>[e,{inspectId:t.inspectId,pseudo:t.pseudo,selector:t.selector,props:[...t.props.entries()]}])}function dt(o){let e=new Map;for(let[t,n]of o)e.set(t,{inspectId:n.inspectId,pseudo:n.pseudo,selector:n.selector,props:new Map(n.props)});p.get().edits=e,ct(),p.set({edits:e})}function z(o,e,t){var g,b;let n=at(),r=le(o),{edits:i,pseudo:l}=p.get(),d=l==="none"?r:`${r}::${l}`,a=(b=(g=i.get(d))==null?void 0:g.props.get(e))!=null?b:getComputedStyle(o).getPropertyValue(e).trim(),c=i.get(d);c||(c={inspectId:r,pseudo:l,selector:Y(o),props:new Map},i.set(d,c)),t===""||t==null?c.props.delete(e):c.props.set(e,t),c.props.size===0&&i.delete(d),ct(),p.set({edits:i}),t!==""&&t!=null&&G({type:"css",id:r,prop:e,from:a,to:t,pseudo:l,label:F(o),selector:c.selector});let u=at();q({undo:()=>dt(n),redo:()=>dt(u)})}function Re(o,e="none"){let t=o.getAttribute("data-inspect-id");if(!t)return new Map;let n=e==="none"?t:`${t}::${e}`,r=p.get().edits.get(n);return r?r.props:new Map}function ct(){let{edits:o}=p.get(),e=[];for(let t of o.values()){if(t.props.size===0)continue;let n=Ve(t.inspectId)+(t.pseudo!=="none"?":"+t.pseudo:""),r=[...t.props.entries()].map(([i,l])=>`  ${i}: ${l} !important;`).join(`
`);e.push(`${n} {
${r}
}`)}Kt().textContent=e.join(`

`)}function Fe(){let{edits:o}=p.get(),e=[];for(let r of o.values()){if(r.props.size===0)continue;let i=(r.selector||Ve(r.inspectId))+(r.pseudo!=="none"?":"+r.pseudo:""),l=[...r.props.entries()].map(([d,a])=>`  ${d}: ${a};`).join(`
`);e.push(`${i} {
${l}
}`)}let t=e.join(`

`),n=st(t);return n.length?n.join(`
`)+`

`+t:t}function B(o,e,t,n=t){let r=Re(o,p.get().pseudo).get(t);return r!=null?r:e.getPropertyValue(n).trim()}function Be(o){let e=getComputedStyle(o),t=o.getBoundingClientRect();return{rect:t,tag:o.tagName.toLowerCase(),layout:{display:B(o,e,"display"),position:B(o,e,"position"),width:e.width,height:e.height,x:R(t.left+window.scrollX),y:R(t.top+window.scrollY),rowGap:e.rowGap==="normal"?"0":e.rowGap,columnGap:e.columnGap==="normal"?"0":e.columnGap,justify:B(o,e,"justify-content"),align:B(o,e,"align-items")},transform:Tt(o,e),spacing:{margin:pt(e,"margin"),padding:pt(e,"padding")},radius:{all:B(o,e,"border-radius"),tl:e.borderTopLeftRadius,tr:e.borderTopRightRadius,br:e.borderBottomRightRadius,bl:e.borderBottomLeftRadius},typography:{fontFamily:e.fontFamily,fontSize:B(o,e,"font-size"),fontWeight:B(o,e,"font-weight"),lineHeight:e.lineHeight,letterSpacing:e.letterSpacing==="normal"?"0px":e.letterSpacing,textAlign:B(o,e,"text-align"),color:B(o,e,"color"),marginBottom:B(o,e,"margin-bottom")},background:{color:B(o,e,"background-color"),image:e.backgroundImage},border:{width:e.borderTopWidth,style:e.borderTopStyle,color:B(o,e,"border-top-color","border-top-color"),sides:{top:e.borderTopWidth,right:e.borderRightWidth,bottom:e.borderBottomWidth,left:e.borderLeftWidth},present:parseFloat(e.borderTopWidth)>0&&e.borderTopStyle!=="none"},effects:{opacity:B(o,e,"opacity"),boxShadow:e.boxShadow==="none"?"":e.boxShadow}}}function pt(o,e){return{top:o.getPropertyValue(`${e}-top`),right:o.getPropertyValue(`${e}-right`),bottom:o.getPropertyValue(`${e}-bottom`),left:o.getPropertyValue(`${e}-left`)}}function Tt(o,e){let n=Re(o,p.get().pseudo).get("transform")||e.transform,r={tx:0,ty:0,rotate:0};if(!n||n==="none")return r;let i=/translate\(\s*(-?[\d.]+)px\s*,\s*(-?[\d.]+)px\s*\)/.exec(n),l=/rotate\(\s*(-?[\d.]+)deg\s*\)/.exec(n);if(i&&(r.tx=parseFloat(i[1]),r.ty=parseFloat(i[2])),l&&(r.rotate=parseFloat(l[1])),i||l)return r;let d=/matrix\(([^)]+)\)/.exec(n);if(d){let[a,c,,,u,g]=d[1].split(",").map(parseFloat);r.tx=R(u),r.ty=R(g),r.rotate=R(Math.atan2(c,a)*(180/Math.PI))}return r}function ut({tx:o=0,ty:e=0,rotate:t=0}){let n=[];return(o||e)&&n.push(`translate(${R(o)}px, ${R(e)}px)`),t&&n.push(`rotate(${R(t)}deg)`),n.length?n.join(" "):""}var Pt=6e3,pe=o=>o.closest&&o.closest("[data-inspect-ui]");function Ue(){let o=document.body?document.body.querySelectorAll("*"):[],e=[];for(let t=0;t<o.length&&e.length<Pt;t++)pe(o[t])||e.push(o[t]);return e}function Nt(o,e,t){let n=o.get(e);n?n.count++:o.set(e,{...t,count:1})}function Zt(){let o=new Map,e=["color","background-color","border-top-color","border-right-color","border-bottom-color","border-left-color","outline-color","fill","stroke"];for(let t of Ue()){let n=getComputedStyle(t);for(let r of e){let i=n.getPropertyValue(r).trim();if(!i||i==="none")continue;let{hex:l,alpha:d}=D(i);if(d===0||l==="#000000"&&r==="fill")continue;let a=l+"|"+d;Nt(o,a,{hex:l,alpha:d,css:i})}}return[...o.values()].sort((t,n)=>n.count-t.count).slice(0,80)}function Yt(){let o=new Map;for(let e of Ue()){if(![...e.childNodes].some(u=>u.nodeType===3&&u.textContent.trim()))continue;let n=getComputedStyle(e),r=(n.fontFamily||"").split(",")[0].replace(/["']/g,"").trim(),i=n.fontSize,l=n.fontWeight,d=`${r}|${i}|${l}`,a=e.textContent.trim().slice(0,40),c=o.get(d);c?c.count++:o.set(d,{family:r,size:i,weight:l,lineHeight:n.lineHeight,letterSpacing:n.letterSpacing,sample:a,count:1})}return[...o.values()].sort((e,t)=>parseFloat(t.size)-parseFloat(e.size)||t.count-e.count).slice(0,60)}function Gt(){let o=[],e=new Set;for(let t of document.querySelectorAll("svg")){if(pe(t))continue;let n=t.outerHTML;/xmlns=/.test(n)||(n=n.replace("<svg",'<svg xmlns="http://www.w3.org/2000/svg"'));let r=n.slice(0,400);if(e.has(r)||n.length>4e4)continue;e.add(r);let i=t.getBoundingClientRect();if(o.push({type:"inline",markup:n,w:Math.round(i.width),h:Math.round(i.height)}),o.length>120)break}for(let t of document.querySelectorAll('img[src$=".svg"], img[src*=".svg?"]'))pe(t)||e.has(t.src)||(e.add(t.src),o.push({type:"url",src:t.src,markup:""}));return o}function qt(){let o=[],e=new Set,t=n=>{!n||e.has(n)||n.endsWith(".svg")||n.startsWith("data:image/svg")||(e.add(n),o.push({src:n}))};for(let n of document.querySelectorAll("img"))pe(n)||(n.currentSrc||n.src)&&t(n.currentSrc||n.src);for(let n of Ue()){let r=getComputedStyle(n).backgroundImage;if(!r||r==="none")continue;let i,l=/url\((['"]?)([^'")]+)\1\)/g;for(;i=l.exec(r);)t(new URL(i[2],location.href).href);if(o.length>120)break}return o}function ht(){return{colors:Zt(),typography:Yt(),svgs:Gt(),images:qt()}}var Ke=new WeakMap;function N(o){return Ke.has(o)||Ke.set(o,Qt(o)),Ke.get(o)}function Qt(o){let e=getComputedStyle(o),t=[],n=e.backgroundImage;if(n&&n!=="none")for(let i of gt(n)){let l=i.trim();!l||l==="none"||(/^linear-gradient/i.test(l)?t.push(Dt(l)):/^url\(/i.test(l)?t.push({type:"image",url:Wt(l),fit:Jt(e)}):t.push({type:"raw",css:l}))}let r=e.backgroundColor;if(r&&r!=="rgba(0, 0, 0, 0)"&&r!=="transparent"){let{hex:i,alpha:l}=D(r);t.push({type:"solid",color:i,alpha:l==null?1:l})}return t}function gt(o){let e=[],t=0,n="";for(let r of o)r==="("?t++:r===")"&&t--,r===","&&t===0?(e.push(n),n=""):n+=r;return n.trim()&&e.push(n),e}function Dt(o){let e=o.slice(o.indexOf("(")+1,o.lastIndexOf(")")),t=gt(e).map(d=>d.trim()),n=180,r=0;/^[\d.]+deg$/i.test(t[0])?(n=parseFloat(t[0]),r=1):/^to\s+/i.test(t[0])?(n=Xt(t[0]),r=1):/^[\d.]+(rad|grad|turn)$/i.test(t[0])&&(n=180,r=1);let i=[];for(let d=r;d<t.length;d++){let a=Ot(t[d]);a&&i.push(a)}let l=i.length;return i.forEach((d,a)=>{d.pos==null&&(d.pos=l<=1?0:Math.round(a/(l-1)*100))}),i.length?{type:"linear",angle:n,stops:i}:{type:"raw",css:o}}function Ot(o){o=o.trim();let e=null,t=o,n=o.match(/\s+(-?[\d.]+)%\s*$/);if(n&&(e=parseFloat(n[1]),t=o.slice(0,n.index).trim()),!t)return null;let{hex:r,alpha:i}=D(t);return{color:r,alpha:i==null?1:i,pos:e}}function Xt(o){let e=o.toLowerCase().replace(/^to\s+/,"").trim(),t={top:0,right:90,bottom:180,left:270,"top right":45,"right top":45,"bottom right":135,"right bottom":135,"bottom left":225,"left bottom":225,"top left":315,"left top":315};return t[e]!=null?t[e]:180}function Wt(o){let e=o.match(/url\(\s*(['"]?)(.*?)\1\s*\)/i);return e?e[2]:""}function Jt(o){let e=(o.backgroundSize||"").split(",")[0].trim();return e==="contain"||e==="cover"?e:"cover"}function O(o){var e,t;if(o.type==="solid"){let n=re(o.color,(e=o.alpha)!=null?e:1);return`linear-gradient(${n}, ${n})`}if(o.type==="linear"){let n=(o.stops||[]).map(r=>{var i;return`${re(r.color,(i=r.alpha)!=null?i:1)} ${r.pos}%`}).join(", ");return`linear-gradient(${(t=o.angle)!=null?t:180}deg, ${n})`}return o.type==="image"?`url("${o.url}")`:o.type==="raw"?o.css:"none"}function ft(o){if(!o||!o.length)return{"background-image":"none","background-color":"rgba(0, 0, 0, 0)"};let e=[],t=[],n=[],r=[];for(let i of o)e.push(O(i)),t.push(i.type==="image"?i.fit||"cover":"auto"),n.push("no-repeat"),r.push("center");return{"background-image":e.join(", "),"background-size":t.join(", "),"background-repeat":n.join(", "),"background-position":r.join(", "),"background-color":"rgba(0, 0, 0, 0)"}}function Te(o){return o.type==="solid"?o.color.replace("#","").toUpperCase():o.type==="linear"?"Gradient":o.type==="image"?"Image":o.type==="raw"?"Gradient":""}function se(o){return o==="linear"?{type:"linear",angle:180,stops:[{color:"#58AEFF",alpha:1,pos:0},{color:"#FF8858",alpha:1,pos:100}]}:o==="image"?{type:"image",url:"",fit:"cover"}:{type:"solid",color:"#FFFFFF",alpha:1}}var _t={"align-bottom":`<svg preserveAspectRatio="xMidYMid meet" overflow="visible" style="display: block;" width="100%" height="100%" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
<g id="align-bottom">
...
</svg>`,"sidebar-right-01":'<svg preserveAspectRatio="xMidYMid meet" overflow="visible" style="display: block;" width="100%" height="100%" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="sidebar-right-01"><path id="Vector" d="M14.6665 8C14.6665 5.50018 14.6665 4.25027 14.0299 3.37405C13.8243 3.09107 13.5755 2.84221 13.2925 2.63661C12.4163 2 11.1663 2 8.66654 2H7.3332C4.83338 2 3.58347 2 2.70725 2.63661C2.42427 2.84221 2.17541 3.09107 1.96981 3.37405C1.3332 4.25027 1.3332 5.50018 1.3332 8C1.3332 10.4998 1.3332 11.7497 1.96981 12.6259C2.17541 12.9089 2.42427 13.1578 2.70725 13.3634C3.58347 14 4.83338 14 7.3332 14H8.66654C11.1663 14 12.4163 14 13.2925 13.3634C13.5755 13.1578 13.8243 12.9089 14.0299 12.6259C14.6665 11.7497 14.6665 10.4998 14.6665 8Z" stroke="currentColor" stroke-linejoin="round"/><path id="Vector_2" d="M9.6668 2.33334V13.6667" stroke="currentColor" stroke-linejoin="round"/><path id="Vector_3" d="M12.6668 4.66666H11.6668" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/><path id="Vector_4" d="M12.6668 7.33334H11.6668" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/><path id="Vector_5" d="M5.3332 6.66666L6.1509 7.37146C6.49466 7.66773 6.66654 7.81593 6.66654 8C6.66654 8.18406 6.49466 8.33226 6.1509 8.62853L5.3332 9.33333" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/></g></svg>',"minus-sign":'<svg preserveAspectRatio="xMidYMid meet" overflow="visible" style="display: block;" width="100%" height="100%" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="minus-sign"><path id="Vector" d="M13.3333 8H2.66667" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/></g></svg>',square:'<svg preserveAspectRatio="xMidYMid meet" overflow="visible" style="display: block;" width="100%" height="100%" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="queue-02"><path id="Vector" d="M12 12H4C3.37146 12 3.05719 12 2.86193 11.8047C2.66667 11.6095 2.66667 11.2952 2.66667 10.6667C2.66667 10.0381 2.66667 9.72387 2.86193 9.5286C3.05719 9.33333 3.37146 9.33333 4 9.33333H12C12.6285 9.33333 12.9428 9.33333 13.1381 9.5286C13.3333 9.72387 13.3333 10.0381 13.3333 10.6667C13.3333 11.2952 13.3333 11.6095 13.1381 11.8047C12.9428 12 12.6285 12 12 12Z" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/><path id="Vector_2" d="M2.66667 6.66667H13.3333" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/><path id="Vector_3" d="M2.66667 4H13.3333" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/></g></svg>',"border-all-01":'<svg preserveAspectRatio="xMidYMid meet" overflow="visible" style="display: block;" width="100%" height="100%" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="border-all-01"><path id="Vector" d="M2.59416 2.59416C3.52166 1.66667 5.01444 1.66667 8 1.66667C10.9855 1.66667 12.4783 1.66667 13.4059 2.59416C14.3333 3.52166 14.3333 5.01444 14.3333 8C14.3333 10.9855 14.3333 12.4783 13.4059 13.4059C12.4783 14.3333 10.9855 14.3333 8 14.3333C5.01444 14.3333 3.52166 14.3333 2.59416 13.4059C1.66667 12.4783 1.66667 10.9855 1.66667 8C1.66667 5.01444 1.66667 3.52166 2.59416 2.59416Z" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/><path id="Vector_2" d="M8 1.66667V2.93333M8 13.0667V14.3333M6.1 8H9.9M13.0667 8H14.3333M1.66667 8H2.93333M8 6.09999V9.9" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/></g></svg>',"stroke-top":'<svg preserveAspectRatio="xMidYMid meet" overflow="visible" style="display: block;" width="100%" height="100%" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="stroke-top"><path id="Vector" d="M12.6666 4.66667V10C12.6666 11.8856 12.6666 12.8284 12.0808 13.4142C11.495 14 10.5522 14 8.66663 14H7.33329C5.44767 14 4.50487 14 3.91908 13.4142C3.33329 12.8284 3.33329 11.8856 3.33329 10V4.66667" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/><path id="Vector_2" d="M14 1.9987H1.99996" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/></g></svg>',"stroke-right":'<svg preserveAspectRatio="xMidYMid meet" overflow="visible" style="display: block;" width="100%" height="100%" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="stroke-right"><path id="Vector" d="M11.3334 12.6667H6.00008C4.11446 12.6667 3.17165 12.6667 2.58587 12.0809C2.00008 11.4951 2.00008 10.5523 2.00008 8.66667V7.33333C2.00008 5.44771 2.00008 4.50491 2.58587 3.91912C3.17165 3.33333 4.11446 3.33333 6.00008 3.33333H11.3334" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/><path id="Vector_2" d="M13.9988 14V2" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/></g></svg>',"stroke-left":'<svg preserveAspectRatio="xMidYMid meet" overflow="visible" style="display: block;" width="100%" height="100%" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="stroke-left"><path id="Vector" d="M4.66675 3.33333H10.0001C11.8857 3.33333 12.8285 3.33333 13.4143 3.91912C14.0001 4.50491 14.0001 5.44771 14.0001 7.33333V8.66667C14.0001 10.5523 14.0001 11.4951 13.4143 12.0809C12.8285 12.6667 11.8857 12.6667 10.0001 12.6667H4.66675" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/><path id="Vector_2" d="M2.00008 2V14" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/></g></svg>',"stroke-bottom":'<svg preserveAspectRatio="xMidYMid meet" overflow="visible" style="display: block;" width="100%" height="100%" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="stroke-bottom"><path id="Vector" d="M3.33341 11.3333V6C3.33341 4.11438 3.33341 3.17157 3.9192 2.58579C4.50499 2 5.44779 2 7.33341 2H8.66675C10.5523 2 11.4951 2 12.0809 2.58579C12.6667 3.17157 12.6667 4.11438 12.6667 6V11.3333" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/><path id="Vector_2" d="M2.00008 14H14.0001" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/></g></svg>',link:'<svg preserveAspectRatio="xMidYMid meet" overflow="visible" style="display: block;" width="100%" height="100%" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="link"><path id="Vector" d="M9.99724 11.3333H11.3306C13.1715 11.3333 14.6639 9.84093 14.6639 8C14.6639 6.15905 13.1715 4.66667 11.3306 4.66667H9.99724M5.99723 11.3333H4.6639C2.82295 11.3333 1.33057 9.84093 1.33057 8C1.33057 6.15905 2.82295 4.66667 4.6639 4.66667H5.99723" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/><path id="Vector_2" d="M5.6639 8H10.3306" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/></g></svg>',"link-off":'<svg preserveAspectRatio="xMidYMid meet" overflow="visible" style="display: block;" width="100%" height="100%" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="link-off"><path id="Vector" d="M1.99609 2L21.9961 22" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/><path id="Vector_2" d="M8.99609 17C7.62926 17 6.99609 17 6.99609 17C4.23467 17 1.99609 14.7614 1.99609 12C1.99609 9.23858 4.23467 7 6.99609 7" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/><path id="Vector_3" d="M20.9965 15C21.6241 14.1643 21.9961 13.1256 21.9961 12C21.9961 9.23858 19.7575 7 16.9961 7H13.4961" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/><path id="Vector_4" d="M16.9961 17H14.9961" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/><path id="Vector_5" d="M8.49609 12H11.9961" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></g></svg>'};function L(o){return _t[o]||""}var $t=["#FFFFFF","#151515","#58AEFF","#FF8858","#33D69F","#FFCB47","#E05151","#B36BFF"],$=null;function _(){if(!$)return;let{pop:o,onDoc:e,onKey:t}=$;o.remove(),document.removeEventListener("mousedown",e,!0),document.removeEventListener("keydown",t,!0),window.removeEventListener("scroll",e,!0),$=null}function vt(o,e,t){if($&&$.anchor===o)return _();_();let n=o.getRootNode(),r=n.querySelector&&n.querySelector(".wrap")||document.body,i=JSON.parse(JSON.stringify(e)),l=()=>t(JSON.parse(JSON.stringify(i))),d=s("div",{class:"cpop-body"}),a=(y,V)=>s("button",{class:"cpop-tab"+(i.type===y?" on":""),text:V,onclick:()=>{i.type!==y&&(i=se(y),l(),b())}}),c=s("div",{class:"cpop-tabs"},[a("solid","Solid"),a("linear","Gradient"),a("image","Image")]),u=s("div",{class:"cpop","data-inspect-ui":""},[c,d]);r.appendChild(u);function g(){[...c.children].forEach(y=>y.classList.toggle("on",y.textContent.toLowerCase().startsWith(i.type==="linear"?"grad":i.type)))}function b(){g(),d.innerHTML="",i.type==="solid"?d.append(v()):i.type==="linear"?d.append(k()):d.append(A())}function v(){var w;let y=s("div",{class:"cpop-col"}),V=s("input",{type:"color",class:"cpop-color",value:mt(i.color)});V.addEventListener("input",()=>{i.color=V.value.toUpperCase(),M.value=i.color.replace("#",""),l()});let M=s("input",{class:"cpop-hex",value:(i.color||"#FFFFFF").replace("#","")});M.addEventListener("change",()=>{let E=M.value.trim().replace(/^#/,"");/^([0-9a-f]{3}|[0-9a-f]{6})$/i.test(E)&&(i.color="#"+E.toUpperCase(),V.value="#"+E,l())});let h=s("input",{class:"cpop-alpha",value:Math.round(((w=i.alpha)!=null?w:1)*100)});return h.addEventListener("change",()=>{i.alpha=to(parseFloat(h.value)/100),l()}),y.append(s("div",{class:"cpop-field"},[V,M,s("span",{class:"cpop-unit"},[h,s("span",{text:"%"})])]),s("div",{class:"cpop-presets"},$t.map(E=>s("button",{class:"cpop-preset",style:{background:E},title:E,onclick:()=>{i.color=E,i.alpha=1,l(),b()}})))),y}function k(){var j;let y=s("div",{class:"cpop-col"}),V=s("div",{class:"cpop-gradient-preview"}),M=()=>{V.style.background=O(i)};M();let h=s("input",{class:"cpop-angle",value:(j=i.angle)!=null?j:180});h.addEventListener("change",()=>{i.angle=parseFloat(h.value)||0,l(),M()});let w=s("div",{class:"cpop-stops"}),E=()=>{w.innerHTML="",i.stops.forEach((H,oe)=>{let P=s("input",{type:"color",class:"cpop-stop-color",value:mt(H.color)});P.addEventListener("input",()=>{H.color=P.value.toUpperCase(),l(),M()});let W=s("input",{class:"cpop-stop-pos",value:H.pos});W.addEventListener("change",()=>{H.pos=eo(parseFloat(W.value)||0,0,100),l(),M()});let St=s("button",{class:"cpop-stop-del",html:L("minus-sign"),title:"Remove stop",onclick:()=>{i.stops.length>2&&(i.stops.splice(oe,1),l(),M(),E())}});w.append(s("div",{class:"cpop-stop"},[P,s("span",{class:"cpop-stop-hex",text:(H.color||"").replace("#","")}),W,s("span",{class:"cpop-unit-s",text:"%"}),St]))})};return E(),y.append(V,s("div",{class:"cpop-field cpop-angle-row"},[s("span",{class:"cpop-lab",text:"Angle"}),h,s("span",{class:"cpop-unit-s",text:"\xB0"})]),w,s("button",{class:"cpop-add",html:L("plus"),onclick:()=>{i.stops.push({color:"#FFFFFF",alpha:1,pos:100}),l(),M(),E()}},["Add stop"])),y}function A(){let y=s("div",{class:"cpop-col"}),V=s("input",{class:"cpop-url",placeholder:"Image URL",value:i.url||""});V.addEventListener("change",()=>{i.url=V.value.trim(),l()});let M=s("input",{type:"file",accept:"image/*",style:{display:"none"}});M.addEventListener("change",()=>{let j=M.files&&M.files[0];if(!j)return;let H=new FileReader;H.onload=()=>{i.url=H.result,V.value="uploaded image",l()},H.readAsDataURL(j)});let h=s("button",{class:"cpop-add",html:L("component"),onclick:()=>M.click()},["Upload"]),E=s("div",{class:"cpop-fits"},["cover","contain","fill"].map(j=>s("button",{class:"cpop-fit"+((i.fit||"cover")===j?" on":""),text:j,onclick:()=>{i.fit=j,l(),[...E.children].forEach(H=>H.classList.toggle("on",H.textContent===j))}})));return y.append(s("div",{class:"cpop-field"},[V]),s("div",{class:"cpop-imgrow"},[h,M]),E),y}b();let x=o.getBoundingClientRect();u.style.left=Math.round(Math.min(x.left,window.innerWidth-250))+"px",u.style.top=Math.round(x.bottom+6)+"px";let f=u.getBoundingClientRect();f.bottom>window.innerHeight-8&&(u.style.top=Math.round(x.top-f.height-6)+"px");let C=y=>{!y.composedPath().includes(u)&&!y.composedPath().includes(o)&&_()},T=y=>{y.key==="Escape"&&_()};setTimeout(()=>{document.addEventListener("mousedown",C,!0),document.addEventListener("keydown",T,!0),window.addEventListener("scroll",C,!0)},0),$={pop:u,anchor:o,onDoc:C,onKey:T}}function mt(o){return/^#[0-9a-f]{6}$/i.test(o||"")?o:"#FFFFFF"}function eo(o,e,t){return Math.max(e,Math.min(t,o))}function to(o){return Math.max(0,Math.min(1,isFinite(o)?o:1))}function xt(o){return s("span",{class:"fic",html:L(o)})}function wt(){return s("span",{class:"chev-mini",html:L("chevron-down")})}var oo=["px","%","em","rem","vw","vh","auto"];function ue(o,e){let t=o.getAttribute("min"),n=o.getAttribute("max");return t!==null&&e<parseFloat(t)&&(e=parseFloat(t)),n!==null&&e>parseFloat(n)&&(e=parseFloat(n)),+e.toFixed(2)}function he(o,e,t,n){o.classList.add("scrub"),o.addEventListener("mousedown",r=>{if(r.button!==0)return;r.preventDefault(),r.stopPropagation();let i=r.clientX,l=parseFloat(e.value)||0,d=!1,a=u=>{let g=u.clientX-i;!d&&Math.abs(g)<2||(d=!0,e.value=ue(e,l+g*(u.shiftKey?10:1)),t())},c=()=>{document.removeEventListener("mousemove",a,!0),document.removeEventListener("mouseup",c,!0),document.documentElement.style.cursor="",d&&(n==null||n())};document.addEventListener("mousemove",a,!0),document.addEventListener("mouseup",c,!0),document.documentElement.style.cursor="ew-resize"})}function ge(o,e,t){o.addEventListener("mousedown",n=>{if(n.button!==0)return;let r=n.clientX,i=parseFloat(o.value)||0,l=!1,d=c=>{var g;let u=c.clientX-r;!l&&Math.abs(u)<3||(l||(l=!0,o.blur(),(g=window.getSelection())==null||g.removeAllRanges(),document.documentElement.style.cursor="ew-resize"),o.value=ue(o,i+u*(c.shiftKey?10:1)),e())},a=()=>{document.removeEventListener("mousemove",d,!0),document.removeEventListener("mouseup",a,!0),document.documentElement.style.cursor="",l&&(t==null||t())};document.addEventListener("mousemove",d,!0),document.addEventListener("mouseup",a,!0)})}function I({key:o,iconName:e,value:t,unit:n="px",onChange:r,showUnit:i=!0,sm:l=!1,scrub:d=!0,onDone:a,min:c,max:u}){let g=ne(t),b=/[a-z%]/i.test(String(t!=null?t:"")),v=s("input",{value:g.value,type:"text",inputmode:"decimal"});c!=null&&v.setAttribute("min",c),u!=null&&v.setAttribute("max",u);let k=i?s("span",{class:"unit unit-pick",text:b?g.unit:n}):null,A=()=>{let f=v.value.trim();if(f==="")return r("");let C=/^-?[\d.]+$/.test(f);C&&(c!=null||u!=null)&&(f=String(ue(v,parseFloat(f))),v.value=f),r(C&&i?f+((k==null?void 0:k.textContent)||n):f)};v.addEventListener("change",()=>{A(),a==null||a()}),v.addEventListener("keydown",f=>{if(f.key==="Enter")return v.blur();if(f.key==="ArrowUp"||f.key==="ArrowDown"){let C=parseFloat(v.value)||0;v.value=ue(v,C+(f.key==="ArrowUp"?1:-1)*(f.shiftKey?10:1)),A(),f.preventDefault()}}),i&&k&&k.addEventListener("mousedown",f=>{f.preventDefault(),f.stopPropagation(),kt(k,oo.map(C=>[C,C]),k.textContent,C=>{k.textContent=C,A(),a==null||a()})});let x=e?xt(e):o?s("span",{class:"fk",text:o}):null;return x&&d&&he(x,v,A,a),s("div",{class:"field"+(l?" sm":"")},[x,v,k])}var bt='<svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12.5l4.5 4.5L19 6.5"/></svg>',Z=null;function K(){if(!Z)return;let{menu:o,anchor:e,onDoc:t,onKey:n}=Z;o.remove(),e.classList.remove("open"),document.removeEventListener("mousedown",t,!0),document.removeEventListener("keydown",n,!0),window.removeEventListener("scroll",t,!0),Z=null}function kt(o,e,t,n){if(Z&&Z.anchor===o)return K();K();let r=o.getRootNode(),i=r.querySelector&&r.querySelector(".wrap")||document.body,l=s("div",{class:"dropdown-menu","data-inspect-ui":""},e.map(([b,v])=>{let k=String(b)===String(t),A=s("div",{class:"dropdown-item"+(k?" active":"")},[s("span",{text:v}),k?s("span",{class:"dropdown-check",html:bt}):null]);return A.addEventListener("mousedown",x=>{x.preventDefault(),x.stopPropagation(),n(b),K()}),A}));i.appendChild(l);let d=o.getBoundingClientRect();l.style.left=Math.round(d.left)+"px",l.style.top=Math.round(d.bottom+4)+"px",l.style.minWidth=Math.round(d.width)+"px";let a=l.getBoundingClientRect();a.bottom>window.innerHeight-8&&(l.style.top=Math.round(d.top-a.height-4)+"px");let c=l.querySelector(".dropdown-item.active");c&&c.scrollIntoView({block:"nearest"}),o.classList.add("open");let u=b=>{!b.composedPath().includes(l)&&!b.composedPath().includes(o)&&K()},g=b=>{b.key==="Escape"&&K()};setTimeout(()=>{document.addEventListener("mousedown",u,!0),document.addEventListener("keydown",g,!0),window.addEventListener("scroll",u,!0)},0),Z={menu:l,anchor:o,onDoc:u,onKey:g}}function ee({value:o,options:e,onChange:t,iconName:n,key:r,sm:i=!0}){let l=e.map(g=>Array.isArray(g)?g:[g,g]),d=l.find(([g])=>String(g)===String(o)),a=s("span",{class:"sel-value",text:d?d[1]:o!=null?o:""}),c=s("div",{class:"field select-like"+(i?" sm":""),tabindex:"0"},[n?xt(n):r?s("span",{class:"fk",text:r}):null,a,wt()]),u=()=>kt(c,l,o,g=>{o=g;let b=l.find(([v])=>String(v)===String(g));a.textContent=b?b[1]:g,t(g)});return c.addEventListener("mousedown",g=>{g.preventDefault(),u()}),c.addEventListener("keydown",g=>{(g.key==="Enter"||g.key===" ")&&(g.preventDefault(),u())}),c}function yt({value:o,onChange:e}){let t=s("span",{class:"sel-value",text:o||"System UI"}),n=s("div",{class:"field select-like sm font-field",tabindex:"0"},[t,wt()]),r=()=>no(n,t.textContent,i=>{t.textContent=i,e(i)});return n.addEventListener("mousedown",i=>{i.preventDefault(),r()}),n.addEventListener("keydown",i=>{(i.key==="Enter"||i.key===" ")&&(i.preventDefault(),r())}),n}function no(o,e,t){if(Z&&Z.anchor===o)return K();K(),it();let n=o.getRootNode(),r=n.querySelector&&n.querySelector(".wrap")||document.body,i=s("input",{class:"font-search",type:"text",placeholder:"Search fonts\u2026",spellcheck:"false"}),l=s("div",{class:"font-list"}),d=[["System",ze.map(x=>x.name)],["Google Fonts",J.map(x=>x.name)]],a=[];for(let[x,f]of d){let C=s("div",{class:"font-group"},[s("span",{text:x})]);l.appendChild(C);let T=[];for(let y of f){let V=y===e,M=s("div",{class:"dropdown-item font-item"+(V?" active":"")},[s("span",{class:"font-name",text:y,style:`font-family:${ot(y)}`}),V?s("span",{class:"dropdown-check",html:bt}):null]);M.addEventListener("mousedown",w=>{w.preventDefault(),w.stopPropagation(),t(y),K()}),l.appendChild(M);let h={el:M,name:y,label:y.toLowerCase(),header:C};a.push(h),T.push(h)}C._rows=T}let c=s("div",{class:"dropdown-menu font-menu","data-inspect-ui":""},[i,l]);r.appendChild(c);let u=o.getBoundingClientRect();c.style.left=Math.round(u.left)+"px",c.style.top=Math.round(u.bottom+4)+"px",c.style.minWidth=Math.max(210,Math.round(u.width))+"px";let g=c.getBoundingClientRect();g.bottom>window.innerHeight-8&&(c.style.top=Math.max(8,Math.round(u.top-g.height-4))+"px");let b=c.querySelector(".font-item.active");b&&b.scrollIntoView({block:"center"});let v=()=>{let x=i.value.trim().toLowerCase();for(let f of a)f.el.style.display=!x||f.label.includes(x)?"":"none";for(let f of l.querySelectorAll(".font-group")){let C=f._rows.some(T=>T.el.style.display!=="none");f.style.display=C?"":"none"}};i.addEventListener("input",v),i.addEventListener("keydown",x=>{if(x.key==="Enter"){let f=a.find(C=>C.el.style.display!=="none");f&&(t(f.name),K())}}),o.classList.add("open");let k=x=>{!x.composedPath().includes(c)&&!x.composedPath().includes(o)&&K()},A=x=>{x.key==="Escape"&&K()};setTimeout(()=>{document.addEventListener("mousedown",k,!0),document.addEventListener("keydown",A,!0),window.addEventListener("scroll",k,!0),i.focus()},0),Z={menu:c,anchor:o,onDoc:k,onKey:A}}function Pe(o,e,t,n){return s("button",{class:"exp-btn"+(o?" on":""),title:t,html:L(e),onclick:n})}function fe(o,e,{disabled:t=!1}={}){return s("div",{class:"sub-head"},[s("span",{class:"sub-label",text:o}),s("button",{class:"sub-add"+(t?" off":""),title:"Add "+o,html:L("plus"),onclick:t?null:e})])}function me(o,{active:e=-1,grow:t=!1,seg:n=!1,onPick:r}={}){let i=s("div",{class:"iconrow"+(t?" grow":"")+(n?" seg":"")});return o.forEach((l,d)=>{let a=s("button",{class:"ibtn"+(d===e?" active":""),title:l.title||"",html:L(l.icon),onclick:()=>r==null?void 0:r(l,d,a)});i.appendChild(a)}),i}function Ct(o,e){return s("button",{class:"link-toggle"+(o?" on":""),title:o?"Unlink width & height":"Link width & height (keep aspect ratio)",html:L(o?"link":"link-off"),onclick:e})}function Ne(o,e,t){let n=D(o),r=n.hex,i=n.alpha==null?1:n.alpha,l=s("input",{type:"color",value:r}),d=s("div",{class:"cr-swatch"},[l]);d.style.background=o&&o!=="rgba(0, 0, 0, 0)"?o:"transparent";let a=s("input",{class:"cr-hex",value:r.replace("#","").toUpperCase()}),c=s("input",{class:"cr-alpha",value:Math.round(i*100),min:"0",max:"100"}),u=v=>{let k=re(v,i);d.style.background=k,e(k)};l.addEventListener("input",()=>{a.value=l.value.replace("#","").toUpperCase(),u(l.value)}),a.addEventListener("change",()=>{let v=a.value.trim().replace(/^#/,"");/^([0-9a-f]{3}|[0-9a-f]{6})$/i.test(v)&&(l.value="#"+v,u("#"+v))});let g=s("span",{class:"cr-unit",text:"%"}),b=()=>{let v=Math.max(0,Math.min(100,parseFloat(c.value)||0));c.value=v,i=v/100,u("#"+a.value.trim().replace(/^#/,""))};return c.addEventListener("change",b),ge(c,b),he(g,c,b),s("div",{class:"color-row"},[s("div",{class:"cr-main"},[d,a]),s("div",{class:"cr-pct"},[c,g]),s("button",{class:"cr-del",title:"Remove",html:L("minus-sign"),onclick:t})])}function te(o,e,{open:t=!0}={}){let n=s("div",{class:"sec-content"},e),r=s("div",{class:"sec-head"},[s("span",{text:o}),s("span",{class:"chev",html:L("chevron-down")})]),i=s("div",{class:"section"+(t?"":" closed")},[r,n]);return r.addEventListener("click",()=>i.classList.toggle("closed")),i}function S(o,e){return s("div",{class:"stack"},[s("span",{class:"label",text:o}),e])}function Mt(o,e,t){let n=(d,a)=>{let c=s("input",{class:"sp-edge",value:ne(o[d][a]).value}),u=()=>{let g=String(c.value).trim();e(`${d}-${a}`,/^-?[\d.]+$/.test(g)?g+"px":g)};return c.addEventListener("change",()=>{u(),t==null||t()}),ge(c,u,t),c},r=(d,a,c,u)=>s("div",{class:a},[s("span",{class:"sp-tag",text:c}),n(d,"top"),s("div",{class:"sp-mid"},[n(d,"left"),u,n(d,"right")]),n(d,"bottom")]),i=s("div",{class:"sp-size"},[s("span",{class:"sp-tag",text:"Size"}),s("span",{html:`${ne(o.width||"0").value} <span class="sp-x">x</span> ${ne(o.height||"0").value}`})]),l=r("padding","sp-box sp-padding","Padding",i);return r("margin","sp-box sp-margin","Margin",l)}var ve=class{constructor(e,t={}){this.root=e,this.api=t,this.el=s("div",{class:"panel","data-inspect-ui":""}),e.appendChild(this.el),this._drag()}set(e){this.selected=e,this.render()}render(){let e=p.get();_();let t=this.el.querySelector(".panel-body"),n=t?t.scrollTop:0;this.el.classList.toggle("hidden",e.collapsed),this.el.innerHTML="",this.el.append(this._head());let r=s("div",{class:"panel-body"});e.view==="assets"?this._assets(r):e.view==="changes"?this._changes(r):e.view==="html"?this._html(r):this.selected?this._design(r):r.append(s("div",{class:"empty",text:"Pick an element on the page to inspect and edit its styles."})),this.el.append(r),r.scrollTop=n}_head(e){let t=p.get();if(t.view==="assets"||t.view==="changes"){let l=t.view==="assets"?{title:"Assets",sub:"Everything this page uses"}:{title:"Changes",sub:"Every edit you make, ready to copy"};return s("div",{class:"head"},[s("div",{class:"head-top"},[s("div",{class:"head-id"},[s("div",{class:"head-title",text:l.title}),s("div",{class:"crumb",style:{color:"var(--muted)"},text:l.sub})]),s("div",{class:"head-actions"},[Et(),Ze("x","Close panel",()=>p.set({collapsed:!0}))])])])}let n=e!==void 0?e:this.selected,r=n?Be(n):null,i=n?io(n):[];return s("div",{class:"head"},[s("div",{class:"head-top"},[s("div",{class:"head-id"},[s("div",{class:"head-title",text:n?F(n)||r.tag:"InspectCSS"}),n&&i.length?s("div",{class:"crumb"},i.map(l=>s("span",{text:l}))):null]),s("div",{class:"head-actions"},[n?Ze("delete02","Delete this element",()=>this._deleteSelected(),"danger"):null,Et(),Ze("x","Close panel (Exit InspectCSS from the left dock)",()=>p.set({collapsed:!0}))])]),n?s("div",{class:"dims"},[s("span",{},[s("b",{text:`${R(r.rect.width)} x ${R(r.rect.height)} `}),s("span",{class:"mut",text:"px"})]),s("span",{},[s("span",{class:"mut",text:"A "}),s("b",{text:`${parseInt(r.typography.fontSize)}`}),s("span",{class:"mut",text:"px"})])]):s("div",{class:"crumb",text:"no selection"})])}_design(e){let t=this.selected,n=Be(t),r=h=>w=>z(t,h,w),i=h=>w=>z(t,h,/^-?[\d.]+$/.test(String(w).trim())?w+"px":w),l=()=>this.render(),d=n.transform,a=h=>{Object.assign(d,h),z(t,"transform",ut(d))},c=[{icon:"align-left",title:"Align left",css:["justify-content","flex-start"]},{icon:"align-bottom",title:"Align bottom",css:["align-items","flex-end"]},{icon:"align-right",title:"Align right",css:["justify-content","flex-end"]},{icon:"align-top",title:"Align top",css:["align-items","flex-start"]},{icon:"align-horizontal-center",title:"Center horizontally",css:["justify-content","center"]},{icon:"align-vertical-center",title:"Center vertically",css:["align-items","center"]}];e.append(te("Position",[S("Alignment",me(c,{grow:!0,seg:!0,onPick:h=>z(t,h.css[0],h.css[1])})),S("Position",s("div",{class:"row"},[I({key:"X",value:d.tx+"px",onChange:h=>a({tx:parseFloat(h)||0})}),I({key:"Y",value:d.ty+"px",onChange:h=>a({ty:parseFloat(h)||0})})])),S("Rotation",s("div",{class:"rot-row"},[I({iconName:"rotate01",value:d.rotate+"",showUnit:!1,scrub:!0,onChange:h=>a({rotate:parseFloat(h)||0})}),me([{icon:"image-flip-horizontal",title:"Flip horizontal",axis:"x"},{icon:"image-flip-vertical",title:"Flip vertical",axis:"y"}],{grow:!0,seg:!0,onPick:h=>so(t,h.axis)})]))]));let u=!!this._sizeLinked,g=parseFloat(n.layout.width),b=parseFloat(n.layout.height),v=g>0&&b>0?g/b:0,k=h=>{z(t,"width",h);let w=parseFloat(h);u&&v&&isFinite(w)&&(z(t,"height",Math.round(w/v)+"px"),this.render())},A=h=>{z(t,"height",h);let w=parseFloat(h);u&&v&&isFinite(w)&&(z(t,"width",Math.round(w*v)+"px"),this.render())};e.append(te("Layout",[S("Size",s("div",{class:"size-row"},[I({key:"W",value:n.layout.width,min:0,onDone:l,onChange:k}),Ct(u,()=>{this._sizeLinked=!u,this.render()}),I({key:"H",value:n.layout.height,min:0,onDone:l,onChange:A})])),S("Display",ee({value:n.layout.display,options:["block","inline","inline-block","flex","inline-flex","grid","none"],onChange:r("display")})),s("div",{class:"row"},[S("Row Gap",I({iconName:"paragraph-spacing",value:n.layout.rowGap,showUnit:!1,sm:!0,min:0,onChange:i("row-gap")})),S("Column Gap",I({iconName:"letter-spacing",value:n.layout.columnGap,showUnit:!1,sm:!0,min:0,onChange:i("column-gap")}))]),s("div",{class:"row"},[S("Horizontal Align",ee({value:n.layout.justify,options:[["flex-start","Start"],["center","Center"],["flex-end","End"],["space-between","Between"]],onChange:r("justify-content")})),S("Vertical Align",ee({value:n.layout.align,options:[["flex-start","Start"],["center","Center"],["flex-end","End"],["stretch","Stretch"]],onChange:r("align-items")}))])]));let x=(h,w,E,j,H,oe)=>{let P=w!==E;return I({iconName:h,value:P?"mix":w,showUnit:!P,scrub:!P,onDone:l,min:oe,onChange:W=>{i(j)(W),i(H)(W)}})};e.append(te("Spacing",[S("Padding",s("div",{class:"row"},[x("horizontal-resize",n.spacing.padding.left,n.spacing.padding.right,"padding-left","padding-right",0),x("vertical-resize",n.spacing.padding.top,n.spacing.padding.bottom,"padding-top","padding-bottom",0)])),S("Margin",s("div",{class:"row"},[x("horizontal-resize",n.spacing.margin.left,n.spacing.margin.right,"margin-left","margin-right"),x("vertical-resize",n.spacing.margin.top,n.spacing.margin.bottom,"margin-top","margin-bottom")])),Mt({...n.spacing,width:n.layout.width,height:n.layout.height},(h,w)=>z(t,h,w),l)]));let f=[],C=!!this._cornerExpanded,T=new Set([n.radius.tl,n.radius.tr,n.radius.bl,n.radius.br]).size>1;if(f.push(s("div",{class:"row"},[S("Opacity",I({iconName:"transparency",value:String(Math.round((parseFloat(n.effects.opacity)||1)*100)),unit:"%",min:0,max:100,onChange:h=>r("opacity")(Math.max(0,Math.min(100,parseFloat(h)||100))/100)})),S("Corner",s("div",{class:"corner-mix"},[I({iconName:"full-screen",value:T?"mix":n.radius.all,showUnit:!1,scrub:!T,min:0,onDone:l,onChange:i("border-radius")}),Pe(C,"full-screen",C?"Collapse corners":"Edit each corner",()=>{this._cornerExpanded=!C,this.render()})]))])),C){let h=[["border-top-left-radius",n.radius.tl],["border-top-right-radius",n.radius.tr],["border-bottom-left-radius",n.radius.bl],["border-bottom-right-radius",n.radius.br]];f.push(s("div",{class:"corner-grid"},h.map(([w,E])=>I({iconName:"full-screen",value:E,showUnit:!1,min:0,onDone:l,onChange:i(w)}))))}let y=N(t),V=()=>{let h=ft(N(t));Object.entries(h).forEach(([w,E])=>z(t,w,E))};f.push(fe("Fill",()=>{N(t).unshift(se("solid")),V(),this.render()})),y.forEach((h,w)=>f.push(this._fillRow(t,w,V)));let M=n.border.present;if(f.push(fe("Stroke",()=>{M||(z(t,"border-style","solid"),z(t,"border-width","1px"),ro(n.border.color)||z(t,"border-color","#FFFFFF"),this.render())},{disabled:M})),M){f.push(Ne(n.border.color,r("border-color"),()=>{z(t,"border-width","0px"),this.render()}));let h=n.border.sides,w=new Set([h.top,h.right,h.bottom,h.left]).size>1,E=!!this._strokeSidesExpanded;if(f.push(s("div",{class:"corner-mix"},[I({iconName:"square",value:w?"mix":parseFloat(n.border.width)+"",showUnit:!1,scrub:!w,min:0,onDone:l,onChange:j=>z(t,"border-width",/^-?[\d.]+$/.test(String(j).trim())?j+"px":j)}),Pe(E,"border-all-01",E?"Collapse sides":"Edit each side",()=>{this._strokeSidesExpanded=!E,this.render()})])),E){let j=[["border-top-width","stroke-top",h.top],["border-right-width","stroke-right",h.right],["border-left-width","stroke-left",h.left],["border-bottom-width","stroke-bottom",h.bottom]];f.push(s("div",{class:"corner-grid"},j.map(([H,oe,P])=>I({iconName:oe,value:parseFloat(P)+"",showUnit:!1,min:0,onDone:l,onChange:i(H)}))))}}e.append(te("Appearance",f)),e.append(te("Typography",[S("Typeface",yt({value:lo(n.typography.fontFamily),onChange:h=>{rt(h),r("font-family")(Ie(h))}})),s("div",{class:"row"},[ee({value:ao(n.typography.fontWeight),options:[["300","Light"],["400","Regular"],["500","Medium"],["600","SemiBold"],["700","Bold"],["800","Extra"]],onChange:r("font-weight")}),ee({value:parseInt(n.typography.fontSize)+"",options:["10","12","13","14","16","18","20","24","32","48"].map(h=>[h,h]),onChange:h=>r("font-size")(h+"px")})]),s("div",{class:"row"},[S("Line Height",I({iconName:"paragraph-spacing",value:co(n.typography.lineHeight),showUnit:!1,sm:!0,onChange:r("line-height")})),S("Letter Spacing",I({iconName:"letter-spacing",value:n.typography.letterSpacing,showUnit:!1,sm:!0,onChange:i("letter-spacing")}))]),s("div",{class:"row"},[S("Paragraph Spacing",I({iconName:"expand-paragraph",value:po(n.typography.marginBottom),sm:!0,onChange:r("margin-bottom")})),S("Alignment",me([{icon:"text-align-right",title:"Right",css:"right"},{icon:"text-align-center",title:"Center",css:"center"},{icon:"text-align-start",title:"Left",css:"left"},{icon:"text-align-justify",title:"Justify",css:"justify"}],{grow:!0,seg:!0,active:["right","center","left","justify"].indexOf(n.typography.textAlign),onPick:h=>r("text-align")(h.css)}))]),fe("Fill",()=>{r("color")("#FFFFFF"),this.render()}),Ne(n.typography.color,r("color"),()=>{z(t,"color","inherit"),this.render()})]))}_fillRow(e,t,n){var v;let r=N(e)[t],i=s("button",{class:"cr-swatch cr-swatch-btn",title:"Edit fill"});i.style.background=O(r);let l=s("span",{class:"cr-hex-text",text:Te(r)}),d=s("div",{class:"cr-main cr-main-btn"},[i,l]),a=s("input",{class:"cr-alpha",value:Math.round(((v=r.alpha)!=null?v:1)*100),min:"0",max:"100"}),c=s("span",{class:"cr-unit",text:"%"}),u=()=>{let k=Math.max(0,Math.min(100,parseFloat(a.value)||0));a.value=k;let A=N(e)[t];A.alpha=k/100,n(),i.style.background=O(A)};a.addEventListener("change",u),ge(a,u),he(c,a,u),d.addEventListener("click",()=>{let k=N(e)[t],A=["solid","linear","image"].includes(k.type)?k:se("linear");vt(d,A,x=>{var f;N(e)[t]=x,n(),i.style.background=O(x),l.textContent=Te(x),a.value=Math.round(((f=x.alpha)!=null?f:1)*100)})});let g=s("button",{class:"cr-del",title:"Remove fill",html:L("minus-sign"),onclick:()=>{N(e).splice(t,1),n(),this.render()}}),b=[d];return r.type==="solid"&&b.push(s("div",{class:"cr-pct"},[a,c])),b.push(g),s("div",{class:"color-row"},b)}_changes(e){let t=p.get(),n=Ae(),r=Fe(),i=_e(t.promptDiff);if(e.append(s("div",{class:"view-actions"},[s("button",{class:"btn primary",text:"Copy CSS",onclick:()=>this._copy()}),s("button",{class:"btn",text:"Copy AI prompt",onclick:()=>{var d;i&&((d=navigator.clipboard)==null||d.writeText(i).then(()=>this._toast("AI prompt copied")))}}),s("button",{class:"btn",text:"Clear",onclick:()=>{Xe(),this.render()}})])),!n.length){e.append(s("div",{class:"empty",text:"No changes yet. Edit a property, colour or text and every change is logged here."}));return}e.append(X("Generated CSS",0,r?s("pre",{class:"code",html:go(r)}):s("div",{class:"empty",text:"No CSS edits."})));let l=s("div",{class:"seg-toggle"},[s("button",{class:"seg-btn"+(t.promptDiff?"":" on"),text:"Final",onclick:d=>{d.stopPropagation(),p.set({promptDiff:!1}),this.render()}}),s("button",{class:"seg-btn"+(t.promptDiff?" on":""),text:"Diff",onclick:d=>{d.stopPropagation(),p.set({promptDiff:!0}),this.render()}})]);e.append(X("AI prompt",0,s("div",{},[s("div",{class:"ai-row"},[s("div",{class:"ai-hint",text:"Paste into any AI to apply these changes."}),l]),s("pre",{class:"code ai-prompt",text:i})]),{closed:!0})),e.append(X("Change log",n.length,s("div",{class:"log-list"},[...n].reverse().map(d=>s("div",{class:"log-item"},[s("span",{class:"log-el",text:d.label||d.selector}),s("span",{class:"log-desc",text:Je(d)})]))),{closed:!0}))}_html(e){if(this._expanded=this._expanded||new Set,this._expanded.add(document.documentElement),this._expanded.add(document.body),this.selected){let r=this.selected.parentElement;for(;r;)this._expanded.add(r),r=r.parentElement}let t=s("div",{class:"domtree"});t.addEventListener("mouseleave",()=>{var r,i;(i=(r=this.api).unhover)==null||i.call(r),this._showHeaderFor(this.selected)}),this._renderNode(document.documentElement,t,0),e.append(t);let n=t.querySelector(".tree-row.selected");n&&setTimeout(()=>n.scrollIntoView({block:"center"}),0)}_showHeaderFor(e){let t=this.el.querySelector(".head");t&&this.el.replaceChild(this._head(e),t)}_renderNode(e,t,n){if(e.nodeType!==1||e.hasAttribute&&e.hasAttribute("data-inspect-ui"))return;let r=[...e.children].filter(u=>!(u.hasAttribute&&u.hasAttribute("data-inspect-ui"))),i=r.length>0,l=this._expanded.has(e),d=n*14+8,a=s("span",{class:"tree-tw"+(i?"":" leaf"),html:i?l?Lt.caretDown:Lt.caretRight:""});a.addEventListener("click",u=>{u.stopPropagation(),i&&(l?this._expanded.delete(e):this._expanded.add(e),this.render())});let c=s("div",{class:"tree-row"+(e===this.selected?" selected":""),style:{paddingLeft:d+"px"}},[a,s("span",{class:"tree-tag",html:uo(e,i&&!l)})]);c.addEventListener("mouseenter",()=>{var u,g;(g=(u=this.api).hover)==null||g.call(u,e),this._showHeaderFor(e)}),c.addEventListener("click",()=>{var u,g;(g=(u=this.api).unhover)==null||g.call(u),this.api.pick?this.api.pick(e):(this.selected=e,p.set({selectedEl:e,view:"design"}),this.render())}),t.append(c),i&&l&&(r.forEach(u=>this._renderNode(u,t,n+1)),t.append(s("div",{class:"tree-row tree-close",style:{paddingLeft:d+"px"}},[s("span",{class:"tree-tag",html:ho(e)})])))}_deleteSelected(){let e=this.selected;if(!e)return;let t=e.parentElement;if(!t)return;let n=e.nextElementSibling,r=F(e),i=Y(e);e.remove(),G({type:"delete",id:e.getAttribute("data-inspect-id"),to:"removed",label:r,selector:i}),q({undo:()=>t.insertBefore(e,n),redo:()=>e.remove()});let l=t!==document.body&&t!==document.documentElement?t:null;this.selected=l,p.set({selectedEl:l}),this._toast("Element deleted"),this.render()}_copy(){var t;let e=Fe();e&&((t=navigator.clipboard)==null||t.writeText(e).then(()=>this._toast("CSS copied")))}_toast(e){let t=s("div",{class:"toast","data-inspect-ui":"",text:e});this.root.appendChild(t),setTimeout(()=>t.remove(),1400)}_assets(e){let t=this._assetCache||(this._assetCache=ht()),n=(a,c)=>{var u;(u=navigator.clipboard)==null||u.writeText(a),this._toast(c||"Copied")},r=s("div",{class:"asset-colors"},t.colors.map(a=>s("button",{class:"asset-swatch",title:`${a.hex} \xB7 used ${a.count}\xD7`,style:{background:a.css},onclick:()=>n(a.hex,a.hex+" copied")}))),i=s("div",{class:"asset-type-list"},t.typography.map(a=>s("button",{class:"asset-type",title:"Copy CSS",onclick:()=>n(`font-family: ${a.family};
font-size: ${a.size};
font-weight: ${a.weight};`,"Type style copied")},[s("div",{class:"asset-type-preview",style:{fontFamily:a.family,fontSize:"min("+a.size+", 28px)",fontWeight:a.weight},text:"Ag"}),s("div",{class:"asset-type-meta"},[s("div",{class:"asset-type-name",text:a.family}),s("div",{class:"asset-type-sub",text:`${parseInt(a.size)}px \xB7 ${a.weight}`})])]))),l=s("div",{class:"asset-grid"},t.svgs.map(a=>{let c=s("div",{class:"asset-thumb asset-svg",title:"Copy SVG"});return a.type==="inline"?c.innerHTML=a.markup:c.appendChild(s("img",{src:a.src,alt:""})),c.addEventListener("click",()=>n(a.markup||a.src,"SVG copied")),c})),d=s("div",{class:"asset-grid"},t.images.map(a=>{let c=s("div",{class:"asset-thumb",title:"Copy image URL"},[s("img",{src:a.src,alt:"",loading:"lazy"})]);return c.addEventListener("click",()=>n(a.src,"Image URL copied")),c}));e.append(s("div",{class:"view-actions"},[s("button",{class:"btn primary",text:"Rescan page",onclick:()=>{this._assetCache=null,this.render()}})]),X("Colors",t.colors.length,r),X("Typography",t.typography.length,i),X("SVGs",t.svgs.length,l),X("Images",t.images.length,d))}_drag(){let e,t,n,r,i=!1;this.el.addEventListener("mousedown",a=>{if(!a.target.closest(".head")||a.target.closest(".hbtn")||p.get().docked)return;i=!0;let u=this.el.getBoundingClientRect();e=a.clientX,t=a.clientY,n=u.left,r=u.top,this.el.style.right="auto",this.el.style.left=u.left+"px",this.el.style.top=u.top+"px",document.addEventListener("mousemove",l,!0),document.addEventListener("mouseup",d,!0),a.preventDefault()});let l=a=>{i&&(this.el.style.left=n+(a.clientX-e)+"px",this.el.style.top=Math.max(0,r+(a.clientY-t))+"px")},d=()=>{i=!1,document.removeEventListener("mousemove",l,!0),document.removeEventListener("mouseup",d,!0)}}};function Ze(o,e,t,n=""){return s("button",{class:"hbtn"+(n?" "+n:""),title:e,onclick:t,html:L(o)})}function Et(){let o=p.get().docked;return s("button",{class:"hbtn"+(o?" active":""),title:o?"Undock panel (float)":"Dock panel to the side",onclick:()=>p.set({docked:!p.get().docked}),html:L("sidebar-right-01")})}function ro(o){if(!o)return!1;let e=String(o).trim();if(e==="transparent"||e==="none")return!1;let t=e.match(/rgba?\(([^)]+)\)/i);if(t){let n=t[1].split(",")[3];return n==null||parseFloat(n)>0}return!0}function X(o,e,t,{closed:n=!1}={}){let r=s("div",{class:"sec-head"},[s("span",{},[o,e?s("span",{class:"asset-count",text:String(e)}):null]),s("span",{class:"chev",html:L("chevron-down")})]),i=s("div",{class:"section"+(n?" closed":"")},[r,s("div",{class:"sec-content"},[t])]);return r.addEventListener("click",()=>i.classList.toggle("closed")),i}function io(o){let e=[],t=o,n=0;for(;t&&t.nodeType===1&&t!==document.documentElement&&n<3;)t.classList.length?e.unshift("."+t.classList[0]):e.unshift(t.tagName.toLowerCase()),t=t.parentElement,n++;return e}function so(o,e){let t=getComputedStyle(o),n=t.transform==="none"?"":t.transform+" ";z(o,"transform",n+(e==="x"?"scaleX(-1)":"scaleY(-1)"))}function lo(o){return(o||"").split(",")[0].replace(/["']/g,"").trim()||"system-ui"}function ao(o){return String(o)}function co(o){return o==="normal"?"1.4":o}function po(o){return o&&o!=="auto"?o:"0px"}function Ye(o){return o.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}var Lt={caretRight:'<svg width="10" height="10" viewBox="0 0 10 10" fill="currentColor"><path d="M3 1.5l4 3.5-4 3.5z"/></svg>',caretDown:'<svg width="10" height="10" viewBox="0 0 10 10" fill="currentColor"><path d="M1.5 3h7l-3.5 4z"/></svg>',back:'<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M15 6l-6 6 6 6"/></svg>',pick:'<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 3v3M12 18v3M3 12h3M18 12h3"/><circle cx="12" cy="12" r="4"/></svg>'};function uo(o,e){let t=o.tagName.toLowerCase(),n="";for(let i of o.attributes){if(i.name.startsWith("data-inspect"))continue;let l=i.value.length>40?i.value.slice(0,40)+"\u2026":i.value;n+=` <span class="t-attr">${Ye(i.name)}</span><span class="t-br">=</span><span class="t-val">"${Ye(l)}"</span>`}let r=`<span class="t-br">&lt;</span><span class="t-tag">${t}</span>${n}<span class="t-br">&gt;</span>`;return e&&(r+=`<span class="t-ell">\u2026</span><span class="t-br">&lt;/</span><span class="t-tag">${t}</span><span class="t-br">&gt;</span>`),r}function ho(o){return`<span class="t-br">&lt;/</span><span class="t-tag">${o.tagName.toLowerCase()}</span><span class="t-br">&gt;</span>`}function go(o){return Ye(o).replace(/^([^{\n]+)\{/gm,'<span class="sel">$1</span>{').replace(/^(\s+)([\w-]+)(:)/gm,'$1<span class="prop">$2</span>$3').replace(/: ([^;]+);/g,': <span class="val">$1</span>;')}var xe=class{constructor(e,t){this.api=t,this.el=s("div",{class:"dock","data-inspect-ui":""}),e.appendChild(this.el),this.render(),p.subscribe(()=>this.sync())}render(){this.el.innerHTML="",this.pauseBtn=Vt("pause","Pause / resume picking",()=>p.set({active:!p.get().active}));let e=s("div",{class:"dock-group"},[Q("undo-03","Undo",()=>{var n,r;return(r=(n=this.api).undo)==null?void 0:r.call(n)}),Q("redo-01","Redo",()=>{var n,r;return(r=(n=this.api).redo)==null?void 0:r.call(n)}),Ge(),Q("layer-bring-forward","Select parent element",()=>{var n,r;return(r=(n=this.api).selectParent)==null?void 0:r.call(n)}),Q("layer-send-backward","Select child element",()=>{var n,r;return(r=(n=this.api).selectChild)==null?void 0:r.call(n)}),Ge(),this.assetsBtn=Q("component","Assets (page colors, type, SVGs, images)",()=>{let n=p.get().view;p.set({view:n==="assets"?"design":"assets",collapsed:!1})}),this.codeBtn=Q("file-diff","Changes & AI prompt",()=>p.set({view:"changes",collapsed:!1})),this.htmlBtn=Q("html-file-01","HTML",()=>p.set({view:"html",collapsed:!1})),Ge(),this.respBtn=Q("laptop-phone-sync","Toggle responsive preview",()=>{var n,r;return(r=(n=this.api).toggleResponsive)==null?void 0:r.call(n)})]),t=Vt("cancel-01","Exit InspectCSS",()=>{var n;return(n=window.InspectCSS)==null?void 0:n.destroy()});this.el.append(this.pauseBtn,e,t),this.sync()}sync(){var t,n,r,i,l;let e=p.get();(t=this.pauseBtn)==null||t.classList.toggle("active",e.active),(n=this.assetsBtn)==null||n.classList.toggle("active",e.view==="assets"),(r=this.codeBtn)==null||r.classList.toggle("active",e.view==="changes"),(i=this.htmlBtn)==null||i.classList.toggle("active",e.view==="html"),(l=this.respBtn)==null||l.classList.toggle("active",e.responsive)}};function Vt(o,e,t){return s("button",{class:"dock-circle",title:e,onclick:t,html:L(o)})}function Q(o,e,t){return s("button",{class:"dock-btn",title:e,onclick:t,html:L(o)})}function Ge(){return s("div",{class:"dock-sep"})}var we=class{constructor(e){this.root=e,this.el=s("div",{class:"tooltip","data-inspect-ui":""}),e.appendChild(this.el),e.addEventListener("pointerover",t=>this._over(t),!0),e.addEventListener("pointerout",t=>this._out(t),!0),e.addEventListener("pointerdown",()=>this.hide(),!0),document.addEventListener("pointerover",t=>this._over(t,!0),!0),document.addEventListener("pointerout",t=>this._out(t),!0),document.addEventListener("pointerdown",()=>this.hide(),!0)}_over(e,t=!1){let n=e.target.closest&&e.target.closest("[title],[data-tip]");if(!n||t&&!n.hasAttribute("data-inspect-ui")||!t&&!this.root.contains(n))return;if(n.hasAttribute("title")){let i=n.getAttribute("title");i&&n.setAttribute("data-tip",i),n.removeAttribute("title")}let r=n.getAttribute("data-tip");r&&this.show(r,n)}_out(e){let t=e.target.closest&&e.target.closest("[data-tip]");t&&!t.contains(e.relatedTarget)&&this.hide()}show(e,t){this.el.textContent=e,this.el.classList.add("show");let n=t.getBoundingClientRect(),r=this.el.getBoundingClientRect(),i=n.top-r.height-8,l=n.left+n.width/2-r.width/2;i<6&&(i=n.bottom+8),l=Math.max(6,Math.min(l,window.innerWidth-r.width-6)),this.el.style.left=Math.round(l)+"px",this.el.style.top=Math.round(i)+"px"}hide(){this.el.classList.remove("show")}};var be=class{constructor(e){this.onChange=e,this._onDblClick=this._onDblClick.bind(this),this._onKey=this._onKey.bind(this)}start(){document.addEventListener("dblclick",this._onDblClick,!0)}stop(){document.removeEventListener("dblclick",this._onDblClick,!0),this._finish()}_editable(e){if(!e||e.nodeType!==1||U(e))return null;let t=e;for(;t&&t!==document.body;){let n=[...t.childNodes].some(i=>i.nodeType===3&&i.textContent.trim()),r=![...t.children].some(i=>{let l=getComputedStyle(i).display;return l==="block"||l==="flex"||l==="grid"});if(n&&r)return t;t=t.parentElement}return e.matches("h1,h2,h3,h4,h5,h6,p,span,a,button,li,td,th,label,strong,em,small,div")?e:null}_onDblClick(e){var i,l;if(U(e.target))return;let t=this._editable(e.target);if(!t)return;e.preventDefault(),e.stopPropagation(),p.set({editing:!0,selectedEl:t}),this.el=t,this._origText=t.textContent,le(t),t.setAttribute("contenteditable","true"),t.setAttribute("data-inspect-editing",""),t.focus();let n=(i=document.caretRangeFromPoint)==null?void 0:i.call(document,e.clientX,e.clientY),r=window.getSelection();r.removeAllRanges(),n?r.addRange(n):(l=document.execCommand)==null||l.call(document,"selectAll",!1,null),t.addEventListener("blur",()=>this._finish(),{once:!0}),document.addEventListener("keydown",this._onKey,!0)}_onKey(e){this.el&&(e.key==="Escape"||e.key==="Enter"&&!e.shiftKey&&this.el.tagName!=="DIV")&&(e.preventDefault(),this.el.blur())}_finish(){var e;if(document.removeEventListener("keydown",this._onKey,!0),this.el){let t=this.el;t.removeAttribute("contenteditable"),t.removeAttribute("data-inspect-editing");let n=t.textContent;if(n!==this._origText){let r=this._origText,i=n;G({type:"text",id:t.getAttribute("data-inspect-id"),from:r,to:i,label:F(t),selector:Y(t)}),q({undo:()=>{t.textContent=r},redo:()=>{t.textContent=i}})}this.el=null}p.get().editing&&p.set({editing:!1}),(e=this.onChange)==null||e.call(this)}};var fo=4,qe=new WeakMap;function Qe(o){let e=o.nextElementSibling;for(;e&&U(e);)e=e.nextElementSibling;return e}function mo(o){let e=o.previousElementSibling;for(;e&&U(e);)e=e.previousElementSibling;return e}function vo(o,e){if(o.length>=2){let r=o[0].getBoundingClientRect(),i=o[1].getBoundingClientRect(),l=Math.min(r.bottom,i.bottom)-Math.max(r.top,i.top),d=Math.min(r.right,i.right)-Math.max(r.left,i.left);if(l!==d)return l>d}let t=getComputedStyle(e);return/flex/.test(t.display)&&/row/.test(t.flexDirection)||t.display.includes("inline")||t.display==="grid"&&t.gridAutoFlow.includes("column")}function xo(o){let e=Qe(o);if(e)return`before ${F(e)}`;let t=mo(o);return t?`after ${F(t)}`:"to the only remaining slot"}var wo='<svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M5 9l-3 3 3 3M9 5l3-3 3 3M15 19l-3 3-3-3M19 9l3 3-3 3M2 12h20M12 2v20"/></svg>',ke=class{constructor(e){this.onReorder=e,this.indicator=s("div",{"data-inspect-ui":"",style:{position:"fixed",background:"#58aeff",borderRadius:"2px",pointerEvents:"none",zIndex:"2147483644",display:"none",boxShadow:"0 0 6px rgba(88,174,255,.8)"}}),this.handle=s("div",{"data-inspect-ui":"",title:"Drag to reorder",html:wo,style:{position:"fixed",width:"26px",height:"26px",borderRadius:"999px",display:"none",alignItems:"center",justifyContent:"center",background:"rgba(0,0,0,0.82)",border:"1px solid rgba(255,255,255,0.18)",color:"#fff",cursor:"grab",zIndex:"2147483645",boxShadow:"0 4px 14px rgba(0,0,0,.5)",backdropFilter:"blur(6px)"}}),document.documentElement.append(this.indicator,this.handle),this._down=this._down.bind(this),this._move=this._move.bind(this),this._up=this._up.bind(this),this._reposition=this._reposition.bind(this),this._sync=this._sync.bind(this)}start(){this.handle.addEventListener("mousedown",this._down,!0),this.handle.addEventListener("mouseenter",()=>this.handle.style.background="#58aeff"),this.handle.addEventListener("mouseleave",()=>this.handle.style.background="rgba(0,0,0,0.82)"),this.unsub=p.subscribe(this._sync),window.addEventListener("scroll",this._reposition,!0),window.addEventListener("resize",this._reposition,!0)}stop(){var e;(e=this.unsub)==null||e.call(this),window.removeEventListener("scroll",this._reposition,!0),window.removeEventListener("resize",this._reposition,!0),this.indicator.remove(),this.handle.remove()}_sync(){let e=p.get(),t=e.selectedEl&&!e.dragging&&!e.editing;this.handle.style.display=t?"flex":"none",t&&this._reposition()}_reposition(){let e=p.get().selectedEl;if(!e||this.dragging)return;let t=e.getBoundingClientRect();this.handle.style.left=Math.round(Math.max(4,t.left-8))+"px",this.handle.style.top=Math.round(Math.max(4,t.top-8))+"px"}_down(e){e.button===0&&(e.preventDefault(),e.stopPropagation(),p.get().selectedEl&&(this.sx=e.clientX,this.sy=e.clientY,this.armed=!0,this.dragging=!1,document.addEventListener("mousemove",this._move,!0),document.addEventListener("mouseup",this._up,!0)))}_move(e){if(this.armed){if(!this.dragging){if(Math.hypot(e.clientX-this.sx,e.clientY-this.sy)<fo)return;this.dragging=!0,p.set({dragging:!0}),document.documentElement.style.cursor="grabbing",this.handle.style.display="none"}this._updateTarget(e)}}_updateTarget(e){let t=p.get().selectedEl,n=t==null?void 0:t.parentElement;if(!n)return;let r=[...n.children].filter(a=>!U(a)&&a!==t);if(!r.length){this.ref=void 0,this.indicator.style.display="none";return}let i=vo(r,n),l=i?e.clientX:e.clientY,d=null;for(let a of r){let c=a.getBoundingClientRect(),u=i?c.left+c.width/2:c.top+c.height/2;if(l<u){d=a;break}}this.ref=d,this._drawLine(d,r,i)}_drawLine(e,t,n){let r=t[t.length-1],l=(e||r).getBoundingClientRect();if(n){let d;if(e){let a=t[t.indexOf(e)-1];d=a?(a.getBoundingClientRect().right+l.left)/2:l.left-2}else d=l.right+2;Object.assign(this.indicator.style,{display:"block",left:d-1.5+"px",top:l.top+"px",width:"3px",height:l.height+"px"})}else{let d;if(e){let a=t[t.indexOf(e)-1];d=a?(a.getBoundingClientRect().bottom+l.top)/2:l.top-2}else d=l.bottom+2;Object.assign(this.indicator.style,{display:"block",left:l.left+"px",top:d-1.5+"px",width:l.width+"px",height:"3px"})}}_up(){var t;document.removeEventListener("mousemove",this._move,!0),document.removeEventListener("mouseup",this._up,!0),this.indicator.style.display="none",document.documentElement.style.cursor="";let e=this.dragging;if(this.armed=!1,this.dragging=!1,e){let n=p.get().selectedEl,r=this.ref;if(n&&r!==void 0&&r!==n&&r!==n.nextElementSibling){let l=n.parentElement,d=n.nextElementSibling;qe.has(n)||qe.set(n,Qe(n)),l.insertBefore(n,r||null);let a=n.getAttribute("data-inspect-id");Qe(n)===qe.get(n)?We(a):G({type:"move",id:a,to:"reordered",label:F(n),selector:Y(n),position:xo(n)}),q({undo:()=>l.insertBefore(n,d),redo:()=>l.insertBefore(n,r||null)})}p.set({dragging:!1}),this.ref=void 0;let i=l=>{l.stopPropagation(),l.preventDefault(),document.removeEventListener("click",i,!0)};document.addEventListener("click",i,!0),(t=this.onReorder)==null||t.call(this,n)}this._sync()}};var ye=class{constructor(){this.active=!1,this.width=0,this.handleR=this._makeHandle(),this.handleL=this._makeHandle(),this.label=s("div",{"data-inspect-ui":"",style:{position:"fixed",top:"10px",left:"50%",transform:"translateX(-50%)",zIndex:"2147483645",display:"none",background:"rgba(0,0,0,0.82)",color:"#fff",font:"500 12px 'Quicksand', -apple-system, sans-serif",padding:"4px 10px",borderRadius:"8px",border:"1px solid rgba(255,255,255,0.14)",pointerEvents:"none"}}),document.documentElement.append(this.handleR,this.handleL,this.label),this._down=this._down.bind(this),this._move=this._move.bind(this),this._up=this._up.bind(this),this._reposition=this._reposition.bind(this),this.handleR.addEventListener("mousedown",this._down),this.handleL.addEventListener("mousedown",this._down)}_makeHandle(){let e=s("div",{"data-inspect-ui":"",style:{position:"fixed",top:"0",bottom:"0",width:"12px",cursor:"ew-resize",zIndex:"2147483645",display:"none"}});return e.appendChild(s("div",{style:{position:"absolute",top:"50%",left:"50%",transform:"translate(-50%,-50%)",width:"6px",height:"54px",borderRadius:"4px",background:"#58aeff",boxShadow:"0 0 8px rgba(88,174,255,.7)"}})),e}toggle(){return this.active?this.disable():this.enable(),this.active}enable(){this.active=!0,this.width=Math.min(1024,window.innerWidth-40),this._apply(),this.handleR.style.display="block",this.handleL.style.display="block",this.label.style.display="block",window.addEventListener("resize",this._reposition)}disable(){this.active=!1;let e=document.documentElement;e.style.width="",e.style.margin="",e.style.transition="",this.handleR.style.display="none",this.handleL.style.display="none",this.label.style.display="none",window.removeEventListener("resize",this._reposition)}_apply(){let e=document.documentElement;e.style.width=this.width+"px",e.style.margin="0 auto",this._reposition()}_reposition(){let e=(window.innerWidth+this.width)/2,t=(window.innerWidth-this.width)/2;this.handleR.style.left=e-6+"px",this.handleL.style.left=t-6+"px",this.label.textContent=Math.round(this.width)+" px"}_down(e){e.preventDefault(),this.dragging=!0,document.addEventListener("mousemove",this._move,!0),document.addEventListener("mouseup",this._up,!0),document.documentElement.style.userSelect="none"}_move(e){if(!this.dragging)return;let t=2*Math.abs(e.clientX-window.innerWidth/2);this.width=Math.max(320,Math.min(t,window.innerWidth)),this._apply()}_up(){this.dragging=!1,document.removeEventListener("mousemove",this._move,!0),document.removeEventListener("mouseup",this._up,!0),document.documentElement.style.userSelect=""}destroy(){this.disable(),this.handleR.remove(),this.handleL.remove(),this.label.remove()}};var Ce=`@font-face {
...
`;var De=class{constructor(){this.host=document.createElement("div"),this.host.setAttribute("data-inspect-ui",""),this.host.style.cssText="all: initial; position: static;";let e=this.host.attachShadow({mode:"open"}),t=document.createElement("style");t.textContent=At;let n=document.createElement("div");n.className="wrap",e.append(t,n),document.documentElement.appendChild(this.host),this.fontStyle=document.createElement("style"),this.fontStyle.setAttribute("data-inspect-ui",""),this.fontStyle.textContent=Ce,document.head.appendChild(this.fontStyle),this.overlay=new ae(document.documentElement),this.panel=new ve(n,{hover:r=>{p.set({hoverEl:r}),this.overlay.highlight(r)},unhover:()=>{p.set({hoverEl:null}),this.overlay.hideHover()},pick:r=>this.select(r)}),this.tooltip=new we(n),this.toolbar=new xe(n,{undo:()=>{je(),this._afterHistory()},redo:()=>{ce(),this._afterHistory()},selectParent:()=>this.selectRelative("parent"),selectChild:()=>this.selectRelative("child"),toggleResponsive:()=>this.toggleResponsive()}),this.inspector=new de(this.overlay,r=>this.select(r)),this.textEditor=new be(()=>this.panel.render()),this.dragMove=new ke(r=>{r&&(this.overlay.select(r),this.panel.render())}),this.responsive=new ye,this.textEditor.start(),this.dragMove.start(),this._prevView=p.get().view,this._prevCollapsed=p.get().collapsed,this._prevDocked=p.get().docked,this.unsub=p.subscribe(r=>this.onState(r)),this._track=()=>{this._raf||(this._raf=requestAnimationFrame(()=>{this._raf=0;let r=p.get();r.hoverEl&&this.overlay.highlight(r.hoverEl),r.selectedEl&&this.overlay.select(r.selectedEl)}))},window.addEventListener("scroll",this._track,!0),window.addEventListener("resize",this._track,!0),this._keyHandler=r=>this._onKey(r),window.addEventListener("keydown",this._keyHandler,!0),p.set({active:!0}),this.panel.render()}select(e){p.set({selectedEl:e,collapsed:!1,view:"design"}),this.overlay.select(e),this.panel.set(e)}_afterHistory(){let e=p.get();e.selectedEl&&document.contains(e.selectedEl)?this.overlay.select(e.selectedEl):(this.overlay.hideSelected(),p.set({selectedEl:null})),this.panel.render()}_onKey(e){if(p.get().editing)return;let t=(e.target.tagName||"").toLowerCase();t==="input"||t==="textarea"||e.target.isContentEditable||((e.ctrlKey||e.metaKey)&&e.key.toLowerCase()==="z"?(e.preventDefault(),e.shiftKey?ce():je(),this._afterHistory()):(e.ctrlKey||e.metaKey)&&e.key.toLowerCase()==="y"&&(e.preventDefault(),ce(),this._afterHistory()))}selectRelative(e){let t=p.get().selectedEl;if(!t)return;let n=null;if(e==="parent"){for(n=t.parentElement;n&&n.closest&&n.closest("[data-inspect-ui]");)n=n.parentElement;if(!n)return}else if(n=[...t.children].find(r=>!r.closest("[data-inspect-ui]")),!n)return;p.set({view:"design",collapsed:!1}),this.select(n)}toggleResponsive(){let e=this.responsive.toggle();p.set({responsive:e});let t=p.get();t.selectedEl&&this.overlay.select(t.selectedEl)}onState(e){if(e.active&&!this._picking?(this._picking=!0,this.inspector.start()):!e.active&&this._picking&&(this._picking=!1,this.inspector.stop()),e.selectedEl&&document.contains(e.selectedEl)?this.overlay.select(e.selectedEl):this.overlay.hideSelected(),this.panel.el.classList.toggle("drag-hidden",!!e.dragging),e.docked!==this._prevDocked){this._prevDocked=e.docked,this.panel.el.classList.toggle("docked",e.docked),document.documentElement.style.transition="margin-right .2s ease";let t=Math.round(this.panel.el.getBoundingClientRect().width)||340;document.documentElement.style.marginRight=e.docked?t+"px":"",this.panel.render()}(e.view!==this._prevView||e.collapsed!==this._prevCollapsed)&&(e.view==="assets"&&this._prevView!=="assets"&&(this.panel._assetCache=null),this._prevView=e.view,this._prevCollapsed=e.collapsed,this.panel.render())}destroy(){var t,n;(t=this.unsub)==null||t.call(this),window.removeEventListener("scroll",this._track,!0),window.removeEventListener("resize",this._track,!0),window.removeEventListener("keydown",this._keyHandler,!0),this.textEditor.stop(),this.dragMove.stop(),this.responsive.destroy(),this.inspector.stop(),this.overlay.destroy(),this.host.remove(),(n=this.fontStyle)==null||n.remove(),this.toggleResponsiveOff();let e=document.getElementById("inspect-css-live-styles");e&&e.remove(),delete window.InspectCSS}toggleResponsiveOff(){document.documentElement.style.maxWidth="",document.documentElement.style.margin="",document.documentElement.style.marginRight=""}};function bo(){if(window.InspectCSS){window.InspectCSS.destroy();return}let o=new De;window.InspectCSS={app:o,destroy:()=>o.destroy(),version:"0.16.0"}}bo();})();
