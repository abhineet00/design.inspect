...
`),i.moved&&(o+=`   - reorder it among its siblings to match the new layout
`),r++}return o+=`
Keep everything else unchanged.`,o.trim()}function Ne(n,e){return n=String(n),n.length>e?n.slice(0,e)+"\u2026":n}var K=[],oe=[];function M(n){K.push(n),K.length>200&&K.shift(),oe.length=0}function ne(){let n=K.pop();return n?(n.undo(),oe.push(n),n):null}function T(){let n=oe.pop();return n?(n.redo(),K.push(n),n):null}var be="inspect-css-live-styles";function Te(){let n=document.getElementById(be);return n||(n=document.createElement("style"),n.id=be,n.setAttribute("data-inspect-ui",""),document.head.appendChild(n)),n}function ye(){let{edits:n}=c.get();return[...n.entries()].map(([e,t])=>[e,{inspectId:t.inspectId,pseudo:t.pseudo,selector:t.selector,props:[...t.props.entries()]}])}function ke(n){let e=new Map;for(let[t,o]of n)e.set(t,{inspectId:o.inspectId,pseudo:o.pseudo,selector:o.selector,props:new Map(o.props)});c.get().edits=e,Ce(),c.set({edits:e})}function E(n,e,t){var p,g;let o=ye(),r=Z(n),{edits:i,pseudo:l}=c.get(),d=l==="none"?r:`${r}::${l}`,a=(g=(p=i.get(d))==null?void 0:p.props.get(e))!=null?g:getComputedStyle(n).getPropertyValue(e).trim(),h=i.get(d);h||(h={inspectId:r,pseudo:l,selector:k(n),props:new Map},i.set(d,h)),t===""||t==null?h.props.delete(e):h.props.set(e,t),h.props.size===0&&i.delete(d),Ce(),c.set({edits:i}),t!==""&&t!=null&&C({type:"css",id:r,prop:e,from:a,to:t,pseudo:l,label:b(n),selector:h.selector});let u=ye();M({undo:()=>ke(o),redo:()=>ke(u)})}function re(n,e="none"){let t=n.getAttribute("data-inspect-id");if(!t)return new Map;let o=e==="none"?t:`${t}::${e}`,r=c.get().edits.get(o);return r?r.props:new Map}function Ce(){let{edits:n}=c.get(),e=[];for(let t of n.values()){if(t.props.size===0)continue;let o=ee(t.inspectId)+(t.pseudo!=="none"?":"+t.pseudo:""),r=[...t.props.entries()].map(([i,l])=>`  ${i}: ${l} !important;`).join(`
`);e.push(`${o} {
${r}
}`)}Te().textContent=e.join(`

`)}function ie(){let{edits:n}=c.get(),e=[];for(let t of n.values()){if(t.props.size===0)continue;let o=(t.selector||ee(t.inspectId))+(t.pseudo!=="none"?":"+t.pseudo:""),r=[...t.props.entries()].map(([i,l])=>`  ${i}: ${l};`).join(`
`);e.push(`${o} {
${r}
}`)}return e.join(`

`)}function x(n,e,t,o=t){let r=re(n,c.get().pseudo).get(t);return r!=null?r:e.getPropertyValue(o).trim()}function se(n){let e=getComputedStyle(n),t=n.getBoundingClientRect();return{rect:t,tag:n.tagName.toLowerCase(),layout:{display:x(n,e,"display"),position:x(n,e,"position"),width:e.width,height:e.height,x:v(t.left+window.scrollX),y:v(t.top+window.scrollY),rowGap:e.rowGap==="normal"?"0":e.rowGap,columnGap:e.columnGap==="normal"?"0":e.columnGap,justify:x(n,e,"justify-content"),align:x(n,e,"align-items")},transform:Qe(n,e),spacing:{margin:Me(e,"margin"),padding:Me(e,"padding")},radius:{all:x(n,e,"border-radius"),tl:e.borderTopLeftRadius,tr:e.borderTopRightRadius,br:e.borderBottomRightRadius,bl:e.borderBottomLeftRadius},typography:{fontFamily:e.fontFamily,fontSize:x(n,e,"font-size"),fontWeight:x(n,e,"font-weight"),lineHeight:e.lineHeight,letterSpacing:e.letterSpacing==="normal"?"0px":e.letterSpacing,textAlign:x(n,e,"text-align"),color:x(n,e,"color"),marginBottom:x(n,e,"margin-bottom")},background:{color:x(n,e,"background-color"),image:e.backgroundImage},border:{width:e.borderTopWidth,style:e.borderTopStyle,color:e.borderTopColor},effects:{opacity:x(n,e,"opacity"),boxShadow:e.boxShadow==="none"?"":e.boxShadow}}}function Me(n,e){return{top:n.getPropertyValue(`${e}-top`),right:n.getPropertyValue(`${e}-right`),bottom:n.getPropertyValue(`${e}-bottom`),left:n.getPropertyValue(`${e}-left`)}}function Qe(n,e){let o=re(n,c.get().pseudo).get("transform")||e.transform,r={tx:0,ty:0,rotate:0};if(!o||o==="none")return r;let i=/translate\(\s*(-?[\d.]+)px\s*,\s*(-?[\d.]+)px\s*\)/.exec(o),l=/rotate\(\s*(-?[\d.]+)deg\s*\)/.exec(o);if(i&&(r.tx=parseFloat(i[1]),r.ty=parseFloat(i[2])),l&&(r.rotate=parseFloat(l[1])),i||l)return r;let d=/matrix\(([^)]+)\)/.exec(o);if(d){let[a,h,,,u,p]=d[1].split(",").map(parseFloat);r.tx=v(u),r.ty=v(p),r.rotate=v(Math.atan2(h,a)*(180/Math.PI))}return r}function Ve({tx:n=0,ty:e=0,rotate:t=0}){let o=[];return(n||e)&&o.push(`translate(${v(n)}px, ${v(e)}px)`),t&&o.push(`rotate(${v(t)}deg)`),o.length?o.join(" "):""}var De=6e3,Q=n=>n.closest&&n.closest("[data-inspect-ui]");function le(){let n=document.body?document.body.querySelectorAll("*"):[],e=[];for(let t=0;t<n.length&&e.length<De;t++)Q(n[t])||e.push(n[t]);return e}function Ye(n,e,t){let o=n.get(e);o?o.count++:n.set(e,{...t,count:1})}function qe(){let n=new Map,e=["color","background-color","border-top-color","border-right-color","border-bottom-color","border-left-color","outline-color","fill","stroke"];for(let t of le()){let o=getComputedStyle(t);for(let r of e){let i=o.getPropertyValue(r).trim();if(!i||i==="none")continue;let{hex:l,alpha:d}=U(i);if(d===0||l==="#000000"&&r==="fill")continue;let a=l+"|"+d;Ye(n,a,{hex:l,alpha:d,css:i})}}return[...n.values()].sort((t,o)=>o.count-t.count).slice(0,80)}function Ge(){let n=new Map;for(let e of le()){if(![...e.childNodes].some(u=>u.nodeType===3&&u.textContent.trim()))continue;let o=getComputedStyle(e),r=(o.fontFamily||"").split(",")[0].replace(/["']/g,"").trim(),i=o.fontSize,l=o.fontWeight,d=`${r}|${i}|${l}`,a=e.textContent.trim().slice(0,40),h=n.get(d);h?h.count++:n.set(d,{family:r,size:i,weight:l,lineHeight:o.lineHeight,letterSpacing:o.letterSpacing,sample:a,count:1})}return[...n.values()].sort((e,t)=>parseFloat(t.size)-parseFloat(e.size)||t.count-e.count).slice(0,60)}function Oe(){let n=[],e=new Set;for(let t of document.querySelectorAll("svg")){if(Q(t))continue;let o=t.outerHTML;/xmlns=/.test(o)||(o=o.replace("<svg",'<svg xmlns="http://www.w3.org/2000/svg"'));let r=o.slice(0,400);if(e.has(r)||o.length>4e4)continue;e.add(r);let i=t.getBoundingClientRect();if(n.push({type:"inline",markup:o,w:Math.round(i.width),h:Math.round(i.height)}),n.length>120)break}for(let t of document.querySelectorAll('img[src$=".svg"], img[src*=".svg?"]'))Q(t)||e.has(t.src)||(e.add(t.src),n.push({type:"url",src:t.src,markup:""}));return n}function Xe(){let n=[],e=new Set,t=o=>{!o||e.has(o)||o.endsWith(".svg")||o.startsWith("data:image/svg")||(e.add(o),n.push({src:o}))};for(let o of document.querySelectorAll("img"))Q(o)||(o.currentSrc||o.src)&&t(o.currentSrc||o.src);for(let o of le()){let r=getComputedStyle(o).backgroundImage;if(!r||r==="none")continue;let i,l=/url\((['"]?)([^'")]+)\1\)/g;for(;i=l.exec(r);)t(new URL(i[2],location.href).href);if(n.length>120)break}return n}function Ee(){return{colors:qe(),typography:Ge(),svgs:Oe(),images:Xe()}}var Fe={"align-bottom":`<svg preserveAspectRatio="xMidYMid meet" overflow="visible" style="display: block;" width="100%" height="100%" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
<g id="align-bottom">
...
</svg>`};function w(n){return Fe[n]||""}function Le(n){return s("span",{class:"fic",html:w(n)})}function We(){return s("span",{class:"chev-mini",html:w("chevron-down")})}function m({key:n,iconName:e,value:t,unit:o="px",onChange:r,showUnit:i=!0,sm:l=!1}){let d=H(t),a=/[a-z%]/i.test(String(t!=null?t:"")),h=s("input",{value:d.value,type:"text",inputmode:"decimal"}),u=i?s("span",{class:"unit",text:a?d.unit:o}):null,p=()=>{let g=h.value.trim();if(g==="")return r("");let V=/^-?[\d.]+$/.test(g);r(V&&i?g+((u==null?void 0:u.textContent)||o):g)};if(h.addEventListener("change",p),h.addEventListener("keydown",g=>{if(g.key==="Enter")return h.blur();if(g.key==="ArrowUp"||g.key==="ArrowDown"){let V=parseFloat(h.value)||0;h.value=+(V+(g.key==="ArrowUp"?1:-1)*(g.shiftKey?10:1)).toFixed(2),p(),g.preventDefault()}}),i&&u){let g=["px","%","em","rem","vw","vh"];u.style.cursor="pointer",u.addEventListener("click",()=>{u.textContent=g[(g.indexOf(u.textContent)+1)%g.length],p()})}return s("div",{class:"field"+(l?" sm":"")},[e?Le(e):n?s("span",{class:"fk",text:n}):null,h,u])}var Je='<svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12.5l4.5 4.5L19 6.5"/></svg>',j=null;function R(){if(!j)return;let{menu:n,anchor:e,onDoc:t,onKey:o}=j;n.remove(),e.classList.remove("open"),document.removeEventListener("mousedown",t,!0),document.removeEventListener("keydown",o,!0),window.removeEventListener("scroll",t,!0),j=null}function _e(n,e,t,o){if(j&&j.anchor===n)return R();R();let r=n.getRootNode(),i=r.querySelector&&r.querySelector(".wrap")||document.body,l=s("div",{class:"dropdown-menu","data-inspect-ui":""},e.map(([g,V])=>{let he=String(g)===String(t),ue=s("div",{class:"dropdown-item"+(he?" active":"")},[s("span",{text:V}),he?s("span",{class:"dropdown-check",html:Je}):null]);return ue.addEventListener("mousedown",ge=>{ge.preventDefault(),ge.stopPropagation(),o(g),R()}),ue}));i.appendChild(l);let d=n.getBoundingClientRect();l.style.left=Math.round(d.left)+"px",l.style.top=Math.round(d.bottom+4)+"px",l.style.minWidth=Math.round(d.width)+"px";let a=l.getBoundingClientRect();a.bottom>window.innerHeight-8&&(l.style.top=Math.round(d.top-a.height-4)+"px");let h=l.querySelector(".dropdown-item.active");h&&h.scrollIntoView({block:"nearest"}),n.classList.add("open");let u=g=>{!g.composedPath().includes(l)&&!g.composedPath().includes(n)&&R()},p=g=>{g.key==="Escape"&&R()};setTimeout(()=>{document.addEventListener("mousedown",u,!0),document.addEventListener("keydown",p,!0),window.addEventListener("scroll",u,!0)},0),j={menu:l,anchor:n,onDoc:u,onKey:p}}function L({value:n,options:e,onChange:t,iconName:o,key:r,sm:i=!0}){let l=e.map(p=>Array.isArray(p)?p:[p,p]),d=l.find(([p])=>String(p)===String(n)),a=s("span",{class:"sel-value",text:d?d[1]:n!=null?n:""}),h=s("div",{class:"field select-like"+(i?" sm":""),tabindex:"0"},[o?Le(o):r?s("span",{class:"fk",text:r}):null,a,We()]),u=()=>_e(h,l,n,p=>{n=p;let g=l.find(([V])=>String(V)===String(p));a.textContent=g?g[1]:p,t(p)});return h.addEventListener("mousedown",p=>{p.preventDefault(),u()}),h.addEventListener("keydown",p=>{(p.key==="Enter"||p.key===" ")&&(p.preventDefault(),u())}),h}function z(n,{active:e=-1,grow:t=!1,seg:o=!1,onPick:r}={}){let i=s("div",{class:"iconrow"+(t?" grow":"")+(o?" seg":"")});return n.forEach((l,d)=>{let a=s("button",{class:"ibtn"+(d===e?" active":""),title:l.title||"",html:w(l.icon),onclick:()=>r==null?void 0:r(l,d,a)});i.appendChild(a)}),i}function ae(n,e,{showPct:t=!0}={}){let o=U(n),r=o.hex,i=o.alpha===0?1:o.alpha,l=s("input",{type:"color",value:r}),d=s("div",{class:"swatch"},[l]);d.style.background=n&&n!=="rgba(0, 0, 0, 0)"?n:"transparent";let a=s("input",{class:"hex",value:r.replace("#","")}),h=t?s("span",{class:"pct",text:Math.round(i*100)+"%"}):null,u=p=>{let g=fe(p,i);d.style.background=g,e(g)};return l.addEventListener("input",()=>{a.value=l.value.replace("#",""),u(l.value)}),a.addEventListener("change",()=>{let p=a.value.trim().replace(/^#/,"");/^([0-9a-f]{3}|[0-9a-f]{6})$/i.test(p)?(l.value="#"+p,u("#"+p)):e(a.value.trim())}),s("div",{class:"colorline"},[d,a,h])}function S(n,e,{open:t=!0}={}){let o=s("div",{class:"sec-content"},e),r=s("div",{class:"sec-head"},[s("span",{text:n}),s("span",{class:"chev",html:w("chevron-down")})]),i=s("div",{class:"section"+(t?"":" closed")},[r,o]);return r.addEventListener("click",()=>i.classList.toggle("closed")),i}function f(n,e){return s("div",{class:"stack"},[s("span",{class:"label",text:n}),e])}function Ae(n,e){let t=(l,d)=>{let a=s("input",{class:"sp-edge",value:H(n[l][d]).value});return a.addEventListener("change",()=>{let h=a.value.trim();e(`${l}-${d}`,/^-?[\d.]+$/.test(h)?h+"px":h)}),a},o=(l,d,a,h)=>s("div",{class:d},[s("span",{class:"sp-tag",text:a}),t(l,"top"),s("div",{class:"sp-mid"},[t(l,"left"),h,t(l,"right")]),t(l,"bottom")]),r=s("div",{class:"sp-size"},[s("span",{class:"sp-tag",text:"Size"}),s("span",{html:`${H(n.width||"0").value} <span class="sp-x">x</span> ${H(n.height||"0").value}`})]),i=o("padding","sp-box sp-padding","Padding",r);return o("margin","sp-box sp-margin","Margin",i)}var Y=class{constructor(e){this.root=e,this.el=s("div",{class:"panel","data-inspect-ui":""}),e.appendChild(this.el),this._drag()}set(e){this.selected=e,this.render()}render(){let e=c.get();this.el.classList.toggle("hidden",e.collapsed),this.el.innerHTML="",this.el.append(this._head());let t=s("div",{class:"panel-body"});e.view==="assets"?this._assets(t):e.view==="changes"?this._changes(t):this.selected?e.view==="html"?this._html(t):this._design(t):t.append(s("div",{class:"empty",text:"Pick an element on the page to inspect and edit its styles."})),this.el.append(t)}_head(){if(c.get().view==="assets")return s("div",{class:"head"},[s("div",{class:"head-top"},[s("div",{class:"head-title",text:"Assets"}),s("div",{class:"head-actions"},[B("minimize-screen","Close panel",()=>c.set({collapsed:!0})),B("x","Close panel",()=>c.set({collapsed:!0}))])]),s("div",{class:"crumb",style:{color:"var(--muted)"},text:"Everything this page uses"})]);let t=this.selected,o=t?se(t):null,r=t?tt(t):[];return s("div",{class:"head"},[s("div",{class:"head-top"},[s("div",{class:"head-title",text:t?b(t)||o.tag:"InspectCSS"}),s("div",{class:"head-actions"},[B("delete02","Delete this element",()=>this._deleteSelected(),"danger"),et(),B("minimize-screen","Close panel",()=>c.set({collapsed:!0})),B("x","Close panel (Exit InspectCSS from the left dock)",()=>c.set({collapsed:!0}))])]),t?s("div",{class:"crumb"},r.map(i=>s("span",{text:i}))):null,t?s("div",{class:"dims"},[s("span",{html:`<b>${v(o.rect.width)}</b> x <b>${v(o.rect.height)}</b> px`}),s("span",{html:`A <b>${parseInt(o.typography.fontSize)}px</b>`})]):s("div",{class:"crumb",text:"no selection"})])}_design(e){let t=this.selected,o=se(t),r=p=>g=>E(t,p,g),i=p=>g=>E(t,p,/^-?[\d.]+$/.test(String(g).trim())?g+"px":g),l=o.transform,d=p=>{Object.assign(l,p),E(t,"transform",Ve(l))},a=[{icon:"align-left",title:"Align left",css:["justify-content","flex-start"]},{icon:"align-bottom",title:"Align bottom",css:["align-items","flex-end"]},{icon:"align-right",title:"Align right",css:["justify-content","flex-end"]},{icon:"align-top",title:"Align top",css:["align-items","flex-start"]},{icon:"align-horizontal-center",title:"Center horizontally",css:["justify-content","center"]},{icon:"align-vertical-center",title:"Center vertically",css:["align-items","center"]}];e.append(S("Position",[f("Alignment",z(a,{grow:!0,seg:!0,onPick:p=>E(t,p.css[0],p.css[1])})),f("Position",s("div",{class:"row"},[m({key:"X",value:l.tx+"px",onChange:p=>d({tx:parseFloat(p)||0})}),m({key:"Y",value:l.ty+"px",onChange:p=>d({ty:parseFloat(p)||0})})])),f("Rotation",s("div",{class:"rot-row"},[m({iconName:"rotate01",value:l.rotate+"",showUnit:!1,onChange:p=>d({rotate:parseFloat(p)||0})}),z([{icon:"image-flip-horizontal",title:"Flip horizontal"}],{grow:!0,onPick:()=>ze(t,"x")}),z([{icon:"image-flip-vertical",title:"Flip vertical"}],{grow:!0,onPick:()=>ze(t,"y")})]))])),e.append(S("Layout",[f("Size",s("div",{class:"row"},[m({key:"W",value:o.layout.width,onChange:r("width")}),m({key:"H",value:o.layout.height,onChange:r("height")})])),f("Display",L({value:o.layout.display,options:["block","inline","inline-block","flex","inline-flex","grid","none"],onChange:r("display")})),s("div",{class:"row"},[f("Row Gap",m({iconName:"paragraph-spacing",value:o.layout.rowGap,showUnit:!1,sm:!0,onChange:i("row-gap")})),f("Column Gap",m({iconName:"letter-spacing",value:o.layout.columnGap,showUnit:!1,sm:!0,onChange:i("column-gap")}))]),s("div",{class:"row"},[f("Horizontal Align",L({value:o.layout.justify,options:[["flex-start","Start"],["center","Center"],["flex-end","End"],["space-between","Between"]],onChange:r("justify-content")})),f("Vertical Align",L({value:o.layout.align,options:[["flex-start","Start"],["center","Center"],["flex-end","End"],["stretch","Stretch"]],onChange:r("align-items")}))])])),e.append(S("Spacing",[f("Padding",s("div",{class:"row"},[m({iconName:"horizontal-resize",value:o.spacing.padding.left,onChange:p=>{r("padding-left")(p),r("padding-right")(p)}}),m({iconName:"vertical-resize",value:o.spacing.padding.top,onChange:p=>{r("padding-top")(p),r("padding-bottom")(p)}})])),f("Margin",s("div",{class:"row"},[m({iconName:"horizontal-resize",value:o.spacing.margin.left,onChange:p=>{r("margin-left")(p),r("margin-right")(p)}}),m({iconName:"vertical-resize",value:o.spacing.margin.top,onChange:p=>{r("margin-top")(p),r("margin-bottom")(p)}})])),Ae({...o.spacing,width:o.layout.width,height:o.layout.height},(p,g)=>E(t,p,g))]));let h=[{key:"tl",prop:"border-top-left-radius",v:o.radius.tl},{key:"tr",prop:"border-top-right-radius",v:o.radius.tr},{key:"bl",prop:"border-bottom-left-radius",v:o.radius.bl},{key:"br",prop:"border-bottom-right-radius",v:o.radius.br}],u=new Set([o.radius.tl,o.radius.tr,o.radius.bl,o.radius.br]).size>1;e.append(S("Appearance",[s("div",{class:"row"},[f("Opacity",m({iconName:"transparency",value:String(Math.round((parseFloat(o.effects.opacity)||1)*100)),unit:"%",onChange:p=>r("opacity")((parseFloat(p)||100)/100)})),f("Corner",s("div",{class:"corner-mix"},[m({iconName:"full-screen",value:u?"mix":o.radius.all,showUnit:!1,onChange:i("border-radius")}),z([{icon:"full-screen",title:"Link corners"}],{onPick:()=>i("border-radius")(o.radius.tl)})]))]),s("div",{class:"corner-grid"},h.map(p=>m({iconName:"full-screen",value:p.v,showUnit:!1,onChange:i(p.prop)}))),je("Fill",()=>{this._fillOpen=!this._fillOpen,this.render()}),this._fillOpen?ae(o.background.color,r("background-color")):null,je("Stroke",()=>{this._strokeOpen=!this._strokeOpen,this.render()}),this._strokeOpen?ae(o.border.color,r("border-color")):null])),e.append(S("Typography",[f("Typeface",L({value:Se(o.typography.fontFamily),options:[Se(o.typography.fontFamily),"Quicksand","Inter","Arial","Georgia","system-ui","monospace"],onChange:r("font-family")})),s("div",{class:"row"},[L({value:ot(o.typography.fontWeight),options:[["300","Light"],["400","Regular"],["500","Medium"],["600","SemiBold"],["700","Bold"],["800","Extra"]],onChange:r("font-weight")}),L({value:parseInt(o.typography.fontSize)+"",options:["10","12","13","14","16","18","20","24","32","48"].map(p=>[p,p]),onChange:p=>r("font-size")(p+"px")})]),s("div",{class:"row"},[f("Line Height",m({iconName:"paragraph-spacing",value:nt(o.typography.lineHeight),showUnit:!1,sm:!0,onChange:r("line-height")})),f("Letter Spacing",m({iconName:"letter-spacing",value:o.typography.letterSpacing,showUnit:!1,sm:!0,onChange:i("letter-spacing")}))]),s("div",{class:"row"},[f("Paragraph Spacing",m({iconName:"expand-paragraph",value:rt(o.typography.marginBottom),sm:!0,onChange:r("margin-bottom")})),f("Alignment",z([{icon:"text-align-right",title:"Right",css:"right"},{icon:"text-align-center",title:"Center",css:"center"},{icon:"text-align-start",title:"Left",css:"left"},{icon:"text-align-justify",title:"Justify",css:"justify"}],{grow:!0,seg:!0,active:["right","center","left","justify"].indexOf(o.typography.textAlign),onPick:p=>r("text-align")(p.css)}))])]))}_changes(e){let t=c.get(),o=te(),r=ie(),i=we(t.promptDiff);if(e.append(s("div",{class:"view-actions"},[s("button",{class:"btn primary",text:"Copy CSS",onclick:()=>this._copy()}),s("button",{class:"btn",text:"Copy AI prompt",onclick:()=>{var d;i&&((d=navigator.clipboard)==null||d.writeText(i).then(()=>this._toast("AI prompt copied")))}}),s("button",{class:"btn",text:"Clear",onclick:()=>{ve(),this.render()}})])),!o.length){e.append(s("div",{class:"empty",text:"No changes yet. Edit a property, colour or text and every change is logged here."}));return}e.append(A("Change log",o.length,s("div",{class:"log-list"},[...o].reverse().map(d=>s("div",{class:"log-item"},[s("span",{class:"log-el",text:d.label||d.selector}),s("span",{class:"log-desc",text:xe(d)})])))));let l=s("div",{class:"seg-toggle"},[s("button",{class:"seg-btn"+(t.promptDiff?"":" on"),text:"Final",onclick:()=>{c.get().promptDiff=!1,c.set({promptDiff:!1}),this.render()}}),s("button",{class:"seg-btn"+(t.promptDiff?" on":""),text:"Diff",onclick:()=>{c.get().promptDiff=!0,c.set({promptDiff:!0}),this.render()}})]);e.append(A("AI prompt",0,s("div",{},[s("div",{class:"ai-row"},[s("div",{class:"ai-hint",text:"Paste into any AI to apply these changes."}),l]),s("pre",{class:"code ai-prompt",text:i})]))),e.append(A("Generated CSS",0,r?s("pre",{class:"code",html:lt(r)}):s("div",{class:"empty",text:"No CSS edits."})))}_html(e){if(this._expanded=this._expanded||new Set,this._expanded.add(document.documentElement),this._expanded.add(document.body),this.selected){let i=this.selected.parentElement;for(;i;)this._expanded.add(i),i=i.parentElement}let t=s("div",{class:"domtree"});this._renderNode(document.documentElement,t,0);let o=s("div",{class:"tree-footer"},[s("button",{class:"tree-btn",onclick:()=>c.set({view:"design"})},[s("span",{html:D.back}),"Back"]),s("button",{class:"tree-btn",onclick:()=>c.set({active:!0})},[s("span",{html:D.pick}),"Pick an element"])]);e.append(t,o);let r=t.querySelector(".tree-row.selected");r&&setTimeout(()=>r.scrollIntoView({block:"center"}),0)}_renderNode(e,t,o){if(e.nodeType!==1||e.hasAttribute&&e.hasAttribute("data-inspect-ui"))return;let r=[...e.children].filter(u=>!(u.hasAttribute&&u.hasAttribute("data-inspect-ui"))),i=r.length>0,l=this._expanded.has(e),d=o*14+8,a=s("span",{class:"tree-tw"+(i?"":" leaf"),html:i?l?D.caretDown:D.caretRight:""});a.addEventListener("click",u=>{u.stopPropagation(),i&&(l?this._expanded.delete(e):this._expanded.add(e),this.render())});let h=s("div",{class:"tree-row"+(e===this.selected?" selected":""),style:{paddingLeft:d+"px"}},[a,s("span",{class:"tree-tag",html:it(e,i&&!l)})]);h.addEventListener("click",()=>{this.selected=e,c.set({selectedEl:e}),this.render()}),t.append(h),i&&l&&(r.forEach(u=>this._renderNode(u,t,o+1)),t.append(s("div",{class:"tree-row tree-close",style:{paddingLeft:d+"px"}},[s("span",{class:"tree-tag",html:st(e)})])))}_deleteSelected(){let e=this.selected;if(!e)return;let t=e.parentElement;if(!t)return;let o=e.nextElementSibling,r=b(e),i=k(e);e.remove(),C({type:"delete",id:e.getAttribute("data-inspect-id"),to:"removed",label:r,selector:i}),M({undo:()=>t.insertBefore(e,o),redo:()=>e.remove()});let l=t!==document.body&&t!==document.documentElement?t:null;this.selected=l,c.set({selectedEl:l}),this._toast("Element deleted"),this.render()}_copy(){var t;let e=ie();e&&((t=navigator.clipboard)==null||t.writeText(e).then(()=>this._toast("CSS copied")))}_toast(e){let t=s("div",{class:"toast","data-inspect-ui":"",text:e});this.root.appendChild(t),setTimeout(()=>t.remove(),1400)}_assets(e){let t=this._assetCache||(this._assetCache=Ee()),o=(a,h)=>{var u;(u=navigator.clipboard)==null||u.writeText(a),this._toast(h||"Copied")},r=s("div",{class:"asset-colors"},t.colors.map(a=>s("button",{class:"asset-swatch",title:`${a.hex} \xB7 used ${a.count}\xD7`,style:{background:a.css},onclick:()=>o(a.hex,a.hex+" copied")}))),i=s("div",{class:"asset-type-list"},t.typography.map(a=>s("button",{class:"asset-type",title:"Copy CSS",onclick:()=>o(`font-family: ${a.family};
font-size: ${a.size};
font-weight: ${a.weight};`,"Type style copied")},[s("div",{class:"asset-type-preview",style:{fontFamily:a.family,fontSize:"min("+a.size+", 28px)",fontWeight:a.weight},text:"Ag"}),s("div",{class:"asset-type-meta"},[s("div",{class:"asset-type-name",text:a.family}),s("div",{class:"asset-type-sub",text:`${parseInt(a.size)}px \xB7 ${a.weight}`})])]))),l=s("div",{class:"asset-grid"},t.svgs.map(a=>{let h=s("div",{class:"asset-thumb asset-svg",title:"Copy SVG"});return a.type==="inline"?h.innerHTML=a.markup:h.appendChild(s("img",{src:a.src,alt:""})),h.addEventListener("click",()=>o(a.markup||a.src,"SVG copied")),h})),d=s("div",{class:"asset-grid"},t.images.map(a=>{let h=s("div",{class:"asset-thumb",title:"Copy image URL"},[s("img",{src:a.src,alt:"",loading:"lazy"})]);return h.addEventListener("click",()=>o(a.src,"Image URL copied")),h}));e.append(s("div",{class:"view-actions"},[s("button",{class:"btn primary",text:"Rescan page",onclick:()=>{this._assetCache=null,this.render()}})]),A("Colors",t.colors.length,r),A("Typography",t.typography.length,i),A("SVGs",t.svgs.length,l),A("Images",t.images.length,d))}_drag(){let e,t,o,r,i=!1;this.el.addEventListener("mousedown",a=>{if(!a.target.closest(".head")||a.target.closest(".hbtn")||c.get().docked)return;i=!0;let u=this.el.getBoundingClientRect();e=a.clientX,t=a.clientY,o=u.left,r=u.top,this.el.style.right="auto",document.addEventListener("mousemove",l,!0),document.addEventListener("mouseup",d,!0),a.preventDefault()});let l=a=>{i&&(this.el.style.left=o+(a.clientX-e)+"px",this.el.style.top=Math.max(0,r+(a.clientY-t))+"px")},d=()=>{i=!1,document.removeEventListener("mousemove",l,!0),document.removeEventListener("mouseup",d,!0)}}};function B(n,e,t,o=""){return s("button",{class:"hbtn"+(o?" "+o:""),title:e,onclick:t,html:w(n)})}var $e='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6"><rect x="3" y="4" width="18" height="16" rx="3"/><path d="M15 4v16" stroke-linecap="round"/><path d="M18 9l-1.5 3 1.5 3" stroke-linecap="round" stroke-linejoin="round"/></svg>';function et(){let n=c.get().docked;return s("button",{class:"hbtn"+(n?" active":""),title:n?"Undock panel (float)":"Dock panel to the side",onclick:()=>c.set({docked:!c.get().docked}),html:$e})}function je(n,e){return s("div",{class:"addrow"},[s("span",{class:"k",text:n}),s("button",{class:"addbtn",title:"Add "+n,html:w("plus"),onclick:e})])}function A(n,e,t){let o=s("div",{class:"sec-head"},[s("span",{},[n,e?s("span",{class:"asset-count",text:String(e)}):null]),s("span",{class:"chev",html:w("chevron-down")})]),r=s("div",{class:"section"},[o,s("div",{class:"sec-content"},[t])]);return o.addEventListener("click",()=>r.classList.toggle("closed")),r}function tt(n){let e=[],t=n,o=0;for(;t&&t.nodeType===1&&t!==document.documentElement&&o<3;)t.classList.length?e.unshift("."+t.classList[0]):e.unshift(t.tagName.toLowerCase()),t=t.parentElement,o++;return e}function ze(n,e){let t=getComputedStyle(n),o=t.transform==="none"?"":t.transform+" ";E(n,"transform",o+(e==="x"?"scaleX(-1)":"scaleY(-1)"))}function Se(n){return(n||"").split(",")[0].replace(/["']/g,"").trim()||"system-ui"}function ot(n){return String(n)}function nt(n){return n==="normal"?"1.4":n}function rt(n){return n&&n!=="auto"?n:"0px"}function de(n){return n.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}var D={caretRight:'<svg width="10" height="10" viewBox="0 0 10 10" fill="currentColor"><path d="M3 1.5l4 3.5-4 3.5z"/></svg>',caretDown:'<svg width="10" height="10" viewBox="0 0 10 10" fill="currentColor"><path d="M1.5 3h7l-3.5 4z"/></svg>',back:'<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M15 6l-6 6 6 6"/></svg>',pick:'<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 3v3M12 18v3M3 12h3M18 12h3"/><circle cx="12" cy="12" r="4"/></svg>'};function it(n,e){let t=n.tagName.toLowerCase(),o="";for(let i of n.attributes){if(i.name.startsWith("data-inspect"))continue;let l=i.value.length>40?i.value.slice(0,40)+"\u2026":i.value;o+=` <span class="t-attr">${de(i.name)}</span><span class="t-br">=</span><span class="t-val">"${de(l)}"</span>`}let r=`<span class="t-br">&lt;</span><span class="t-tag">${t}</span>${o}<span class="t-br">&gt;</span>`;return e&&(r+=`<span class="t-ell">\u2026</span><span class="t-br">&lt;/</span><span class="t-tag">${t}</span><span class="t-br">&gt;</span>`),r}function st(n){return`<span class="t-br">&lt;/</span><span class="t-tag">${n.tagName.toLowerCase()}</span><span class="t-br">&gt;</span>`}function lt(n){return de(n).replace(/^([^{\n]+)\{/gm,'<span class="sel">$1</span>{').replace(/^(\s+)([\w-]+)(:)/gm,'$1<span class="prop">$2</span>$3').replace(/: ([^;]+);/g,': <span class="val">$1</span>;')}var q=class{constructor(e,t){this.api=t,this.el=s("div",{class:"dock","data-inspect-ui":""}),e.appendChild(this.el),this.render(),c.subscribe(()=>this.sync())}render(){this.el.innerHTML="",this.pauseBtn=Ie("pause","Pause / resume picking",()=>c.set({active:!c.get().active}));let e=s("div",{class:"dock-group"},[I("undo-03","Undo",()=>{var o,r;return(r=(o=this.api).undo)==null?void 0:r.call(o)}),I("redo-01","Redo",()=>{var o,r;return(r=(o=this.api).redo)==null?void 0:r.call(o)}),ce(),He(at,"Select parent element",()=>{var o,r;return(r=(o=this.api).selectParent)==null?void 0:r.call(o)}),He(dt,"Select child element",()=>{var o,r;return(r=(o=this.api).selectChild)==null?void 0:r.call(o)}),ce(),this.assetsBtn=I("component","Assets (page colors, type, SVGs, images)",()=>{let o=c.get().view;c.set({view:o==="assets"?"design":"assets",collapsed:!1})}),this.codeBtn=I("file-diff","Changes & AI prompt",()=>c.set({view:"changes",collapsed:!1})),this.htmlBtn=I("html-file-01","HTML",()=>c.set({view:"html",collapsed:!1})),ce(),I("laptop-phone-sync","Toggle responsive preview",()=>{var o,r;return(r=(o=this.api).toggleResponsive)==null?void 0:r.call(o)})]),t=Ie("cancel-01","Exit InspectCSS",()=>{var o;return(o=window.InspectCSS)==null?void 0:o.destroy()});this.el.append(this.pauseBtn,e,t),this.sync()}sync(){var t,o,r,i;let e=c.get();(t=this.pauseBtn)==null||t.classList.toggle("active",e.active),(o=this.assetsBtn)==null||o.classList.toggle("active",e.view==="assets"),(r=this.codeBtn)==null||r.classList.toggle("active",e.view==="changes"),(i=this.htmlBtn)==null||i.classList.toggle("active",e.view==="html")}};function Ie(n,e,t){return s("button",{class:"dock-circle",title:e,onclick:t,html:w(n)})}function I(n,e,t){return s("button",{class:"dock-btn",title:e,onclick:t,html:w(n)})}function He(n,e,t){return s("button",{class:"dock-btn",title:e,onclick:t,html:n})}var at='<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M12 20V4M6 10l6-6 6 6"/></svg>',dt='<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M12 4v16M6 14l6 6 6-6"/></svg>';function ce(){return s("div",{class:"dock-sep"})}var G=class{constructor(e){this.root=e,this.el=s("div",{class:"tooltip","data-inspect-ui":""}),e.appendChild(this.el),e.addEventListener("pointerover",t=>this._over(t),!0),e.addEventListener("pointerout",t=>this._out(t),!0),e.addEventListener("pointerdown",()=>this.hide(),!0),document.addEventListener("pointerover",t=>this._over(t,!0),!0),document.addEventListener("pointerout",t=>this._out(t),!0),document.addEventListener("pointerdown",()=>this.hide(),!0)}_over(e,t=!1){let o=e.target.closest&&e.target.closest("[title],[data-tip]");if(!o||t&&!o.hasAttribute("data-inspect-ui")||!t&&!this.root.contains(o))return;if(o.hasAttribute("title")){let i=o.getAttribute("title");i&&o.setAttribute("data-tip",i),o.removeAttribute("title")}let r=o.getAttribute("data-tip");r&&this.show(r,o)}_out(e){let t=e.target.closest&&e.target.closest("[data-tip]");t&&!t.contains(e.relatedTarget)&&this.hide()}show(e,t){this.el.textContent=e,this.el.classList.add("show");let o=t.getBoundingClientRect(),r=this.el.getBoundingClientRect(),i=o.top-r.height-8,l=o.left+o.width/2-r.width/2;i<6&&(i=o.bottom+8),l=Math.max(6,Math.min(l,window.innerWidth-r.width-6)),this.el.style.left=Math.round(l)+"px",this.el.style.top=Math.round(i)+"px"}hide(){this.el.classList.remove("show")}};var O=class{constructor(e){this.onChange=e,this._onDblClick=this._onDblClick.bind(this),this._onKey=this._onKey.bind(this)}start(){document.addEventListener("dblclick",this._onDblClick,!0)}stop(){document.removeEventListener("dblclick",this._onDblClick,!0),this._finish()}_editable(e){if(!e||e.nodeType!==1||y(e))return null;let t=e;for(;t&&t!==document.body;){let o=[...t.childNodes].some(i=>i.nodeType===3&&i.textContent.trim()),r=![...t.children].some(i=>{let l=getComputedStyle(i).display;return l==="block"||l==="flex"||l==="grid"});if(o&&r)return t;t=t.parentElement}return e.matches("h1,h2,h3,h4,h5,h6,p,span,a,button,li,td,th,label,strong,em,small,div")?e:null}_onDblClick(e){var i,l;if(y(e.target))return;let t=this._editable(e.target);if(!t)return;e.preventDefault(),e.stopPropagation(),c.set({editing:!0,selectedEl:t}),this.el=t,this._origText=t.textContent,Z(t),t.setAttribute("contenteditable","true"),t.setAttribute("data-inspect-editing",""),t.focus();let o=(i=document.caretRangeFromPoint)==null?void 0:i.call(document,e.clientX,e.clientY),r=window.getSelection();r.removeAllRanges(),o?r.addRange(o):(l=document.execCommand)==null||l.call(document,"selectAll",!1,null),t.addEventListener("blur",()=>this._finish(),{once:!0}),document.addEventListener("keydown",this._onKey,!0)}_onKey(e){this.el&&(e.key==="Escape"||e.key==="Enter"&&!e.shiftKey&&this.el.tagName!=="DIV")&&(e.preventDefault(),this.el.blur())}_finish(){var e;if(document.removeEventListener("keydown",this._onKey,!0),this.el){let t=this.el;t.removeAttribute("contenteditable"),t.removeAttribute("data-inspect-editing");let o=t.textContent;if(o!==this._origText){let r=this._origText,i=o;C({type:"text",id:t.getAttribute("data-inspect-id"),from:r,to:i,label:b(t),selector:k(t)}),M({undo:()=>{t.textContent=r},redo:()=>{t.textContent=i}})}this.el=null}c.get().editing&&c.set({editing:!1}),(e=this.onChange)==null||e.call(this)}};var ct=4,pt='<svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M5 9l-3 3 3 3M9 5l3-3 3 3M15 19l-3 3-3-3M19 9l3 3-3 3M2 12h20M12 2v20"/></svg>',X=class{constructor(e){this.onReorder=e,this.indicator=s("div",{"data-inspect-ui":"",style:{position:"fixed",background:"#58aeff",borderRadius:"2px",pointerEvents:"none",zIndex:"2147483644",display:"none",boxShadow:"0 0 6px rgba(88,174,255,.8)"}}),this.handle=s("div",{"data-inspect-ui":"",title:"Drag to reorder",html:pt,style:{position:"fixed",width:"26px",height:"26px",borderRadius:"999px",display:"none",alignItems:"center",justifyContent:"center",background:"rgba(0,0,0,0.82)",border:"1px solid rgba(255,255,255,0.18)",color:"#fff",cursor:"grab",zIndex:"2147483645",boxShadow:"0 4px 14px rgba(0,0,0,.5)",backdropFilter:"blur(6px)"}}),document.documentElement.append(this.indicator,this.handle),this._down=this._down.bind(this),this._move=this._move.bind(this),this._up=this._up.bind(this),this._reposition=this._reposition.bind(this),this._sync=this._sync.bind(this)}start(){this.handle.addEventListener("mousedown",this._down,!0),this.handle.addEventListener("mouseenter",()=>this.handle.style.background="#58aeff"),this.handle.addEventListener("mouseleave",()=>this.handle.style.background="rgba(0,0,0,0.82)"),this.unsub=c.subscribe(this._sync),window.addEventListener("scroll",this._reposition,!0),window.addEventListener("resize",this._reposition,!0)}stop(){var e;(e=this.unsub)==null||e.call(this),window.removeEventListener("scroll",this._reposition,!0),window.removeEventListener("resize",this._reposition,!0),this.indicator.remove(),this.handle.remove()}_sync(){let e=c.get(),t=e.selectedEl&&!e.dragging&&!e.editing;this.handle.style.display=t?"flex":"none",t&&this._reposition()}_reposition(){let e=c.get().selectedEl;if(!e||this.dragging)return;let t=e.getBoundingClientRect();this.handle.style.left=Math.round(Math.max(4,t.left-8))+"px",this.handle.style.top=Math.round(Math.max(4,t.top-8))+"px"}_down(e){e.button===0&&(e.preventDefault(),e.stopPropagation(),c.get().selectedEl&&(this.sx=e.clientX,this.sy=e.clientY,this.armed=!0,this.dragging=!1,document.addEventListener("mousemove",this._move,!0),document.addEventListener("mouseup",this._up,!0)))}_move(e){if(this.armed){if(!this.dragging){if(Math.hypot(e.clientX-this.sx,e.clientY-this.sy)<ct)return;this.dragging=!0,c.set({dragging:!0}),document.documentElement.style.cursor="grabbing",this.handle.style.display="none"}this._updateTarget(e)}}_updateTarget(e){let t=c.get().selectedEl,o=t==null?void 0:t.parentElement;if(!o)return;let r=[...o.children].filter(h=>!y(h)&&h!==t);if(!r.length){this.ref=void 0,this.indicator.style.display="none";return}let i=getComputedStyle(o),l=/row/.test(i.flexDirection)||i.display.includes("inline")||i.display==="grid"&&i.gridAutoFlow.includes("column"),d=l?e.clientX:e.clientY,a=null;for(let h of r){let u=h.getBoundingClientRect(),p=l?u.left+u.width/2:u.top+u.height/2;if(d<p){a=h;break}}this.ref=a,this._drawLine(a,r,l)}_drawLine(e,t,o){let r=t[t.length-1],l=(e||r).getBoundingClientRect();if(o){let d;if(e){let a=t[t.indexOf(e)-1];d=a?(a.getBoundingClientRect().right+l.left)/2:l.left-2}else d=l.right+2;Object.assign(this.indicator.style,{display:"block",left:d-1.5+"px",top:l.top+"px",width:"3px",height:l.height+"px"})}else{let d;if(e){let a=t[t.indexOf(e)-1];d=a?(a.getBoundingClientRect().bottom+l.top)/2:l.top-2}else d=l.bottom+2;Object.assign(this.indicator.style,{display:"block",left:l.left+"px",top:d-1.5+"px",width:l.width+"px",height:"3px"})}}_up(){var t;document.removeEventListener("mousemove",this._move,!0),document.removeEventListener("mouseup",this._up,!0),this.indicator.style.display="none",document.documentElement.style.cursor="";let e=this.dragging;if(this.armed=!1,this.dragging=!1,e){let o=c.get().selectedEl,r=this.ref;if(o&&r!==void 0&&r!==o&&r!==o.nextElementSibling){let l=o.parentElement,d=o.nextElementSibling;l.insertBefore(o,r||null),C({type:"move",id:o.getAttribute("data-inspect-id"),to:"reordered",label:b(o),selector:k(o)}),M({undo:()=>l.insertBefore(o,d),redo:()=>l.insertBefore(o,r||null)})}c.set({dragging:!1}),this.ref=void 0;let i=l=>{l.stopPropagation(),l.preventDefault(),document.removeEventListener("click",i,!0)};document.addEventListener("click",i,!0),(t=this.onReorder)==null||t.call(this,o)}this._sync()}};var F=class{constructor(){this.active=!1,this.width=0,this.handle=s("div",{"data-inspect-ui":"",style:{position:"fixed",top:"0",bottom:"0",width:"12px",cursor:"ew-resize",zIndex:"2147483645",display:"none"}}),this.grip=s("div",{style:{position:"absolute",top:"50%",left:"50%",transform:"translate(-50%,-50%)",width:"6px",height:"54px",borderRadius:"4px",background:"#58aeff",boxShadow:"0 0 8px rgba(88,174,255,.7)"}}),this.handle.appendChild(this.grip),this.label=s("div",{"data-inspect-ui":"",style:{position:"fixed",top:"10px",left:"50%",transform:"translateX(-50%)",zIndex:"2147483645",display:"none",background:"rgba(0,0,0,0.82)",color:"#fff",font:"500 12px 'Quicksand', -apple-system, sans-serif",padding:"4px 10px",borderRadius:"8px",border:"1px solid rgba(255,255,255,0.14)",pointerEvents:"none"}}),document.documentElement.append(this.handle,this.label),this._down=this._down.bind(this),this._move=this._move.bind(this),this._up=this._up.bind(this),this._reposition=this._reposition.bind(this),this.handle.addEventListener("mousedown",this._down)}toggle(){return this.active?this.disable():this.enable(),this.active}enable(){this.active=!0,this.width=Math.min(1024,window.innerWidth-40),this._apply(),this.handle.style.display="block",this.label.style.display="block",window.addEventListener("resize",this._reposition)}disable(){this.active=!1;let e=document.documentElement;e.style.width="",e.style.margin="",e.style.transition="",this.handle.style.display="none",this.label.style.display="none",window.removeEventListener("resize",this._reposition)}_apply(){let e=document.documentElement;e.style.width=this.width+"px",e.style.margin="0 auto",this._reposition()}_reposition(){let e=(window.innerWidth+this.width)/2;this.handle.style.left=e-6+"px",this.label.textContent=Math.round(this.width)+" px"}_down(e){e.preventDefault(),this.dragging=!0,document.addEventListener("mousemove",this._move,!0),document.addEventListener("mouseup",this._up,!0),document.documentElement.style.userSelect="none"}_move(e){if(!this.dragging)return;let t=2*(e.clientX-window.innerWidth/2);this.width=Math.max(320,Math.min(t,window.innerWidth)),this._apply()}_up(){this.dragging=!1,document.removeEventListener("mousemove",this._move,!0),document.removeEventListener("mouseup",this._up,!0),document.documentElement.style.userSelect=""}destroy(){this.disable(),this.handle.remove(),this.label.remove()}};var W=`@font-face {
