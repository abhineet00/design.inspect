...
</svg>`};function x(o){return ye[o]||""}function le(o){return i("span",{class:"fic",html:x(o)})}function Me(){return i("span",{class:"chev-mini",html:x("chevron-down")})}function g({key:o,iconName:e,value:t,unit:r="px",onChange:n,showUnit:l=!0}){let a=V(t),c=i("input",{value:a.value,type:"text",inputmode:"decimal"}),p=l?i("span",{class:"unit",text:a.unit||r}):null,v=()=>{let s=c.value.trim();if(s==="")return n("");let u=/^-?[\d.]+$/.test(s);n(u&&l?s+((p==null?void 0:p.textContent)||r):s)};if(c.addEventListener("change",v),c.addEventListener("keydown",s=>{if(s.key==="Enter")return c.blur();if(s.key==="ArrowUp"||s.key==="ArrowDown"){let u=parseFloat(c.value)||0;c.value=+(u+(s.key==="ArrowUp"?1:-1)*(s.shiftKey?10:1)).toFixed(2),v(),s.preventDefault()}}),l&&p){let s=["px","%","em","rem","vw","vh"];p.style.cursor="pointer",p.addEventListener("click",()=>{p.textContent=s[(s.indexOf(p.textContent)+1)%s.length],v()})}return i("div",{class:"field"},[e?le(e):o?i("span",{class:"fk",text:o}):null,c,p])}function k({value:o,options:e,onChange:t,iconName:r,key:n}){let l=i("select",{});for(let a of e){let[c,p]=Array.isArray(a)?a:[a,a],v=i("option",{value:c,text:p});String(c)===String(o)&&(v.selected=!0),l.appendChild(v)}return l.addEventListener("change",()=>t(l.value)),i("div",{class:"field select-like"},[r?le(r):n?i("span",{class:"fk",text:n}):null,l,Me()])}function y(o,{active:e=-1,grow:t=!1,onPick:r}={}){let n=i("div",{class:"iconrow"+(t?" grow":"")});return o.forEach((l,a)=>{let c=i("button",{class:"ibtn"+(a===e?" active":""),title:l.title||"",html:x(l.icon),onclick:()=>r==null?void 0:r(l,a,c)});n.appendChild(c)}),n}function G(o,e,{showPct:t=!0}={}){let r=q(o),n=r.hex,l=r.alpha===0?1:r.alpha,a=i("input",{type:"color",value:n}),c=i("div",{class:"swatch"},[a]);c.style.background=o&&o!=="rgba(0, 0, 0, 0)"?o:"transparent";let p=i("input",{class:"hex",value:n.replace("#","")}),v=t?i("span",{class:"pct",text:Math.round(l*100)+"%"}):null,s=u=>{let _=Q(u,l);c.style.background=_,e(_)};return a.addEventListener("input",()=>{p.value=a.value.replace("#",""),s(a.value)}),p.addEventListener("change",()=>{let u=p.value.trim().replace(/^#/,"");/^([0-9a-f]{3}|[0-9a-f]{6})$/i.test(u)?(a.value="#"+u,s("#"+u)):e(p.value.trim())}),i("div",{class:"colorline"},[c,p,v])}function M(o,e,{open:t=!0}={}){let r=i("div",{class:"sec-content"},e),n=i("div",{class:"sec-head"},[i("span",{text:o}),i("span",{class:"chev",html:x("chevron-down")})]),l=i("div",{class:"section"+(t?"":" closed")},[n,r]);return n.addEventListener("click",()=>l.classList.toggle("closed")),l}function h(o,e){return i("div",{class:"stack"},[i("span",{class:"label",text:o}),e])}function ae(o,e){let t=(s,u,_,fe)=>{let z=i("input",{class:"edge "+fe,value:V(_).value});return z.addEventListener("change",()=>{let A=z.value.trim();e(`${s}-${u}`,/^-?[\d.]+$/.test(A)?A+"px":A)}),z},r={top:"top:2px;left:50%;transform:translateX(-50%)",bottom:"bottom:2px;left:50%;transform:translateX(-50%)",left:"left:2px;top:50%;transform:translateY(-50%)",right:"right:2px;top:50%;transform:translateY(-50%)"},n=(s,u)=>(s.setAttribute("style",r[u]),s),l=["top","bottom","left","right"].map(s=>n(t("margin",s,o.margin[s],"m-"+s),s)),a={top:"top:2px;left:50%;transform:translateX(-50%)",bottom:"bottom:2px;left:50%;transform:translateX(-50%)",left:"left:2px;top:50%;transform:translateY(-50%)",right:"right:2px;top:50%;transform:translateY(-50%)"},c=["top","bottom","left","right"].map(s=>{let u=t("padding",s,o.padding[s],"p-"+s);return u.setAttribute("style",a[s]),u}),p=i("div",{class:"center-size"},[i("span",{class:"tag",text:"Size"}),i("span",{text:V(o.width||"0").value+" \xD7 "+V(o.height||"0").value})]),v=i("div",{class:"ring pad"},[i("span",{class:"tag",text:"Padding"}),...c,p]);return i("div",{class:"boxeditor"},[i("span",{class:"tag",text:"Margin"}),...l,v])}var H=class{constructor(e){this.root=e,this.el=i("div",{class:"panel","data-inspect-ui":""}),e.appendChild(this.el),this._drag()}set(e){this.selected=e,this.render()}render(){let e=d.get();this.el.classList.toggle("hidden",e.collapsed),this.el.innerHTML="",this.el.append(this._head());let t=i("div",{class:"panel-body"});this.selected?e.view==="code"?this._code(t):e.view==="html"?this._html(t):this._design(t):t.append(i("div",{class:"empty",text:"Pick an element on the page to inspect and edit its styles."})),this.el.append(t)}_head(){let e=this.selected,t=e?O(e):null,r=e?Ve(e):[];return i("div",{class:"head"},[i("div",{class:"head-top"},[i("div",{class:"head-title",text:e?K(e)||t.tag:"InspectCSS"}),i("div",{class:"head-actions"},[U("delete02","Reset all edits",()=>{P(),this.render()}),U("minimize-screen","Collapse panel",()=>d.set({collapsed:!0})),U("x","Close",()=>{var n;return(n=window.InspectCSS)==null?void 0:n.destroy()})])]),e?i("div",{class:"crumb"},r.map(n=>i("span",{text:n}))):null,e?i("div",{class:"dims"},[i("span",{html:`<b>${f(t.rect.width)}</b> x <b>${f(t.rect.height)}</b> px`}),i("span",{html:`A <b>${parseInt(t.typography.fontSize)}px</b>`})]):i("div",{class:"crumb",text:"no selection"})])}_design(e){let t=this.selected,r=O(t),n=s=>u=>C(t,s,u),l=r.transform,a=s=>{Object.assign(l,s),C(t,"transform",se(l))},c=[{icon:"align-left",title:"Align left",css:["justify-content","flex-start"]},{icon:"align-bottom",title:"Align bottom",css:["align-items","flex-end"]},{icon:"align-right",title:"Align right",css:["justify-content","flex-end"]},{icon:"align-top",title:"Align top",css:["align-items","flex-start"]},{icon:"align-horizontal-center",title:"Center horizontally",css:["justify-content","center"]},{icon:"align-vertical-center",title:"Center vertically",css:["align-items","center"]}];e.append(M("Position",[h("Alignment",y(c,{grow:!0,onPick:s=>C(t,s.css[0],s.css[1])})),h("Position",i("div",{class:"row"},[g({key:"X",value:l.tx+"px",onChange:s=>a({tx:parseFloat(s)||0})}),g({key:"Y",value:l.ty+"px",onChange:s=>a({ty:parseFloat(s)||0})})])),h("Rotation",i("div",{class:"rot-row"},[g({iconName:"rotate01",value:l.rotate+"",showUnit:!1,onChange:s=>a({rotate:parseFloat(s)||0})}),y([{icon:"image-flip-horizontal",title:"Flip horizontal"}],{grow:!0,onPick:()=>ce(t,"x")}),y([{icon:"image-flip-vertical",title:"Flip vertical"}],{grow:!0,onPick:()=>ce(t,"y")})]))])),e.append(M("Layout",[h("Size",i("div",{class:"row"},[g({key:"W",value:r.layout.width,onChange:n("width")}),g({key:"H",value:r.layout.height,onChange:n("height")})])),h("Display",k({value:r.layout.display,options:["block","inline","inline-block","flex","inline-flex","grid","none"],onChange:n("display")})),i("div",{class:"row"},[h("Row Gap",g({iconName:"paragraph-spacing",value:r.layout.rowGap,showUnit:!1,onChange:n("row-gap")})),h("Column Gap",g({iconName:"letter-spacing",value:r.layout.columnGap,showUnit:!1,onChange:n("column-gap")}))]),i("div",{class:"row"},[h("Horizontal Align",k({value:r.layout.justify,options:[["flex-start","Start"],["center","Center"],["flex-end","End"],["space-between","Between"]],onChange:n("justify-content")})),h("Vertical Align",k({value:r.layout.align,options:[["flex-start","Start"],["center","Center"],["flex-end","End"],["stretch","Stretch"]],onChange:n("align-items")}))])])),e.append(M("Spacing",[h("Padding",i("div",{class:"row"},[g({iconName:"horizontal-resize",value:r.spacing.padding.left,onChange:s=>{n("padding-left")(s),n("padding-right")(s)}}),g({iconName:"vertical-resize",value:r.spacing.padding.top,onChange:s=>{n("padding-top")(s),n("padding-bottom")(s)}})])),h("Margin",i("div",{class:"row"},[g({iconName:"horizontal-resize",value:r.spacing.margin.left,onChange:s=>{n("margin-left")(s),n("margin-right")(s)}}),g({iconName:"vertical-resize",value:r.spacing.margin.top,onChange:s=>{n("margin-top")(s),n("margin-bottom")(s)}})])),ae({...r.spacing,width:r.layout.width,height:r.layout.height},(s,u)=>C(t,s,u))]));let p=[{key:"tl",prop:"border-top-left-radius",v:r.radius.tl},{key:"tr",prop:"border-top-right-radius",v:r.radius.tr},{key:"bl",prop:"border-bottom-left-radius",v:r.radius.bl},{key:"br",prop:"border-bottom-right-radius",v:r.radius.br}],v=new Set([r.radius.tl,r.radius.tr,r.radius.bl,r.radius.br]).size>1;e.append(M("Appearance",[i("div",{class:"row"},[h("Opacity",g({iconName:"transparency",value:String(Math.round((parseFloat(r.effects.opacity)||1)*100)),unit:"%",onChange:s=>n("opacity")((parseFloat(s)||100)/100)})),h("Corner",i("div",{class:"corner-mix"},[g({iconName:"full-screen",value:v?"mix":r.radius.all,showUnit:!1,onChange:n("border-radius")}),y([{icon:"full-screen",title:"Link corners"}],{onPick:()=>n("border-radius")(r.radius.tl)})]))]),i("div",{class:"corner-grid"},p.map(s=>g({iconName:"full-screen",value:s.v,showUnit:!1,onChange:n(s.prop)}))),h("",de("Fill",()=>n("background-color")("#ffffff"))),r.background.color&&r.background.color!=="rgba(0, 0, 0, 0)"?G(r.background.color,n("background-color")):null,h("",de("Stroke",()=>{n("border-style")("solid"),n("border-width")("1px"),n("border-color")("#ffffff")})),r.border.style!=="none"?G(r.border.color,n("border-color")):null])),e.append(M("Typography",[h("Typeface",k({value:pe(r.typography.fontFamily),options:[pe(r.typography.fontFamily),"Quicksand","Inter","Arial","Georgia","system-ui","monospace"],onChange:n("font-family")})),i("div",{class:"row"},[k({value:_e(r.typography.fontWeight),options:[["300","Light"],["400","Regular"],["500","Medium"],["600","SemiBold"],["700","Bold"],["800","Extra"]],onChange:n("font-weight")}),k({value:parseInt(r.typography.fontSize)+"",options:["10","12","13","14","16","18","20","24","32","48"].map(s=>[s,s]),onChange:s=>n("font-size")(s+"px")})]),i("div",{class:"row"},[h("Line Height",g({iconName:"paragraph-spacing",value:je(r.typography.lineHeight),showUnit:!1,onChange:n("line-height")})),h("Letter Spacing",g({iconName:"letter-spacing",value:r.typography.letterSpacing,showUnit:!1,onChange:n("letter-spacing")}))]),i("div",{class:"row"},[h("Paragraph Spacing",g({iconName:"expand-paragraph",value:Le(r.typography.marginBottom),onChange:n("margin-bottom")})),h("Alignment",y([{icon:"text-align-right",title:"Right",css:"right"},{icon:"text-align-center",title:"Center",css:"center"},{icon:"text-align-start",title:"Left",css:"left"},{icon:"text-align-justify",title:"Justify",css:"justify"}],{grow:!0,active:["right","center","left","justify"].indexOf(r.typography.textAlign),onPick:s=>n("text-align")(s.css)}))])]))}_code(e){let t=N();e.append(i("div",{class:"view-actions"},[i("button",{class:"btn primary",text:"Copy CSS",onclick:()=>this._copy()}),i("button",{class:"btn",text:"Reset",onclick:()=>{P(),this.render()}})]),t?i("pre",{class:"code",html:Se(t)}):i("div",{class:"empty",text:"No edits yet. Change a property in the Design view and the generated CSS appears here."}))}_html(e){let t=this.selected;if(!t)return e.append(i("div",{class:"empty",text:"No element selected."}));let r=t.cloneNode(!1);r.removeAttribute("data-inspect-id"),e.append(i("pre",{class:"code",html:ue(r.outerHTML.replace(/></,`>
  \u2026
<`))}))}_copy(){var t;let e=N();e&&((t=navigator.clipboard)==null||t.writeText(e).then(()=>this._toast("CSS copied")))}_toast(e){let t=i("div",{class:"toast","data-inspect-ui":"",text:e});this.root.appendChild(t),setTimeout(()=>t.remove(),1400)}_drag(){let e,t,r,n,l=!1;this.el.addEventListener("mousedown",p=>{if(!p.target.closest(".head")||p.target.closest(".hbtn"))return;l=!0;let s=this.el.getBoundingClientRect();e=p.clientX,t=p.clientY,r=s.left,n=s.top,this.el.style.right="auto",document.addEventListener("mousemove",a,!0),document.addEventListener("mouseup",c,!0),p.preventDefault()});let a=p=>{l&&(this.el.style.left=r+(p.clientX-e)+"px",this.el.style.top=Math.max(0,n+(p.clientY-t))+"px")},c=()=>{l=!1,document.removeEventListener("mousemove",a,!0),document.removeEventListener("mouseup",c,!0)}}};function U(o,e,t){return i("button",{class:"hbtn",title:e,onclick:t,html:x(o)})}function de(o,e){return i("div",{class:"addrow"},[i("span",{class:"k",text:o}),i("button",{class:"addbtn",title:"Add "+o,html:x("plus"),onclick:e})])}function Ve(o){let e=[],t=o,r=0;for(;t&&t.nodeType===1&&t!==document.documentElement&&r<3;)t.classList.length?e.unshift("."+t.classList[0]):e.unshift(t.tagName.toLowerCase()),t=t.parentElement,r++;return e}function ce(o,e){let t=getComputedStyle(o),r=t.transform==="none"?"":t.transform+" ";C(o,"transform",r+(e==="x"?"scaleX(-1)":"scaleY(-1)"))}function pe(o){return(o||"").split(",")[0].replace(/["']/g,"").trim()||"system-ui"}function _e(o){return String(o)}function je(o){return o==="normal"?"1.4":o}function Le(o){return o&&o!=="auto"?o:"0px"}function ue(o){return o.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function Se(o){return ue(o).replace(/^([^{\n]+)\{/gm,'<span class="sel">$1</span>{').replace(/^(\s+)([\w-]+)(:)/gm,'$1<span class="prop">$2</span>$3').replace(/: ([^;]+);/g,': <span class="val">$1</span>;')}var E=class{constructor(e,t){this.api=t,this.el=i("div",{class:"dock","data-inspect-ui":""}),e.appendChild(this.el),this.render(),d.subscribe(()=>this.sync())}render(){this.el.innerHTML="",this.pauseBtn=he("pause","Pause / resume picking",()=>d.set({active:!d.get().active}));let e=i("div",{class:"dock-group"},[w("undo-03","Undo",()=>{var r,n;return(n=(r=this.api).undo)==null?void 0:n.call(r)}),w("redo-01","Redo",()=>{var r,n;return(n=(r=this.api).redo)==null?void 0:n.call(r)}),X(),w("layer-bring-forward","Bring forward",()=>{var r,n;return(n=(r=this.api).bump)==null?void 0:n.call(r,1)}),w("layer-send-backward","Send backward",()=>{var r,n;return(n=(r=this.api).bump)==null?void 0:n.call(r,-1)}),X(),this.designBtn=w("component","Design",()=>d.set({view:"design",collapsed:!1})),this.codeBtn=w("file-diff","Generated CSS",()=>d.set({view:"code",collapsed:!1})),this.htmlBtn=w("html-file-01","HTML",()=>d.set({view:"html",collapsed:!1})),X(),w("laptop-phone-sync","Toggle responsive preview",()=>{var r,n;return(n=(r=this.api).toggleResponsive)==null?void 0:n.call(r)})]),t=he("cancel-01","Exit InspectCSS",()=>{var r;return(r=window.InspectCSS)==null?void 0:r.destroy()});this.el.append(this.pauseBtn,e,t),this.sync()}sync(){var t,r,n,l;let e=d.get();(t=this.pauseBtn)==null||t.classList.toggle("active",e.active),(r=this.designBtn)==null||r.classList.toggle("active",e.view==="design"),(n=this.codeBtn)==null||n.classList.toggle("active",e.view==="code"),(l=this.htmlBtn)==null||l.classList.toggle("active",e.view==="html")}};function he(o,e,t){return i("button",{class:"dock-circle",title:e,onclick:t,html:x(o)})}function w(o,e,t){return i("button",{class:"dock-btn",title:e,onclick:t,html:x(o)})}function X(){return i("div",{class:"dock-sep"})}var ge=`
