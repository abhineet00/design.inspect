(()=>{var R={active:!1,hoverEl:null,selectedEl:null,pseudo:"none",view:"design",edits:new Map,panelPos:{x:null,y:16},collapsed:!1},B=new Set,d={get:()=>R,set(o){Object.assign(R,o),B.forEach(e=>e(R))},subscribe(o){return B.add(o),()=>B.delete(o)}};var ve=0,$="data-inspect-id";function W(o){let e=o.getAttribute($);return e||(e="ic-"+ ++ve,o.setAttribute($,e)),e}function I(o){return`[${$}="${o}"]`}function f(o,e=2){if(o==null||Number.isNaN(o))return 0;let t=Math.pow(10,e);return Math.round(o*t)/t}function i(o,e={},t=[]){let n=document.createElement(o);for(let[r,l]of Object.entries(e))r==="class"?n.className=l:r==="style"&&typeof l=="object"?Object.assign(n.style,l):r==="html"?n.innerHTML=l:r==="text"?n.textContent=l:r.startsWith("on")&&typeof l=="function"?n.addEventListener(r.slice(2).toLowerCase(),l):l!==!1&&l!=null&&n.setAttribute(r,l===!0?"":l);for(let r of[].concat(t))r==null||r===!1||n.appendChild(typeof r=="string"?document.createTextNode(r):r);return n}function K(o){if(!o||o.nodeType!==1)return"";let e=o.tagName.toLowerCase();return o.id?e+="#"+o.id:o.classList.length&&(e+="."+o.classList[0]),e}function V(o){if(o==null)return{value:0,unit:"px"};let e=String(o).trim().match(/^(-?[\d.]+)\s*([a-z%]*)$/i);return e?{value:parseFloat(e[1]),unit:e[2]||"px"}:{value:o,unit:""}}function q(o){if(!o)return{hex:"#000000",alpha:1};if(o.startsWith("#"))return{hex:o,alpha:1};let e=o.match(/rgba?\(([^)]+)\)/i);if(!e)return{hex:"#000000",alpha:1};let t=e[1].split(",").map(p=>p.trim()),[n,r,l]=t.map(p=>parseInt(p,10)),a=t[3]!=null?parseFloat(t[3]):1;return{hex:"#"+[n,r,l].map(p=>Math.max(0,Math.min(255,p||0)).toString(16).padStart(2,"0")).join(""),alpha:a}}function Q(o,e=1){let t=o.replace("#",""),n=t.length===3?t.split("").map(c=>c+c).join(""):t.padEnd(6,"0"),r=parseInt(n.slice(0,2),16),l=parseInt(n.slice(2,4),16),a=parseInt(n.slice(4,6),16);return e>=1?`rgb(${r}, ${l}, ${a})`:`rgba(${r}, ${l}, ${a}, ${f(e,3)})`}function T(o){return!!(o&&o.closest&&o.closest("[data-inspect-ui]"))}var j=class{constructor(e){this.el=i("div",{"data-inspect-ui":"",style:{position:"fixed",inset:"0",pointerEvents:"none",zIndex:"2147483646"}}),this.margin=this._box("rgba(246, 178, 107, 0.28)"),this.padding=this._box("rgba(147, 196, 125, 0.30)"),this.content=i("div",{style:this._boxStyle("transparent","#4c8dff")}),this.selected=i("div",{style:this._boxStyle("transparent","#7c5cff")}),this.badge=i("div",{"data-inspect-ui":"",style:{position:"fixed",font:"600 11px/1.4 ui-monospace, SFMono-Regular, Menlo, monospace",color:"#fff",background:"#4c8dff",padding:"2px 6px",borderRadius:"4px",whiteSpace:"nowrap",pointerEvents:"none",boxShadow:"0 1px 4px rgba(0,0,0,.3)"}}),this.el.append(this.margin,this.padding,this.content,this.selected,this.badge),e.appendChild(this.el),this.hideHover(),this.hideSelected()}_box(e){return i("div",{style:{position:"fixed",background:e,pointerEvents:"none"}})}_boxStyle(e,t){return{position:"fixed",background:e,outline:`1px solid ${t}`,outlineOffset:"-1px",pointerEvents:"none"}}_place(e,t){Object.assign(e.style,{left:t.left+"px",top:t.top+"px",width:Math.max(0,t.width)+"px",height:Math.max(0,t.height)+"px",display:"block"})}highlight(e){if(!e)return this.hideHover();let t=getComputedStyle(e),n=e.getBoundingClientRect(),r=J(t,"margin"),l=J(t,"padding");this._place(this.margin,{left:n.left-r.left,top:n.top-r.top,width:n.width+r.left+r.right,height:n.height+r.top+r.bottom}),this._place(this.content,n),this._place(this.padding,n),this.badge.textContent=`${f(n.width)} \xD7 ${f(n.height)}`,this.badge.style.display="block";let a=n.top>24?n.top-22:n.bottom+6;this.badge.style.left=Math.max(4,n.left)+"px",this.badge.style.top=a+"px"}select(e){if(!e)return this.hideSelected();this._place(this.selected,e.getBoundingClientRect())}hideHover(){[this.margin,this.padding,this.content,this.badge].forEach(e=>e.style.display="none")}hideSelected(){this.selected.style.display="none"}destroy(){this.el.remove()}};function J(o,e){let t=n=>parseFloat(o.getPropertyValue(`${e}-${n}`))||0;return{top:t("top"),right:t("right"),bottom:t("bottom"),left:t("left")}}var L=class{constructor(e,t){this.overlay=e,this.onSelect=t,this._onMove=this._onMove.bind(this),this._onClick=this._onClick.bind(this),this._onKey=this._onKey.bind(this),this._onScroll=this._onScroll.bind(this)}start(){document.addEventListener("mousemove",this._onMove,!0),document.addEventListener("click",this._onClick,!0),document.addEventListener("keydown",this._onKey,!0),window.addEventListener("scroll",this._onScroll,!0),window.addEventListener("resize",this._onScroll,!0),document.documentElement.style.cursor="crosshair"}stop(){document.removeEventListener("mousemove",this._onMove,!0),document.removeEventListener("click",this._onClick,!0),document.removeEventListener("keydown",this._onKey,!0),window.removeEventListener("scroll",this._onScroll,!0),window.removeEventListener("resize",this._onScroll,!0),document.documentElement.style.cursor="",this.overlay.hideHover(),d.set({hoverEl:null})}_target(e){let t=document.elementFromPoint(e.clientX,e.clientY);return!t||T(t)||t===document.documentElement||t===document.body?null:t}_onMove(e){let t=this._target(e);if(!t)return this.overlay.hideHover();t!==d.get().hoverEl&&(d.set({hoverEl:t}),this.overlay.highlight(t))}_onClick(e){if(T(e.target))return;let t=this._target(e);t&&(e.preventDefault(),e.stopPropagation(),this.onSelect(t))}_onKey(e){e.key==="Escape"&&(e.preventDefault(),d.set({active:!1}))}_onScroll(){let{hoverEl:e,selectedEl:t}=d.get();e&&this.overlay.highlight(e),t&&this.overlay.select(t)}};function me(o){return o&&!/[^a-zA-Z0-9_-]/.test(o)&&!/^(is-|has-|js-)/.test(o)?!0:o&&!/[^a-zA-Z0-9_-]/.test(o)}function Ce(o){let e=1,t=o;for(;t=t.previousElementSibling;)t.tagName===o.tagName&&e++;return e}function we(o){let e=o.tagName.toLowerCase();if(o.id&&document.querySelectorAll("#"+CSS.escape(o.id)).length===1)return"#"+o.id;let t=Array.from(o.classList).filter(me).slice(0,2);return t.length?e+"."+t.map(r=>r).join("."):`${e}:nth-of-type(${Ce(o)})`}function ee(o,e=4){if(!o||o.nodeType!==1)return"";let t=[],n=o;for(;n&&n.nodeType===1&&n!==document.documentElement;){let r=we(n);if(t.unshift(r),r.startsWith("#"))break;try{if(document.querySelectorAll(t.join(" > ")).length===1)break}catch{}if(n=n.parentElement,t.length>=e)break}return t.join(" > ")}var te="inspect-css-live-styles";function xe(){let o=document.getElementById(te);return o||(o=document.createElement("style"),o.id=te,o.setAttribute("data-inspect-ui",""),document.head.appendChild(o)),o}var b=[],S=[];function Z(){let{edits:o}=d.get();return[...o.entries()].map(([e,t])=>[e,{inspectId:t.inspectId,pseudo:t.pseudo,selector:t.selector,props:[...t.props.entries()]}])}function oe(o){let e=new Map;for(let[t,n]of o)e.set(t,{inspectId:n.inspectId,pseudo:n.pseudo,selector:n.selector,props:new Map(n.props)});d.get().edits=e,N(),d.set({edits:e})}function ke(){b.push(Z()),b.length>100&&b.shift(),S.length=0}function ne(){b.length&&(S.push(Z()),oe(b.pop()))}function re(){S.length&&(b.push(Z()),oe(S.pop()))}function w(o,e,t){ke();let n=W(o),{edits:r,pseudo:l}=d.get(),a=l==="none"?n:`${n}::${l}`,c=r.get(a);c||(c={inspectId:n,pseudo:l,selector:ee(o),props:new Map},r.set(a,c)),t===""||t==null?c.props.delete(e):c.props.set(e,t),c.props.size===0&&r.delete(a),N(),d.set({edits:r})}function F(o,e="none"){let t=o.getAttribute("data-inspect-id");if(!t)return new Map;let n=e==="none"?t:`${t}::${e}`,r=d.get().edits.get(n);return r?r.props:new Map}function N(){let{edits:o}=d.get(),e=[];for(let t of o.values()){if(t.props.size===0)continue;let n=I(t.inspectId)+(t.pseudo!=="none"?":"+t.pseudo:""),r=[...t.props.entries()].map(([l,a])=>`  ${l}: ${a} !important;`).join(`
`);e.push(`${n} {
${r}
}`)}xe().textContent=e.join(`

`)}function P(){let{edits:o}=d.get(),e=[];for(let t of o.values()){if(t.props.size===0)continue;let n=(t.selector||I(t.inspectId))+(t.pseudo!=="none"?":"+t.pseudo:""),r=[...t.props.entries()].map(([l,a])=>`  ${l}: ${a};`).join(`
`);e.push(`${n} {
${r}
}`)}return e.join(`

`)}function O(){d.get().edits.clear(),N(),d.set({edits:d.get().edits})}function m(o,e,t,n=t){let r=F(o,d.get().pseudo).get(t);return r!=null?r:e.getPropertyValue(n).trim()}function G(o){let e=getComputedStyle(o),t=o.getBoundingClientRect();return{rect:t,tag:o.tagName.toLowerCase(),layout:{display:m(o,e,"display"),position:m(o,e,"position"),width:e.width,height:e.height,x:f(t.left+window.scrollX),y:f(t.top+window.scrollY),rowGap:e.rowGap==="normal"?"0":e.rowGap,columnGap:e.columnGap==="normal"?"0":e.columnGap,justify:m(o,e,"justify-content"),align:m(o,e,"align-items")},transform:be(o,e),spacing:{margin:ie(e,"margin"),padding:ie(e,"padding")},radius:{all:m(o,e,"border-radius"),tl:e.borderTopLeftRadius,tr:e.borderTopRightRadius,br:e.borderBottomRightRadius,bl:e.borderBottomLeftRadius},typography:{fontFamily:e.fontFamily,fontSize:m(o,e,"font-size"),fontWeight:m(o,e,"font-weight"),lineHeight:e.lineHeight,letterSpacing:e.letterSpacing==="normal"?"0px":e.letterSpacing,textAlign:m(o,e,"text-align"),color:m(o,e,"color"),marginBottom:m(o,e,"margin-bottom")},background:{color:m(o,e,"background-color"),image:e.backgroundImage},border:{width:e.borderTopWidth,style:e.borderTopStyle,color:e.borderTopColor},effects:{opacity:m(o,e,"opacity"),boxShadow:e.boxShadow==="none"?"":e.boxShadow}}}function ie(o,e){return{top:o.getPropertyValue(`${e}-top`),right:o.getPropertyValue(`${e}-right`),bottom:o.getPropertyValue(`${e}-bottom`),left:o.getPropertyValue(`${e}-left`)}}function be(o,e){let n=F(o,d.get().pseudo).get("transform")||e.transform,r={tx:0,ty:0,rotate:0};if(!n||n==="none")return r;let l=/translate\(\s*(-?[\d.]+)px\s*,\s*(-?[\d.]+)px\s*\)/.exec(n),a=/rotate\(\s*(-?[\d.]+)deg\s*\)/.exec(n);if(l&&(r.tx=parseFloat(l[1]),r.ty=parseFloat(l[2])),a&&(r.rotate=parseFloat(a[1])),l||a)return r;let c=/matrix\(([^)]+)\)/.exec(n);if(c){let[p,v,,,s,u]=c[1].split(",").map(parseFloat);r.tx=f(s),r.ty=f(u),r.rotate=f(Math.atan2(v,p)*(180/Math.PI))}return r}function se({tx:o=0,ty:e=0,rotate:t=0}){let n=[];return(o||e)&&n.push(`translate(${f(o)}px, ${f(e)}px)`),t&&n.push(`rotate(${f(t)}deg)`),n.length?n.join(" "):""}var ye={"align-bottom":`<svg preserveAspectRatio="none" overflow="visible" style="display: block;" width="100%" height="100%" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
<g id="align-bottom">
...
</svg>`};function C(o){return ye[o]||""}function le(o){return i("span",{class:"fic",html:C(o)})}function Me(){return i("span",{class:"chev-mini",html:C("chevron-down")})}function g({key:o,iconName:e,value:t,unit:n="px",onChange:r,showUnit:l=!0}){let a=V(t),c=i("input",{value:a.value,type:"text",inputmode:"decimal"}),p=l?i("span",{class:"unit",text:a.unit||n}):null,v=()=>{let s=c.value.trim();if(s==="")return r("");let u=/^-?[\d.]+$/.test(s);r(u&&l?s+((p==null?void 0:p.textContent)||n):s)};if(c.addEventListener("change",v),c.addEventListener("keydown",s=>{if(s.key==="Enter")return c.blur();if(s.key==="ArrowUp"||s.key==="ArrowDown"){let u=parseFloat(c.value)||0;c.value=+(u+(s.key==="ArrowUp"?1:-1)*(s.shiftKey?10:1)).toFixed(2),v(),s.preventDefault()}}),l&&p){let s=["px","%","em","rem","vw","vh"];p.style.cursor="pointer",p.addEventListener("click",()=>{p.textContent=s[(s.indexOf(p.textContent)+1)%s.length],v()})}return i("div",{class:"field"},[e?le(e):o?i("span",{class:"fk",text:o}):null,c,p])}function k({value:o,options:e,onChange:t,iconName:n,key:r}){let l=i("select",{});for(let a of e){let[c,p]=Array.isArray(a)?a:[a,a],v=i("option",{value:c,text:p});String(c)===String(o)&&(v.selected=!0),l.appendChild(v)}return l.addEventListener("change",()=>t(l.value)),i("div",{class:"field select-like"},[n?le(n):r?i("span",{class:"fk",text:r}):null,l,Me()])}function y(o,{active:e=-1,grow:t=!1,onPick:n}={}){let r=i("div",{class:"iconrow"+(t?" grow":"")});return o.forEach((l,a)=>{let c=i("button",{class:"ibtn"+(a===e?" active":""),title:l.title||"",html:C(l.icon),onclick:()=>n==null?void 0:n(l,a,c)});r.appendChild(c)}),r}function U(o,e,{showPct:t=!0}={}){let n=q(o),r=n.hex,l=n.alpha===0?1:n.alpha,a=i("input",{type:"color",value:r}),c=i("div",{class:"swatch"},[a]);c.style.background=o&&o!=="rgba(0, 0, 0, 0)"?o:"transparent";let p=i("input",{class:"hex",value:r.replace("#","")}),v=t?i("span",{class:"pct",text:Math.round(l*100)+"%"}):null,s=u=>{let _=Q(u,l);c.style.background=_,e(_)};return a.addEventListener("input",()=>{p.value=a.value.replace("#",""),s(a.value)}),p.addEventListener("change",()=>{let u=p.value.trim().replace(/^#/,"");/^([0-9a-f]{3}|[0-9a-f]{6})$/i.test(u)?(a.value="#"+u,s("#"+u)):e(p.value.trim())}),i("div",{class:"colorline"},[c,p,v])}function M(o,e,{open:t=!0}={}){let n=i("div",{class:"sec-content"},e),r=i("div",{class:"sec-head"},[i("span",{text:o}),i("span",{class:"chev",html:C("chevron-down")})]),l=i("div",{class:"section"+(t?"":" closed")},[r,n]);return r.addEventListener("click",()=>l.classList.toggle("closed")),l}function h(o,e){return i("div",{class:"stack"},[i("span",{class:"label",text:o}),e])}function ae(o,e){let t=(s,u,_,fe)=>{let z=i("input",{class:"edge "+fe,value:V(_).value});return z.addEventListener("change",()=>{let A=z.value.trim();e(`${s}-${u}`,/^-?[\d.]+$/.test(A)?A+"px":A)}),z},n={top:"top:2px;left:50%;transform:translateX(-50%)",bottom:"bottom:2px;left:50%;transform:translateX(-50%)",left:"left:2px;top:50%;transform:translateY(-50%)",right:"right:2px;top:50%;transform:translateY(-50%)"},r=(s,u)=>(s.setAttribute("style",n[u]),s),l=["top","bottom","left","right"].map(s=>r(t("margin",s,o.margin[s],"m-"+s),s)),a={top:"top:2px;left:50%;transform:translateX(-50%)",bottom:"bottom:2px;left:50%;transform:translateX(-50%)",left:"left:2px;top:50%;transform:translateY(-50%)",right:"right:2px;top:50%;transform:translateY(-50%)"},c=["top","bottom","left","right"].map(s=>{let u=t("padding",s,o.padding[s],"p-"+s);return u.setAttribute("style",a[s]),u}),p=i("div",{class:"center-size"},[i("span",{class:"tag",text:"Size"}),i("span",{text:V(o.width||"0").value+" \xD7 "+V(o.height||"0").value})]),v=i("div",{class:"ring pad"},[i("span",{class:"tag",text:"Padding"}),...c,p]);return i("div",{class:"boxeditor"},[i("span",{class:"tag",text:"Margin"}),...l,v])}var H=class{constructor(e){this.root=e,this.el=i("div",{class:"panel","data-inspect-ui":""}),e.appendChild(this.el),this._drag()}set(e){this.selected=e,this.render()}render(){let e=d.get();this.el.classList.toggle("hidden",e.collapsed),this.el.innerHTML="",this.el.append(this._head());let t=i("div",{class:"panel-body"});this.selected?e.view==="code"?this._code(t):e.view==="html"?this._html(t):this._design(t):t.append(i("div",{class:"empty",text:"Pick an element on the page to inspect and edit its styles."})),this.el.append(t)}_head(){let e=this.selected,t=e?G(e):null,n=e?Ve(e):[];return i("div",{class:"head"},[i("div",{class:"head-top"},[i("div",{class:"head-title",text:e?K(e)||t.tag:"InspectCSS"}),i("div",{class:"head-actions"},[Y("delete02","Reset all edits",()=>{O(),this.render()}),Y("minimize-screen","Collapse panel",()=>d.set({collapsed:!0})),Y("x","Close",()=>{var r;return(r=window.InspectCSS)==null?void 0:r.destroy()})])]),e?i("div",{class:"crumb"},n.map(r=>i("span",{text:r}))):null,e?i("div",{class:"dims"},[i("span",{html:`<b>${f(t.rect.width)}</b> x <b>${f(t.rect.height)}</b> px`}),i("span",{html:`A <b>${parseInt(t.typography.fontSize)}px</b>`})]):i("div",{class:"crumb",text:"no selection"})])}_design(e){let t=this.selected,n=G(t),r=s=>u=>w(t,s,u),l=n.transform,a=s=>{Object.assign(l,s),w(t,"transform",se(l))},c=[{icon:"align-left",title:"Align left",css:["justify-content","flex-start"]},{icon:"align-bottom",title:"Align bottom",css:["align-items","flex-end"]},{icon:"align-right",title:"Align right",css:["justify-content","flex-end"]},{icon:"align-top",title:"Align top",css:["align-items","flex-start"]},{icon:"align-horizontal-center",title:"Center horizontally",css:["justify-content","center"]},{icon:"align-vertical-center",title:"Center vertically",css:["align-items","center"]}];e.append(M("Position",[h("Alignment",y(c,{grow:!0,onPick:s=>w(t,s.css[0],s.css[1])})),h("Position",i("div",{class:"row"},[g({key:"X",value:l.tx+"px",onChange:s=>a({tx:parseFloat(s)||0})}),g({key:"Y",value:l.ty+"px",onChange:s=>a({ty:parseFloat(s)||0})})])),h("Rotation",i("div",{class:"rot-row"},[g({iconName:"rotate01",value:l.rotate+"",showUnit:!1,onChange:s=>a({rotate:parseFloat(s)||0})}),y([{icon:"image-flip-horizontal",title:"Flip horizontal"}],{grow:!0,onPick:()=>ce(t,"x")}),y([{icon:"image-flip-vertical",title:"Flip vertical"}],{grow:!0,onPick:()=>ce(t,"y")})]))])),e.append(M("Layout",[h("Size",i("div",{class:"row"},[g({key:"W",value:n.layout.width,onChange:r("width")}),g({key:"H",value:n.layout.height,onChange:r("height")})])),h("Display",k({value:n.layout.display,options:["block","inline","inline-block","flex","inline-flex","grid","none"],onChange:r("display")})),i("div",{class:"row"},[h("Row Gap",g({iconName:"paragraph-spacing",value:n.layout.rowGap,showUnit:!1,onChange:r("row-gap")})),h("Column Gap",g({iconName:"letter-spacing",value:n.layout.columnGap,showUnit:!1,onChange:r("column-gap")}))]),i("div",{class:"row"},[h("Horizontal Align",k({value:n.layout.justify,options:[["flex-start","Start"],["center","Center"],["flex-end","End"],["space-between","Between"]],onChange:r("justify-content")})),h("Vertical Align",k({value:n.layout.align,options:[["flex-start","Start"],["center","Center"],["flex-end","End"],["stretch","Stretch"]],onChange:r("align-items")}))])])),e.append(M("Spacing",[h("Padding",i("div",{class:"row"},[g({iconName:"horizontal-resize",value:n.spacing.padding.left,onChange:s=>{r("padding-left")(s),r("padding-right")(s)}}),g({iconName:"vertical-resize",value:n.spacing.padding.top,onChange:s=>{r("padding-top")(s),r("padding-bottom")(s)}})])),h("Margin",i("div",{class:"row"},[g({iconName:"horizontal-resize",value:n.spacing.margin.left,onChange:s=>{r("margin-left")(s),r("margin-right")(s)}}),g({iconName:"vertical-resize",value:n.spacing.margin.top,onChange:s=>{r("margin-top")(s),r("margin-bottom")(s)}})])),ae({...n.spacing,width:n.layout.width,height:n.layout.height},(s,u)=>w(t,s,u))]));let p=[{key:"tl",prop:"border-top-left-radius",v:n.radius.tl},{key:"tr",prop:"border-top-right-radius",v:n.radius.tr},{key:"bl",prop:"border-bottom-left-radius",v:n.radius.bl},{key:"br",prop:"border-bottom-right-radius",v:n.radius.br}],v=new Set([n.radius.tl,n.radius.tr,n.radius.bl,n.radius.br]).size>1;e.append(M("Appearance",[i("div",{class:"row"},[h("Opacity",g({iconName:"transparency",value:String(Math.round((parseFloat(n.effects.opacity)||1)*100)),unit:"%",onChange:s=>r("opacity")((parseFloat(s)||100)/100)})),h("Corner",i("div",{class:"corner-mix"},[g({iconName:"full-screen",value:v?"mix":n.radius.all,showUnit:!1,onChange:r("border-radius")}),y([{icon:"full-screen",title:"Link corners"}],{onPick:()=>r("border-radius")(n.radius.tl)})]))]),i("div",{class:"corner-grid"},p.map(s=>g({iconName:"full-screen",value:s.v,showUnit:!1,onChange:r(s.prop)}))),h("",de("Fill",()=>r("background-color")("#ffffff"))),n.background.color&&n.background.color!=="rgba(0, 0, 0, 0)"?U(n.background.color,r("background-color")):null,h("",de("Stroke",()=>{r("border-style")("solid"),r("border-width")("1px"),r("border-color")("#ffffff")})),n.border.style!=="none"?U(n.border.color,r("border-color")):null])),e.append(M("Typography",[h("Typeface",k({value:pe(n.typography.fontFamily),options:[pe(n.typography.fontFamily),"Quicksand","Inter","Arial","Georgia","system-ui","monospace"],onChange:r("font-family")})),i("div",{class:"row"},[k({value:_e(n.typography.fontWeight),options:[["300","Light"],["400","Regular"],["500","Medium"],["600","SemiBold"],["700","Bold"],["800","Extra"]],onChange:r("font-weight")}),k({value:parseInt(n.typography.fontSize)+"",options:["10","12","13","14","16","18","20","24","32","48"].map(s=>[s,s]),onChange:s=>r("font-size")(s+"px")})]),i("div",{class:"row"},[h("Line Height",g({iconName:"paragraph-spacing",value:je(n.typography.lineHeight),showUnit:!1,onChange:r("line-height")})),h("Letter Spacing",g({iconName:"letter-spacing",value:n.typography.letterSpacing,showUnit:!1,onChange:r("letter-spacing")}))]),i("div",{class:"row"},[h("Paragraph Spacing",g({iconName:"expand-paragraph",value:Le(n.typography.marginBottom),onChange:r("margin-bottom")})),h("Alignment",y([{icon:"text-align-right",title:"Right",css:"right"},{icon:"text-align-center",title:"Center",css:"center"},{icon:"text-align-start",title:"Left",css:"left"},{icon:"text-align-justify",title:"Justify",css:"justify"}],{grow:!0,active:["right","center","left","justify"].indexOf(n.typography.textAlign),onPick:s=>r("text-align")(s.css)}))])]))}_code(e){let t=P();e.append(i("div",{class:"view-actions"},[i("button",{class:"btn primary",text:"Copy CSS",onclick:()=>this._copy()}),i("button",{class:"btn",text:"Reset",onclick:()=>{O(),this.render()}})]),t?i("pre",{class:"code",html:Se(t)}):i("div",{class:"empty",text:"No edits yet. Change a property in the Design view and the generated CSS appears here."}))}_html(e){let t=this.selected;if(!t)return e.append(i("div",{class:"empty",text:"No element selected."}));let n=t.cloneNode(!1);n.removeAttribute("data-inspect-id"),e.append(i("pre",{class:"code",html:ue(n.outerHTML.replace(/></,`>
  \u2026
<`))}))}_copy(){var t;let e=P();e&&((t=navigator.clipboard)==null||t.writeText(e).then(()=>this._toast("CSS copied")))}_toast(e){let t=i("div",{class:"toast","data-inspect-ui":"",text:e});this.root.appendChild(t),setTimeout(()=>t.remove(),1400)}_drag(){let e,t,n,r,l=!1;this.el.addEventListener("mousedown",p=>{if(!p.target.closest(".head")||p.target.closest(".hbtn"))return;l=!0;let s=this.el.getBoundingClientRect();e=p.clientX,t=p.clientY,n=s.left,r=s.top,this.el.style.right="auto",document.addEventListener("mousemove",a,!0),document.addEventListener("mouseup",c,!0),p.preventDefault()});let a=p=>{l&&(this.el.style.left=n+(p.clientX-e)+"px",this.el.style.top=Math.max(0,r+(p.clientY-t))+"px")},c=()=>{l=!1,document.removeEventListener("mousemove",a,!0),document.removeEventListener("mouseup",c,!0)}}};function Y(o,e,t){return i("button",{class:"hbtn",title:e,onclick:t,html:C(o)})}function de(o,e){return i("div",{class:"addrow"},[i("span",{class:"k",text:o}),i("button",{class:"addbtn",title:"Add "+o,html:C("plus"),onclick:e})])}function Ve(o){let e=[],t=o,n=0;for(;t&&t.nodeType===1&&t!==document.documentElement&&n<3;)t.classList.length?e.unshift("."+t.classList[0]):e.unshift(t.tagName.toLowerCase()),t=t.parentElement,n++;return e}function ce(o,e){let t=getComputedStyle(o),n=t.transform==="none"?"":t.transform+" ";w(o,"transform",n+(e==="x"?"scaleX(-1)":"scaleY(-1)"))}function pe(o){return(o||"").split(",")[0].replace(/["']/g,"").trim()||"system-ui"}function _e(o){return String(o)}function je(o){return o==="normal"?"1.4":o}function Le(o){return o&&o!=="auto"?o:"0px"}function ue(o){return o.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function Se(o){return ue(o).replace(/^([^{\n]+)\{/gm,'<span class="sel">$1</span>{').replace(/^(\s+)([\w-]+)(:)/gm,'$1<span class="prop">$2</span>$3').replace(/: ([^;]+);/g,': <span class="val">$1</span>;')}var E=class{constructor(e,t){this.api=t,this.el=i("div",{class:"dock","data-inspect-ui":""}),e.appendChild(this.el),this.render(),d.subscribe(()=>this.sync())}render(){this.el.innerHTML="",this.pauseBtn=he("pause","Pause / resume picking",()=>d.set({active:!d.get().active}));let e=i("div",{class:"dock-group"},[x("undo-03","Undo",()=>{var n,r;return(r=(n=this.api).undo)==null?void 0:r.call(n)}),x("redo-01","Redo",()=>{var n,r;return(r=(n=this.api).redo)==null?void 0:r.call(n)}),X(),x("layer-bring-forward","Bring forward",()=>{var n,r;return(r=(n=this.api).bump)==null?void 0:r.call(n,1)}),x("layer-send-backward","Send backward",()=>{var n,r;return(r=(n=this.api).bump)==null?void 0:r.call(n,-1)}),X(),this.designBtn=x("component","Design",()=>d.set({view:"design",collapsed:!1})),this.codeBtn=x("file-diff","Generated CSS",()=>d.set({view:"code",collapsed:!1})),this.htmlBtn=x("html-file-01","HTML",()=>d.set({view:"html",collapsed:!1})),X(),x("laptop-phone-sync","Toggle responsive preview",()=>{var n,r;return(r=(n=this.api).toggleResponsive)==null?void 0:r.call(n)})]),t=he("cancel-01","Exit InspectCSS",()=>{var n;return(n=window.InspectCSS)==null?void 0:n.destroy()});this.el.append(this.pauseBtn,e,t),this.sync()}sync(){var t,n,r,l;let e=d.get();(t=this.pauseBtn)==null||t.classList.toggle("active",e.active),(n=this.designBtn)==null||n.classList.toggle("active",e.view==="design"),(r=this.codeBtn)==null||r.classList.toggle("active",e.view==="code"),(l=this.htmlBtn)==null||l.classList.toggle("active",e.view==="html")}};function he(o,e,t){return i("button",{class:"dock-circle",title:e,onclick:t,html:C(o)})}function x(o,e,t){return i("button",{class:"dock-btn",title:e,onclick:t,html:C(o)})}function X(){return i("div",{class:"dock-sep"})}var ge=`
...
`;var D=class{constructor(){this.host=document.createElement("div"),this.host.setAttribute("data-inspect-ui",""),this.host.style.cssText="all: initial; position: static;";let e=this.host.attachShadow({mode:"open"}),t=document.createElement("style");t.textContent=ge;let n=document.createElement("div");n.className="wrap",e.append(t,n),document.documentElement.appendChild(this.host),this.overlay=new j(document.documentElement),this.panel=new H(n),this.toolbar=new E(n,{undo:()=>{ne(),this.panel.render()},redo:()=>{re(),this.panel.render()},bump:r=>this.bumpZ(r),toggleResponsive:()=>this.toggleResponsive()}),this.inspector=new L(this.overlay,r=>this.select(r)),this._prevView=d.get().view,this._prevCollapsed=d.get().collapsed,this.unsub=d.subscribe(r=>this.onState(r)),this._track=()=>{this._raf||(this._raf=requestAnimationFrame(()=>{this._raf=0;let r=d.get();r.hoverEl&&this.overlay.highlight(r.hoverEl),r.selectedEl&&this.overlay.select(r.selectedEl)}))},window.addEventListener("scroll",this._track,!0),window.addEventListener("resize",this._track,!0),d.set({active:!0}),this.panel.render()}select(e){d.set({selectedEl:e,active:!1}),this.overlay.select(e),this.panel.set(e)}bumpZ(e){let t=d.get().selectedEl;if(!t)return;let n=parseInt(getComputedStyle(t).zIndex)||0;w(t,"position",getComputedStyle(t).position==="static"?"relative":getComputedStyle(t).position),w(t,"z-index",String(n+e)),this.panel.render()}toggleResponsive(){this._resp=!this._resp;let e=document.documentElement;this._resp?(e.style.maxWidth="420px",e.style.margin="0 auto",e.style.transition="max-width .2s"):(e.style.maxWidth="",e.style.margin="");let t=d.get();t.selectedEl&&this.overlay.select(t.selectedEl)}onState(e){e.active&&!this._picking?(this._picking=!0,this.inspector.start()):!e.active&&this._picking&&(this._picking=!1,this.inspector.stop()),e.selectedEl&&this.overlay.select(e.selectedEl),(e.view!==this._prevView||e.collapsed!==this._prevCollapsed)&&(this._prevView=e.view,this._prevCollapsed=e.collapsed,this.panel.render())}destroy(){var t;(t=this.unsub)==null||t.call(this),window.removeEventListener("scroll",this._track,!0),window.removeEventListener("resize",this._track,!0),this.inspector.stop(),this.overlay.destroy(),this.host.remove(),this.toggleResponsiveOff();let e=document.getElementById("inspect-css-live-styles");e&&e.remove(),delete window.InspectCSS}toggleResponsiveOff(){document.documentElement.style.maxWidth="",document.documentElement.style.margin=""}};function He(){if(window.InspectCSS){window.InspectCSS.destroy();return}let o=new D;window.InspectCSS={app:o,destroy:()=>o.destroy(),version:"0.2.0"}}He();})();
