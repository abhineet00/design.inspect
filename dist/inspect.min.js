(()=>{var X={active:!1,hoverEl:null,selectedEl:null,pseudo:"none",view:"design",edits:new Map,panelPos:{x:null,y:16},collapsed:!1,editing:!1,dragging:!1,changeLog:[]},F=new Set,c={get:()=>X,set(n){Object.assign(X,n),F.forEach(e=>e(X))},subscribe(n){return F.add(n),()=>F.delete(n)}};var Se=0,W="data-inspect-id";function K(n){let e=n.getAttribute(W);return e||(e="ic-"+ ++Se,n.setAttribute(W,e)),e}function J(n){return`[${W}="${n}"]`}function v(n,e=2){if(n==null||Number.isNaN(n))return 0;let t=Math.pow(10,e);return Math.round(n*t)/t}function i(n,e={},t=[]){let o=document.createElement(n);for(let[r,s]of Object.entries(e))r==="class"?o.className=s:r==="style"&&typeof s=="object"?Object.assign(o.style,s):r==="html"?o.innerHTML=s:r==="text"?o.textContent=s:r.startsWith("on")&&typeof s=="function"?o.addEventListener(r.slice(2).toLowerCase(),s):s!==!1&&s!=null&&o.setAttribute(r,s===!0?"":s);for(let r of[].concat(t))r==null||r===!1||o.appendChild(typeof r=="string"?document.createTextNode(r):r);return o}function b(n){if(!n||n.nodeType!==1)return"";let e=n.tagName.toLowerCase();return n.id?e+="#"+n.id:n.classList.length&&(e+="."+n.classList[0]),e}function I(n){if(n==null)return{value:0,unit:"px"};let e=String(n).trim().match(/^(-?[\d.]+)\s*([a-z%]*)$/i);return e?{value:parseFloat(e[1]),unit:e[2]||"px"}:{value:n,unit:""}}function Z(n){if(!n)return{hex:"#000000",alpha:1};if(n.startsWith("#"))return{hex:n,alpha:1};let e=n.match(/rgba?\(([^)]+)\)/i);if(!e)return{hex:"#000000",alpha:1};let t=e[1].split(",").map(a=>a.trim()),[o,r,s]=t.map(a=>parseInt(a,10)),l=t[3]!=null?parseFloat(t[3]):1;return{hex:"#"+[o,r,s].map(a=>Math.max(0,Math.min(255,a||0)).toString(16).padStart(2,"0")).join(""),alpha:l}}function pe(n,e=1){let t=n.replace("#",""),o=t.length===3?t.split("").map(h=>h+h).join(""):t.padEnd(6,"0"),r=parseInt(o.slice(0,2),16),s=parseInt(o.slice(2,4),16),l=parseInt(o.slice(4,6),16);return e>=1?`rgb(${r}, ${s}, ${l})`:`rgba(${r}, ${s}, ${l}, ${v(e,3)})`}function C(n){return!!(n&&n.closest&&n.closest("[data-inspect-ui]"))}var U=class{constructor(e){this.el=i("div",{"data-inspect-ui":"",style:{position:"fixed",inset:"0",pointerEvents:"none",zIndex:"2147483640"}}),this.margin=this._box("rgba(246, 178, 107, 0.28)"),this.padding=this._box("rgba(147, 196, 125, 0.30)"),this.content=i("div",{style:this._boxStyle("transparent","#4c8dff")}),this.selected=i("div",{style:this._boxStyle("transparent","#7c5cff")}),this.badge=i("div",{"data-inspect-ui":"",style:{position:"fixed",font:"500 12px/1.4 'Quicksand', -apple-system, 'Segoe UI', Roboto, sans-serif",color:"rgba(255,255,255,0.6)",background:"rgba(0,0,0,0.82)",border:"1px solid rgba(255,255,255,0.12)",padding:"4px 9px",borderRadius:"8px",whiteSpace:"nowrap",pointerEvents:"none",boxShadow:"0 6px 20px rgba(0,0,0,.45)",backdropFilter:"blur(6px)"}}),this.el.append(this.margin,this.padding,this.content,this.selected,this.badge),e.appendChild(this.el),this.hideHover(),this.hideSelected()}_box(e){return i("div",{style:{position:"fixed",background:e,pointerEvents:"none"}})}_boxStyle(e,t){return{position:"fixed",background:e,outline:`1px solid ${t}`,outlineOffset:"-1px",pointerEvents:"none"}}_place(e,t){Object.assign(e.style,{left:t.left+"px",top:t.top+"px",width:Math.max(0,t.width)+"px",height:Math.max(0,t.height)+"px",display:"block"})}highlight(e){if(!e)return this.hideHover();let t=getComputedStyle(e),o=e.getBoundingClientRect(),r=he(t,"margin"),s=he(t,"padding");this._place(this.margin,{left:o.left-r.left,top:o.top-r.top,width:o.width+r.left+r.right,height:o.height+r.top+r.bottom}),this._place(this.content,o),this._place(this.padding,o);let l=b(e);this.badge.innerHTML=`<span style="color:#58aeff">${He(l)}</span><span style="opacity:.5">&nbsp;&nbsp;${v(o.width)} \xD7 ${v(o.height)}</span>`,this.badge.style.display="block";let h=o.top>24?o.top-22:o.bottom+6;this.badge.style.left=Math.max(4,o.left)+"px",this.badge.style.top=h+"px"}select(e){if(!e)return this.hideSelected();this._place(this.selected,e.getBoundingClientRect())}hideHover(){[this.margin,this.padding,this.content,this.badge].forEach(e=>e.style.display="none")}hideSelected(){this.selected.style.display="none"}destroy(){this.el.remove()}};function he(n,e){let t=o=>parseFloat(n.getPropertyValue(`${e}-${o}`))||0;return{top:t("top"),right:t("right"),bottom:t("bottom"),left:t("left")}}function He(n){return String(n).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}var R=class{constructor(e,t){this.overlay=e,this.onSelect=t,this._onMove=this._onMove.bind(this),this._onClick=this._onClick.bind(this),this._onKey=this._onKey.bind(this),this._onScroll=this._onScroll.bind(this)}start(){document.addEventListener("mousemove",this._onMove,!0),document.addEventListener("click",this._onClick,!0),document.addEventListener("keydown",this._onKey,!0),window.addEventListener("scroll",this._onScroll,!0),window.addEventListener("resize",this._onScroll,!0),document.documentElement.style.cursor="crosshair"}stop(){document.removeEventListener("mousemove",this._onMove,!0),document.removeEventListener("click",this._onClick,!0),document.removeEventListener("keydown",this._onKey,!0),window.removeEventListener("scroll",this._onScroll,!0),window.removeEventListener("resize",this._onScroll,!0),document.documentElement.style.cursor="",this.overlay.hideHover(),c.set({hoverEl:null})}_target(e){let t=document.elementFromPoint(e.clientX,e.clientY);return!t||C(t)||t===document.documentElement||t===document.body?null:t}_onMove(e){if(c.get().editing||c.get().dragging)return;let t=this._target(e);if(!t)return this.overlay.hideHover();t!==c.get().hoverEl&&(c.set({hoverEl:t}),this.overlay.highlight(t))}_onClick(e){if(C(e.target)||c.get().editing||c.get().dragging)return;let t=this._target(e);t&&(e.preventDefault(),e.stopPropagation(),this.onSelect(t))}_onKey(e){e.key==="Escape"&&(e.preventDefault(),c.set({active:!1}))}_onScroll(){let{hoverEl:e,selectedEl:t}=c.get();e&&this.overlay.highlight(e),t&&this.overlay.select(t)}};function Ke(n){return n&&!/[^a-zA-Z0-9_-]/.test(n)&&!/^(is-|has-|js-)/.test(n)?!0:n&&!/[^a-zA-Z0-9_-]/.test(n)}function Ze(n){let e=1,t=n;for(;t=t.previousElementSibling;)t.tagName===n.tagName&&e++;return e}function Ue(n){let e=n.tagName.toLowerCase();if(n.id&&document.querySelectorAll("#"+CSS.escape(n.id)).length===1)return"#"+n.id;let t=Array.from(n.classList).filter(Ke).slice(0,2);return t.length?e+"."+t.map(r=>r).join("."):`${e}:nth-of-type(${Ze(n)})`}function B(n,e=4){if(!n||n.nodeType!==1)return"";let t=[],o=n;for(;o&&o.nodeType===1&&o!==document.documentElement;){let r=Ue(o);if(t.unshift(r),r.startsWith("#"))break;try{if(document.querySelectorAll(t.join(" > ")).length===1)break}catch{}if(o=o.parentElement,t.length>=e)break}return t.join(" > ")}function P(n){n.time=Date.now();let e=c.get().changeLog,t=e[e.length-1],o=n.type==="css"&&t&&t.type==="css"&&t.id===n.id&&t.prop===n.prop&&t.pseudo===n.pseudo,r=n.type==="text"&&t&&t.type==="text"&&t.id===n.id;o||r?(t.to=n.to,t.time=n.time):e.push(n),c.set({changeLog:e})}function _(){return c.get().changeLog}function ue(){let n=c.get().changeLog;n.length=0,c.set({changeLog:n})}function ge(n){return n.type==="text"?`text \u2192 "${Re(n.to,40)}"`:`${n.prop}: ${n.to}`}function fe(){let n=_();if(!n.length)return"";let e=new Map;for(let r of n){let s=r.selector||r.label;e.has(s)||e.set(s,{label:r.label,selector:r.selector,css:new Map,text:null});let l=e.get(s);r.type==="css"?l.css.set(r.pseudo&&r.pseudo!=="none"?`${r.prop} (:${r.pseudo})`:r.prop,r.to):l.text=r.to}let t=`Apply the following design changes to my web page, then return the updated HTML/CSS.

`,o=1;for(let r of e.values()){t+=`${o}. Element \`${r.selector||r.label}\`:
`;for(let[s,l]of r.css)t+=`   - set ${s} to ${l}
`;r.text!=null&&(t+=`   - change its text to: "${r.text}"
`),o++}return t+=`
Keep everything else unchanged.`,t.trim()}function Re(n,e){return n=String(n),n.length>e?n.slice(0,e)+"\u2026":n}var me="inspect-css-live-styles";function Be(){let n=document.getElementById(me);return n||(n=document.createElement("style"),n.id=me,n.setAttribute("data-inspect-ui",""),document.head.appendChild(n)),n}var L=[],Q=[];function $(){let{edits:n}=c.get();return[...n.entries()].map(([e,t])=>[e,{inspectId:t.inspectId,pseudo:t.pseudo,selector:t.selector,props:[...t.props.entries()]}])}function ve(n){let e=new Map;for(let[t,o]of n)e.set(t,{inspectId:o.inspectId,pseudo:o.pseudo,selector:o.selector,props:new Map(o.props)});c.get().edits=e,te(),c.set({edits:e})}function Pe(){L.push($()),L.length>100&&L.shift(),Q.length=0}function xe(){L.length&&(Q.push($()),ve(L.pop()))}function we(){Q.length&&(L.push($()),ve(Q.pop()))}function M(n,e,t){var p,u;Pe();let o=K(n),{edits:r,pseudo:s}=c.get(),l=s==="none"?o:`${o}::${s}`,h=(u=(p=r.get(l))==null?void 0:p.props.get(e))!=null?u:getComputedStyle(n).getPropertyValue(e).trim(),a=r.get(l);a||(a={inspectId:o,pseudo:s,selector:B(n),props:new Map},r.set(l,a)),t===""||t==null?a.props.delete(e):a.props.set(e,t),a.props.size===0&&r.delete(l),te(),c.set({edits:r}),t!==""&&t!=null&&P({type:"css",id:o,prop:e,from:h,to:t,pseudo:s,label:b(n),selector:a.selector})}function ee(n,e="none"){let t=n.getAttribute("data-inspect-id");if(!t)return new Map;let o=e==="none"?t:`${t}::${e}`,r=c.get().edits.get(o);return r?r.props:new Map}function te(){let{edits:n}=c.get(),e=[];for(let t of n.values()){if(t.props.size===0)continue;let o=J(t.inspectId)+(t.pseudo!=="none"?":"+t.pseudo:""),r=[...t.props.entries()].map(([s,l])=>`  ${s}: ${l} !important;`).join(`
`);e.push(`${o} {
${r}
}`)}Be().textContent=e.join(`

`)}function oe(){let{edits:n}=c.get(),e=[];for(let t of n.values()){if(t.props.size===0)continue;let o=(t.selector||J(t.inspectId))+(t.pseudo!=="none"?":"+t.pseudo:""),r=[...t.props.entries()].map(([s,l])=>`  ${s}: ${l};`).join(`
`);e.push(`${o} {
${r}
}`)}return e.join(`

`)}function be(){c.get().edits.clear(),te(),c.set({edits:c.get().edits})}function x(n,e,t,o=t){let r=ee(n,c.get().pseudo).get(t);return r!=null?r:e.getPropertyValue(o).trim()}function ne(n){let e=getComputedStyle(n),t=n.getBoundingClientRect();return{rect:t,tag:n.tagName.toLowerCase(),layout:{display:x(n,e,"display"),position:x(n,e,"position"),width:e.width,height:e.height,x:v(t.left+window.scrollX),y:v(t.top+window.scrollY),rowGap:e.rowGap==="normal"?"0":e.rowGap,columnGap:e.columnGap==="normal"?"0":e.columnGap,justify:x(n,e,"justify-content"),align:x(n,e,"align-items")},transform:Qe(n,e),spacing:{margin:Ce(e,"margin"),padding:Ce(e,"padding")},radius:{all:x(n,e,"border-radius"),tl:e.borderTopLeftRadius,tr:e.borderTopRightRadius,br:e.borderBottomRightRadius,bl:e.borderBottomLeftRadius},typography:{fontFamily:e.fontFamily,fontSize:x(n,e,"font-size"),fontWeight:x(n,e,"font-weight"),lineHeight:e.lineHeight,letterSpacing:e.letterSpacing==="normal"?"0px":e.letterSpacing,textAlign:x(n,e,"text-align"),color:x(n,e,"color"),marginBottom:x(n,e,"margin-bottom")},background:{color:x(n,e,"background-color"),image:e.backgroundImage},border:{width:e.borderTopWidth,style:e.borderTopStyle,color:e.borderTopColor},effects:{opacity:x(n,e,"opacity"),boxShadow:e.boxShadow==="none"?"":e.boxShadow}}}function Ce(n,e){return{top:n.getPropertyValue(`${e}-top`),right:n.getPropertyValue(`${e}-right`),bottom:n.getPropertyValue(`${e}-bottom`),left:n.getPropertyValue(`${e}-left`)}}function Qe(n,e){let o=ee(n,c.get().pseudo).get("transform")||e.transform,r={tx:0,ty:0,rotate:0};if(!o||o==="none")return r;let s=/translate\(\s*(-?[\d.]+)px\s*,\s*(-?[\d.]+)px\s*\)/.exec(o),l=/rotate\(\s*(-?[\d.]+)deg\s*\)/.exec(o);if(s&&(r.tx=parseFloat(s[1]),r.ty=parseFloat(s[2])),l&&(r.rotate=parseFloat(l[1])),s||l)return r;let h=/matrix\(([^)]+)\)/.exec(o);if(h){let[a,p,,,u,d]=h[1].split(",").map(parseFloat);r.tx=v(u),r.ty=v(d),r.rotate=v(Math.atan2(p,a)*(180/Math.PI))}return r}function ke({tx:n=0,ty:e=0,rotate:t=0}){let o=[];return(n||e)&&o.push(`translate(${v(n)}px, ${v(e)}px)`),t&&o.push(`rotate(${v(t)}deg)`),o.length?o.join(" "):""}var Te=6e3,T=n=>n.closest&&n.closest("[data-inspect-ui]");function re(){let n=document.body?document.body.querySelectorAll("*"):[],e=[];for(let t=0;t<n.length&&e.length<Te;t++)T(n[t])||e.push(n[t]);return e}function Ne(n,e,t){let o=n.get(e);o?o.count++:n.set(e,{...t,count:1})}function Ye(){let n=new Map,e=["color","background-color","border-top-color","border-right-color","border-bottom-color","border-left-color","outline-color","fill","stroke"];for(let t of re()){let o=getComputedStyle(t);for(let r of e){let s=o.getPropertyValue(r).trim();if(!s||s==="none")continue;let{hex:l,alpha:h}=Z(s);if(h===0||l==="#000000"&&r==="fill")continue;let a=l+"|"+h;Ne(n,a,{hex:l,alpha:h,css:s})}}return[...n.values()].sort((t,o)=>o.count-t.count).slice(0,80)}function qe(){let n=new Map;for(let e of re()){if(![...e.childNodes].some(u=>u.nodeType===3&&u.textContent.trim()))continue;let o=getComputedStyle(e),r=(o.fontFamily||"").split(",")[0].replace(/["']/g,"").trim(),s=o.fontSize,l=o.fontWeight,h=`${r}|${s}|${l}`,a=e.textContent.trim().slice(0,40),p=n.get(h);p?p.count++:n.set(h,{family:r,size:s,weight:l,lineHeight:o.lineHeight,letterSpacing:o.letterSpacing,sample:a,count:1})}return[...n.values()].sort((e,t)=>parseFloat(t.size)-parseFloat(e.size)||t.count-e.count).slice(0,60)}function Ge(){let n=[],e=new Set;for(let t of document.querySelectorAll("svg")){if(T(t))continue;let o=t.outerHTML;/xmlns=/.test(o)||(o=o.replace("<svg",'<svg xmlns="http://www.w3.org/2000/svg"'));let r=o.slice(0,400);if(e.has(r)||o.length>4e4)continue;e.add(r);let s=t.getBoundingClientRect();if(n.push({type:"inline",markup:o,w:Math.round(s.width),h:Math.round(s.height)}),n.length>120)break}for(let t of document.querySelectorAll('img[src$=".svg"], img[src*=".svg?"]'))T(t)||e.has(t.src)||(e.add(t.src),n.push({type:"url",src:t.src,markup:""}));return n}function De(){let n=[],e=new Set,t=o=>{!o||e.has(o)||o.endsWith(".svg")||o.startsWith("data:image/svg")||(e.add(o),n.push({src:o}))};for(let o of document.querySelectorAll("img"))T(o)||(o.currentSrc||o.src)&&t(o.currentSrc||o.src);for(let o of re()){let r=getComputedStyle(o).backgroundImage;if(!r||r==="none")continue;let s,l=/url\((['"]?)([^'")]+)\1\)/g;for(;s=l.exec(r);)t(new URL(s[2],location.href).href);if(n.length>120)break}return n}function ye(){return{colors:Ye(),typography:qe(),svgs:Ge(),images:De()}}var Oe={"align-bottom":`<svg preserveAspectRatio="xMidYMid meet" overflow="visible" style="display: block;" width="100%" height="100%" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
<g id="align-bottom">
...
</svg>`};function w(n){return Oe[n]||""}function Me(n){return i("span",{class:"fic",html:w(n)})}function Xe(){return i("span",{class:"chev-mini",html:w("chevron-down")})}function m({key:n,iconName:e,value:t,unit:o="px",onChange:r,showUnit:s=!0,sm:l=!1}){let h=I(t),a=/[a-z%]/i.test(String(t!=null?t:"")),p=i("input",{value:h.value,type:"text",inputmode:"decimal"}),u=s?i("span",{class:"unit",text:a?h.unit:o}):null,d=()=>{let g=p.value.trim();if(g==="")return r("");let y=/^-?[\d.]+$/.test(g);r(y&&s?g+((u==null?void 0:u.textContent)||o):g)};if(p.addEventListener("change",d),p.addEventListener("keydown",g=>{if(g.key==="Enter")return p.blur();if(g.key==="ArrowUp"||g.key==="ArrowDown"){let y=parseFloat(p.value)||0;p.value=+(y+(g.key==="ArrowUp"?1:-1)*(g.shiftKey?10:1)).toFixed(2),d(),g.preventDefault()}}),s&&u){let g=["px","%","em","rem","vw","vh"];u.style.cursor="pointer",u.addEventListener("click",()=>{u.textContent=g[(g.indexOf(u.textContent)+1)%g.length],d()})}return i("div",{class:"field"+(l?" sm":"")},[e?Me(e):n?i("span",{class:"fk",text:n}):null,p,u])}var Fe='<svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12.5l4.5 4.5L19 6.5"/></svg>',E=null;function S(){if(!E)return;let{menu:n,anchor:e,onDoc:t,onKey:o}=E;n.remove(),e.classList.remove("open"),document.removeEventListener("mousedown",t,!0),document.removeEventListener("keydown",o,!0),window.removeEventListener("scroll",t,!0),E=null}function We(n,e,t,o){if(E&&E.anchor===n)return S();S();let r=n.getRootNode(),s=r.querySelector&&r.querySelector(".wrap")||document.body,l=i("div",{class:"dropdown-menu","data-inspect-ui":""},e.map(([g,y])=>{let ae=String(g)===String(t),de=i("div",{class:"dropdown-item"+(ae?" active":"")},[i("span",{text:y}),ae?i("span",{class:"dropdown-check",html:Fe}):null]);return de.addEventListener("mousedown",ce=>{ce.preventDefault(),ce.stopPropagation(),o(g),S()}),de}));s.appendChild(l);let h=n.getBoundingClientRect();l.style.left=Math.round(h.left)+"px",l.style.top=Math.round(h.bottom+4)+"px",l.style.minWidth=Math.round(h.width)+"px";let a=l.getBoundingClientRect();a.bottom>window.innerHeight-8&&(l.style.top=Math.round(h.top-a.height-4)+"px");let p=l.querySelector(".dropdown-item.active");p&&p.scrollIntoView({block:"nearest"}),n.classList.add("open");let u=g=>{!g.composedPath().includes(l)&&!g.composedPath().includes(n)&&S()},d=g=>{g.key==="Escape"&&S()};setTimeout(()=>{document.addEventListener("mousedown",u,!0),document.addEventListener("keydown",d,!0),window.addEventListener("scroll",u,!0)},0),E={menu:l,anchor:n,onDoc:u,onKey:d}}function V({value:n,options:e,onChange:t,iconName:o,key:r,sm:s=!0}){let l=e.map(d=>Array.isArray(d)?d:[d,d]),h=l.find(([d])=>String(d)===String(n)),a=i("span",{class:"sel-value",text:h?h[1]:n!=null?n:""}),p=i("div",{class:"field select-like"+(s?" sm":""),tabindex:"0"},[o?Me(o):r?i("span",{class:"fk",text:r}):null,a,Xe()]),u=()=>We(p,l,n,d=>{n=d;let g=l.find(([y])=>String(y)===String(d));a.textContent=g?g[1]:d,t(d)});return p.addEventListener("mousedown",d=>{d.preventDefault(),u()}),p.addEventListener("keydown",d=>{(d.key==="Enter"||d.key===" ")&&(d.preventDefault(),u())}),p}function j(n,{active:e=-1,grow:t=!1,seg:o=!1,onPick:r}={}){let s=i("div",{class:"iconrow"+(t?" grow":"")+(o?" seg":"")});return n.forEach((l,h)=>{let a=i("button",{class:"ibtn"+(h===e?" active":""),title:l.title||"",html:w(l.icon),onclick:()=>r==null?void 0:r(l,h,a)});s.appendChild(a)}),s}function ie(n,e,{showPct:t=!0}={}){let o=Z(n),r=o.hex,s=o.alpha===0?1:o.alpha,l=i("input",{type:"color",value:r}),h=i("div",{class:"swatch"},[l]);h.style.background=n&&n!=="rgba(0, 0, 0, 0)"?n:"transparent";let a=i("input",{class:"hex",value:r.replace("#","")}),p=t?i("span",{class:"pct",text:Math.round(s*100)+"%"}):null,u=d=>{let g=pe(d,s);h.style.background=g,e(g)};return l.addEventListener("input",()=>{a.value=l.value.replace("#",""),u(l.value)}),a.addEventListener("change",()=>{let d=a.value.trim().replace(/^#/,"");/^([0-9a-f]{3}|[0-9a-f]{6})$/i.test(d)?(l.value="#"+d,u("#"+d)):e(a.value.trim())}),i("div",{class:"colorline"},[h,a,p])}function z(n,e,{open:t=!0}={}){let o=i("div",{class:"sec-content"},e),r=i("div",{class:"sec-head"},[i("span",{text:n}),i("span",{class:"chev",html:w("chevron-down")})]),s=i("div",{class:"section"+(t?"":" closed")},[r,o]);return r.addEventListener("click",()=>s.classList.toggle("closed")),s}function f(n,e){return i("div",{class:"stack"},[i("span",{class:"label",text:n}),e])}function Ve(n,e){let t=(l,h)=>{let a=i("input",{class:"sp-edge",value:I(n[l][h]).value});return a.addEventListener("change",()=>{let p=a.value.trim();e(`${l}-${h}`,/^-?[\d.]+$/.test(p)?p+"px":p)}),a},o=(l,h,a,p)=>i("div",{class:h},[i("span",{class:"sp-tag",text:a}),t(l,"top"),i("div",{class:"sp-mid"},[t(l,"left"),p,t(l,"right")]),t(l,"bottom")]),r=i("div",{class:"sp-size"},[i("span",{class:"sp-tag",text:"Size"}),i("span",{html:`${I(n.width||"0").value} <span class="sp-x">x</span> ${I(n.height||"0").value}`})]),s=o("padding","sp-box sp-padding","Padding",r);return o("margin","sp-box sp-margin","Margin",s)}var N=class{constructor(e){this.root=e,this.el=i("div",{class:"panel","data-inspect-ui":""}),e.appendChild(this.el),this._drag()}set(e){this.selected=e,this.render()}render(){let e=c.get();this.el.classList.toggle("hidden",e.collapsed),this.el.innerHTML="",this.el.append(this._head());let t=i("div",{class:"panel-body"});e.view==="assets"?this._assets(t):e.view==="changes"?this._changes(t):this.selected?e.view==="html"?this._html(t):this._design(t):t.append(i("div",{class:"empty",text:"Pick an element on the page to inspect and edit its styles."})),this.el.append(t)}_head(){if(c.get().view==="assets")return i("div",{class:"head"},[i("div",{class:"head-top"},[i("div",{class:"head-title",text:"Assets"}),i("div",{class:"head-actions"},[H("minimize-screen","Close panel",()=>c.set({collapsed:!0})),H("x","Close panel",()=>c.set({collapsed:!0}))])]),i("div",{class:"crumb",style:{color:"var(--muted)"},text:"Everything this page uses"})]);let t=this.selected,o=t?ne(t):null,r=t?Je(t):[];return i("div",{class:"head"},[i("div",{class:"head-top"},[i("div",{class:"head-title",text:t?b(t)||o.tag:"InspectCSS"}),i("div",{class:"head-actions"},[H("delete02","Reset all edits",()=>{be(),this.render()},"danger"),H("minimize-screen","Close panel",()=>c.set({collapsed:!0})),H("x","Close panel (Exit InspectCSS from the left dock)",()=>c.set({collapsed:!0}))])]),t?i("div",{class:"crumb"},r.map(s=>i("span",{text:s}))):null,t?i("div",{class:"dims"},[i("span",{html:`<b>${v(o.rect.width)}</b> x <b>${v(o.rect.height)}</b> px`}),i("span",{html:`A <b>${parseInt(o.typography.fontSize)}px</b>`})]):i("div",{class:"crumb",text:"no selection"})])}_design(e){let t=this.selected,o=ne(t),r=d=>g=>M(t,d,g),s=d=>g=>M(t,d,/^-?[\d.]+$/.test(String(g).trim())?g+"px":g),l=o.transform,h=d=>{Object.assign(l,d),M(t,"transform",ke(l))},a=[{icon:"align-left",title:"Align left",css:["justify-content","flex-start"]},{icon:"align-bottom",title:"Align bottom",css:["align-items","flex-end"]},{icon:"align-right",title:"Align right",css:["justify-content","flex-end"]},{icon:"align-top",title:"Align top",css:["align-items","flex-start"]},{icon:"align-horizontal-center",title:"Center horizontally",css:["justify-content","center"]},{icon:"align-vertical-center",title:"Center vertically",css:["align-items","center"]}];e.append(z("Position",[f("Alignment",j(a,{grow:!0,seg:!0,onPick:d=>M(t,d.css[0],d.css[1])})),f("Position",i("div",{class:"row"},[m({key:"X",value:l.tx+"px",onChange:d=>h({tx:parseFloat(d)||0})}),m({key:"Y",value:l.ty+"px",onChange:d=>h({ty:parseFloat(d)||0})})])),f("Rotation",i("div",{class:"rot-row"},[m({iconName:"rotate01",value:l.rotate+"",showUnit:!1,onChange:d=>h({rotate:parseFloat(d)||0})}),j([{icon:"image-flip-horizontal",title:"Flip horizontal"}],{grow:!0,onPick:()=>Le(t,"x")}),j([{icon:"image-flip-vertical",title:"Flip vertical"}],{grow:!0,onPick:()=>Le(t,"y")})]))])),e.append(z("Layout",[f("Size",i("div",{class:"row"},[m({key:"W",value:o.layout.width,onChange:r("width")}),m({key:"H",value:o.layout.height,onChange:r("height")})])),f("Display",V({value:o.layout.display,options:["block","inline","inline-block","flex","inline-flex","grid","none"],onChange:r("display")})),i("div",{class:"row"},[f("Row Gap",m({iconName:"paragraph-spacing",value:o.layout.rowGap,showUnit:!1,sm:!0,onChange:s("row-gap")})),f("Column Gap",m({iconName:"letter-spacing",value:o.layout.columnGap,showUnit:!1,sm:!0,onChange:s("column-gap")}))]),i("div",{class:"row"},[f("Horizontal Align",V({value:o.layout.justify,options:[["flex-start","Start"],["center","Center"],["flex-end","End"],["space-between","Between"]],onChange:r("justify-content")})),f("Vertical Align",V({value:o.layout.align,options:[["flex-start","Start"],["center","Center"],["flex-end","End"],["stretch","Stretch"]],onChange:r("align-items")}))])])),e.append(z("Spacing",[f("Padding",i("div",{class:"row"},[m({iconName:"horizontal-resize",value:o.spacing.padding.left,onChange:d=>{r("padding-left")(d),r("padding-right")(d)}}),m({iconName:"vertical-resize",value:o.spacing.padding.top,onChange:d=>{r("padding-top")(d),r("padding-bottom")(d)}})])),f("Margin",i("div",{class:"row"},[m({iconName:"horizontal-resize",value:o.spacing.margin.left,onChange:d=>{r("margin-left")(d),r("margin-right")(d)}}),m({iconName:"vertical-resize",value:o.spacing.margin.top,onChange:d=>{r("margin-top")(d),r("margin-bottom")(d)}})])),Ve({...o.spacing,width:o.layout.width,height:o.layout.height},(d,g)=>M(t,d,g))]));let p=[{key:"tl",prop:"border-top-left-radius",v:o.radius.tl},{key:"tr",prop:"border-top-right-radius",v:o.radius.tr},{key:"bl",prop:"border-bottom-left-radius",v:o.radius.bl},{key:"br",prop:"border-bottom-right-radius",v:o.radius.br}],u=new Set([o.radius.tl,o.radius.tr,o.radius.bl,o.radius.br]).size>1;e.append(z("Appearance",[i("div",{class:"row"},[f("Opacity",m({iconName:"transparency",value:String(Math.round((parseFloat(o.effects.opacity)||1)*100)),unit:"%",onChange:d=>r("opacity")((parseFloat(d)||100)/100)})),f("Corner",i("div",{class:"corner-mix"},[m({iconName:"full-screen",value:u?"mix":o.radius.all,showUnit:!1,onChange:s("border-radius")}),j([{icon:"full-screen",title:"Link corners"}],{onPick:()=>s("border-radius")(o.radius.tl)})]))]),i("div",{class:"corner-grid"},p.map(d=>m({iconName:"full-screen",value:d.v,showUnit:!1,onChange:s(d.prop)}))),Ae("Fill",()=>{this._fillOpen=!this._fillOpen,this.render()}),this._fillOpen?ie(o.background.color,r("background-color")):null,Ae("Stroke",()=>{this._strokeOpen=!this._strokeOpen,this.render()}),this._strokeOpen?ie(o.border.color,r("border-color")):null])),e.append(z("Typography",[f("Typeface",V({value:Ee(o.typography.fontFamily),options:[Ee(o.typography.fontFamily),"Quicksand","Inter","Arial","Georgia","system-ui","monospace"],onChange:r("font-family")})),i("div",{class:"row"},[V({value:_e(o.typography.fontWeight),options:[["300","Light"],["400","Regular"],["500","Medium"],["600","SemiBold"],["700","Bold"],["800","Extra"]],onChange:r("font-weight")}),V({value:parseInt(o.typography.fontSize)+"",options:["10","12","13","14","16","18","20","24","32","48"].map(d=>[d,d]),onChange:d=>r("font-size")(d+"px")})]),i("div",{class:"row"},[f("Line Height",m({iconName:"paragraph-spacing",value:$e(o.typography.lineHeight),showUnit:!1,sm:!0,onChange:r("line-height")})),f("Letter Spacing",m({iconName:"letter-spacing",value:o.typography.letterSpacing,showUnit:!1,sm:!0,onChange:s("letter-spacing")}))]),i("div",{class:"row"},[f("Paragraph Spacing",m({iconName:"expand-paragraph",value:et(o.typography.marginBottom),sm:!0,onChange:r("margin-bottom")})),f("Alignment",j([{icon:"text-align-right",title:"Right",css:"right"},{icon:"text-align-center",title:"Center",css:"center"},{icon:"text-align-start",title:"Left",css:"left"},{icon:"text-align-justify",title:"Justify",css:"justify"}],{grow:!0,seg:!0,active:["right","center","left","justify"].indexOf(o.typography.textAlign),onPick:d=>r("text-align")(d.css)}))])]))}_changes(e){let t=_(),o=oe(),r=fe();if(e.append(i("div",{class:"view-actions"},[i("button",{class:"btn primary",text:"Copy CSS",onclick:()=>this._copy()}),i("button",{class:"btn",text:"Copy AI prompt",onclick:()=>{var s;r&&((s=navigator.clipboard)==null||s.writeText(r).then(()=>this._toast("AI prompt copied")))}}),i("button",{class:"btn",text:"Clear",onclick:()=>{ue(),this.render()}})])),!t.length){e.append(i("div",{class:"empty",text:"No changes yet. Edit a property, colour or text and every change is logged here."}));return}e.append(A("Change log",t.length,i("div",{class:"log-list"},[...t].reverse().map(s=>i("div",{class:"log-item"},[i("span",{class:"log-el",text:s.label||s.selector}),i("span",{class:"log-desc",text:ge(s)})]))))),e.append(A("AI prompt",0,i("div",{},[i("div",{class:"ai-hint",text:"Paste this into any AI to apply these changes to your codebase."}),i("pre",{class:"code ai-prompt",text:r})]))),e.append(A("Generated CSS",0,o?i("pre",{class:"code",html:tt(o)}):i("div",{class:"empty",text:"No CSS edits."})))}_html(e){let t=this.selected;if(!t)return e.append(i("div",{class:"empty",text:"No element selected."}));let o=t.cloneNode(!1);o.removeAttribute("data-inspect-id"),e.append(i("pre",{class:"code",html:je(o.outerHTML.replace(/></,`>
  \u2026
<`))}))}_copy(){var t;let e=oe();e&&((t=navigator.clipboard)==null||t.writeText(e).then(()=>this._toast("CSS copied")))}_toast(e){let t=i("div",{class:"toast","data-inspect-ui":"",text:e});this.root.appendChild(t),setTimeout(()=>t.remove(),1400)}_assets(e){let t=this._assetCache||(this._assetCache=ye()),o=(a,p)=>{var u;(u=navigator.clipboard)==null||u.writeText(a),this._toast(p||"Copied")},r=i("div",{class:"asset-colors"},t.colors.map(a=>i("button",{class:"asset-swatch",title:`${a.hex} \xB7 used ${a.count}\xD7`,style:{background:a.css},onclick:()=>o(a.hex,a.hex+" copied")}))),s=i("div",{class:"asset-type-list"},t.typography.map(a=>i("button",{class:"asset-type",title:"Copy CSS",onclick:()=>o(`font-family: ${a.family};
font-size: ${a.size};
font-weight: ${a.weight};`,"Type style copied")},[i("div",{class:"asset-type-preview",style:{fontFamily:a.family,fontSize:"min("+a.size+", 28px)",fontWeight:a.weight},text:"Ag"}),i("div",{class:"asset-type-meta"},[i("div",{class:"asset-type-name",text:a.family}),i("div",{class:"asset-type-sub",text:`${parseInt(a.size)}px \xB7 ${a.weight}`})])]))),l=i("div",{class:"asset-grid"},t.svgs.map(a=>{let p=i("div",{class:"asset-thumb asset-svg",title:"Copy SVG"});return a.type==="inline"?p.innerHTML=a.markup:p.appendChild(i("img",{src:a.src,alt:""})),p.addEventListener("click",()=>o(a.markup||a.src,"SVG copied")),p})),h=i("div",{class:"asset-grid"},t.images.map(a=>{let p=i("div",{class:"asset-thumb",title:"Copy image URL"},[i("img",{src:a.src,alt:"",loading:"lazy"})]);return p.addEventListener("click",()=>o(a.src,"Image URL copied")),p}));e.append(i("div",{class:"view-actions"},[i("button",{class:"btn primary",text:"Rescan page",onclick:()=>{this._assetCache=null,this.render()}})]),A("Colors",t.colors.length,r),A("Typography",t.typography.length,s),A("SVGs",t.svgs.length,l),A("Images",t.images.length,h))}_drag(){let e,t,o,r,s=!1;this.el.addEventListener("mousedown",a=>{if(!a.target.closest(".head")||a.target.closest(".hbtn"))return;s=!0;let u=this.el.getBoundingClientRect();e=a.clientX,t=a.clientY,o=u.left,r=u.top,this.el.style.right="auto",document.addEventListener("mousemove",l,!0),document.addEventListener("mouseup",h,!0),a.preventDefault()});let l=a=>{s&&(this.el.style.left=o+(a.clientX-e)+"px",this.el.style.top=Math.max(0,r+(a.clientY-t))+"px")},h=()=>{s=!1,document.removeEventListener("mousemove",l,!0),document.removeEventListener("mouseup",h,!0)}}};function H(n,e,t,o=""){return i("button",{class:"hbtn"+(o?" "+o:""),title:e,onclick:t,html:w(n)})}function Ae(n,e){return i("div",{class:"addrow"},[i("span",{class:"k",text:n}),i("button",{class:"addbtn",title:"Add "+n,html:w("plus"),onclick:e})])}function A(n,e,t){let o=i("div",{class:"sec-head"},[i("span",{},[n,e?i("span",{class:"asset-count",text:String(e)}):null]),i("span",{class:"chev",html:w("chevron-down")})]),r=i("div",{class:"section"},[o,i("div",{class:"sec-content"},[t])]);return o.addEventListener("click",()=>r.classList.toggle("closed")),r}function Je(n){let e=[],t=n,o=0;for(;t&&t.nodeType===1&&t!==document.documentElement&&o<3;)t.classList.length?e.unshift("."+t.classList[0]):e.unshift(t.tagName.toLowerCase()),t=t.parentElement,o++;return e}function Le(n,e){let t=getComputedStyle(n),o=t.transform==="none"?"":t.transform+" ";M(n,"transform",o+(e==="x"?"scaleX(-1)":"scaleY(-1)"))}function Ee(n){return(n||"").split(",")[0].replace(/["']/g,"").trim()||"system-ui"}function _e(n){return String(n)}function $e(n){return n==="normal"?"1.4":n}function et(n){return n&&n!=="auto"?n:"0px"}function je(n){return n.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function tt(n){return je(n).replace(/^([^{\n]+)\{/gm,'<span class="sel">$1</span>{').replace(/^(\s+)([\w-]+)(:)/gm,'$1<span class="prop">$2</span>$3').replace(/: ([^;]+);/g,': <span class="val">$1</span>;')}var Y=class{constructor(e,t){this.api=t,this.el=i("div",{class:"dock","data-inspect-ui":""}),e.appendChild(this.el),this.render(),c.subscribe(()=>this.sync())}render(){this.el.innerHTML="",this.pauseBtn=ze("pause","Pause / resume picking",()=>c.set({active:!c.get().active}));let e=i("div",{class:"dock-group"},[k("undo-03","Undo",()=>{var o,r;return(r=(o=this.api).undo)==null?void 0:r.call(o)}),k("redo-01","Redo",()=>{var o,r;return(r=(o=this.api).redo)==null?void 0:r.call(o)}),se(),k("layer-send-backward","Select parent element",()=>{var o,r;return(r=(o=this.api).selectParent)==null?void 0:r.call(o)}),k("layer-bring-forward","Select child element",()=>{var o,r;return(r=(o=this.api).selectChild)==null?void 0:r.call(o)}),se(),this.assetsBtn=k("component","Assets (page colors, type, SVGs, images)",()=>{let o=c.get().view;c.set({view:o==="assets"?"design":"assets",collapsed:!1})}),this.codeBtn=k("file-diff","Changes & AI prompt",()=>c.set({view:"changes",collapsed:!1})),this.htmlBtn=k("html-file-01","HTML",()=>c.set({view:"html",collapsed:!1})),se(),k("laptop-phone-sync","Toggle responsive preview",()=>{var o,r;return(r=(o=this.api).toggleResponsive)==null?void 0:r.call(o)})]),t=ze("cancel-01","Exit InspectCSS",()=>{var o;return(o=window.InspectCSS)==null?void 0:o.destroy()});this.el.append(this.pauseBtn,e,t),this.sync()}sync(){var t,o,r,s;let e=c.get();(t=this.pauseBtn)==null||t.classList.toggle("active",e.active),(o=this.assetsBtn)==null||o.classList.toggle("active",e.view==="assets"),(r=this.codeBtn)==null||r.classList.toggle("active",e.view==="changes"),(s=this.htmlBtn)==null||s.classList.toggle("active",e.view==="html")}};function ze(n,e,t){return i("button",{class:"dock-circle",title:e,onclick:t,html:w(n)})}function k(n,e,t){return i("button",{class:"dock-btn",title:e,onclick:t,html:w(n)})}function se(){return i("div",{class:"dock-sep"})}var q=class{constructor(e){this.root=e,this.el=i("div",{class:"tooltip","data-inspect-ui":""}),e.appendChild(this.el),e.addEventListener("pointerover",t=>this._over(t),!0),e.addEventListener("pointerout",t=>this._out(t),!0),e.addEventListener("pointerdown",()=>this.hide(),!0)}_over(e){let t=e.target.closest&&e.target.closest("[title],[data-tip]");if(!t||!this.root.contains(t))return;if(t.hasAttribute("title")){let r=t.getAttribute("title");r&&t.setAttribute("data-tip",r),t.removeAttribute("title")}let o=t.getAttribute("data-tip");o&&this.show(o,t)}_out(e){let t=e.target.closest&&e.target.closest("[data-tip]");t&&!t.contains(e.relatedTarget)&&this.hide()}show(e,t){this.el.textContent=e,this.el.classList.add("show");let o=t.getBoundingClientRect(),r=this.el.getBoundingClientRect(),s=o.top-r.height-8,l=o.left+o.width/2-r.width/2;s<6&&(s=o.bottom+8),l=Math.max(6,Math.min(l,window.innerWidth-r.width-6)),this.el.style.left=Math.round(l)+"px",this.el.style.top=Math.round(s)+"px"}hide(){this.el.classList.remove("show")}};var G=class{constructor(e){this.onChange=e,this._onDblClick=this._onDblClick.bind(this),this._onKey=this._onKey.bind(this)}start(){document.addEventListener("dblclick",this._onDblClick,!0)}stop(){document.removeEventListener("dblclick",this._onDblClick,!0),this._finish()}_editable(e){if(!e||e.nodeType!==1||C(e))return null;let t=e;for(;t&&t!==document.body;){let o=[...t.childNodes].some(s=>s.nodeType===3&&s.textContent.trim()),r=![...t.children].some(s=>{let l=getComputedStyle(s).display;return l==="block"||l==="flex"||l==="grid"});if(o&&r)return t;t=t.parentElement}return e.matches("h1,h2,h3,h4,h5,h6,p,span,a,button,li,td,th,label,strong,em,small,div")?e:null}_onDblClick(e){var s,l;if(C(e.target))return;let t=this._editable(e.target);if(!t)return;e.preventDefault(),e.stopPropagation(),c.set({editing:!0,selectedEl:t}),this.el=t,this._origText=t.textContent,K(t),t.setAttribute("contenteditable","true"),t.setAttribute("data-inspect-editing",""),t.focus();let o=(s=document.caretRangeFromPoint)==null?void 0:s.call(document,e.clientX,e.clientY),r=window.getSelection();r.removeAllRanges(),o?r.addRange(o):(l=document.execCommand)==null||l.call(document,"selectAll",!1,null),t.addEventListener("blur",()=>this._finish(),{once:!0}),document.addEventListener("keydown",this._onKey,!0)}_onKey(e){this.el&&(e.key==="Escape"||e.key==="Enter"&&!e.shiftKey&&this.el.tagName!=="DIV")&&(e.preventDefault(),this.el.blur())}_finish(){var e;if(document.removeEventListener("keydown",this._onKey,!0),this.el){let t=this.el;t.removeAttribute("contenteditable"),t.removeAttribute("data-inspect-editing");let o=t.textContent;o!==this._origText&&P({type:"text",id:t.getAttribute("data-inspect-id"),from:this._origText,to:o,label:b(t),selector:B(t)}),this.el=null}c.get().editing&&c.set({editing:!1}),(e=this.onChange)==null||e.call(this)}};var ot=4,nt='<svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M5 9l-3 3 3 3M9 5l3-3 3 3M15 19l-3 3-3-3M19 9l3 3-3 3M2 12h20M12 2v20"/></svg>',D=class{constructor(e){this.onReorder=e,this.indicator=i("div",{"data-inspect-ui":"",style:{position:"fixed",background:"#58aeff",borderRadius:"2px",pointerEvents:"none",zIndex:"2147483644",display:"none",boxShadow:"0 0 6px rgba(88,174,255,.8)"}}),this.handle=i("div",{"data-inspect-ui":"",title:"Drag to reorder",html:nt,style:{position:"fixed",width:"26px",height:"26px",borderRadius:"999px",display:"none",alignItems:"center",justifyContent:"center",background:"rgba(0,0,0,0.82)",border:"1px solid rgba(255,255,255,0.18)",color:"#fff",cursor:"grab",zIndex:"2147483645",boxShadow:"0 4px 14px rgba(0,0,0,.5)",backdropFilter:"blur(6px)"}}),document.documentElement.append(this.indicator,this.handle),this._down=this._down.bind(this),this._move=this._move.bind(this),this._up=this._up.bind(this),this._reposition=this._reposition.bind(this),this._sync=this._sync.bind(this)}start(){this.handle.addEventListener("mousedown",this._down,!0),this.handle.addEventListener("mouseenter",()=>this.handle.style.background="#58aeff"),this.handle.addEventListener("mouseleave",()=>this.handle.style.background="rgba(0,0,0,0.82)"),this.unsub=c.subscribe(this._sync),window.addEventListener("scroll",this._reposition,!0),window.addEventListener("resize",this._reposition,!0)}stop(){var e;(e=this.unsub)==null||e.call(this),window.removeEventListener("scroll",this._reposition,!0),window.removeEventListener("resize",this._reposition,!0),this.indicator.remove(),this.handle.remove()}_sync(){let e=c.get(),t=e.selectedEl&&!e.dragging&&!e.editing;this.handle.style.display=t?"flex":"none",t&&this._reposition()}_reposition(){let e=c.get().selectedEl;if(!e||this.dragging)return;let t=e.getBoundingClientRect();this.handle.style.left=Math.round(Math.max(4,t.left-8))+"px",this.handle.style.top=Math.round(Math.max(4,t.top-8))+"px"}_down(e){e.button===0&&(e.preventDefault(),e.stopPropagation(),c.get().selectedEl&&(this.sx=e.clientX,this.sy=e.clientY,this.armed=!0,this.dragging=!1,document.addEventListener("mousemove",this._move,!0),document.addEventListener("mouseup",this._up,!0)))}_move(e){if(this.armed){if(!this.dragging){if(Math.hypot(e.clientX-this.sx,e.clientY-this.sy)<ot)return;this.dragging=!0,c.set({dragging:!0}),document.documentElement.style.cursor="grabbing",this.handle.style.display="none"}this._updateTarget(e)}}_updateTarget(e){let t=c.get().selectedEl,o=t==null?void 0:t.parentElement;if(!o)return;let r=[...o.children].filter(d=>!C(d)),s=document.elementFromPoint(e.clientX,e.clientY),l=r.find(d=>d===s||d.contains(s));if(!l||l===t){this.ref=void 0,this.indicator.style.display="none";return}let h=getComputedStyle(o),a=/row/.test(h.flexDirection)||h.display.includes("inline")||h.display==="grid"&&h.gridAutoFlow.includes("column"),p=l.getBoundingClientRect(),u=a?e.clientX>p.left+p.width/2:e.clientY>p.top+p.height/2;if(this.ref=u?l.nextElementSibling:l,a){let d=u?p.right:p.left;Object.assign(this.indicator.style,{display:"block",left:d-1.5+"px",top:p.top+"px",width:"3px",height:p.height+"px"})}else{let d=u?p.bottom:p.top;Object.assign(this.indicator.style,{display:"block",left:p.left+"px",top:d-1.5+"px",width:p.width+"px",height:"3px"})}}_up(){var t;document.removeEventListener("mousemove",this._move,!0),document.removeEventListener("mouseup",this._up,!0),this.indicator.style.display="none",document.documentElement.style.cursor="";let e=this.dragging;if(this.armed=!1,this.dragging=!1,e){let o=c.get().selectedEl;o&&this.ref!==void 0&&this.ref!==o&&o.parentElement.insertBefore(o,this.ref||null),c.set({dragging:!1}),this.ref=void 0;let r=s=>{s.stopPropagation(),s.preventDefault(),document.removeEventListener("click",r,!0)};document.addEventListener("click",r,!0),(t=this.onReorder)==null||t.call(this,o)}this._sync()}};var O=`@font-face {
...
`;var le=class{constructor(){this.host=document.createElement("div"),this.host.setAttribute("data-inspect-ui",""),this.host.style.cssText="all: initial; position: static;";let e=this.host.attachShadow({mode:"open"}),t=document.createElement("style");t.textContent=Ie;let o=document.createElement("div");o.className="wrap",e.append(t,o),document.documentElement.appendChild(this.host),this.fontStyle=document.createElement("style"),this.fontStyle.setAttribute("data-inspect-ui",""),this.fontStyle.textContent=O,document.head.appendChild(this.fontStyle),this.overlay=new U(document.documentElement),this.panel=new N(o),this.tooltip=new q(o),this.toolbar=new Y(o,{undo:()=>{xe(),this.panel.render()},redo:()=>{we(),this.panel.render()},selectParent:()=>this.selectRelative("parent"),selectChild:()=>this.selectRelative("child"),toggleResponsive:()=>this.toggleResponsive()}),this.inspector=new R(this.overlay,r=>this.select(r)),this.textEditor=new G(()=>this.panel.render()),this.dragMove=new D(r=>{r&&(this.overlay.select(r),this.panel.render())}),this.textEditor.start(),this.dragMove.start(),this._prevView=c.get().view,this._prevCollapsed=c.get().collapsed,this.unsub=c.subscribe(r=>this.onState(r)),this._track=()=>{this._raf||(this._raf=requestAnimationFrame(()=>{this._raf=0;let r=c.get();r.hoverEl&&this.overlay.highlight(r.hoverEl),r.selectedEl&&this.overlay.select(r.selectedEl)}))},window.addEventListener("scroll",this._track,!0),window.addEventListener("resize",this._track,!0),c.set({active:!0}),this.panel.render()}select(e){c.set({selectedEl:e,collapsed:!1,view:"design"}),this.overlay.select(e),this.panel.set(e)}selectRelative(e){let t=c.get().selectedEl;if(!t)return;let o=null;if(e==="parent"){if(o=t.parentElement,!o||o===document.documentElement||o===document.body)return}else if(o=[...t.children].find(r=>!r.closest("[data-inspect-ui]")),!o)return;c.set({view:"design",collapsed:!1}),this.select(o)}toggleResponsive(){this._resp=!this._resp;let e=document.documentElement;this._resp?(e.style.maxWidth="420px",e.style.margin="0 auto",e.style.transition="max-width .2s"):(e.style.maxWidth="",e.style.margin="");let t=c.get();t.selectedEl&&this.overlay.select(t.selectedEl)}onState(e){e.active&&!this._picking?(this._picking=!0,this.inspector.start()):!e.active&&this._picking&&(this._picking=!1,this.inspector.stop()),e.selectedEl&&this.overlay.select(e.selectedEl),(e.view!==this._prevView||e.collapsed!==this._prevCollapsed)&&(e.view==="assets"&&this._prevView!=="assets"&&(this.panel._assetCache=null),this._prevView=e.view,this._prevCollapsed=e.collapsed,this.panel.render())}destroy(){var t,o;(t=this.unsub)==null||t.call(this),window.removeEventListener("scroll",this._track,!0),window.removeEventListener("resize",this._track,!0),this.textEditor.stop(),this.dragMove.stop(),this.inspector.stop(),this.overlay.destroy(),this.host.remove(),(o=this.fontStyle)==null||o.remove(),this.toggleResponsiveOff();let e=document.getElementById("inspect-css-live-styles");e&&e.remove(),delete window.InspectCSS}toggleResponsiveOff(){document.documentElement.style.maxWidth="",document.documentElement.style.margin=""}};function rt(){if(window.InspectCSS){window.InspectCSS.destroy();return}let n=new le;window.InspectCSS={app:n,destroy:()=>n.destroy(),version:"0.6.0"}}rt();})();
