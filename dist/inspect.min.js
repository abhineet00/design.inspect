(()=>{var J={active:!1,hoverEl:null,selectedEl:null,pseudo:"none",view:"design",edits:new Map,panelPos:{x:null,y:16},collapsed:!1,editing:!1,dragging:!1,changeLog:[],promptDiff:!1,docked:!1,responsive:!1},_=new Set,c={get:()=>J,set(n){Object.assign(J,n),_.forEach(e=>e(J))},subscribe(n){return _.add(n),()=>_.delete(n)}};var Ze=0,$="data-inspect-id";function Z(n){let e=n.getAttribute($);return e||(e="ic-"+ ++Ze,n.setAttribute($,e)),e}function ee(n){return`[${$}="${n}"]`}function v(n,e=2){if(n==null||Number.isNaN(n))return 0;let t=Math.pow(10,e);return Math.round(n*t)/t}function s(n,e={},t=[]){let o=document.createElement(n);for(let[i,r]of Object.entries(e))i==="class"?o.className=r:i==="style"&&typeof r=="object"?Object.assign(o.style,r):i==="html"?o.innerHTML=r:i==="text"?o.textContent=r:i.startsWith("on")&&typeof r=="function"?o.addEventListener(i.slice(2).toLowerCase(),r):r!==!1&&r!=null&&o.setAttribute(i,r===!0?"":r);for(let i of[].concat(t))i==null||i===!1||o.appendChild(typeof i=="string"?document.createTextNode(i):i);return o}function x(n){if(!n||n.nodeType!==1)return"";let e=n.tagName.toLowerCase();return n.id?e+="#"+n.id:n.classList.length&&(e+="."+n.classList[0]),e}function H(n){if(n==null)return{value:0,unit:"px"};let e=String(n).trim().match(/^(-?[\d.]+)\s*([a-z%]*)$/i);return e?{value:parseFloat(e[1]),unit:e[2]||"px"}:{value:n,unit:""}}function U(n){if(!n)return{hex:"#000000",alpha:1};if(n.startsWith("#"))return{hex:n,alpha:1};let e=n.match(/rgba?\(([^)]+)\)/i);if(!e)return{hex:"#000000",alpha:1};let t=e[1].split(",").map(a=>a.trim()),[o,i,r]=t.map(a=>parseInt(a,10)),l=t[3]!=null?parseFloat(t[3]):1;return{hex:"#"+[o,i,r].map(a=>Math.max(0,Math.min(255,a||0)).toString(16).padStart(2,"0")).join(""),alpha:l}}function ve(n,e=1){let t=n.replace("#",""),o=t.length===3?t.split("").map(d=>d+d).join(""):t.padEnd(6,"0"),i=parseInt(o.slice(0,2),16),r=parseInt(o.slice(2,4),16),l=parseInt(o.slice(4,6),16);return e>=1?`rgb(${i}, ${r}, ${l})`:`rgba(${i}, ${r}, ${l}, ${v(e,3)})`}function y(n){return!!(n&&n.closest&&n.closest("[data-inspect-ui]"))}var P=class{constructor(e){this.el=s("div",{"data-inspect-ui":"",style:{position:"fixed",inset:"0",pointerEvents:"none",zIndex:"2147483640"}}),this.margin=this._box("rgba(246, 178, 107, 0.28)"),this.padding=this._box("rgba(147, 196, 125, 0.30)"),this.content=s("div",{style:this._boxStyle("transparent","#4c8dff")}),this.selected=s("div",{style:this._boxStyle("transparent","#7c5cff")}),this.badge=s("div",{"data-inspect-ui":"",style:{position:"fixed",font:"500 12px/1.4 'Quicksand', -apple-system, 'Segoe UI', Roboto, sans-serif",color:"rgba(255,255,255,0.6)",background:"rgba(0,0,0,0.82)",border:"1px solid rgba(255,255,255,0.12)",padding:"4px 9px",borderRadius:"8px",whiteSpace:"nowrap",pointerEvents:"none",boxShadow:"0 6px 20px rgba(0,0,0,.45)",backdropFilter:"blur(6px)"}}),this.el.append(this.margin,this.padding,this.content,this.selected,this.badge),e.appendChild(this.el),this.hideHover(),this.hideSelected()}_box(e){return s("div",{style:{position:"fixed",background:e,pointerEvents:"none"}})}_boxStyle(e,t){return{position:"fixed",background:e,outline:`1px solid ${t}`,outlineOffset:"-1px",pointerEvents:"none"}}_place(e,t){Object.assign(e.style,{left:t.left+"px",top:t.top+"px",width:Math.max(0,t.width)+"px",height:Math.max(0,t.height)+"px",display:"block"})}highlight(e){if(!e)return this.hideHover();let t=getComputedStyle(e),o=e.getBoundingClientRect(),i=xe(t,"margin"),r=xe(t,"padding");this._place(this.margin,{left:o.left-i.left,top:o.top-i.top,width:o.width+i.left+i.right,height:o.height+i.top+i.bottom}),this._place(this.content,o),this._place(this.padding,o);let l=x(e);this.badge.innerHTML=`<span style="color:#58aeff">${Ue(l)}</span><span style="opacity:.5">&nbsp;&nbsp;${v(o.width)} \xD7 ${v(o.height)}</span>`,this.badge.style.display="block";let d=o.top>24?o.top-22:o.bottom+6;this.badge.style.left=Math.max(4,o.left)+"px",this.badge.style.top=d+"px"}select(e){if(!e)return this.hideSelected();this._place(this.selected,e.getBoundingClientRect())}hideHover(){[this.margin,this.padding,this.content,this.badge].forEach(e=>e.style.display="none")}hideSelected(){this.selected.style.display="none"}destroy(){this.el.remove()}};function xe(n,e){let t=o=>parseFloat(n.getPropertyValue(`${e}-${o}`))||0;return{top:t("top"),right:t("right"),bottom:t("bottom"),left:t("left")}}function Ue(n){return String(n).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}var T=class{constructor(e,t){this.overlay=e,this.onSelect=t,this._onMove=this._onMove.bind(this),this._onClick=this._onClick.bind(this),this._onKey=this._onKey.bind(this),this._onScroll=this._onScroll.bind(this)}start(){document.addEventListener("mousemove",this._onMove,!0),document.addEventListener("click",this._onClick,!0),document.addEventListener("keydown",this._onKey,!0),window.addEventListener("scroll",this._onScroll,!0),window.addEventListener("resize",this._onScroll,!0),document.documentElement.style.cursor="crosshair"}stop(){document.removeEventListener("mousemove",this._onMove,!0),document.removeEventListener("click",this._onClick,!0),document.removeEventListener("keydown",this._onKey,!0),window.removeEventListener("scroll",this._onScroll,!0),window.removeEventListener("resize",this._onScroll,!0),document.documentElement.style.cursor="",this.overlay.hideHover(),c.set({hoverEl:null})}_target(e){let t=document.elementFromPoint(e.clientX,e.clientY);return!t||y(t)||t===document.documentElement||t===document.body?null:t}_onMove(e){if(c.get().editing||c.get().dragging)return;let t=this._target(e);if(!t)return this.overlay.hideHover();t!==c.get().hoverEl&&(c.set({hoverEl:t}),this.overlay.highlight(t))}_onClick(e){if(y(e.target)||c.get().editing||c.get().dragging)return;let t=this._target(e);t&&(e.preventDefault(),e.stopPropagation(),this.onSelect(t))}_onKey(e){e.key==="Escape"&&(e.preventDefault(),c.set({active:!1}))}_onScroll(){let{hoverEl:e,selectedEl:t}=c.get();e&&this.overlay.highlight(e),t&&this.overlay.select(t)}};function Pe(n){return n&&!/[^a-zA-Z0-9_-]/.test(n)&&!/^(is-|has-|js-)/.test(n)?!0:n&&!/[^a-zA-Z0-9_-]/.test(n)}function Te(n){let e=1,t=n;for(;t=t.previousElementSibling;)t.tagName===n.tagName&&e++;return e}function Ne(n){let e=n.tagName.toLowerCase();if(n.id&&document.querySelectorAll("#"+CSS.escape(n.id)).length===1)return"#"+n.id;let t=Array.from(n.classList).filter(Pe).slice(0,2);return t.length?e+"."+t.map(i=>i).join("."):`${e}:nth-of-type(${Te(n)})`}function k(n,e=4){if(!n||n.nodeType!==1)return"";let t=[],o=n;for(;o&&o.nodeType===1&&o!==document.documentElement;){let i=Ne(o);if(t.unshift(i),i.startsWith("#"))break;try{if(document.querySelectorAll(t.join(" > ")).length===1)break}catch{}if(o=o.parentElement,t.length>=e)break}return t.join(" > ")}function C(n){n.time=Date.now();let e=c.get().changeLog,t=e[e.length-1],o=n.type==="css"&&t&&t.type==="css"&&t.id===n.id&&t.prop===n.prop&&t.pseudo===n.pseudo,i=n.type==="text"&&t&&t.type==="text"&&t.id===n.id;o||i?(t.to=n.to,t.time=n.time):e.push(n),c.set({changeLog:e})}function te(){return c.get().changeLog}function we(){let n=c.get().changeLog;n.length=0,c.set({changeLog:n})}function be(n){let e=c.get().changeLog,t=e.filter(o=>!(o.type==="move"&&o.id===n));e.length=0,e.push(...t),c.set({changeLog:e})}function ye(n){return n.type==="text"?`text \u2192 "${Qe(n.to,34)}"`:n.type==="move"?n.position?`moved ${n.position}`:"reordered among siblings":n.type==="delete"?"removed from the page":`${n.prop}: ${n.to}`}function ke(n=!1){let e=te();if(!e.length)return"";let t=new Map;for(let r of e){let l=r.selector||r.label;t.has(l)||t.set(l,{label:r.label,selector:r.selector,css:new Map,text:null,movedTo:null,deleted:!1});let d=t.get(l);if(r.type==="css"){let a=r.pseudo&&r.pseudo!=="none"?`${r.prop} (:${r.pseudo})`:r.prop,h=d.css.get(a);d.css.set(a,{from:h?h.from:r.from,to:r.to})}else r.type==="text"?d.text={from:d.text?d.text.from:r.from,to:r.to}:r.type==="move"?d.movedTo=r.position||"to a new position":r.type==="delete"&&(d.deleted=!0)}let o=`Apply the following design changes to my web page, then return the updated HTML/CSS.

`,i=1;for(let r of t.values()){if(o+=`${i}. Element \`${r.selector||r.label}\`:
`,r.deleted){o+=`   - remove this element from the page
`,i++;continue}for(let[l,d]of r.css)o+=n?`   - change ${l} from ${d.from||"default"} to ${d.to}
`:`   - set ${l} to ${d.to}
`;r.text!=null&&(o+=n?`   - change its text from "${r.text.from}" to "${r.text.to}"
`:`   - change its text to: "${r.text.to}"
`),r.movedTo&&(o+=`   - move it ${r.movedTo} (relative to its siblings)
`),i++}return o+=`
Keep everything else unchanged.`,o.trim()}function Qe(n,e){return n=String(n),n.length>e?n.slice(0,e)+"\u2026":n}var R=[],oe=[];function M(n){R.push(n),R.length>200&&R.shift(),oe.length=0}function ne(){let n=R.pop();return n?(n.undo(),oe.push(n),n):null}function N(){let n=oe.pop();return n?(n.redo(),R.push(n),n):null}var Ce="inspect-css-live-styles";function De(){let n=document.getElementById(Ce);return n||(n=document.createElement("style"),n.id=Ce,n.setAttribute("data-inspect-ui",""),document.head.appendChild(n)),n}function Me(){let{edits:n}=c.get();return[...n.entries()].map(([e,t])=>[e,{inspectId:t.inspectId,pseudo:t.pseudo,selector:t.selector,props:[...t.props.entries()]}])}function Ee(n){let e=new Map;for(let[t,o]of n)e.set(t,{inspectId:o.inspectId,pseudo:o.pseudo,selector:o.selector,props:new Map(o.props)});c.get().edits=e,Le(),c.set({edits:e})}function V(n,e,t){var p,g;let o=Me(),i=Z(n),{edits:r,pseudo:l}=c.get(),d=l==="none"?i:`${i}::${l}`,a=(g=(p=r.get(d))==null?void 0:p.props.get(e))!=null?g:getComputedStyle(n).getPropertyValue(e).trim(),h=r.get(d);h||(h={inspectId:i,pseudo:l,selector:k(n),props:new Map},r.set(d,h)),t===""||t==null?h.props.delete(e):h.props.set(e,t),h.props.size===0&&r.delete(d),Le(),c.set({edits:r}),t!==""&&t!=null&&C({type:"css",id:i,prop:e,from:a,to:t,pseudo:l,label:x(n),selector:h.selector});let u=Me();M({undo:()=>Ee(o),redo:()=>Ee(u)})}function ie(n,e="none"){let t=n.getAttribute("data-inspect-id");if(!t)return new Map;let o=e==="none"?t:`${t}::${e}`,i=c.get().edits.get(o);return i?i.props:new Map}function Le(){let{edits:n}=c.get(),e=[];for(let t of n.values()){if(t.props.size===0)continue;let o=ee(t.inspectId)+(t.pseudo!=="none"?":"+t.pseudo:""),i=[...t.props.entries()].map(([r,l])=>`  ${r}: ${l} !important;`).join(`
`);e.push(`${o} {
${i}
}`)}De().textContent=e.join(`

`)}function re(){let{edits:n}=c.get(),e=[];for(let t of n.values()){if(t.props.size===0)continue;let o=(t.selector||ee(t.inspectId))+(t.pseudo!=="none"?":"+t.pseudo:""),i=[...t.props.entries()].map(([r,l])=>`  ${r}: ${l};`).join(`
`);e.push(`${o} {
${i}
}`)}return e.join(`

`)}function w(n,e,t,o=t){let i=ie(n,c.get().pseudo).get(t);return i!=null?i:e.getPropertyValue(o).trim()}function se(n){let e=getComputedStyle(n),t=n.getBoundingClientRect();return{rect:t,tag:n.tagName.toLowerCase(),layout:{display:w(n,e,"display"),position:w(n,e,"position"),width:e.width,height:e.height,x:v(t.left+window.scrollX),y:v(t.top+window.scrollY),rowGap:e.rowGap==="normal"?"0":e.rowGap,columnGap:e.columnGap==="normal"?"0":e.columnGap,justify:w(n,e,"justify-content"),align:w(n,e,"align-items")},transform:Ye(n,e),spacing:{margin:Ve(e,"margin"),padding:Ve(e,"padding")},radius:{all:w(n,e,"border-radius"),tl:e.borderTopLeftRadius,tr:e.borderTopRightRadius,br:e.borderBottomRightRadius,bl:e.borderBottomLeftRadius},typography:{fontFamily:e.fontFamily,fontSize:w(n,e,"font-size"),fontWeight:w(n,e,"font-weight"),lineHeight:e.lineHeight,letterSpacing:e.letterSpacing==="normal"?"0px":e.letterSpacing,textAlign:w(n,e,"text-align"),color:w(n,e,"color"),marginBottom:w(n,e,"margin-bottom")},background:{color:w(n,e,"background-color"),image:e.backgroundImage},border:{width:e.borderTopWidth,style:e.borderTopStyle,color:e.borderTopColor},effects:{opacity:w(n,e,"opacity"),boxShadow:e.boxShadow==="none"?"":e.boxShadow}}}function Ve(n,e){return{top:n.getPropertyValue(`${e}-top`),right:n.getPropertyValue(`${e}-right`),bottom:n.getPropertyValue(`${e}-bottom`),left:n.getPropertyValue(`${e}-left`)}}function Ye(n,e){let o=ie(n,c.get().pseudo).get("transform")||e.transform,i={tx:0,ty:0,rotate:0};if(!o||o==="none")return i;let r=/translate\(\s*(-?[\d.]+)px\s*,\s*(-?[\d.]+)px\s*\)/.exec(o),l=/rotate\(\s*(-?[\d.]+)deg\s*\)/.exec(o);if(r&&(i.tx=parseFloat(r[1]),i.ty=parseFloat(r[2])),l&&(i.rotate=parseFloat(l[1])),r||l)return i;let d=/matrix\(([^)]+)\)/.exec(o);if(d){let[a,h,,,u,p]=d[1].split(",").map(parseFloat);i.tx=v(u),i.ty=v(p),i.rotate=v(Math.atan2(h,a)*(180/Math.PI))}return i}function Ae({tx:n=0,ty:e=0,rotate:t=0}){let o=[];return(n||e)&&o.push(`translate(${v(n)}px, ${v(e)}px)`),t&&o.push(`rotate(${v(t)}deg)`),o.length?o.join(" "):""}var qe=6e3,Q=n=>n.closest&&n.closest("[data-inspect-ui]");function le(){let n=document.body?document.body.querySelectorAll("*"):[],e=[];for(let t=0;t<n.length&&e.length<qe;t++)Q(n[t])||e.push(n[t]);return e}function Ge(n,e,t){let o=n.get(e);o?o.count++:n.set(e,{...t,count:1})}function Oe(){let n=new Map,e=["color","background-color","border-top-color","border-right-color","border-bottom-color","border-left-color","outline-color","fill","stroke"];for(let t of le()){let o=getComputedStyle(t);for(let i of e){let r=o.getPropertyValue(i).trim();if(!r||r==="none")continue;let{hex:l,alpha:d}=U(r);if(d===0||l==="#000000"&&i==="fill")continue;let a=l+"|"+d;Ge(n,a,{hex:l,alpha:d,css:r})}}return[...n.values()].sort((t,o)=>o.count-t.count).slice(0,80)}function Xe(){let n=new Map;for(let e of le()){if(![...e.childNodes].some(u=>u.nodeType===3&&u.textContent.trim()))continue;let o=getComputedStyle(e),i=(o.fontFamily||"").split(",")[0].replace(/["']/g,"").trim(),r=o.fontSize,l=o.fontWeight,d=`${i}|${r}|${l}`,a=e.textContent.trim().slice(0,40),h=n.get(d);h?h.count++:n.set(d,{family:i,size:r,weight:l,lineHeight:o.lineHeight,letterSpacing:o.letterSpacing,sample:a,count:1})}return[...n.values()].sort((e,t)=>parseFloat(t.size)-parseFloat(e.size)||t.count-e.count).slice(0,60)}function Fe(){let n=[],e=new Set;for(let t of document.querySelectorAll("svg")){if(Q(t))continue;let o=t.outerHTML;/xmlns=/.test(o)||(o=o.replace("<svg",'<svg xmlns="http://www.w3.org/2000/svg"'));let i=o.slice(0,400);if(e.has(i)||o.length>4e4)continue;e.add(i);let r=t.getBoundingClientRect();if(n.push({type:"inline",markup:o,w:Math.round(r.width),h:Math.round(r.height)}),n.length>120)break}for(let t of document.querySelectorAll('img[src$=".svg"], img[src*=".svg?"]'))Q(t)||e.has(t.src)||(e.add(t.src),n.push({type:"url",src:t.src,markup:""}));return n}function We(){let n=[],e=new Set,t=o=>{!o||e.has(o)||o.endsWith(".svg")||o.startsWith("data:image/svg")||(e.add(o),n.push({src:o}))};for(let o of document.querySelectorAll("img"))Q(o)||(o.currentSrc||o.src)&&t(o.currentSrc||o.src);for(let o of le()){let i=getComputedStyle(o).backgroundImage;if(!i||i==="none")continue;let r,l=/url\((['"]?)([^'")]+)\1\)/g;for(;r=l.exec(i);)t(new URL(r[2],location.href).href);if(n.length>120)break}return n}function je(){return{colors:Oe(),typography:Xe(),svgs:Fe(),images:We()}}var Je={"align-bottom":`<svg preserveAspectRatio="xMidYMid meet" overflow="visible" style="display: block;" width="100%" height="100%" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
<g id="align-bottom">
...
</svg>`};function b(n){return Je[n]||""}function ze(n){return s("span",{class:"fic",html:b(n)})}function _e(){return s("span",{class:"chev-mini",html:b("chevron-down")})}function m({key:n,iconName:e,value:t,unit:o="px",onChange:i,showUnit:r=!0,sm:l=!1}){let d=H(t),a=/[a-z%]/i.test(String(t!=null?t:"")),h=s("input",{value:d.value,type:"text",inputmode:"decimal"}),u=r?s("span",{class:"unit",text:a?d.unit:o}):null,p=()=>{let g=h.value.trim();if(g==="")return i("");let L=/^-?[\d.]+$/.test(g);i(L&&r?g+((u==null?void 0:u.textContent)||o):g)};if(h.addEventListener("change",p),h.addEventListener("keydown",g=>{if(g.key==="Enter")return h.blur();if(g.key==="ArrowUp"||g.key==="ArrowDown"){let L=parseFloat(h.value)||0;h.value=+(L+(g.key==="ArrowUp"?1:-1)*(g.shiftKey?10:1)).toFixed(2),p(),g.preventDefault()}}),r&&u){let g=["px","%","em","rem","vw","vh"];u.style.cursor="pointer",u.addEventListener("click",()=>{u.textContent=g[(g.indexOf(u.textContent)+1)%g.length],p()})}return s("div",{class:"field"+(l?" sm":"")},[e?ze(e):n?s("span",{class:"fk",text:n}):null,h,u])}var $e='<svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12.5l4.5 4.5L19 6.5"/></svg>',z=null;function K(){if(!z)return;let{menu:n,anchor:e,onDoc:t,onKey:o}=z;n.remove(),e.classList.remove("open"),document.removeEventListener("mousedown",t,!0),document.removeEventListener("keydown",o,!0),window.removeEventListener("scroll",t,!0),z=null}function et(n,e,t,o){if(z&&z.anchor===n)return K();K();let i=n.getRootNode(),r=i.querySelector&&i.querySelector(".wrap")||document.body,l=s("div",{class:"dropdown-menu","data-inspect-ui":""},e.map(([g,L])=>{let ge=String(g)===String(t),fe=s("div",{class:"dropdown-item"+(ge?" active":"")},[s("span",{text:L}),ge?s("span",{class:"dropdown-check",html:$e}):null]);return fe.addEventListener("mousedown",me=>{me.preventDefault(),me.stopPropagation(),o(g),K()}),fe}));r.appendChild(l);let d=n.getBoundingClientRect();l.style.left=Math.round(d.left)+"px",l.style.top=Math.round(d.bottom+4)+"px",l.style.minWidth=Math.round(d.width)+"px";let a=l.getBoundingClientRect();a.bottom>window.innerHeight-8&&(l.style.top=Math.round(d.top-a.height-4)+"px");let h=l.querySelector(".dropdown-item.active");h&&h.scrollIntoView({block:"nearest"}),n.classList.add("open");let u=g=>{!g.composedPath().includes(l)&&!g.composedPath().includes(n)&&K()},p=g=>{g.key==="Escape"&&K()};setTimeout(()=>{document.addEventListener("mousedown",u,!0),document.addEventListener("keydown",p,!0),window.addEventListener("scroll",u,!0)},0),z={menu:l,anchor:n,onDoc:u,onKey:p}}function A({value:n,options:e,onChange:t,iconName:o,key:i,sm:r=!0}){let l=e.map(p=>Array.isArray(p)?p:[p,p]),d=l.find(([p])=>String(p)===String(n)),a=s("span",{class:"sel-value",text:d?d[1]:n!=null?n:""}),h=s("div",{class:"field select-like"+(r?" sm":""),tabindex:"0"},[o?ze(o):i?s("span",{class:"fk",text:i}):null,a,_e()]),u=()=>et(h,l,n,p=>{n=p;let g=l.find(([L])=>String(L)===String(p));a.textContent=g?g[1]:p,t(p)});return h.addEventListener("mousedown",p=>{p.preventDefault(),u()}),h.addEventListener("keydown",p=>{(p.key==="Enter"||p.key===" ")&&(p.preventDefault(),u())}),h}function S(n,{active:e=-1,grow:t=!1,seg:o=!1,onPick:i}={}){let r=s("div",{class:"iconrow"+(t?" grow":"")+(o?" seg":"")});return n.forEach((l,d)=>{let a=s("button",{class:"ibtn"+(d===e?" active":""),title:l.title||"",html:b(l.icon),onclick:()=>i==null?void 0:i(l,d,a)});r.appendChild(a)}),r}function ae(n,e,{showPct:t=!0}={}){let o=U(n),i=o.hex,r=o.alpha===0?1:o.alpha,l=s("input",{type:"color",value:i}),d=s("div",{class:"swatch"},[l]);d.style.background=n&&n!=="rgba(0, 0, 0, 0)"?n:"transparent";let a=s("input",{class:"hex",value:i.replace("#","")}),h=t?s("span",{class:"pct",text:Math.round(r*100)+"%"}):null,u=p=>{let g=ve(p,r);d.style.background=g,e(g)};return l.addEventListener("input",()=>{a.value=l.value.replace("#",""),u(l.value)}),a.addEventListener("change",()=>{let p=a.value.trim().replace(/^#/,"");/^([0-9a-f]{3}|[0-9a-f]{6})$/i.test(p)?(l.value="#"+p,u("#"+p)):e(a.value.trim())}),s("div",{class:"colorline"},[d,a,h])}function I(n,e,{open:t=!0}={}){let o=s("div",{class:"sec-content"},e),i=s("div",{class:"sec-head"},[s("span",{text:n}),s("span",{class:"chev",html:b("chevron-down")})]),r=s("div",{class:"section"+(t?"":" closed")},[i,o]);return i.addEventListener("click",()=>r.classList.toggle("closed")),r}function f(n,e){return s("div",{class:"stack"},[s("span",{class:"label",text:n}),e])}function Se(n,e){let t=(l,d)=>{let a=s("input",{class:"sp-edge",value:H(n[l][d]).value});return a.addEventListener("change",()=>{let h=a.value.trim();e(`${l}-${d}`,/^-?[\d.]+$/.test(h)?h+"px":h)}),a},o=(l,d,a,h)=>s("div",{class:d},[s("span",{class:"sp-tag",text:a}),t(l,"top"),s("div",{class:"sp-mid"},[t(l,"left"),h,t(l,"right")]),t(l,"bottom")]),i=s("div",{class:"sp-size"},[s("span",{class:"sp-tag",text:"Size"}),s("span",{html:`${H(n.width||"0").value} <span class="sp-x">x</span> ${H(n.height||"0").value}`})]),r=o("padding","sp-box sp-padding","Padding",i);return o("margin","sp-box sp-margin","Margin",r)}var Y=class{constructor(e){this.root=e,this.el=s("div",{class:"panel","data-inspect-ui":""}),e.appendChild(this.el),this._drag()}set(e){this.selected=e,this.render()}render(){let e=c.get();this.el.classList.toggle("hidden",e.collapsed),this.el.innerHTML="",this.el.append(this._head());let t=s("div",{class:"panel-body"});e.view==="assets"?this._assets(t):e.view==="changes"?this._changes(t):this.selected?e.view==="html"?this._html(t):this._design(t):t.append(s("div",{class:"empty",text:"Pick an element on the page to inspect and edit its styles."})),this.el.append(t)}_head(){let e=c.get();if(e.view==="assets"||e.view==="changes"){let r=e.view==="assets"?{title:"Assets",sub:"Everything this page uses"}:{title:"Changes",sub:"Every edit you make, ready to copy"};return s("div",{class:"head"},[s("div",{class:"head-top"},[s("div",{class:"head-title",text:r.title}),s("div",{class:"head-actions"},[B("minimize-screen","Close panel",()=>c.set({collapsed:!0})),B("x","Close panel",()=>c.set({collapsed:!0}))])]),s("div",{class:"crumb",style:{color:"var(--muted)"},text:r.sub})])}let t=this.selected,o=t?se(t):null,i=t?nt(t):[];return s("div",{class:"head"},[s("div",{class:"head-top"},[s("div",{class:"head-title",text:t?x(t)||o.tag:"InspectCSS"}),s("div",{class:"head-actions"},[B("delete02","Delete this element",()=>this._deleteSelected(),"danger"),ot(),B("minimize-screen","Close panel",()=>c.set({collapsed:!0})),B("x","Close panel (Exit InspectCSS from the left dock)",()=>c.set({collapsed:!0}))])]),t?s("div",{class:"crumb"},i.map(r=>s("span",{text:r}))):null,t?s("div",{class:"dims"},[s("span",{html:`<b>${v(o.rect.width)}</b> x <b>${v(o.rect.height)}</b> px`}),s("span",{html:`A <b>${parseInt(o.typography.fontSize)}px</b>`})]):s("div",{class:"crumb",text:"no selection"})])}_design(e){let t=this.selected,o=se(t),i=p=>g=>V(t,p,g),r=p=>g=>V(t,p,/^-?[\d.]+$/.test(String(g).trim())?g+"px":g),l=o.transform,d=p=>{Object.assign(l,p),V(t,"transform",Ae(l))},a=[{icon:"align-left",title:"Align left",css:["justify-content","flex-start"]},{icon:"align-bottom",title:"Align bottom",css:["align-items","flex-end"]},{icon:"align-right",title:"Align right",css:["justify-content","flex-end"]},{icon:"align-top",title:"Align top",css:["align-items","flex-start"]},{icon:"align-horizontal-center",title:"Center horizontally",css:["justify-content","center"]},{icon:"align-vertical-center",title:"Center vertically",css:["align-items","center"]}];e.append(I("Position",[f("Alignment",S(a,{grow:!0,seg:!0,onPick:p=>V(t,p.css[0],p.css[1])})),f("Position",s("div",{class:"row"},[m({key:"X",value:l.tx+"px",onChange:p=>d({tx:parseFloat(p)||0})}),m({key:"Y",value:l.ty+"px",onChange:p=>d({ty:parseFloat(p)||0})})])),f("Rotation",s("div",{class:"rot-row"},[m({iconName:"rotate01",value:l.rotate+"",showUnit:!1,onChange:p=>d({rotate:parseFloat(p)||0})}),S([{icon:"image-flip-horizontal",title:"Flip horizontal"}],{grow:!0,onPick:()=>He(t,"x")}),S([{icon:"image-flip-vertical",title:"Flip vertical"}],{grow:!0,onPick:()=>He(t,"y")})]))])),e.append(I("Layout",[f("Size",s("div",{class:"row"},[m({key:"W",value:o.layout.width,onChange:i("width")}),m({key:"H",value:o.layout.height,onChange:i("height")})])),f("Display",A({value:o.layout.display,options:["block","inline","inline-block","flex","inline-flex","grid","none"],onChange:i("display")})),s("div",{class:"row"},[f("Row Gap",m({iconName:"paragraph-spacing",value:o.layout.rowGap,showUnit:!1,sm:!0,onChange:r("row-gap")})),f("Column Gap",m({iconName:"letter-spacing",value:o.layout.columnGap,showUnit:!1,sm:!0,onChange:r("column-gap")}))]),s("div",{class:"row"},[f("Horizontal Align",A({value:o.layout.justify,options:[["flex-start","Start"],["center","Center"],["flex-end","End"],["space-between","Between"]],onChange:i("justify-content")})),f("Vertical Align",A({value:o.layout.align,options:[["flex-start","Start"],["center","Center"],["flex-end","End"],["stretch","Stretch"]],onChange:i("align-items")}))])])),e.append(I("Spacing",[f("Padding",s("div",{class:"row"},[m({iconName:"horizontal-resize",value:o.spacing.padding.left,onChange:p=>{i("padding-left")(p),i("padding-right")(p)}}),m({iconName:"vertical-resize",value:o.spacing.padding.top,onChange:p=>{i("padding-top")(p),i("padding-bottom")(p)}})])),f("Margin",s("div",{class:"row"},[m({iconName:"horizontal-resize",value:o.spacing.margin.left,onChange:p=>{i("margin-left")(p),i("margin-right")(p)}}),m({iconName:"vertical-resize",value:o.spacing.margin.top,onChange:p=>{i("margin-top")(p),i("margin-bottom")(p)}})])),Se({...o.spacing,width:o.layout.width,height:o.layout.height},(p,g)=>V(t,p,g))]));let h=[{key:"tl",prop:"border-top-left-radius",v:o.radius.tl},{key:"tr",prop:"border-top-right-radius",v:o.radius.tr},{key:"bl",prop:"border-bottom-left-radius",v:o.radius.bl},{key:"br",prop:"border-bottom-right-radius",v:o.radius.br}],u=new Set([o.radius.tl,o.radius.tr,o.radius.bl,o.radius.br]).size>1;e.append(I("Appearance",[s("div",{class:"row"},[f("Opacity",m({iconName:"transparency",value:String(Math.round((parseFloat(o.effects.opacity)||1)*100)),unit:"%",onChange:p=>i("opacity")((parseFloat(p)||100)/100)})),f("Corner",s("div",{class:"corner-mix"},[m({iconName:"full-screen",value:u?"mix":o.radius.all,showUnit:!1,onChange:r("border-radius")}),S([{icon:"full-screen",title:"Link corners"}],{onPick:()=>r("border-radius")(o.radius.tl)})]))]),s("div",{class:"corner-grid"},h.map(p=>m({iconName:"full-screen",value:p.v,showUnit:!1,onChange:r(p.prop)}))),Ie("Fill",()=>{this._fillOpen=!this._fillOpen,this.render()}),this._fillOpen?ae(o.background.color,i("background-color")):null,Ie("Stroke",()=>{this._strokeOpen=!this._strokeOpen,this.render()}),this._strokeOpen?ae(o.border.color,i("border-color")):null])),e.append(I("Typography",[f("Typeface",A({value:Re(o.typography.fontFamily),options:[Re(o.typography.fontFamily),"Quicksand","Inter","Arial","Georgia","system-ui","monospace"],onChange:i("font-family")})),s("div",{class:"row"},[A({value:it(o.typography.fontWeight),options:[["300","Light"],["400","Regular"],["500","Medium"],["600","SemiBold"],["700","Bold"],["800","Extra"]],onChange:i("font-weight")}),A({value:parseInt(o.typography.fontSize)+"",options:["10","12","13","14","16","18","20","24","32","48"].map(p=>[p,p]),onChange:p=>i("font-size")(p+"px")})]),s("div",{class:"row"},[f("Line Height",m({iconName:"paragraph-spacing",value:rt(o.typography.lineHeight),showUnit:!1,sm:!0,onChange:i("line-height")})),f("Letter Spacing",m({iconName:"letter-spacing",value:o.typography.letterSpacing,showUnit:!1,sm:!0,onChange:r("letter-spacing")}))]),s("div",{class:"row"},[f("Paragraph Spacing",m({iconName:"expand-paragraph",value:st(o.typography.marginBottom),sm:!0,onChange:i("margin-bottom")})),f("Alignment",S([{icon:"text-align-right",title:"Right",css:"right"},{icon:"text-align-center",title:"Center",css:"center"},{icon:"text-align-start",title:"Left",css:"left"},{icon:"text-align-justify",title:"Justify",css:"justify"}],{grow:!0,seg:!0,active:["right","center","left","justify"].indexOf(o.typography.textAlign),onPick:p=>i("text-align")(p.css)}))])]))}_changes(e){let t=c.get(),o=te(),i=re(),r=ke(t.promptDiff);if(e.append(s("div",{class:"view-actions"},[s("button",{class:"btn primary",text:"Copy CSS",onclick:()=>this._copy()}),s("button",{class:"btn",text:"Copy AI prompt",onclick:()=>{var d;r&&((d=navigator.clipboard)==null||d.writeText(r).then(()=>this._toast("AI prompt copied")))}}),s("button",{class:"btn",text:"Clear",onclick:()=>{we(),this.render()}})])),!o.length){e.append(s("div",{class:"empty",text:"No changes yet. Edit a property, colour or text and every change is logged here."}));return}e.append(j("Change log",o.length,s("div",{class:"log-list"},[...o].reverse().map(d=>s("div",{class:"log-item"},[s("span",{class:"log-el",text:d.label||d.selector}),s("span",{class:"log-desc",text:ye(d)})])))));let l=s("div",{class:"seg-toggle"},[s("button",{class:"seg-btn"+(t.promptDiff?"":" on"),text:"Final",onclick:()=>{c.get().promptDiff=!1,c.set({promptDiff:!1}),this.render()}}),s("button",{class:"seg-btn"+(t.promptDiff?" on":""),text:"Diff",onclick:()=>{c.get().promptDiff=!0,c.set({promptDiff:!0}),this.render()}})]);e.append(j("AI prompt",0,s("div",{},[s("div",{class:"ai-row"},[s("div",{class:"ai-hint",text:"Paste into any AI to apply these changes."}),l]),s("pre",{class:"code ai-prompt",text:r})]))),e.append(j("Generated CSS",0,i?s("pre",{class:"code",html:dt(i)}):s("div",{class:"empty",text:"No CSS edits."})))}_html(e){if(this._expanded=this._expanded||new Set,this._expanded.add(document.documentElement),this._expanded.add(document.body),this.selected){let r=this.selected.parentElement;for(;r;)this._expanded.add(r),r=r.parentElement}let t=s("div",{class:"domtree"});this._renderNode(document.documentElement,t,0);let o=s("div",{class:"tree-footer"},[s("button",{class:"tree-btn",onclick:()=>c.set({view:"design"})},[s("span",{html:D.back}),"Back"]),s("button",{class:"tree-btn",onclick:()=>c.set({active:!0})},[s("span",{html:D.pick}),"Pick an element"])]);e.append(t,o);let i=t.querySelector(".tree-row.selected");i&&setTimeout(()=>i.scrollIntoView({block:"center"}),0)}_renderNode(e,t,o){if(e.nodeType!==1||e.hasAttribute&&e.hasAttribute("data-inspect-ui"))return;let i=[...e.children].filter(u=>!(u.hasAttribute&&u.hasAttribute("data-inspect-ui"))),r=i.length>0,l=this._expanded.has(e),d=o*14+8,a=s("span",{class:"tree-tw"+(r?"":" leaf"),html:r?l?D.caretDown:D.caretRight:""});a.addEventListener("click",u=>{u.stopPropagation(),r&&(l?this._expanded.delete(e):this._expanded.add(e),this.render())});let h=s("div",{class:"tree-row"+(e===this.selected?" selected":""),style:{paddingLeft:d+"px"}},[a,s("span",{class:"tree-tag",html:lt(e,r&&!l)})]);h.addEventListener("click",()=>{this.selected=e,c.set({selectedEl:e}),this.render()}),t.append(h),r&&l&&(i.forEach(u=>this._renderNode(u,t,o+1)),t.append(s("div",{class:"tree-row tree-close",style:{paddingLeft:d+"px"}},[s("span",{class:"tree-tag",html:at(e)})])))}_deleteSelected(){let e=this.selected;if(!e)return;let t=e.parentElement;if(!t)return;let o=e.nextElementSibling,i=x(e),r=k(e);e.remove(),C({type:"delete",id:e.getAttribute("data-inspect-id"),to:"removed",label:i,selector:r}),M({undo:()=>t.insertBefore(e,o),redo:()=>e.remove()});let l=t!==document.body&&t!==document.documentElement?t:null;this.selected=l,c.set({selectedEl:l}),this._toast("Element deleted"),this.render()}_copy(){var t;let e=re();e&&((t=navigator.clipboard)==null||t.writeText(e).then(()=>this._toast("CSS copied")))}_toast(e){let t=s("div",{class:"toast","data-inspect-ui":"",text:e});this.root.appendChild(t),setTimeout(()=>t.remove(),1400)}_assets(e){let t=this._assetCache||(this._assetCache=je()),o=(a,h)=>{var u;(u=navigator.clipboard)==null||u.writeText(a),this._toast(h||"Copied")},i=s("div",{class:"asset-colors"},t.colors.map(a=>s("button",{class:"asset-swatch",title:`${a.hex} \xB7 used ${a.count}\xD7`,style:{background:a.css},onclick:()=>o(a.hex,a.hex+" copied")}))),r=s("div",{class:"asset-type-list"},t.typography.map(a=>s("button",{class:"asset-type",title:"Copy CSS",onclick:()=>o(`font-family: ${a.family};
font-size: ${a.size};
font-weight: ${a.weight};`,"Type style copied")},[s("div",{class:"asset-type-preview",style:{fontFamily:a.family,fontSize:"min("+a.size+", 28px)",fontWeight:a.weight},text:"Ag"}),s("div",{class:"asset-type-meta"},[s("div",{class:"asset-type-name",text:a.family}),s("div",{class:"asset-type-sub",text:`${parseInt(a.size)}px \xB7 ${a.weight}`})])]))),l=s("div",{class:"asset-grid"},t.svgs.map(a=>{let h=s("div",{class:"asset-thumb asset-svg",title:"Copy SVG"});return a.type==="inline"?h.innerHTML=a.markup:h.appendChild(s("img",{src:a.src,alt:""})),h.addEventListener("click",()=>o(a.markup||a.src,"SVG copied")),h})),d=s("div",{class:"asset-grid"},t.images.map(a=>{let h=s("div",{class:"asset-thumb",title:"Copy image URL"},[s("img",{src:a.src,alt:"",loading:"lazy"})]);return h.addEventListener("click",()=>o(a.src,"Image URL copied")),h}));e.append(s("div",{class:"view-actions"},[s("button",{class:"btn primary",text:"Rescan page",onclick:()=>{this._assetCache=null,this.render()}})]),j("Colors",t.colors.length,i),j("Typography",t.typography.length,r),j("SVGs",t.svgs.length,l),j("Images",t.images.length,d))}_drag(){let e,t,o,i,r=!1;this.el.addEventListener("mousedown",a=>{if(!a.target.closest(".head")||a.target.closest(".hbtn")||c.get().docked)return;r=!0;let u=this.el.getBoundingClientRect();e=a.clientX,t=a.clientY,o=u.left,i=u.top,this.el.style.right="auto",this.el.style.left=u.left+"px",this.el.style.top=u.top+"px",document.addEventListener("mousemove",l,!0),document.addEventListener("mouseup",d,!0),a.preventDefault()});let l=a=>{r&&(this.el.style.left=o+(a.clientX-e)+"px",this.el.style.top=Math.max(0,i+(a.clientY-t))+"px")},d=()=>{r=!1,document.removeEventListener("mousemove",l,!0),document.removeEventListener("mouseup",d,!0)}}};function B(n,e,t,o=""){return s("button",{class:"hbtn"+(o?" "+o:""),title:e,onclick:t,html:b(n)})}var tt='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6"><rect x="3" y="4" width="18" height="16" rx="3"/><path d="M15 4v16" stroke-linecap="round"/><path d="M18 9l-1.5 3 1.5 3" stroke-linecap="round" stroke-linejoin="round"/></svg>';function ot(){let n=c.get().docked;return s("button",{class:"hbtn"+(n?" active":""),title:n?"Undock panel (float)":"Dock panel to the side",onclick:()=>c.set({docked:!c.get().docked}),html:tt})}function Ie(n,e){return s("div",{class:"addrow"},[s("span",{class:"k",text:n}),s("button",{class:"addbtn",title:"Add "+n,html:b("plus"),onclick:e})])}function j(n,e,t){let o=s("div",{class:"sec-head"},[s("span",{},[n,e?s("span",{class:"asset-count",text:String(e)}):null]),s("span",{class:"chev",html:b("chevron-down")})]),i=s("div",{class:"section"},[o,s("div",{class:"sec-content"},[t])]);return o.addEventListener("click",()=>i.classList.toggle("closed")),i}function nt(n){let e=[],t=n,o=0;for(;t&&t.nodeType===1&&t!==document.documentElement&&o<3;)t.classList.length?e.unshift("."+t.classList[0]):e.unshift(t.tagName.toLowerCase()),t=t.parentElement,o++;return e}function He(n,e){let t=getComputedStyle(n),o=t.transform==="none"?"":t.transform+" ";V(n,"transform",o+(e==="x"?"scaleX(-1)":"scaleY(-1)"))}function Re(n){return(n||"").split(",")[0].replace(/["']/g,"").trim()||"system-ui"}function it(n){return String(n)}function rt(n){return n==="normal"?"1.4":n}function st(n){return n&&n!=="auto"?n:"0px"}function de(n){return n.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}var D={caretRight:'<svg width="10" height="10" viewBox="0 0 10 10" fill="currentColor"><path d="M3 1.5l4 3.5-4 3.5z"/></svg>',caretDown:'<svg width="10" height="10" viewBox="0 0 10 10" fill="currentColor"><path d="M1.5 3h7l-3.5 4z"/></svg>',back:'<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M15 6l-6 6 6 6"/></svg>',pick:'<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 3v3M12 18v3M3 12h3M18 12h3"/><circle cx="12" cy="12" r="4"/></svg>'};function lt(n,e){let t=n.tagName.toLowerCase(),o="";for(let r of n.attributes){if(r.name.startsWith("data-inspect"))continue;let l=r.value.length>40?r.value.slice(0,40)+"\u2026":r.value;o+=` <span class="t-attr">${de(r.name)}</span><span class="t-br">=</span><span class="t-val">"${de(l)}"</span>`}let i=`<span class="t-br">&lt;</span><span class="t-tag">${t}</span>${o}<span class="t-br">&gt;</span>`;return e&&(i+=`<span class="t-ell">\u2026</span><span class="t-br">&lt;/</span><span class="t-tag">${t}</span><span class="t-br">&gt;</span>`),i}function at(n){return`<span class="t-br">&lt;/</span><span class="t-tag">${n.tagName.toLowerCase()}</span><span class="t-br">&gt;</span>`}function dt(n){return de(n).replace(/^([^{\n]+)\{/gm,'<span class="sel">$1</span>{').replace(/^(\s+)([\w-]+)(:)/gm,'$1<span class="prop">$2</span>$3').replace(/: ([^;]+);/g,': <span class="val">$1</span>;')}var q=class{constructor(e,t){this.api=t,this.el=s("div",{class:"dock","data-inspect-ui":""}),e.appendChild(this.el),this.render(),c.subscribe(()=>this.sync())}render(){this.el.innerHTML="",this.pauseBtn=Ke("pause","Pause / resume picking",()=>c.set({active:!c.get().active}));let e=s("div",{class:"dock-group"},[E("undo-03","Undo",()=>{var o,i;return(i=(o=this.api).undo)==null?void 0:i.call(o)}),E("redo-01","Redo",()=>{var o,i;return(i=(o=this.api).redo)==null?void 0:i.call(o)}),ce(),E("layer-bring-forward","Select parent element",()=>{var o,i;return(i=(o=this.api).selectParent)==null?void 0:i.call(o)}),E("layer-send-backward","Select child element",()=>{var o,i;return(i=(o=this.api).selectChild)==null?void 0:i.call(o)}),ce(),this.assetsBtn=E("component","Assets (page colors, type, SVGs, images)",()=>{let o=c.get().view;c.set({view:o==="assets"?"design":"assets",collapsed:!1})}),this.codeBtn=E("file-diff","Changes & AI prompt",()=>c.set({view:"changes",collapsed:!1})),this.htmlBtn=E("html-file-01","HTML",()=>c.set({view:"html",collapsed:!1})),ce(),this.respBtn=E("laptop-phone-sync","Toggle responsive preview",()=>{var o,i;return(i=(o=this.api).toggleResponsive)==null?void 0:i.call(o)})]),t=Ke("cancel-01","Exit InspectCSS",()=>{var o;return(o=window.InspectCSS)==null?void 0:o.destroy()});this.el.append(this.pauseBtn,e,t),this.sync()}sync(){var t,o,i,r,l;let e=c.get();(t=this.pauseBtn)==null||t.classList.toggle("active",e.active),(o=this.assetsBtn)==null||o.classList.toggle("active",e.view==="assets"),(i=this.codeBtn)==null||i.classList.toggle("active",e.view==="changes"),(r=this.htmlBtn)==null||r.classList.toggle("active",e.view==="html"),(l=this.respBtn)==null||l.classList.toggle("active",e.responsive)}};function Ke(n,e,t){return s("button",{class:"dock-circle",title:e,onclick:t,html:b(n)})}function E(n,e,t){return s("button",{class:"dock-btn",title:e,onclick:t,html:b(n)})}function ce(){return s("div",{class:"dock-sep"})}var G=class{constructor(e){this.root=e,this.el=s("div",{class:"tooltip","data-inspect-ui":""}),e.appendChild(this.el),e.addEventListener("pointerover",t=>this._over(t),!0),e.addEventListener("pointerout",t=>this._out(t),!0),e.addEventListener("pointerdown",()=>this.hide(),!0),document.addEventListener("pointerover",t=>this._over(t,!0),!0),document.addEventListener("pointerout",t=>this._out(t),!0),document.addEventListener("pointerdown",()=>this.hide(),!0)}_over(e,t=!1){let o=e.target.closest&&e.target.closest("[title],[data-tip]");if(!o||t&&!o.hasAttribute("data-inspect-ui")||!t&&!this.root.contains(o))return;if(o.hasAttribute("title")){let r=o.getAttribute("title");r&&o.setAttribute("data-tip",r),o.removeAttribute("title")}let i=o.getAttribute("data-tip");i&&this.show(i,o)}_out(e){let t=e.target.closest&&e.target.closest("[data-tip]");t&&!t.contains(e.relatedTarget)&&this.hide()}show(e,t){this.el.textContent=e,this.el.classList.add("show");let o=t.getBoundingClientRect(),i=this.el.getBoundingClientRect(),r=o.top-i.height-8,l=o.left+o.width/2-i.width/2;r<6&&(r=o.bottom+8),l=Math.max(6,Math.min(l,window.innerWidth-i.width-6)),this.el.style.left=Math.round(l)+"px",this.el.style.top=Math.round(r)+"px"}hide(){this.el.classList.remove("show")}};var O=class{constructor(e){this.onChange=e,this._onDblClick=this._onDblClick.bind(this),this._onKey=this._onKey.bind(this)}start(){document.addEventListener("dblclick",this._onDblClick,!0)}stop(){document.removeEventListener("dblclick",this._onDblClick,!0),this._finish()}_editable(e){if(!e||e.nodeType!==1||y(e))return null;let t=e;for(;t&&t!==document.body;){let o=[...t.childNodes].some(r=>r.nodeType===3&&r.textContent.trim()),i=![...t.children].some(r=>{let l=getComputedStyle(r).display;return l==="block"||l==="flex"||l==="grid"});if(o&&i)return t;t=t.parentElement}return e.matches("h1,h2,h3,h4,h5,h6,p,span,a,button,li,td,th,label,strong,em,small,div")?e:null}_onDblClick(e){var r,l;if(y(e.target))return;let t=this._editable(e.target);if(!t)return;e.preventDefault(),e.stopPropagation(),c.set({editing:!0,selectedEl:t}),this.el=t,this._origText=t.textContent,Z(t),t.setAttribute("contenteditable","true"),t.setAttribute("data-inspect-editing",""),t.focus();let o=(r=document.caretRangeFromPoint)==null?void 0:r.call(document,e.clientX,e.clientY),i=window.getSelection();i.removeAllRanges(),o?i.addRange(o):(l=document.execCommand)==null||l.call(document,"selectAll",!1,null),t.addEventListener("blur",()=>this._finish(),{once:!0}),document.addEventListener("keydown",this._onKey,!0)}_onKey(e){this.el&&(e.key==="Escape"||e.key==="Enter"&&!e.shiftKey&&this.el.tagName!=="DIV")&&(e.preventDefault(),this.el.blur())}_finish(){var e;if(document.removeEventListener("keydown",this._onKey,!0),this.el){let t=this.el;t.removeAttribute("contenteditable"),t.removeAttribute("data-inspect-editing");let o=t.textContent;if(o!==this._origText){let i=this._origText,r=o;C({type:"text",id:t.getAttribute("data-inspect-id"),from:i,to:r,label:x(t),selector:k(t)}),M({undo:()=>{t.textContent=i},redo:()=>{t.textContent=r}})}this.el=null}c.get().editing&&c.set({editing:!1}),(e=this.onChange)==null||e.call(this)}};var ct=4,pe=new WeakMap;function he(n){let e=n.nextElementSibling;for(;e&&y(e);)e=e.nextElementSibling;return e}function pt(n){let e=n.previousElementSibling;for(;e&&y(e);)e=e.previousElementSibling;return e}function ht(n,e){if(n.length>=2){let i=n[0].getBoundingClientRect(),r=n[1].getBoundingClientRect(),l=Math.min(i.bottom,r.bottom)-Math.max(i.top,r.top),d=Math.min(i.right,r.right)-Math.max(i.left,r.left);if(l!==d)return l>d}let t=getComputedStyle(e);return/flex/.test(t.display)&&/row/.test(t.flexDirection)||t.display.includes("inline")||t.display==="grid"&&t.gridAutoFlow.includes("column")}function ut(n){let e=he(n);if(e)return`before ${x(e)}`;let t=pt(n);return t?`after ${x(t)}`:"to the only remaining slot"}var gt='<svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M5 9l-3 3 3 3M9 5l3-3 3 3M15 19l-3 3-3-3M19 9l3 3-3 3M2 12h20M12 2v20"/></svg>',X=class{constructor(e){this.onReorder=e,this.indicator=s("div",{"data-inspect-ui":"",style:{position:"fixed",background:"#58aeff",borderRadius:"2px",pointerEvents:"none",zIndex:"2147483644",display:"none",boxShadow:"0 0 6px rgba(88,174,255,.8)"}}),this.handle=s("div",{"data-inspect-ui":"",title:"Drag to reorder",html:gt,style:{position:"fixed",width:"26px",height:"26px",borderRadius:"999px",display:"none",alignItems:"center",justifyContent:"center",background:"rgba(0,0,0,0.82)",border:"1px solid rgba(255,255,255,0.18)",color:"#fff",cursor:"grab",zIndex:"2147483645",boxShadow:"0 4px 14px rgba(0,0,0,.5)",backdropFilter:"blur(6px)"}}),document.documentElement.append(this.indicator,this.handle),this._down=this._down.bind(this),this._move=this._move.bind(this),this._up=this._up.bind(this),this._reposition=this._reposition.bind(this),this._sync=this._sync.bind(this)}start(){this.handle.addEventListener("mousedown",this._down,!0),this.handle.addEventListener("mouseenter",()=>this.handle.style.background="#58aeff"),this.handle.addEventListener("mouseleave",()=>this.handle.style.background="rgba(0,0,0,0.82)"),this.unsub=c.subscribe(this._sync),window.addEventListener("scroll",this._reposition,!0),window.addEventListener("resize",this._reposition,!0)}stop(){var e;(e=this.unsub)==null||e.call(this),window.removeEventListener("scroll",this._reposition,!0),window.removeEventListener("resize",this._reposition,!0),this.indicator.remove(),this.handle.remove()}_sync(){let e=c.get(),t=e.selectedEl&&!e.dragging&&!e.editing;this.handle.style.display=t?"flex":"none",t&&this._reposition()}_reposition(){let e=c.get().selectedEl;if(!e||this.dragging)return;let t=e.getBoundingClientRect();this.handle.style.left=Math.round(Math.max(4,t.left-8))+"px",this.handle.style.top=Math.round(Math.max(4,t.top-8))+"px"}_down(e){e.button===0&&(e.preventDefault(),e.stopPropagation(),c.get().selectedEl&&(this.sx=e.clientX,this.sy=e.clientY,this.armed=!0,this.dragging=!1,document.addEventListener("mousemove",this._move,!0),document.addEventListener("mouseup",this._up,!0)))}_move(e){if(this.armed){if(!this.dragging){if(Math.hypot(e.clientX-this.sx,e.clientY-this.sy)<ct)return;this.dragging=!0,c.set({dragging:!0}),document.documentElement.style.cursor="grabbing",this.handle.style.display="none"}this._updateTarget(e)}}_updateTarget(e){let t=c.get().selectedEl,o=t==null?void 0:t.parentElement;if(!o)return;let i=[...o.children].filter(a=>!y(a)&&a!==t);if(!i.length){this.ref=void 0,this.indicator.style.display="none";return}let r=ht(i,o),l=r?e.clientX:e.clientY,d=null;for(let a of i){let h=a.getBoundingClientRect(),u=r?h.left+h.width/2:h.top+h.height/2;if(l<u){d=a;break}}this.ref=d,this._drawLine(d,i,r)}_drawLine(e,t,o){let i=t[t.length-1],l=(e||i).getBoundingClientRect();if(o){let d;if(e){let a=t[t.indexOf(e)-1];d=a?(a.getBoundingClientRect().right+l.left)/2:l.left-2}else d=l.right+2;Object.assign(this.indicator.style,{display:"block",left:d-1.5+"px",top:l.top+"px",width:"3px",height:l.height+"px"})}else{let d;if(e){let a=t[t.indexOf(e)-1];d=a?(a.getBoundingClientRect().bottom+l.top)/2:l.top-2}else d=l.bottom+2;Object.assign(this.indicator.style,{display:"block",left:l.left+"px",top:d-1.5+"px",width:l.width+"px",height:"3px"})}}_up(){var t;document.removeEventListener("mousemove",this._move,!0),document.removeEventListener("mouseup",this._up,!0),this.indicator.style.display="none",document.documentElement.style.cursor="";let e=this.dragging;if(this.armed=!1,this.dragging=!1,e){let o=c.get().selectedEl,i=this.ref;if(o&&i!==void 0&&i!==o&&i!==o.nextElementSibling){let l=o.parentElement,d=o.nextElementSibling;pe.has(o)||pe.set(o,he(o)),l.insertBefore(o,i||null);let a=o.getAttribute("data-inspect-id");he(o)===pe.get(o)?be(a):C({type:"move",id:a,to:"reordered",label:x(o),selector:k(o),position:ut(o)}),M({undo:()=>l.insertBefore(o,d),redo:()=>l.insertBefore(o,i||null)})}c.set({dragging:!1}),this.ref=void 0;let r=l=>{l.stopPropagation(),l.preventDefault(),document.removeEventListener("click",r,!0)};document.addEventListener("click",r,!0),(t=this.onReorder)==null||t.call(this,o)}this._sync()}};var F=class{constructor(){this.active=!1,this.width=0,this.handleR=this._makeHandle(),this.handleL=this._makeHandle(),this.label=s("div",{"data-inspect-ui":"",style:{position:"fixed",top:"10px",left:"50%",transform:"translateX(-50%)",zIndex:"2147483645",display:"none",background:"rgba(0,0,0,0.82)",color:"#fff",font:"500 12px 'Quicksand', -apple-system, sans-serif",padding:"4px 10px",borderRadius:"8px",border:"1px solid rgba(255,255,255,0.14)",pointerEvents:"none"}}),document.documentElement.append(this.handleR,this.handleL,this.label),this._down=this._down.bind(this),this._move=this._move.bind(this),this._up=this._up.bind(this),this._reposition=this._reposition.bind(this),this.handleR.addEventListener("mousedown",this._down),this.handleL.addEventListener("mousedown",this._down)}_makeHandle(){let e=s("div",{"data-inspect-ui":"",style:{position:"fixed",top:"0",bottom:"0",width:"12px",cursor:"ew-resize",zIndex:"2147483645",display:"none"}});return e.appendChild(s("div",{style:{position:"absolute",top:"50%",left:"50%",transform:"translate(-50%,-50%)",width:"6px",height:"54px",borderRadius:"4px",background:"#58aeff",boxShadow:"0 0 8px rgba(88,174,255,.7)"}})),e}toggle(){return this.active?this.disable():this.enable(),this.active}enable(){this.active=!0,this.width=Math.min(1024,window.innerWidth-40),this._apply(),this.handleR.style.display="block",this.handleL.style.display="block",this.label.style.display="block",window.addEventListener("resize",this._reposition)}disable(){this.active=!1;let e=document.documentElement;e.style.width="",e.style.margin="",e.style.transition="",this.handleR.style.display="none",this.handleL.style.display="none",this.label.style.display="none",window.removeEventListener("resize",this._reposition)}_apply(){let e=document.documentElement;e.style.width=this.width+"px",e.style.margin="0 auto",this._reposition()}_reposition(){let e=(window.innerWidth+this.width)/2,t=(window.innerWidth-this.width)/2;this.handleR.style.left=e-6+"px",this.handleL.style.left=t-6+"px",this.label.textContent=Math.round(this.width)+" px"}_down(e){e.preventDefault(),this.dragging=!0,document.addEventListener("mousemove",this._move,!0),document.addEventListener("mouseup",this._up,!0),document.documentElement.style.userSelect="none"}_move(e){if(!this.dragging)return;let t=2*Math.abs(e.clientX-window.innerWidth/2);this.width=Math.max(320,Math.min(t,window.innerWidth)),this._apply()}_up(){this.dragging=!1,document.removeEventListener("mousemove",this._move,!0),document.removeEventListener("mouseup",this._up,!0),document.documentElement.style.userSelect=""}destroy(){this.disable(),this.handleR.remove(),this.handleL.remove(),this.label.remove()}};var W=`@font-face {
...
`;var ue=class{constructor(){this.host=document.createElement("div"),this.host.setAttribute("data-inspect-ui",""),this.host.style.cssText="all: initial; position: static;";let e=this.host.attachShadow({mode:"open"}),t=document.createElement("style");t.textContent=Be;let o=document.createElement("div");o.className="wrap",e.append(t,o),document.documentElement.appendChild(this.host),this.fontStyle=document.createElement("style"),this.fontStyle.setAttribute("data-inspect-ui",""),this.fontStyle.textContent=W,document.head.appendChild(this.fontStyle),this.overlay=new P(document.documentElement),this.panel=new Y(o),this.tooltip=new G(o),this.toolbar=new q(o,{undo:()=>{ne(),this._afterHistory()},redo:()=>{N(),this._afterHistory()},selectParent:()=>this.selectRelative("parent"),selectChild:()=>this.selectRelative("child"),toggleResponsive:()=>this.toggleResponsive()}),this.inspector=new T(this.overlay,i=>this.select(i)),this.textEditor=new O(()=>this.panel.render()),this.dragMove=new X(i=>{i&&(this.overlay.select(i),this.panel.render())}),this.responsive=new F,this.textEditor.start(),this.dragMove.start(),this._prevView=c.get().view,this._prevCollapsed=c.get().collapsed,this._prevDocked=c.get().docked,this.unsub=c.subscribe(i=>this.onState(i)),this._track=()=>{this._raf||(this._raf=requestAnimationFrame(()=>{this._raf=0;let i=c.get();i.hoverEl&&this.overlay.highlight(i.hoverEl),i.selectedEl&&this.overlay.select(i.selectedEl)}))},window.addEventListener("scroll",this._track,!0),window.addEventListener("resize",this._track,!0),this._keyHandler=i=>this._onKey(i),window.addEventListener("keydown",this._keyHandler,!0),c.set({active:!0}),this.panel.render()}select(e){c.set({selectedEl:e,collapsed:!1,view:"design"}),this.overlay.select(e),this.panel.set(e)}_afterHistory(){let e=c.get();e.selectedEl&&document.contains(e.selectedEl)?this.overlay.select(e.selectedEl):(this.overlay.hideSelected(),c.set({selectedEl:null})),this.panel.render()}_onKey(e){if(c.get().editing)return;let t=(e.target.tagName||"").toLowerCase();t==="input"||t==="textarea"||e.target.isContentEditable||((e.ctrlKey||e.metaKey)&&e.key.toLowerCase()==="z"?(e.preventDefault(),e.shiftKey?N():ne(),this._afterHistory()):(e.ctrlKey||e.metaKey)&&e.key.toLowerCase()==="y"&&(e.preventDefault(),N(),this._afterHistory()))}selectRelative(e){let t=c.get().selectedEl;if(!t)return;let o=null;if(e==="parent"){if(o=t.parentElement,!o||o===document.documentElement||o===document.body)return}else if(o=[...t.children].find(i=>!i.closest("[data-inspect-ui]")),!o)return;c.set({view:"design",collapsed:!1}),this.select(o)}toggleResponsive(){let e=this.responsive.toggle();c.set({responsive:e});let t=c.get();t.selectedEl&&this.overlay.select(t.selectedEl)}onState(e){if(e.active&&!this._picking?(this._picking=!0,this.inspector.start()):!e.active&&this._picking&&(this._picking=!1,this.inspector.stop()),e.selectedEl&&document.contains(e.selectedEl)?this.overlay.select(e.selectedEl):this.overlay.hideSelected(),this.panel.el.classList.toggle("drag-hidden",!!e.dragging),e.docked!==this._prevDocked){this._prevDocked=e.docked,this.panel.el.classList.toggle("docked",e.docked),document.documentElement.style.transition="margin-right .2s ease";let t=Math.round(this.panel.el.getBoundingClientRect().width)||340;document.documentElement.style.marginRight=e.docked?t+"px":"",this.panel.render()}(e.view!==this._prevView||e.collapsed!==this._prevCollapsed)&&(e.view==="assets"&&this._prevView!=="assets"&&(this.panel._assetCache=null),this._prevView=e.view,this._prevCollapsed=e.collapsed,this.panel.render())}destroy(){var t,o;(t=this.unsub)==null||t.call(this),window.removeEventListener("scroll",this._track,!0),window.removeEventListener("resize",this._track,!0),window.removeEventListener("keydown",this._keyHandler,!0),this.textEditor.stop(),this.dragMove.stop(),this.responsive.destroy(),this.inspector.stop(),this.overlay.destroy(),this.host.remove(),(o=this.fontStyle)==null||o.remove(),this.toggleResponsiveOff();let e=document.getElementById("inspect-css-live-styles");e&&e.remove(),delete window.InspectCSS}toggleResponsiveOff(){document.documentElement.style.maxWidth="",document.documentElement.style.margin="",document.documentElement.style.marginRight=""}};function ft(){if(window.InspectCSS){window.InspectCSS.destroy();return}let n=new ue;window.InspectCSS={app:n,destroy:()=>n.destroy(),version:"0.8.1"}}ft();})();
