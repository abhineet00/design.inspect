(()=>{var ie={active:!1,hoverEl:null,selectedEl:null,pseudo:"none",view:"design",edits:new Map,panelPos:{x:null,y:16},collapsed:!1,editing:!1,dragging:!1,changeLog:[],promptDiff:!1,docked:!1,responsive:!1},se=new Set,c={get:()=>ie,set(n){Object.assign(ie,n),se.forEach(e=>e(ie))},subscribe(n){return se.add(n),()=>se.delete(n)}};var Je=0,le="data-inspect-id";function Y(n){let e=n.getAttribute(le);return e||(e="ic-"+ ++Je,n.setAttribute(le,e)),e}function ae(n){return`[${le}="${n}"]`}function w(n,e=2){if(n==null||Number.isNaN(n))return 0;let t=Math.pow(10,e);return Math.round(n*t)/t}function s(n,e={},t=[]){let o=document.createElement(n);for(let[r,i]of Object.entries(e))r==="class"?o.className=i:r==="style"&&typeof i=="object"?Object.assign(o.style,i):r==="html"?o.innerHTML=i:r==="text"?o.textContent=i:r.startsWith("on")&&typeof i=="function"?o.addEventListener(r.slice(2).toLowerCase(),i):i!==!1&&i!=null&&o.setAttribute(r,i===!0?"":i);for(let r of[].concat(t))r==null||r===!1||o.appendChild(typeof r=="string"?document.createTextNode(r):r);return o}function C(n){if(!n||n.nodeType!==1)return"";let e=n.tagName.toLowerCase();return n.id?e+="#"+n.id:n.classList.length&&(e+="."+n.classList[0]),e}function U(n){if(n==null)return{value:0,unit:"px"};let e=String(n).trim().match(/^(-?[\d.]+)\s*([a-z%]*)$/i);return e?{value:parseFloat(e[1]),unit:e[2]||"px"}:{value:n,unit:""}}function D(n){if(!n)return{hex:"#000000",alpha:1};if(n.startsWith("#"))return{hex:n,alpha:1};let e=n.match(/rgba?\(([^)]+)\)/i);if(!e)return{hex:"#000000",alpha:1};let t=e[1].split(",").map(a=>a.trim()),[o,r,i]=t.map(a=>parseInt(a,10)),l=t[3]!=null?parseFloat(t[3]):1;return{hex:"#"+[o,r,i].map(a=>Math.max(0,Math.min(255,a||0)).toString(16).padStart(2,"0")).join(""),alpha:l}}function Ve(n,e=1){let t=n.replace("#",""),o=t.length===3?t.split("").map(d=>d+d).join(""):t.padEnd(6,"0"),r=parseInt(o.slice(0,2),16),i=parseInt(o.slice(2,4),16),l=parseInt(o.slice(4,6),16);return e>=1?`rgb(${r}, ${i}, ${l})`:`rgba(${r}, ${i}, ${l}, ${w(e,3)})`}function V(n){return!!(n&&n.closest&&n.closest("[data-inspect-ui]"))}var q=class{constructor(e){this.el=s("div",{"data-inspect-ui":"",style:{position:"fixed",inset:"0",pointerEvents:"none",zIndex:"2147483640"}}),this.margin=this._box("rgba(246, 178, 107, 0.28)"),this.padding=this._box("rgba(147, 196, 125, 0.30)"),this.content=s("div",{style:this._boxStyle("transparent","#4c8dff")}),this.selected=s("div",{style:this._boxStyle("transparent","#7c5cff")}),this.badge=s("div",{"data-inspect-ui":"",style:{position:"fixed",font:"500 12px/1.4 'Quicksand', -apple-system, 'Segoe UI', Roboto, sans-serif",color:"rgba(255,255,255,0.6)",background:"rgba(0,0,0,0.82)",border:"1px solid rgba(255,255,255,0.12)",padding:"4px 9px",borderRadius:"8px",whiteSpace:"nowrap",pointerEvents:"none",boxShadow:"0 6px 20px rgba(0,0,0,.45)",backdropFilter:"blur(6px)"}}),this.el.append(this.margin,this.padding,this.content,this.selected,this.badge),e.appendChild(this.el),this.hideHover(),this.hideSelected()}_box(e){return s("div",{style:{position:"fixed",background:e,pointerEvents:"none"}})}_boxStyle(e,t){return{position:"fixed",background:e,outline:`1px solid ${t}`,outlineOffset:"-1px",pointerEvents:"none"}}_place(e,t){Object.assign(e.style,{left:t.left+"px",top:t.top+"px",width:Math.max(0,t.width)+"px",height:Math.max(0,t.height)+"px",display:"block"})}highlight(e){if(!e)return this.hideHover();let t=getComputedStyle(e),o=e.getBoundingClientRect(),r=Ee(t,"margin"),i=Ee(t,"padding");this._place(this.margin,{left:o.left-r.left,top:o.top-r.top,width:o.width+r.left+r.right,height:o.height+r.top+r.bottom}),this._place(this.content,o),this._place(this.padding,o);let l=C(e);this.badge.innerHTML=`<span style="color:#58aeff">${_e(l)}</span><span style="opacity:.5">&nbsp;&nbsp;${w(o.width)} \xD7 ${w(o.height)}</span>`,this.badge.style.display="block";let d=o.top>24?o.top-22:o.bottom+6;this.badge.style.left=Math.max(4,o.left)+"px",this.badge.style.top=d+"px"}select(e){if(!e)return this.hideSelected();this._place(this.selected,e.getBoundingClientRect())}hideHover(){[this.margin,this.padding,this.content,this.badge].forEach(e=>e.style.display="none")}hideSelected(){this.selected.style.display="none"}destroy(){this.el.remove()}};function Ee(n,e){let t=o=>parseFloat(n.getPropertyValue(`${e}-${o}`))||0;return{top:t("top"),right:t("right"),bottom:t("bottom"),left:t("left")}}function _e(n){return String(n).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}var F=class{constructor(e,t){this.overlay=e,this.onSelect=t,this._onMove=this._onMove.bind(this),this._onClick=this._onClick.bind(this),this._onKey=this._onKey.bind(this),this._onScroll=this._onScroll.bind(this)}start(){document.addEventListener("mousemove",this._onMove,!0),document.addEventListener("click",this._onClick,!0),document.addEventListener("keydown",this._onKey,!0),window.addEventListener("scroll",this._onScroll,!0),window.addEventListener("resize",this._onScroll,!0),document.documentElement.style.cursor="crosshair"}stop(){document.removeEventListener("mousemove",this._onMove,!0),document.removeEventListener("click",this._onClick,!0),document.removeEventListener("keydown",this._onKey,!0),window.removeEventListener("scroll",this._onScroll,!0),window.removeEventListener("resize",this._onScroll,!0),document.documentElement.style.cursor="",this.overlay.hideHover(),c.set({hoverEl:null})}_target(e){let t=document.elementFromPoint(e.clientX,e.clientY);return!t||V(t)||t===document.documentElement||t===document.body?null:t}_onMove(e){if(c.get().editing||c.get().dragging)return;let t=this._target(e);if(!t)return this.overlay.hideHover();t!==c.get().hoverEl&&(c.set({hoverEl:t}),this.overlay.highlight(t))}_onClick(e){if(V(e.target)||c.get().editing||c.get().dragging)return;let t=this._target(e);t&&(e.preventDefault(),e.stopPropagation(),this.onSelect(t))}_onKey(e){e.key==="Escape"&&(e.preventDefault(),c.set({active:!1}))}_onScroll(){let{hoverEl:e,selectedEl:t}=c.get();e&&this.overlay.highlight(e),t&&this.overlay.select(t)}};function $e(n){return n&&!/[^a-zA-Z0-9_-]/.test(n)&&!/^(is-|has-|js-)/.test(n)?!0:n&&!/[^a-zA-Z0-9_-]/.test(n)}function et(n){let e=1,t=n;for(;t=t.previousElementSibling;)t.tagName===n.tagName&&e++;return e}function tt(n){let e=n.tagName.toLowerCase();if(n.id&&document.querySelectorAll("#"+CSS.escape(n.id)).length===1)return"#"+n.id;let t=Array.from(n.classList).filter($e).slice(0,2);return t.length?e+"."+t.map(r=>r).join("."):`${e}:nth-of-type(${et(n)})`}function L(n,e=4){if(!n||n.nodeType!==1)return"";let t=[],o=n;for(;o&&o.nodeType===1&&o!==document.documentElement;){let r=tt(o);if(t.unshift(r),r.startsWith("#"))break;try{if(document.querySelectorAll(t.join(" > ")).length===1)break}catch{}if(o=o.parentElement,t.length>=e)break}return t.join(" > ")}function A(n){n.time=Date.now();let e=c.get().changeLog,t=e[e.length-1],o=n.type==="css"&&t&&t.type==="css"&&t.id===n.id&&t.prop===n.prop&&t.pseudo===n.pseudo,r=n.type==="text"&&t&&t.type==="text"&&t.id===n.id;o||r?(t.to=n.to,t.time=n.time):e.push(n),c.set({changeLog:e})}function de(){return c.get().changeLog}function Le(){let n=c.get().changeLog;n.length=0,c.set({changeLog:n})}function Ae(n){let e=c.get().changeLog,t=e.filter(o=>!(o.type==="move"&&o.id===n));e.length=0,e.push(...t),c.set({changeLog:e})}function je(n){return n.type==="text"?`text \u2192 "${ot(n.to,34)}"`:n.type==="move"?n.position?`moved ${n.position}`:"reordered among siblings":n.type==="delete"?"removed from the page":`${n.prop}: ${n.to}`}function ze(n=!1){let e=de();if(!e.length)return"";let t=new Map;for(let i of e){let l=i.selector||i.label;t.has(l)||t.set(l,{label:i.label,selector:i.selector,css:new Map,text:null,movedTo:null,deleted:!1});let d=t.get(l);if(i.type==="css"){let a=i.pseudo&&i.pseudo!=="none"?`${i.prop} (:${i.pseudo})`:i.prop,p=d.css.get(a);d.css.set(a,{from:p?p.from:i.from,to:i.to})}else i.type==="text"?d.text={from:d.text?d.text.from:i.from,to:i.to}:i.type==="move"?d.movedTo=i.position||"to a new position":i.type==="delete"&&(d.deleted=!0)}let o=`Apply the following design changes to my web page, then return the updated HTML/CSS.

`,r=1;for(let i of t.values()){if(o+=`${r}. Element \`${i.selector||i.label}\`:
`,i.deleted){o+=`   - remove this element from the page
`,r++;continue}for(let[l,d]of i.css)o+=n?`   - change ${l} from ${d.from||"default"} to ${d.to}
`:`   - set ${l} to ${d.to}
`;i.text!=null&&(o+=n?`   - change its text from "${i.text.from}" to "${i.text.to}"
`:`   - change its text to: "${i.text.to}"
`),i.movedTo&&(o+=`   - move it ${i.movedTo} (relative to its siblings)
`),r++}return o+=`
Keep everything else unchanged.`,o.trim()}function ot(n,e){return n=String(n),n.length>e?n.slice(0,e)+"\u2026":n}var T=[],ce=[];function j(n){T.push(n),T.length>200&&T.shift(),ce.length=0}function pe(){let n=T.pop();return n?(n.undo(),ce.push(n),n):null}function G(){let n=ce.pop();return n?(n.redo(),T.push(n),n):null}var Se="inspect-css-live-styles";function nt(){let n=document.getElementById(Se);return n||(n=document.createElement("style"),n.id=Se,n.setAttribute("data-inspect-ui",""),document.head.appendChild(n)),n}function He(){let{edits:n}=c.get();return[...n.entries()].map(([e,t])=>[e,{inspectId:t.inspectId,pseudo:t.pseudo,selector:t.selector,props:[...t.props.entries()]}])}function Ie(n){let e=new Map;for(let[t,o]of n)e.set(t,{inspectId:o.inspectId,pseudo:o.pseudo,selector:o.selector,props:new Map(o.props)});c.get().edits=e,Re(),c.set({edits:e})}function b(n,e,t){var g,f;let o=He(),r=Y(n),{edits:i,pseudo:l}=c.get(),d=l==="none"?r:`${r}::${l}`,a=(f=(g=i.get(d))==null?void 0:g.props.get(e))!=null?f:getComputedStyle(n).getPropertyValue(e).trim(),p=i.get(d);p||(p={inspectId:r,pseudo:l,selector:L(n),props:new Map},i.set(d,p)),t===""||t==null?p.props.delete(e):p.props.set(e,t),p.props.size===0&&i.delete(d),Re(),c.set({edits:i}),t!==""&&t!=null&&A({type:"css",id:r,prop:e,from:a,to:t,pseudo:l,label:C(n),selector:p.selector});let u=He();j({undo:()=>Ie(o),redo:()=>Ie(u)})}function he(n,e="none"){let t=n.getAttribute("data-inspect-id");if(!t)return new Map;let o=e==="none"?t:`${t}::${e}`,r=c.get().edits.get(o);return r?r.props:new Map}function Re(){let{edits:n}=c.get(),e=[];for(let t of n.values()){if(t.props.size===0)continue;let o=ae(t.inspectId)+(t.pseudo!=="none"?":"+t.pseudo:""),r=[...t.props.entries()].map(([i,l])=>`  ${i}: ${l} !important;`).join(`
`);e.push(`${o} {
${r}
}`)}nt().textContent=e.join(`

`)}function ue(){let{edits:n}=c.get(),e=[];for(let t of n.values()){if(t.props.size===0)continue;let o=(t.selector||ae(t.inspectId))+(t.pseudo!=="none"?":"+t.pseudo:""),r=[...t.props.entries()].map(([i,l])=>`  ${i}: ${l};`).join(`
`);e.push(`${o} {
${r}
}`)}return e.join(`

`)}function y(n,e,t,o=t){let r=he(n,c.get().pseudo).get(t);return r!=null?r:e.getPropertyValue(o).trim()}function ge(n){let e=getComputedStyle(n),t=n.getBoundingClientRect();return{rect:t,tag:n.tagName.toLowerCase(),layout:{display:y(n,e,"display"),position:y(n,e,"position"),width:e.width,height:e.height,x:w(t.left+window.scrollX),y:w(t.top+window.scrollY),rowGap:e.rowGap==="normal"?"0":e.rowGap,columnGap:e.columnGap==="normal"?"0":e.columnGap,justify:y(n,e,"justify-content"),align:y(n,e,"align-items")},transform:rt(n,e),spacing:{margin:Be(e,"margin"),padding:Be(e,"padding")},radius:{all:y(n,e,"border-radius"),tl:e.borderTopLeftRadius,tr:e.borderTopRightRadius,br:e.borderBottomRightRadius,bl:e.borderBottomLeftRadius},typography:{fontFamily:e.fontFamily,fontSize:y(n,e,"font-size"),fontWeight:y(n,e,"font-weight"),lineHeight:e.lineHeight,letterSpacing:e.letterSpacing==="normal"?"0px":e.letterSpacing,textAlign:y(n,e,"text-align"),color:y(n,e,"color"),marginBottom:y(n,e,"margin-bottom")},background:{color:y(n,e,"background-color"),image:e.backgroundImage},border:{width:e.borderTopWidth,style:e.borderTopStyle,color:y(n,e,"border-top-color","border-top-color"),sides:{top:e.borderTopWidth,right:e.borderRightWidth,bottom:e.borderBottomWidth,left:e.borderLeftWidth},present:parseFloat(e.borderTopWidth)>0&&e.borderTopStyle!=="none"},effects:{opacity:y(n,e,"opacity"),boxShadow:e.boxShadow==="none"?"":e.boxShadow}}}function Be(n,e){return{top:n.getPropertyValue(`${e}-top`),right:n.getPropertyValue(`${e}-right`),bottom:n.getPropertyValue(`${e}-bottom`),left:n.getPropertyValue(`${e}-left`)}}function rt(n,e){let o=he(n,c.get().pseudo).get("transform")||e.transform,r={tx:0,ty:0,rotate:0};if(!o||o==="none")return r;let i=/translate\(\s*(-?[\d.]+)px\s*,\s*(-?[\d.]+)px\s*\)/.exec(o),l=/rotate\(\s*(-?[\d.]+)deg\s*\)/.exec(o);if(i&&(r.tx=parseFloat(i[1]),r.ty=parseFloat(i[2])),l&&(r.rotate=parseFloat(l[1])),i||l)return r;let d=/matrix\(([^)]+)\)/.exec(o);if(d){let[a,p,,,u,g]=d[1].split(",").map(parseFloat);r.tx=w(u),r.ty=w(g),r.rotate=w(Math.atan2(p,a)*(180/Math.PI))}return r}function Ke({tx:n=0,ty:e=0,rotate:t=0}){let o=[];return(n||e)&&o.push(`translate(${w(n)}px, ${w(e)}px)`),t&&o.push(`rotate(${w(t)}deg)`),o.length?o.join(" "):""}var it=6e3,O=n=>n.closest&&n.closest("[data-inspect-ui]");function fe(){let n=document.body?document.body.querySelectorAll("*"):[],e=[];for(let t=0;t<n.length&&e.length<it;t++)O(n[t])||e.push(n[t]);return e}function st(n,e,t){let o=n.get(e);o?o.count++:n.set(e,{...t,count:1})}function lt(){let n=new Map,e=["color","background-color","border-top-color","border-right-color","border-bottom-color","border-left-color","outline-color","fill","stroke"];for(let t of fe()){let o=getComputedStyle(t);for(let r of e){let i=o.getPropertyValue(r).trim();if(!i||i==="none")continue;let{hex:l,alpha:d}=D(i);if(d===0||l==="#000000"&&r==="fill")continue;let a=l+"|"+d;st(n,a,{hex:l,alpha:d,css:i})}}return[...n.values()].sort((t,o)=>o.count-t.count).slice(0,80)}function at(){let n=new Map;for(let e of fe()){if(![...e.childNodes].some(u=>u.nodeType===3&&u.textContent.trim()))continue;let o=getComputedStyle(e),r=(o.fontFamily||"").split(",")[0].replace(/["']/g,"").trim(),i=o.fontSize,l=o.fontWeight,d=`${r}|${i}|${l}`,a=e.textContent.trim().slice(0,40),p=n.get(d);p?p.count++:n.set(d,{family:r,size:i,weight:l,lineHeight:o.lineHeight,letterSpacing:o.letterSpacing,sample:a,count:1})}return[...n.values()].sort((e,t)=>parseFloat(t.size)-parseFloat(e.size)||t.count-e.count).slice(0,60)}function dt(){let n=[],e=new Set;for(let t of document.querySelectorAll("svg")){if(O(t))continue;let o=t.outerHTML;/xmlns=/.test(o)||(o=o.replace("<svg",'<svg xmlns="http://www.w3.org/2000/svg"'));let r=o.slice(0,400);if(e.has(r)||o.length>4e4)continue;e.add(r);let i=t.getBoundingClientRect();if(n.push({type:"inline",markup:o,w:Math.round(i.width),h:Math.round(i.height)}),n.length>120)break}for(let t of document.querySelectorAll('img[src$=".svg"], img[src*=".svg?"]'))O(t)||e.has(t.src)||(e.add(t.src),n.push({type:"url",src:t.src,markup:""}));return n}function ct(){let n=[],e=new Set,t=o=>{!o||e.has(o)||o.endsWith(".svg")||o.startsWith("data:image/svg")||(e.add(o),n.push({src:o}))};for(let o of document.querySelectorAll("img"))O(o)||(o.currentSrc||o.src)&&t(o.currentSrc||o.src);for(let o of fe()){let r=getComputedStyle(o).backgroundImage;if(!r||r==="none")continue;let i,l=/url\((['"]?)([^'")]+)\1\)/g;for(;i=l.exec(r);)t(new URL(i[2],location.href).href);if(n.length>120)break}return n}function Ze(){return{colors:lt(),typography:at(),svgs:dt(),images:ct()}}var pt={"align-bottom":`<svg preserveAspectRatio="xMidYMid meet" overflow="visible" style="display: block;" width="100%" height="100%" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
<g id="align-bottom">
...
</svg>`,"sidebar-right-01":'<svg preserveAspectRatio="xMidYMid meet" overflow="visible" style="display: block;" width="100%" height="100%" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="sidebar-right-01"><path id="Vector" d="M14.6665 8C14.6665 5.50018 14.6665 4.25027 14.0299 3.37405C13.8243 3.09107 13.5755 2.84221 13.2925 2.63661C12.4163 2 11.1663 2 8.66654 2H7.3332C4.83338 2 3.58347 2 2.70725 2.63661C2.42427 2.84221 2.17541 3.09107 1.96981 3.37405C1.3332 4.25027 1.3332 5.50018 1.3332 8C1.3332 10.4998 1.3332 11.7497 1.96981 12.6259C2.17541 12.9089 2.42427 13.1578 2.70725 13.3634C3.58347 14 4.83338 14 7.3332 14H8.66654C11.1663 14 12.4163 14 13.2925 13.3634C13.5755 13.1578 13.8243 12.9089 14.0299 12.6259C14.6665 11.7497 14.6665 10.4998 14.6665 8Z" stroke="currentColor" stroke-linejoin="round"/><path id="Vector_2" d="M9.6668 2.33334V13.6667" stroke="currentColor" stroke-linejoin="round"/><path id="Vector_3" d="M12.6668 4.66666H11.6668" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/><path id="Vector_4" d="M12.6668 7.33334H11.6668" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/><path id="Vector_5" d="M5.3332 6.66666L6.1509 7.37146C6.49466 7.66773 6.66654 7.81593 6.66654 8C6.66654 8.18406 6.49466 8.33226 6.1509 8.62853L5.3332 9.33333" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/></g></svg>',"minus-sign":'<svg preserveAspectRatio="xMidYMid meet" overflow="visible" style="display: block;" width="100%" height="100%" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="minus-sign"><path id="Vector" d="M13.3333 8H2.66667" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/></g></svg>',square:'<svg preserveAspectRatio="xMidYMid meet" overflow="visible" style="display: block;" width="100%" height="100%" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="queue-02"><path id="Vector" d="M12 12H4C3.37146 12 3.05719 12 2.86193 11.8047C2.66667 11.6095 2.66667 11.2952 2.66667 10.6667C2.66667 10.0381 2.66667 9.72387 2.86193 9.5286C3.05719 9.33333 3.37146 9.33333 4 9.33333H12C12.6285 9.33333 12.9428 9.33333 13.1381 9.5286C13.3333 9.72387 13.3333 10.0381 13.3333 10.6667C13.3333 11.2952 13.3333 11.6095 13.1381 11.8047C12.9428 12 12.6285 12 12 12Z" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/><path id="Vector_2" d="M2.66667 6.66667H13.3333" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/><path id="Vector_3" d="M2.66667 4H13.3333" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/></g></svg>',"border-all-01":'<svg preserveAspectRatio="xMidYMid meet" overflow="visible" style="display: block;" width="100%" height="100%" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="border-all-01"><path id="Vector" d="M2.59416 2.59416C3.52166 1.66667 5.01444 1.66667 8 1.66667C10.9855 1.66667 12.4783 1.66667 13.4059 2.59416C14.3333 3.52166 14.3333 5.01444 14.3333 8C14.3333 10.9855 14.3333 12.4783 13.4059 13.4059C12.4783 14.3333 10.9855 14.3333 8 14.3333C5.01444 14.3333 3.52166 14.3333 2.59416 13.4059C1.66667 12.4783 1.66667 10.9855 1.66667 8C1.66667 5.01444 1.66667 3.52166 2.59416 2.59416Z" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/><path id="Vector_2" d="M8 1.66667V2.93333M8 13.0667V14.3333M6.1 8H9.9M13.0667 8H14.3333M1.66667 8H2.93333M8 6.09999V9.9" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/></g></svg>',"stroke-top":'<svg preserveAspectRatio="xMidYMid meet" overflow="visible" style="display: block;" width="100%" height="100%" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="stroke-top"><path id="Vector" d="M12.6666 4.66667V10C12.6666 11.8856 12.6666 12.8284 12.0808 13.4142C11.495 14 10.5522 14 8.66663 14H7.33329C5.44767 14 4.50487 14 3.91908 13.4142C3.33329 12.8284 3.33329 11.8856 3.33329 10V4.66667" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/><path id="Vector_2" d="M14 1.9987H1.99996" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/></g></svg>',"stroke-right":'<svg preserveAspectRatio="xMidYMid meet" overflow="visible" style="display: block;" width="100%" height="100%" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="stroke-right"><path id="Vector" d="M11.3334 12.6667H6.00008C4.11446 12.6667 3.17165 12.6667 2.58587 12.0809C2.00008 11.4951 2.00008 10.5523 2.00008 8.66667V7.33333C2.00008 5.44771 2.00008 4.50491 2.58587 3.91912C3.17165 3.33333 4.11446 3.33333 6.00008 3.33333H11.3334" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/><path id="Vector_2" d="M13.9988 14V2" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/></g></svg>',"stroke-left":'<svg preserveAspectRatio="xMidYMid meet" overflow="visible" style="display: block;" width="100%" height="100%" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="stroke-left"><path id="Vector" d="M4.66675 3.33333H10.0001C11.8857 3.33333 12.8285 3.33333 13.4143 3.91912C14.0001 4.50491 14.0001 5.44771 14.0001 7.33333V8.66667C14.0001 10.5523 14.0001 11.4951 13.4143 12.0809C12.8285 12.6667 11.8857 12.6667 10.0001 12.6667H4.66675" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/><path id="Vector_2" d="M2.00008 2V14" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/></g></svg>',"stroke-bottom":'<svg preserveAspectRatio="xMidYMid meet" overflow="visible" style="display: block;" width="100%" height="100%" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="stroke-bottom"><path id="Vector" d="M3.33341 11.3333V6C3.33341 4.11438 3.33341 3.17157 3.9192 2.58579C4.50499 2 5.44779 2 7.33341 2H8.66675C10.5523 2 11.4951 2 12.0809 2.58579C12.6667 3.17157 12.6667 4.11438 12.6667 6V11.3333" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/><path id="Vector_2" d="M2.00008 14H14.0001" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/></g></svg>',link:'<svg preserveAspectRatio="xMidYMid meet" overflow="visible" style="display: block;" width="100%" height="100%" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="link"><path id="Vector" d="M9.99724 11.3333H11.3306C13.1715 11.3333 14.6639 9.84093 14.6639 8C14.6639 6.15905 13.1715 4.66667 11.3306 4.66667H9.99724M5.99723 11.3333H4.6639C2.82295 11.3333 1.33057 9.84093 1.33057 8C1.33057 6.15905 2.82295 4.66667 4.6639 4.66667H5.99723" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/><path id="Vector_2" d="M5.6639 8H10.3306" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/></g></svg>',"link-off":'<svg preserveAspectRatio="xMidYMid meet" overflow="visible" style="display: block;" width="100%" height="100%" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="link-off"><path id="Vector" d="M1.99609 2L21.9961 22" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/><path id="Vector_2" d="M8.99609 17C7.62926 17 6.99609 17 6.99609 17C4.23467 17 1.99609 14.7614 1.99609 12C1.99609 9.23858 4.23467 7 6.99609 7" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/><path id="Vector_3" d="M20.9965 15C21.6241 14.1643 21.9961 13.1256 21.9961 12C21.9961 9.23858 19.7575 7 16.9961 7H13.4961" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/><path id="Vector_4" d="M16.9961 17H14.9961" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/><path id="Vector_5" d="M8.49609 12H11.9961" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></g></svg>'};function k(n){return pt[n]||""}function Ue(n){return s("span",{class:"fic",html:k(n)})}function ht(){return s("span",{class:"chev-mini",html:k("chevron-down")})}function m({key:n,iconName:e,value:t,unit:o="px",onChange:r,showUnit:i=!0,sm:l=!1}){let d=U(t),a=/[a-z%]/i.test(String(t!=null?t:"")),p=s("input",{value:d.value,type:"text",inputmode:"decimal"}),u=i?s("span",{class:"unit",text:a?d.unit:o}):null,g=()=>{let f=p.value.trim();if(f==="")return r("");let E=/^-?[\d.]+$/.test(f);r(E&&i?f+((u==null?void 0:u.textContent)||o):f)};if(p.addEventListener("change",g),p.addEventListener("keydown",f=>{if(f.key==="Enter")return p.blur();if(f.key==="ArrowUp"||f.key==="ArrowDown"){let E=parseFloat(p.value)||0;p.value=+(E+(f.key==="ArrowUp"?1:-1)*(f.shiftKey?10:1)).toFixed(2),g(),f.preventDefault()}}),i&&u){let f=["px","%","em","rem","vw","vh"];u.style.cursor="pointer",u.addEventListener("click",()=>{u.textContent=f[(f.indexOf(u.textContent)+1)%f.length],g()})}return s("div",{class:"field"+(l?" sm":"")},[e?Ue(e):n?s("span",{class:"fk",text:n}):null,p,u])}var ut='<svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12.5l4.5 4.5L19 6.5"/></svg>',B=null;function P(){if(!B)return;let{menu:n,anchor:e,onDoc:t,onKey:o}=B;n.remove(),e.classList.remove("open"),document.removeEventListener("mousedown",t,!0),document.removeEventListener("keydown",o,!0),window.removeEventListener("scroll",t,!0),B=null}function gt(n,e,t,o){if(B&&B.anchor===n)return P();P();let r=n.getRootNode(),i=r.querySelector&&r.querySelector(".wrap")||document.body,l=s("div",{class:"dropdown-menu","data-inspect-ui":""},e.map(([f,E])=>{let Q=String(f)===String(t),M=s("div",{class:"dropdown-item"+(Q?" active":"")},[s("span",{text:E}),Q?s("span",{class:"dropdown-check",html:ut}):null]);return M.addEventListener("mousedown",S=>{S.preventDefault(),S.stopPropagation(),o(f),P()}),M}));i.appendChild(l);let d=n.getBoundingClientRect();l.style.left=Math.round(d.left)+"px",l.style.top=Math.round(d.bottom+4)+"px",l.style.minWidth=Math.round(d.width)+"px";let a=l.getBoundingClientRect();a.bottom>window.innerHeight-8&&(l.style.top=Math.round(d.top-a.height-4)+"px");let p=l.querySelector(".dropdown-item.active");p&&p.scrollIntoView({block:"nearest"}),n.classList.add("open");let u=f=>{!f.composedPath().includes(l)&&!f.composedPath().includes(n)&&P()},g=f=>{f.key==="Escape"&&P()};setTimeout(()=>{document.addEventListener("mousedown",u,!0),document.addEventListener("keydown",g,!0),window.addEventListener("scroll",u,!0)},0),B={menu:l,anchor:n,onDoc:u,onKey:g}}function H({value:n,options:e,onChange:t,iconName:o,key:r,sm:i=!0}){let l=e.map(g=>Array.isArray(g)?g:[g,g]),d=l.find(([g])=>String(g)===String(n)),a=s("span",{class:"sel-value",text:d?d[1]:n!=null?n:""}),p=s("div",{class:"field select-like"+(i?" sm":""),tabindex:"0"},[o?Ue(o):r?s("span",{class:"fk",text:r}):null,a,ht()]),u=()=>gt(p,l,n,g=>{n=g;let f=l.find(([E])=>String(E)===String(g));a.textContent=f?f[1]:g,t(g)});return p.addEventListener("mousedown",g=>{g.preventDefault(),u()}),p.addEventListener("keydown",g=>{(g.key==="Enter"||g.key===" ")&&(g.preventDefault(),u())}),p}function me(n,e,t,o){return s("button",{class:"exp-btn"+(n?" on":""),title:t,html:k(e),onclick:o})}function ve(n,e,{disabled:t=!1}={}){return s("div",{class:"sub-head"},[s("span",{class:"sub-label",text:n}),s("button",{class:"sub-add"+(t?" off":""),title:"Add "+n,html:k("plus"),onclick:t?null:e})])}function N(n,{active:e=-1,grow:t=!1,seg:o=!1,onPick:r}={}){let i=s("div",{class:"iconrow"+(t?" grow":"")+(o?" seg":"")});return n.forEach((l,d)=>{let a=s("button",{class:"ibtn"+(d===e?" active":""),title:l.title||"",html:k(l.icon),onclick:()=>r==null?void 0:r(l,d,a)});i.appendChild(a)}),i}function Te(n,e){return s("button",{class:"link-toggle"+(n?" on":""),title:n?"Unlink width & height":"Link width & height (keep aspect ratio)",html:k(n?"link":"link-off"),onclick:e})}function xe(n,e,t){let o=D(n),r=o.hex,i=o.alpha==null?1:o.alpha,l=s("input",{type:"color",value:r}),d=s("div",{class:"cr-swatch"},[l]);d.style.background=n&&n!=="rgba(0, 0, 0, 0)"?n:"transparent";let a=s("input",{class:"cr-hex",value:r.replace("#","").toUpperCase()}),p=s("input",{class:"cr-alpha",value:Math.round(i*100)}),u=g=>{let f=Ve(g,i);d.style.background=f,e(f)};return l.addEventListener("input",()=>{a.value=l.value.replace("#","").toUpperCase(),u(l.value)}),a.addEventListener("change",()=>{let g=a.value.trim().replace(/^#/,"");/^([0-9a-f]{3}|[0-9a-f]{6})$/i.test(g)&&(l.value="#"+g,u("#"+g))}),p.addEventListener("change",()=>{i=Math.max(0,Math.min(100,parseFloat(p.value)||0))/100,u("#"+a.value.trim().replace(/^#/,""))}),s("div",{class:"color-row"},[s("div",{class:"cr-main"},[d,a]),s("div",{class:"cr-pct"},[p,s("span",{class:"cr-unit",text:"%"})]),s("button",{class:"cr-del",title:"Remove",html:k("minus-sign"),onclick:t})])}function K(n,e,{open:t=!0}={}){let o=s("div",{class:"sec-content"},e),r=s("div",{class:"sec-head"},[s("span",{text:n}),s("span",{class:"chev",html:k("chevron-down")})]),i=s("div",{class:"section"+(t?"":" closed")},[r,o]);return r.addEventListener("click",()=>i.classList.toggle("closed")),i}function v(n,e){return s("div",{class:"stack"},[s("span",{class:"label",text:n}),e])}function Pe(n,e){let t=(l,d)=>{let a=s("input",{class:"sp-edge",value:U(n[l][d]).value});return a.addEventListener("change",()=>{let p=a.value.trim();e(`${l}-${d}`,/^-?[\d.]+$/.test(p)?p+"px":p)}),a},o=(l,d,a,p)=>s("div",{class:d},[s("span",{class:"sp-tag",text:a}),t(l,"top"),s("div",{class:"sp-mid"},[t(l,"left"),p,t(l,"right")]),t(l,"bottom")]),r=s("div",{class:"sp-size"},[s("span",{class:"sp-tag",text:"Size"}),s("span",{html:`${U(n.width||"0").value} <span class="sp-x">x</span> ${U(n.height||"0").value}`})]),i=o("padding","sp-box sp-padding","Padding",r);return o("margin","sp-box sp-margin","Margin",i)}var W=class{constructor(e){this.root=e,this.el=s("div",{class:"panel","data-inspect-ui":""}),e.appendChild(this.el),this._drag()}set(e){this.selected=e,this.render()}render(){let e=c.get();this.el.classList.toggle("hidden",e.collapsed),this.el.innerHTML="",this.el.append(this._head());let t=s("div",{class:"panel-body"});e.view==="assets"?this._assets(t):e.view==="changes"?this._changes(t):this.selected?e.view==="html"?this._html(t):this._design(t):t.append(s("div",{class:"empty",text:"Pick an element on the page to inspect and edit its styles."})),this.el.append(t)}_head(){let e=c.get();if(e.view==="assets"||e.view==="changes"){let i=e.view==="assets"?{title:"Assets",sub:"Everything this page uses"}:{title:"Changes",sub:"Every edit you make, ready to copy"};return s("div",{class:"head"},[s("div",{class:"head-top"},[s("div",{class:"head-title",text:i.title}),s("div",{class:"head-actions"},[Ne(),we("x","Close panel",()=>c.set({collapsed:!0}))])]),s("div",{class:"crumb",style:{color:"var(--muted)"},text:i.sub})])}let t=this.selected,o=t?ge(t):null,r=t?ft(t):[];return s("div",{class:"head"},[s("div",{class:"head-top"},[s("div",{class:"head-title",text:t?C(t)||o.tag:"InspectCSS"}),s("div",{class:"head-actions"},[we("delete02","Delete this element",()=>this._deleteSelected(),"danger"),Ne(),we("x","Close panel (Exit InspectCSS from the left dock)",()=>c.set({collapsed:!0}))])]),t?s("div",{class:"crumb"},r.map(i=>s("span",{text:i}))):null,t?s("div",{class:"dims"},[s("span",{html:`<b>${w(o.rect.width)}</b> x <b>${w(o.rect.height)}</b> px`}),s("span",{html:`A <b>${parseInt(o.typography.fontSize)}px</b>`})]):s("div",{class:"crumb",text:"no selection"})])}_design(e){let t=this.selected,o=ge(t),r=h=>x=>b(t,h,x),i=h=>x=>b(t,h,/^-?[\d.]+$/.test(String(x).trim())?x+"px":x),l=o.transform,d=h=>{Object.assign(l,h),b(t,"transform",Ke(l))},a=[{icon:"align-left",title:"Align left",css:["justify-content","flex-start"]},{icon:"align-bottom",title:"Align bottom",css:["align-items","flex-end"]},{icon:"align-right",title:"Align right",css:["justify-content","flex-end"]},{icon:"align-top",title:"Align top",css:["align-items","flex-start"]},{icon:"align-horizontal-center",title:"Center horizontally",css:["justify-content","center"]},{icon:"align-vertical-center",title:"Center vertically",css:["align-items","center"]}];e.append(K("Position",[v("Alignment",N(a,{grow:!0,seg:!0,onPick:h=>b(t,h.css[0],h.css[1])})),v("Position",s("div",{class:"row"},[m({key:"X",value:l.tx+"px",onChange:h=>d({tx:parseFloat(h)||0})}),m({key:"Y",value:l.ty+"px",onChange:h=>d({ty:parseFloat(h)||0})})])),v("Rotation",s("div",{class:"rot-row"},[m({iconName:"rotate01",value:l.rotate+"",showUnit:!1,onChange:h=>d({rotate:parseFloat(h)||0})}),N([{icon:"image-flip-horizontal",title:"Flip horizontal"}],{grow:!0,onPick:()=>Ye(t,"x")}),N([{icon:"image-flip-vertical",title:"Flip vertical"}],{grow:!0,onPick:()=>Ye(t,"y")})]))]));let p=!!this._sizeLinked,u=parseFloat(o.layout.width),g=parseFloat(o.layout.height),f=u>0&&g>0?u/g:0,E=h=>{b(t,"width",h);let x=parseFloat(h);p&&f&&isFinite(x)&&(b(t,"height",Math.round(x/f)+"px"),this.render())},Q=h=>{b(t,"height",h);let x=parseFloat(h);p&&f&&isFinite(x)&&(b(t,"width",Math.round(x*f)+"px"),this.render())};e.append(K("Layout",[v("Size",s("div",{class:"size-row"},[m({key:"W",value:o.layout.width,onChange:E}),Te(p,()=>{this._sizeLinked=!p,this.render()}),m({key:"H",value:o.layout.height,onChange:Q})])),v("Display",H({value:o.layout.display,options:["block","inline","inline-block","flex","inline-flex","grid","none"],onChange:r("display")})),s("div",{class:"row"},[v("Row Gap",m({iconName:"paragraph-spacing",value:o.layout.rowGap,showUnit:!1,sm:!0,onChange:i("row-gap")})),v("Column Gap",m({iconName:"letter-spacing",value:o.layout.columnGap,showUnit:!1,sm:!0,onChange:i("column-gap")}))]),s("div",{class:"row"},[v("Horizontal Align",H({value:o.layout.justify,options:[["flex-start","Start"],["center","Center"],["flex-end","End"],["space-between","Between"]],onChange:r("justify-content")})),v("Vertical Align",H({value:o.layout.align,options:[["flex-start","Start"],["center","Center"],["flex-end","End"],["stretch","Stretch"]],onChange:r("align-items")}))])])),e.append(K("Spacing",[v("Padding",s("div",{class:"row"},[m({iconName:"horizontal-resize",value:o.spacing.padding.left,onChange:h=>{r("padding-left")(h),r("padding-right")(h)}}),m({iconName:"vertical-resize",value:o.spacing.padding.top,onChange:h=>{r("padding-top")(h),r("padding-bottom")(h)}})])),v("Margin",s("div",{class:"row"},[m({iconName:"horizontal-resize",value:o.spacing.margin.left,onChange:h=>{r("margin-left")(h),r("margin-right")(h)}}),m({iconName:"vertical-resize",value:o.spacing.margin.top,onChange:h=>{r("margin-top")(h),r("margin-bottom")(h)}})])),Pe({...o.spacing,width:o.layout.width,height:o.layout.height},(h,x)=>b(t,h,x))]));let M=[],S=!!this._cornerExpanded,Ge=new Set([o.radius.tl,o.radius.tr,o.radius.bl,o.radius.br]).size>1;if(M.push(s("div",{class:"row"},[v("Opacity",m({iconName:"transparency",value:String(Math.round((parseFloat(o.effects.opacity)||1)*100)),unit:"%",onChange:h=>r("opacity")((parseFloat(h)||100)/100)})),v("Corner",s("div",{class:"corner-mix"},[m({iconName:"full-screen",value:Ge?"mix":o.radius.all,showUnit:!1,onChange:i("border-radius")}),me(S,"full-screen",S?"Collapse corners":"Edit each corner",()=>{this._cornerExpanded=!S,this.render()})]))])),S){let h=[["border-top-left-radius",o.radius.tl],["border-top-right-radius",o.radius.tr],["border-bottom-left-radius",o.radius.bl],["border-bottom-right-radius",o.radius.br]];M.push(s("div",{class:"corner-grid"},h.map(([x,R])=>m({iconName:"full-screen",value:R,showUnit:!1,onChange:i(x)}))))}let ne=Qe(o.background.color);M.push(ve("Fill",()=>{ne||(r("background-color")("#FFFFFF"),this.render())},{disabled:ne})),ne&&M.push(xe(o.background.color,r("background-color"),()=>{r("background-color")("rgba(0, 0, 0, 0)"),this.render()}));let re=o.border.present;if(M.push(ve("Stroke",()=>{re||(b(t,"border-style","solid"),b(t,"border-width","1px"),Qe(o.border.color)||b(t,"border-color","#FFFFFF"),this.render())},{disabled:re})),re){M.push(xe(o.border.color,r("border-color"),()=>{b(t,"border-width","0px"),this.render()}));let h=o.border.sides,x=new Set([h.top,h.right,h.bottom,h.left]).size>1,R=!!this._strokeSidesExpanded;if(M.push(s("div",{class:"corner-mix"},[m({iconName:"square",value:x?"mix":parseFloat(o.border.width)+"",showUnit:!1,onChange:Z=>b(t,"border-width",/^-?[\d.]+$/.test(String(Z).trim())?Z+"px":Z)}),me(R,"border-all-01",R?"Collapse sides":"Edit each side",()=>{this._strokeSidesExpanded=!R,this.render()})])),R){let Z=[["border-top-width","stroke-top",h.top],["border-right-width","stroke-right",h.right],["border-left-width","stroke-left",h.left],["border-bottom-width","stroke-bottom",h.bottom]];M.push(s("div",{class:"corner-grid"},Z.map(([Oe,Xe,We])=>m({iconName:Xe,value:parseFloat(We)+"",showUnit:!1,onChange:i(Oe)}))))}}e.append(K("Appearance",M)),e.append(K("Typography",[v("Typeface",H({value:De(o.typography.fontFamily),options:[De(o.typography.fontFamily),"Quicksand","Inter","Arial","Georgia","system-ui","monospace"],onChange:r("font-family")})),s("div",{class:"row"},[H({value:mt(o.typography.fontWeight),options:[["300","Light"],["400","Regular"],["500","Medium"],["600","SemiBold"],["700","Bold"],["800","Extra"]],onChange:r("font-weight")}),H({value:parseInt(o.typography.fontSize)+"",options:["10","12","13","14","16","18","20","24","32","48"].map(h=>[h,h]),onChange:h=>r("font-size")(h+"px")})]),s("div",{class:"row"},[v("Line Height",m({iconName:"paragraph-spacing",value:vt(o.typography.lineHeight),showUnit:!1,sm:!0,onChange:r("line-height")})),v("Letter Spacing",m({iconName:"letter-spacing",value:o.typography.letterSpacing,showUnit:!1,sm:!0,onChange:i("letter-spacing")}))]),s("div",{class:"row"},[v("Paragraph Spacing",m({iconName:"expand-paragraph",value:xt(o.typography.marginBottom),sm:!0,onChange:r("margin-bottom")})),v("Alignment",N([{icon:"text-align-right",title:"Right",css:"right"},{icon:"text-align-center",title:"Center",css:"center"},{icon:"text-align-start",title:"Left",css:"left"},{icon:"text-align-justify",title:"Justify",css:"justify"}],{grow:!0,seg:!0,active:["right","center","left","justify"].indexOf(o.typography.textAlign),onPick:h=>r("text-align")(h.css)}))])]))}_changes(e){let t=c.get(),o=de(),r=ue(),i=ze(t.promptDiff);if(e.append(s("div",{class:"view-actions"},[s("button",{class:"btn primary",text:"Copy CSS",onclick:()=>this._copy()}),s("button",{class:"btn",text:"Copy AI prompt",onclick:()=>{var d;i&&((d=navigator.clipboard)==null||d.writeText(i).then(()=>this._toast("AI prompt copied")))}}),s("button",{class:"btn",text:"Clear",onclick:()=>{Le(),this.render()}})])),!o.length){e.append(s("div",{class:"empty",text:"No changes yet. Edit a property, colour or text and every change is logged here."}));return}e.append(I("Change log",o.length,s("div",{class:"log-list"},[...o].reverse().map(d=>s("div",{class:"log-item"},[s("span",{class:"log-el",text:d.label||d.selector}),s("span",{class:"log-desc",text:je(d)})])))));let l=s("div",{class:"seg-toggle"},[s("button",{class:"seg-btn"+(t.promptDiff?"":" on"),text:"Final",onclick:()=>{c.get().promptDiff=!1,c.set({promptDiff:!1}),this.render()}}),s("button",{class:"seg-btn"+(t.promptDiff?" on":""),text:"Diff",onclick:()=>{c.get().promptDiff=!0,c.set({promptDiff:!0}),this.render()}})]);e.append(I("AI prompt",0,s("div",{},[s("div",{class:"ai-row"},[s("div",{class:"ai-hint",text:"Paste into any AI to apply these changes."}),l]),s("pre",{class:"code ai-prompt",text:i})]))),e.append(I("Generated CSS",0,r?s("pre",{class:"code",html:kt(r)}):s("div",{class:"empty",text:"No CSS edits."})))}_html(e){if(this._expanded=this._expanded||new Set,this._expanded.add(document.documentElement),this._expanded.add(document.body),this.selected){let i=this.selected.parentElement;for(;i;)this._expanded.add(i),i=i.parentElement}let t=s("div",{class:"domtree"});this._renderNode(document.documentElement,t,0);let o=s("div",{class:"tree-footer"},[s("button",{class:"tree-btn",onclick:()=>c.set({view:"design"})},[s("span",{html:X.back}),"Back"]),s("button",{class:"tree-btn",onclick:()=>c.set({active:!0})},[s("span",{html:X.pick}),"Pick an element"])]);e.append(t,o);let r=t.querySelector(".tree-row.selected");r&&setTimeout(()=>r.scrollIntoView({block:"center"}),0)}_renderNode(e,t,o){if(e.nodeType!==1||e.hasAttribute&&e.hasAttribute("data-inspect-ui"))return;let r=[...e.children].filter(u=>!(u.hasAttribute&&u.hasAttribute("data-inspect-ui"))),i=r.length>0,l=this._expanded.has(e),d=o*14+8,a=s("span",{class:"tree-tw"+(i?"":" leaf"),html:i?l?X.caretDown:X.caretRight:""});a.addEventListener("click",u=>{u.stopPropagation(),i&&(l?this._expanded.delete(e):this._expanded.add(e),this.render())});let p=s("div",{class:"tree-row"+(e===this.selected?" selected":""),style:{paddingLeft:d+"px"}},[a,s("span",{class:"tree-tag",html:wt(e,i&&!l)})]);p.addEventListener("click",()=>{this.selected=e,c.set({selectedEl:e}),this.render()}),t.append(p),i&&l&&(r.forEach(u=>this._renderNode(u,t,o+1)),t.append(s("div",{class:"tree-row tree-close",style:{paddingLeft:d+"px"}},[s("span",{class:"tree-tag",html:bt(e)})])))}_deleteSelected(){let e=this.selected;if(!e)return;let t=e.parentElement;if(!t)return;let o=e.nextElementSibling,r=C(e),i=L(e);e.remove(),A({type:"delete",id:e.getAttribute("data-inspect-id"),to:"removed",label:r,selector:i}),j({undo:()=>t.insertBefore(e,o),redo:()=>e.remove()});let l=t!==document.body&&t!==document.documentElement?t:null;this.selected=l,c.set({selectedEl:l}),this._toast("Element deleted"),this.render()}_copy(){var t;let e=ue();e&&((t=navigator.clipboard)==null||t.writeText(e).then(()=>this._toast("CSS copied")))}_toast(e){let t=s("div",{class:"toast","data-inspect-ui":"",text:e});this.root.appendChild(t),setTimeout(()=>t.remove(),1400)}_assets(e){let t=this._assetCache||(this._assetCache=Ze()),o=(a,p)=>{var u;(u=navigator.clipboard)==null||u.writeText(a),this._toast(p||"Copied")},r=s("div",{class:"asset-colors"},t.colors.map(a=>s("button",{class:"asset-swatch",title:`${a.hex} \xB7 used ${a.count}\xD7`,style:{background:a.css},onclick:()=>o(a.hex,a.hex+" copied")}))),i=s("div",{class:"asset-type-list"},t.typography.map(a=>s("button",{class:"asset-type",title:"Copy CSS",onclick:()=>o(`font-family: ${a.family};
font-size: ${a.size};
font-weight: ${a.weight};`,"Type style copied")},[s("div",{class:"asset-type-preview",style:{fontFamily:a.family,fontSize:"min("+a.size+", 28px)",fontWeight:a.weight},text:"Ag"}),s("div",{class:"asset-type-meta"},[s("div",{class:"asset-type-name",text:a.family}),s("div",{class:"asset-type-sub",text:`${parseInt(a.size)}px \xB7 ${a.weight}`})])]))),l=s("div",{class:"asset-grid"},t.svgs.map(a=>{let p=s("div",{class:"asset-thumb asset-svg",title:"Copy SVG"});return a.type==="inline"?p.innerHTML=a.markup:p.appendChild(s("img",{src:a.src,alt:""})),p.addEventListener("click",()=>o(a.markup||a.src,"SVG copied")),p})),d=s("div",{class:"asset-grid"},t.images.map(a=>{let p=s("div",{class:"asset-thumb",title:"Copy image URL"},[s("img",{src:a.src,alt:"",loading:"lazy"})]);return p.addEventListener("click",()=>o(a.src,"Image URL copied")),p}));e.append(s("div",{class:"view-actions"},[s("button",{class:"btn primary",text:"Rescan page",onclick:()=>{this._assetCache=null,this.render()}})]),I("Colors",t.colors.length,r),I("Typography",t.typography.length,i),I("SVGs",t.svgs.length,l),I("Images",t.images.length,d))}_drag(){let e,t,o,r,i=!1;this.el.addEventListener("mousedown",a=>{if(!a.target.closest(".head")||a.target.closest(".hbtn")||c.get().docked)return;i=!0;let u=this.el.getBoundingClientRect();e=a.clientX,t=a.clientY,o=u.left,r=u.top,this.el.style.right="auto",this.el.style.left=u.left+"px",this.el.style.top=u.top+"px",document.addEventListener("mousemove",l,!0),document.addEventListener("mouseup",d,!0),a.preventDefault()});let l=a=>{i&&(this.el.style.left=o+(a.clientX-e)+"px",this.el.style.top=Math.max(0,r+(a.clientY-t))+"px")},d=()=>{i=!1,document.removeEventListener("mousemove",l,!0),document.removeEventListener("mouseup",d,!0)}}};function we(n,e,t,o=""){return s("button",{class:"hbtn"+(o?" "+o:""),title:e,onclick:t,html:k(n)})}function Ne(){let n=c.get().docked;return s("button",{class:"hbtn"+(n?" active":""),title:n?"Undock panel (float)":"Dock panel to the side",onclick:()=>c.set({docked:!c.get().docked}),html:k("sidebar-right-01")})}function Qe(n){if(!n)return!1;let e=String(n).trim();if(e==="transparent"||e==="none")return!1;let t=e.match(/rgba?\(([^)]+)\)/i);if(t){let o=t[1].split(",")[3];return o==null||parseFloat(o)>0}return!0}function I(n,e,t){let o=s("div",{class:"sec-head"},[s("span",{},[n,e?s("span",{class:"asset-count",text:String(e)}):null]),s("span",{class:"chev",html:k("chevron-down")})]),r=s("div",{class:"section"},[o,s("div",{class:"sec-content"},[t])]);return o.addEventListener("click",()=>r.classList.toggle("closed")),r}function ft(n){let e=[],t=n,o=0;for(;t&&t.nodeType===1&&t!==document.documentElement&&o<3;)t.classList.length?e.unshift("."+t.classList[0]):e.unshift(t.tagName.toLowerCase()),t=t.parentElement,o++;return e}function Ye(n,e){let t=getComputedStyle(n),o=t.transform==="none"?"":t.transform+" ";b(n,"transform",o+(e==="x"?"scaleX(-1)":"scaleY(-1)"))}function De(n){return(n||"").split(",")[0].replace(/["']/g,"").trim()||"system-ui"}function mt(n){return String(n)}function vt(n){return n==="normal"?"1.4":n}function xt(n){return n&&n!=="auto"?n:"0px"}function be(n){return n.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}var X={caretRight:'<svg width="10" height="10" viewBox="0 0 10 10" fill="currentColor"><path d="M3 1.5l4 3.5-4 3.5z"/></svg>',caretDown:'<svg width="10" height="10" viewBox="0 0 10 10" fill="currentColor"><path d="M1.5 3h7l-3.5 4z"/></svg>',back:'<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M15 6l-6 6 6 6"/></svg>',pick:'<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 3v3M12 18v3M3 12h3M18 12h3"/><circle cx="12" cy="12" r="4"/></svg>'};function wt(n,e){let t=n.tagName.toLowerCase(),o="";for(let i of n.attributes){if(i.name.startsWith("data-inspect"))continue;let l=i.value.length>40?i.value.slice(0,40)+"\u2026":i.value;o+=` <span class="t-attr">${be(i.name)}</span><span class="t-br">=</span><span class="t-val">"${be(l)}"</span>`}let r=`<span class="t-br">&lt;</span><span class="t-tag">${t}</span>${o}<span class="t-br">&gt;</span>`;return e&&(r+=`<span class="t-ell">\u2026</span><span class="t-br">&lt;/</span><span class="t-tag">${t}</span><span class="t-br">&gt;</span>`),r}function bt(n){return`<span class="t-br">&lt;/</span><span class="t-tag">${n.tagName.toLowerCase()}</span><span class="t-br">&gt;</span>`}function kt(n){return be(n).replace(/^([^{\n]+)\{/gm,'<span class="sel">$1</span>{').replace(/^(\s+)([\w-]+)(:)/gm,'$1<span class="prop">$2</span>$3').replace(/: ([^;]+);/g,': <span class="val">$1</span>;')}var J=class{constructor(e,t){this.api=t,this.el=s("div",{class:"dock","data-inspect-ui":""}),e.appendChild(this.el),this.render(),c.subscribe(()=>this.sync())}render(){this.el.innerHTML="",this.pauseBtn=qe("pause","Pause / resume picking",()=>c.set({active:!c.get().active}));let e=s("div",{class:"dock-group"},[z("undo-03","Undo",()=>{var o,r;return(r=(o=this.api).undo)==null?void 0:r.call(o)}),z("redo-01","Redo",()=>{var o,r;return(r=(o=this.api).redo)==null?void 0:r.call(o)}),ke(),z("layer-bring-forward","Select parent element",()=>{var o,r;return(r=(o=this.api).selectParent)==null?void 0:r.call(o)}),z("layer-send-backward","Select child element",()=>{var o,r;return(r=(o=this.api).selectChild)==null?void 0:r.call(o)}),ke(),this.assetsBtn=z("component","Assets (page colors, type, SVGs, images)",()=>{let o=c.get().view;c.set({view:o==="assets"?"design":"assets",collapsed:!1})}),this.codeBtn=z("file-diff","Changes & AI prompt",()=>c.set({view:"changes",collapsed:!1})),this.htmlBtn=z("html-file-01","HTML",()=>c.set({view:"html",collapsed:!1})),ke(),this.respBtn=z("laptop-phone-sync","Toggle responsive preview",()=>{var o,r;return(r=(o=this.api).toggleResponsive)==null?void 0:r.call(o)})]),t=qe("cancel-01","Exit InspectCSS",()=>{var o;return(o=window.InspectCSS)==null?void 0:o.destroy()});this.el.append(this.pauseBtn,e,t),this.sync()}sync(){var t,o,r,i,l;let e=c.get();(t=this.pauseBtn)==null||t.classList.toggle("active",e.active),(o=this.assetsBtn)==null||o.classList.toggle("active",e.view==="assets"),(r=this.codeBtn)==null||r.classList.toggle("active",e.view==="changes"),(i=this.htmlBtn)==null||i.classList.toggle("active",e.view==="html"),(l=this.respBtn)==null||l.classList.toggle("active",e.responsive)}};function qe(n,e,t){return s("button",{class:"dock-circle",title:e,onclick:t,html:k(n)})}function z(n,e,t){return s("button",{class:"dock-btn",title:e,onclick:t,html:k(n)})}function ke(){return s("div",{class:"dock-sep"})}var _=class{constructor(e){this.root=e,this.el=s("div",{class:"tooltip","data-inspect-ui":""}),e.appendChild(this.el),e.addEventListener("pointerover",t=>this._over(t),!0),e.addEventListener("pointerout",t=>this._out(t),!0),e.addEventListener("pointerdown",()=>this.hide(),!0),document.addEventListener("pointerover",t=>this._over(t,!0),!0),document.addEventListener("pointerout",t=>this._out(t),!0),document.addEventListener("pointerdown",()=>this.hide(),!0)}_over(e,t=!1){let o=e.target.closest&&e.target.closest("[title],[data-tip]");if(!o||t&&!o.hasAttribute("data-inspect-ui")||!t&&!this.root.contains(o))return;if(o.hasAttribute("title")){let i=o.getAttribute("title");i&&o.setAttribute("data-tip",i),o.removeAttribute("title")}let r=o.getAttribute("data-tip");r&&this.show(r,o)}_out(e){let t=e.target.closest&&e.target.closest("[data-tip]");t&&!t.contains(e.relatedTarget)&&this.hide()}show(e,t){this.el.textContent=e,this.el.classList.add("show");let o=t.getBoundingClientRect(),r=this.el.getBoundingClientRect(),i=o.top-r.height-8,l=o.left+o.width/2-r.width/2;i<6&&(i=o.bottom+8),l=Math.max(6,Math.min(l,window.innerWidth-r.width-6)),this.el.style.left=Math.round(l)+"px",this.el.style.top=Math.round(i)+"px"}hide(){this.el.classList.remove("show")}};var $=class{constructor(e){this.onChange=e,this._onDblClick=this._onDblClick.bind(this),this._onKey=this._onKey.bind(this)}start(){document.addEventListener("dblclick",this._onDblClick,!0)}stop(){document.removeEventListener("dblclick",this._onDblClick,!0),this._finish()}_editable(e){if(!e||e.nodeType!==1||V(e))return null;let t=e;for(;t&&t!==document.body;){let o=[...t.childNodes].some(i=>i.nodeType===3&&i.textContent.trim()),r=![...t.children].some(i=>{let l=getComputedStyle(i).display;return l==="block"||l==="flex"||l==="grid"});if(o&&r)return t;t=t.parentElement}return e.matches("h1,h2,h3,h4,h5,h6,p,span,a,button,li,td,th,label,strong,em,small,div")?e:null}_onDblClick(e){var i,l;if(V(e.target))return;let t=this._editable(e.target);if(!t)return;e.preventDefault(),e.stopPropagation(),c.set({editing:!0,selectedEl:t}),this.el=t,this._origText=t.textContent,Y(t),t.setAttribute("contenteditable","true"),t.setAttribute("data-inspect-editing",""),t.focus();let o=(i=document.caretRangeFromPoint)==null?void 0:i.call(document,e.clientX,e.clientY),r=window.getSelection();r.removeAllRanges(),o?r.addRange(o):(l=document.execCommand)==null||l.call(document,"selectAll",!1,null),t.addEventListener("blur",()=>this._finish(),{once:!0}),document.addEventListener("keydown",this._onKey,!0)}_onKey(e){this.el&&(e.key==="Escape"||e.key==="Enter"&&!e.shiftKey&&this.el.tagName!=="DIV")&&(e.preventDefault(),this.el.blur())}_finish(){var e;if(document.removeEventListener("keydown",this._onKey,!0),this.el){let t=this.el;t.removeAttribute("contenteditable"),t.removeAttribute("data-inspect-editing");let o=t.textContent;if(o!==this._origText){let r=this._origText,i=o;A({type:"text",id:t.getAttribute("data-inspect-id"),from:r,to:i,label:C(t),selector:L(t)}),j({undo:()=>{t.textContent=r},redo:()=>{t.textContent=i}})}this.el=null}c.get().editing&&c.set({editing:!1}),(e=this.onChange)==null||e.call(this)}};var Ct=4,Ce=new WeakMap;function ye(n){let e=n.nextElementSibling;for(;e&&V(e);)e=e.nextElementSibling;return e}function yt(n){let e=n.previousElementSibling;for(;e&&V(e);)e=e.previousElementSibling;return e}function Mt(n,e){if(n.length>=2){let r=n[0].getBoundingClientRect(),i=n[1].getBoundingClientRect(),l=Math.min(r.bottom,i.bottom)-Math.max(r.top,i.top),d=Math.min(r.right,i.right)-Math.max(r.left,i.left);if(l!==d)return l>d}let t=getComputedStyle(e);return/flex/.test(t.display)&&/row/.test(t.flexDirection)||t.display.includes("inline")||t.display==="grid"&&t.gridAutoFlow.includes("column")}function Vt(n){let e=ye(n);if(e)return`before ${C(e)}`;let t=yt(n);return t?`after ${C(t)}`:"to the only remaining slot"}var Et='<svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M5 9l-3 3 3 3M9 5l3-3 3 3M15 19l-3 3-3-3M19 9l3 3-3 3M2 12h20M12 2v20"/></svg>',ee=class{constructor(e){this.onReorder=e,this.indicator=s("div",{"data-inspect-ui":"",style:{position:"fixed",background:"#58aeff",borderRadius:"2px",pointerEvents:"none",zIndex:"2147483644",display:"none",boxShadow:"0 0 6px rgba(88,174,255,.8)"}}),this.handle=s("div",{"data-inspect-ui":"",title:"Drag to reorder",html:Et,style:{position:"fixed",width:"26px",height:"26px",borderRadius:"999px",display:"none",alignItems:"center",justifyContent:"center",background:"rgba(0,0,0,0.82)",border:"1px solid rgba(255,255,255,0.18)",color:"#fff",cursor:"grab",zIndex:"2147483645",boxShadow:"0 4px 14px rgba(0,0,0,.5)",backdropFilter:"blur(6px)"}}),document.documentElement.append(this.indicator,this.handle),this._down=this._down.bind(this),this._move=this._move.bind(this),this._up=this._up.bind(this),this._reposition=this._reposition.bind(this),this._sync=this._sync.bind(this)}start(){this.handle.addEventListener("mousedown",this._down,!0),this.handle.addEventListener("mouseenter",()=>this.handle.style.background="#58aeff"),this.handle.addEventListener("mouseleave",()=>this.handle.style.background="rgba(0,0,0,0.82)"),this.unsub=c.subscribe(this._sync),window.addEventListener("scroll",this._reposition,!0),window.addEventListener("resize",this._reposition,!0)}stop(){var e;(e=this.unsub)==null||e.call(this),window.removeEventListener("scroll",this._reposition,!0),window.removeEventListener("resize",this._reposition,!0),this.indicator.remove(),this.handle.remove()}_sync(){let e=c.get(),t=e.selectedEl&&!e.dragging&&!e.editing;this.handle.style.display=t?"flex":"none",t&&this._reposition()}_reposition(){let e=c.get().selectedEl;if(!e||this.dragging)return;let t=e.getBoundingClientRect();this.handle.style.left=Math.round(Math.max(4,t.left-8))+"px",this.handle.style.top=Math.round(Math.max(4,t.top-8))+"px"}_down(e){e.button===0&&(e.preventDefault(),e.stopPropagation(),c.get().selectedEl&&(this.sx=e.clientX,this.sy=e.clientY,this.armed=!0,this.dragging=!1,document.addEventListener("mousemove",this._move,!0),document.addEventListener("mouseup",this._up,!0)))}_move(e){if(this.armed){if(!this.dragging){if(Math.hypot(e.clientX-this.sx,e.clientY-this.sy)<Ct)return;this.dragging=!0,c.set({dragging:!0}),document.documentElement.style.cursor="grabbing",this.handle.style.display="none"}this._updateTarget(e)}}_updateTarget(e){let t=c.get().selectedEl,o=t==null?void 0:t.parentElement;if(!o)return;let r=[...o.children].filter(a=>!V(a)&&a!==t);if(!r.length){this.ref=void 0,this.indicator.style.display="none";return}let i=Mt(r,o),l=i?e.clientX:e.clientY,d=null;for(let a of r){let p=a.getBoundingClientRect(),u=i?p.left+p.width/2:p.top+p.height/2;if(l<u){d=a;break}}this.ref=d,this._drawLine(d,r,i)}_drawLine(e,t,o){let r=t[t.length-1],l=(e||r).getBoundingClientRect();if(o){let d;if(e){let a=t[t.indexOf(e)-1];d=a?(a.getBoundingClientRect().right+l.left)/2:l.left-2}else d=l.right+2;Object.assign(this.indicator.style,{display:"block",left:d-1.5+"px",top:l.top+"px",width:"3px",height:l.height+"px"})}else{let d;if(e){let a=t[t.indexOf(e)-1];d=a?(a.getBoundingClientRect().bottom+l.top)/2:l.top-2}else d=l.bottom+2;Object.assign(this.indicator.style,{display:"block",left:l.left+"px",top:d-1.5+"px",width:l.width+"px",height:"3px"})}}_up(){var t;document.removeEventListener("mousemove",this._move,!0),document.removeEventListener("mouseup",this._up,!0),this.indicator.style.display="none",document.documentElement.style.cursor="";let e=this.dragging;if(this.armed=!1,this.dragging=!1,e){let o=c.get().selectedEl,r=this.ref;if(o&&r!==void 0&&r!==o&&r!==o.nextElementSibling){let l=o.parentElement,d=o.nextElementSibling;Ce.has(o)||Ce.set(o,ye(o)),l.insertBefore(o,r||null);let a=o.getAttribute("data-inspect-id");ye(o)===Ce.get(o)?Ae(a):A({type:"move",id:a,to:"reordered",label:C(o),selector:L(o),position:Vt(o)}),j({undo:()=>l.insertBefore(o,d),redo:()=>l.insertBefore(o,r||null)})}c.set({dragging:!1}),this.ref=void 0;let i=l=>{l.stopPropagation(),l.preventDefault(),document.removeEventListener("click",i,!0)};document.addEventListener("click",i,!0),(t=this.onReorder)==null||t.call(this,o)}this._sync()}};var te=class{constructor(){this.active=!1,this.width=0,this.handleR=this._makeHandle(),this.handleL=this._makeHandle(),this.label=s("div",{"data-inspect-ui":"",style:{position:"fixed",top:"10px",left:"50%",transform:"translateX(-50%)",zIndex:"2147483645",display:"none",background:"rgba(0,0,0,0.82)",color:"#fff",font:"500 12px 'Quicksand', -apple-system, sans-serif",padding:"4px 10px",borderRadius:"8px",border:"1px solid rgba(255,255,255,0.14)",pointerEvents:"none"}}),document.documentElement.append(this.handleR,this.handleL,this.label),this._down=this._down.bind(this),this._move=this._move.bind(this),this._up=this._up.bind(this),this._reposition=this._reposition.bind(this),this.handleR.addEventListener("mousedown",this._down),this.handleL.addEventListener("mousedown",this._down)}_makeHandle(){let e=s("div",{"data-inspect-ui":"",style:{position:"fixed",top:"0",bottom:"0",width:"12px",cursor:"ew-resize",zIndex:"2147483645",display:"none"}});return e.appendChild(s("div",{style:{position:"absolute",top:"50%",left:"50%",transform:"translate(-50%,-50%)",width:"6px",height:"54px",borderRadius:"4px",background:"#58aeff",boxShadow:"0 0 8px rgba(88,174,255,.7)"}})),e}toggle(){return this.active?this.disable():this.enable(),this.active}enable(){this.active=!0,this.width=Math.min(1024,window.innerWidth-40),this._apply(),this.handleR.style.display="block",this.handleL.style.display="block",this.label.style.display="block",window.addEventListener("resize",this._reposition)}disable(){this.active=!1;let e=document.documentElement;e.style.width="",e.style.margin="",e.style.transition="",this.handleR.style.display="none",this.handleL.style.display="none",this.label.style.display="none",window.removeEventListener("resize",this._reposition)}_apply(){let e=document.documentElement;e.style.width=this.width+"px",e.style.margin="0 auto",this._reposition()}_reposition(){let e=(window.innerWidth+this.width)/2,t=(window.innerWidth-this.width)/2;this.handleR.style.left=e-6+"px",this.handleL.style.left=t-6+"px",this.label.textContent=Math.round(this.width)+" px"}_down(e){e.preventDefault(),this.dragging=!0,document.addEventListener("mousemove",this._move,!0),document.addEventListener("mouseup",this._up,!0),document.documentElement.style.userSelect="none"}_move(e){if(!this.dragging)return;let t=2*Math.abs(e.clientX-window.innerWidth/2);this.width=Math.max(320,Math.min(t,window.innerWidth)),this._apply()}_up(){this.dragging=!1,document.removeEventListener("mousemove",this._move,!0),document.removeEventListener("mouseup",this._up,!0),document.documentElement.style.userSelect=""}destroy(){this.disable(),this.handleR.remove(),this.handleL.remove(),this.label.remove()}};var oe=`@font-face {
