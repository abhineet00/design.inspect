(()=>{var R={active:!1,hoverEl:null,selectedEl:null,pseudo:"none",view:"design",edits:new Map,panelPos:{x:null,y:16},collapsed:!1},B=new Set,d={get:()=>R,set(o){Object.assign(R,o),B.forEach(e=>e(R))},subscribe(o){return B.add(o),()=>B.delete(o)}};var ve=0,Y="data-inspect-id";function W(o){let e=o.getAttribute(Y);return e||(e="ic-"+ ++ve,o.setAttribute(Y,e)),e}function $(o){return`[${Y}="${o}"]`}function v(o,e=2){if(o==null||Number.isNaN(o))return 0;let t=Math.pow(10,e);return Math.round(o*t)/t}function i(o,e={},t=[]){let n=document.createElement(o);for(let[r,l]of Object.entries(e))r==="class"?n.className=l:r==="style"&&typeof l=="object"?Object.assign(n.style,l):r==="html"?n.innerHTML=l:r==="text"?n.textContent=l:r.startsWith("on")&&typeof l=="function"?n.addEventListener(r.slice(2).toLowerCase(),l):l!==!1&&l!=null&&n.setAttribute(r,l===!0?"":l);for(let r of[].concat(t))r==null||r===!1||n.appendChild(typeof r=="string"?document.createTextNode(r):r);return n}function K(o){if(!o||o.nodeType!==1)return"";let e=o.tagName.toLowerCase();return o.id?e+="#"+o.id:o.classList.length&&(e+="."+o.classList[0]),e}function _(o){if(o==null)return{value:0,unit:"px"};let e=String(o).trim().match(/^(-?[\d.]+)\s*([a-z%]*)$/i);return e?{value:parseFloat(e[1]),unit:e[2]||"px"}:{value:o,unit:""}}function q(o){if(!o)return{hex:"#000000",alpha:1};if(o.startsWith("#"))return{hex:o,alpha:1};let e=o.match(/rgba?\(([^)]+)\)/i);if(!e)return{hex:"#000000",alpha:1};let t=e[1].split(",").map(c=>c.trim()),[n,r,l]=t.map(c=>parseInt(c,10)),a=t[3]!=null?parseFloat(t[3]):1;return{hex:"#"+[n,r,l].map(c=>Math.max(0,Math.min(255,c||0)).toString(16).padStart(2,"0")).join(""),alpha:a}}function Q(o,e=1){let t=o.replace("#",""),n=t.length===3?t.split("").map(p=>p+p).join(""):t.padEnd(6,"0"),r=parseInt(n.slice(0,2),16),l=parseInt(n.slice(2,4),16),a=parseInt(n.slice(4,6),16);return e>=1?`rgb(${r}, ${l}, ${a})`:`rgba(${r}, ${l}, ${a}, ${v(e,3)})`}function I(o){return!!(o&&o.closest&&o.closest("[data-inspect-ui]"))}var j=class{constructor(e){this.el=i("div",{"data-inspect-ui":"",style:{position:"fixed",inset:"0",pointerEvents:"none",zIndex:"2147483646"}}),this.margin=this._box("rgba(246, 178, 107, 0.28)"),this.padding=this._box("rgba(147, 196, 125, 0.30)"),this.content=i("div",{style:this._boxStyle("transparent","#4c8dff")}),this.selected=i("div",{style:this._boxStyle("transparent","#7c5cff")}),this.badge=i("div",{"data-inspect-ui":"",style:{position:"fixed",font:"600 11px/1.4 ui-monospace, SFMono-Regular, Menlo, monospace",color:"#fff",background:"#4c8dff",padding:"2px 6px",borderRadius:"4px",whiteSpace:"nowrap",pointerEvents:"none",boxShadow:"0 1px 4px rgba(0,0,0,.3)"}}),this.el.append(this.margin,this.padding,this.content,this.selected,this.badge),e.appendChild(this.el),this.hideHover(),this.hideSelected()}_box(e){return i("div",{style:{position:"fixed",background:e,pointerEvents:"none"}})}_boxStyle(e,t){return{position:"fixed",background:e,outline:`1px solid ${t}`,outlineOffset:"-1px",pointerEvents:"none"}}_place(e,t){Object.assign(e.style,{left:t.left+"px",top:t.top+"px",width:Math.max(0,t.width)+"px",height:Math.max(0,t.height)+"px",display:"block"})}highlight(e){if(!e)return this.hideHover();let t=getComputedStyle(e),n=e.getBoundingClientRect(),r=J(t,"margin"),l=J(t,"padding");this._place(this.margin,{left:n.left-r.left,top:n.top-r.top,width:n.width+r.left+r.right,height:n.height+r.top+r.bottom}),this._place(this.content,n),this._place(this.padding,n),this.badge.textContent=`${v(n.width)} \xD7 ${v(n.height)}`,this.badge.style.display="block";let a=n.top>24?n.top-22:n.bottom+6;this.badge.style.left=Math.max(4,n.left)+"px",this.badge.style.top=a+"px"}select(e){if(!e)return this.hideSelected();this._place(this.selected,e.getBoundingClientRect())}hideHover(){[this.margin,this.padding,this.content,this.badge].forEach(e=>e.style.display="none")}hideSelected(){this.selected.style.display="none"}destroy(){this.el.remove()}};function J(o,e){let t=n=>parseFloat(o.getPropertyValue(`${e}-${n}`))||0;return{top:t("top"),right:t("right"),bottom:t("bottom"),left:t("left")}}var L=class{constructor(e,t){this.overlay=e,this.onSelect=t,this._onMove=this._onMove.bind(this),this._onClick=this._onClick.bind(this),this._onKey=this._onKey.bind(this),this._onScroll=this._onScroll.bind(this)}start(){document.addEventListener("mousemove",this._onMove,!0),document.addEventListener("click",this._onClick,!0),document.addEventListener("keydown",this._onKey,!0),window.addEventListener("scroll",this._onScroll,!0),window.addEventListener("resize",this._onScroll,!0),document.documentElement.style.cursor="crosshair"}stop(){document.removeEventListener("mousemove",this._onMove,!0),document.removeEventListener("click",this._onClick,!0),document.removeEventListener("keydown",this._onKey,!0),window.removeEventListener("scroll",this._onScroll,!0),window.removeEventListener("resize",this._onScroll,!0),document.documentElement.style.cursor="",this.overlay.hideHover(),d.set({hoverEl:null})}_target(e){let t=document.elementFromPoint(e.clientX,e.clientY);return!t||I(t)||t===document.documentElement||t===document.body?null:t}_onMove(e){let t=this._target(e);if(!t)return this.overlay.hideHover();t!==d.get().hoverEl&&(d.set({hoverEl:t}),this.overlay.highlight(t))}_onClick(e){if(I(e.target))return;let t=this._target(e);t&&(e.preventDefault(),e.stopPropagation(),this.onSelect(t))}_onKey(e){e.key==="Escape"&&(e.preventDefault(),d.set({active:!1}))}_onScroll(){let{hoverEl:e,selectedEl:t}=d.get();e&&this.overlay.highlight(e),t&&this.overlay.select(t)}};function me(o){return o&&!/[^a-zA-Z0-9_-]/.test(o)&&!/^(is-|has-|js-)/.test(o)?!0:o&&!/[^a-zA-Z0-9_-]/.test(o)}function xe(o){let e=1,t=o;for(;t=t.previousElementSibling;)t.tagName===o.tagName&&e++;return e}function Ce(o){let e=o.tagName.toLowerCase();if(o.id&&document.querySelectorAll("#"+CSS.escape(o.id)).length===1)return"#"+o.id;let t=Array.from(o.classList).filter(me).slice(0,2);return t.length?e+"."+t.map(r=>r).join("."):`${e}:nth-of-type(${xe(o)})`}function ee(o,e=4){if(!o||o.nodeType!==1)return"";let t=[],n=o;for(;n&&n.nodeType===1&&n!==document.documentElement;){let r=Ce(n);if(t.unshift(r),r.startsWith("#"))break;try{if(document.querySelectorAll(t.join(" > ")).length===1)break}catch{}if(n=n.parentElement,t.length>=e)break}return t.join(" > ")}var te="inspect-css-live-styles";function we(){let o=document.getElementById(te);return o||(o=document.createElement("style"),o.id=te,o.setAttribute("data-inspect-ui",""),document.head.appendChild(o)),o}var y=[],S=[];function T(){let{edits:o}=d.get();return[...o.entries()].map(([e,t])=>[e,{inspectId:t.inspectId,pseudo:t.pseudo,selector:t.selector,props:[...t.props.entries()]}])}function oe(o){let e=new Map;for(let[t,n]of o)e.set(t,{inspectId:n.inspectId,pseudo:n.pseudo,selector:n.selector,props:new Map(n.props)});d.get().edits=e,F(),d.set({edits:e})}function ke(){y.push(T()),y.length>100&&y.shift(),S.length=0}function ne(){y.length&&(S.push(T()),oe(y.pop()))}function re(){S.length&&(y.push(T()),oe(S.pop()))}function C(o,e,t){ke();let n=W(o),{edits:r,pseudo:l}=d.get(),a=l==="none"?n:`${n}::${l}`,p=r.get(a);p||(p={inspectId:n,pseudo:l,selector:ee(o),props:new Map},r.set(a,p)),t===""||t==null?p.props.delete(e):p.props.set(e,t),p.props.size===0&&r.delete(a),F(),d.set({edits:r})}function Z(o,e="none"){let t=o.getAttribute("data-inspect-id");if(!t)return new Map;let n=e==="none"?t:`${t}::${e}`,r=d.get().edits.get(n);return r?r.props:new Map}function F(){let{edits:o}=d.get(),e=[];for(let t of o.values()){if(t.props.size===0)continue;let n=$(t.inspectId)+(t.pseudo!=="none"?":"+t.pseudo:""),r=[...t.props.entries()].map(([l,a])=>`  ${l}: ${a} !important;`).join(`
`);e.push(`${n} {
${r}
}`)}we().textContent=e.join(`

`)}function N(){let{edits:o}=d.get(),e=[];for(let t of o.values()){if(t.props.size===0)continue;let n=(t.selector||$(t.inspectId))+(t.pseudo!=="none"?":"+t.pseudo:""),r=[...t.props.entries()].map(([l,a])=>`  ${l}: ${a};`).join(`
`);e.push(`${n} {
${r}
}`)}return e.join(`

`)}function P(){d.get().edits.clear(),F(),d.set({edits:d.get().edits})}function m(o,e,t,n=t){let r=Z(o,d.get().pseudo).get(t);return r!=null?r:e.getPropertyValue(n).trim()}function O(o){let e=getComputedStyle(o),t=o.getBoundingClientRect();return{rect:t,tag:o.tagName.toLowerCase(),layout:{display:m(o,e,"display"),position:m(o,e,"position"),width:e.width,height:e.height,x:v(t.left+window.scrollX),y:v(t.top+window.scrollY),rowGap:e.rowGap==="normal"?"0":e.rowGap,columnGap:e.columnGap==="normal"?"0":e.columnGap,justify:m(o,e,"justify-content"),align:m(o,e,"align-items")},transform:be(o,e),spacing:{margin:ie(e,"margin"),padding:ie(e,"padding")},radius:{all:m(o,e,"border-radius"),tl:e.borderTopLeftRadius,tr:e.borderTopRightRadius,br:e.borderBottomRightRadius,bl:e.borderBottomLeftRadius},typography:{fontFamily:e.fontFamily,fontSize:m(o,e,"font-size"),fontWeight:m(o,e,"font-weight"),lineHeight:e.lineHeight,letterSpacing:e.letterSpacing==="normal"?"0px":e.letterSpacing,textAlign:m(o,e,"text-align"),color:m(o,e,"color"),marginBottom:m(o,e,"margin-bottom")},background:{color:m(o,e,"background-color"),image:e.backgroundImage},border:{width:e.borderTopWidth,style:e.borderTopStyle,color:e.borderTopColor},effects:{opacity:m(o,e,"opacity"),boxShadow:e.boxShadow==="none"?"":e.boxShadow}}}function ie(o,e){return{top:o.getPropertyValue(`${e}-top`),right:o.getPropertyValue(`${e}-right`),bottom:o.getPropertyValue(`${e}-bottom`),left:o.getPropertyValue(`${e}-left`)}}function be(o,e){let n=Z(o,d.get().pseudo).get("transform")||e.transform,r={tx:0,ty:0,rotate:0};if(!n||n==="none")return r;let l=/translate\(\s*(-?[\d.]+)px\s*,\s*(-?[\d.]+)px\s*\)/.exec(n),a=/rotate\(\s*(-?[\d.]+)deg\s*\)/.exec(n);if(l&&(r.tx=parseFloat(l[1]),r.ty=parseFloat(l[2])),a&&(r.rotate=parseFloat(a[1])),l||a)return r;let p=/matrix\(([^)]+)\)/.exec(n);if(p){let[c,g,,,s,u]=p[1].split(",").map(parseFloat);r.tx=v(s),r.ty=v(u),r.rotate=v(Math.atan2(g,c)*(180/Math.PI))}return r}function se({tx:o=0,ty:e=0,rotate:t=0}){let n=[];return(o||e)&&n.push(`translate(${v(o)}px, ${v(e)}px)`),t&&n.push(`rotate(${v(t)}deg)`),n.length?n.join(" "):""}var ye={"align-bottom":`<svg preserveAspectRatio="xMidYMid meet" overflow="visible" style="display: block;" width="100%" height="100%" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
<g id="align-bottom">
...
</svg>`};function x(o){return ye[o]||""}function le(o){return i("span",{class:"fic",html:x(o)})}function Me(){return i("span",{class:"chev-mini",html:x("chevron-down")})}function f({key:o,iconName:e,value:t,unit:n="px",onChange:r,showUnit:l=!0,sm:a=!1}){let p=_(t),c=i("input",{value:p.value,type:"text",inputmode:"decimal"}),g=l?i("span",{class:"unit",text:p.unit||n}):null,s=()=>{let u=c.value.trim();if(u==="")return r("");let w=/^-?[\d.]+$/.test(u);r(w&&l?u+((g==null?void 0:g.textContent)||n):u)};if(c.addEventListener("change",s),c.addEventListener("keydown",u=>{if(u.key==="Enter")return c.blur();if(u.key==="ArrowUp"||u.key==="ArrowDown"){let w=parseFloat(c.value)||0;c.value=+(w+(u.key==="ArrowUp"?1:-1)*(u.shiftKey?10:1)).toFixed(2),s(),u.preventDefault()}}),l&&g){let u=["px","%","em","rem","vw","vh"];g.style.cursor="pointer",g.addEventListener("click",()=>{g.textContent=u[(u.indexOf(g.textContent)+1)%u.length],s()})}return i("div",{class:"field"+(a?" sm":"")},[e?le(e):o?i("span",{class:"fk",text:o}):null,c,g])}function b({value:o,options:e,onChange:t,iconName:n,key:r,sm:l=!0}){let a=i("select",{});for(let p of e){let[c,g]=Array.isArray(p)?p:[p,p],s=i("option",{value:c,text:g});String(c)===String(o)&&(s.selected=!0),a.appendChild(s)}return a.addEventListener("change",()=>t(a.value)),i("div",{class:"field select-like"+(l?" sm":"")},[n?le(n):r?i("span",{class:"fk",text:r}):null,a,Me()])}function M(o,{active:e=-1,grow:t=!1,onPick:n}={}){let r=i("div",{class:"iconrow"+(t?" grow":"")});return o.forEach((l,a)=>{let p=i("button",{class:"ibtn"+(a===e?" active":""),title:l.title||"",html:x(l.icon),onclick:()=>n==null?void 0:n(l,a,p)});r.appendChild(p)}),r}function G(o,e,{showPct:t=!0}={}){let n=q(o),r=n.hex,l=n.alpha===0?1:n.alpha,a=i("input",{type:"color",value:r}),p=i("div",{class:"swatch"},[a]);p.style.background=o&&o!=="rgba(0, 0, 0, 0)"?o:"transparent";let c=i("input",{class:"hex",value:r.replace("#","")}),g=t?i("span",{class:"pct",text:Math.round(l*100)+"%"}):null,s=u=>{let w=Q(u,l);p.style.background=w,e(w)};return a.addEventListener("input",()=>{c.value=a.value.replace("#",""),s(a.value)}),c.addEventListener("change",()=>{let u=c.value.trim().replace(/^#/,"");/^([0-9a-f]{3}|[0-9a-f]{6})$/i.test(u)?(a.value="#"+u,s("#"+u)):e(c.value.trim())}),i("div",{class:"colorline"},[p,c,g])}function V(o,e,{open:t=!0}={}){let n=i("div",{class:"sec-content"},e),r=i("div",{class:"sec-head"},[i("span",{text:o}),i("span",{class:"chev",html:x("chevron-down")})]),l=i("div",{class:"section"+(t?"":" closed")},[r,n]);return r.addEventListener("click",()=>l.classList.toggle("closed")),l}function h(o,e){return i("div",{class:"stack"},[i("span",{class:"label",text:o}),e])}function ae(o,e){let t=(s,u,w,fe)=>{let z=i("input",{class:"edge "+fe,value:_(w).value});return z.addEventListener("change",()=>{let A=z.value.trim();e(`${s}-${u}`,/^-?[\d.]+$/.test(A)?A+"px":A)}),z},n={top:"top:2px;left:50%;transform:translateX(-50%)",bottom:"bottom:2px;left:50%;transform:translateX(-50%)",left:"left:2px;top:50%;transform:translateY(-50%)",right:"right:2px;top:50%;transform:translateY(-50%)"},r=(s,u)=>(s.setAttribute("style",n[u]),s),l=["top","bottom","left","right"].map(s=>r(t("margin",s,o.margin[s],"m-"+s),s)),a={top:"top:2px;left:50%;transform:translateX(-50%)",bottom:"bottom:2px;left:50%;transform:translateX(-50%)",left:"left:2px;top:50%;transform:translateY(-50%)",right:"right:2px;top:50%;transform:translateY(-50%)"},p=["top","bottom","left","right"].map(s=>{let u=t("padding",s,o.padding[s],"p-"+s);return u.setAttribute("style",a[s]),u}),c=i("div",{class:"center-size"},[i("span",{class:"tag",text:"Size"}),i("span",{text:_(o.width||"0").value+" \xD7 "+_(o.height||"0").value})]),g=i("div",{class:"ring pad"},[i("span",{class:"tag",text:"Padding"}),...p,c]);return i("div",{class:"boxeditor"},[i("span",{class:"tag",text:"Margin"}),...l,g])}var H=class{constructor(e){this.root=e,this.el=i("div",{class:"panel","data-inspect-ui":""}),e.appendChild(this.el),this._drag()}set(e){this.selected=e,this.render()}render(){let e=d.get();this.el.classList.toggle("hidden",e.collapsed),this.el.innerHTML="",this.el.append(this._head());let t=i("div",{class:"panel-body"});this.selected?e.view==="code"?this._code(t):e.view==="html"?this._html(t):this._design(t):t.append(i("div",{class:"empty",text:"Pick an element on the page to inspect and edit its styles."})),this.el.append(t)}_head(){let e=this.selected,t=e?O(e):null,n=e?Ve(e):[];return i("div",{class:"head"},[i("div",{class:"head-top"},[i("div",{class:"head-title",text:e?K(e)||t.tag:"InspectCSS"}),i("div",{class:"head-actions"},[U("delete02","Reset all edits",()=>{P(),this.render()}),U("minimize-screen","Collapse panel",()=>d.set({collapsed:!0})),U("x","Close",()=>{var r;return(r=window.InspectCSS)==null?void 0:r.destroy()})])]),e?i("div",{class:"crumb"},n.map(r=>i("span",{text:r}))):null,e?i("div",{class:"dims"},[i("span",{html:`<b>${v(t.rect.width)}</b> x <b>${v(t.rect.height)}</b> px`}),i("span",{html:`A <b>${parseInt(t.typography.fontSize)}px</b>`})]):i("div",{class:"crumb",text:"no selection"})])}_design(e){let t=this.selected,n=O(t),r=s=>u=>C(t,s,u),l=n.transform,a=s=>{Object.assign(l,s),C(t,"transform",se(l))},p=[{icon:"align-left",title:"Align left",css:["justify-content","flex-start"]},{icon:"align-bottom",title:"Align bottom",css:["align-items","flex-end"]},{icon:"align-right",title:"Align right",css:["justify-content","flex-end"]},{icon:"align-top",title:"Align top",css:["align-items","flex-start"]},{icon:"align-horizontal-center",title:"Center horizontally",css:["justify-content","center"]},{icon:"align-vertical-center",title:"Center vertically",css:["align-items","center"]}];e.append(V("Position",[h("Alignment",M(p,{grow:!0,onPick:s=>C(t,s.css[0],s.css[1])})),h("Position",i("div",{class:"row"},[f({key:"X",value:l.tx+"px",onChange:s=>a({tx:parseFloat(s)||0})}),f({key:"Y",value:l.ty+"px",onChange:s=>a({ty:parseFloat(s)||0})})])),h("Rotation",i("div",{class:"rot-row"},[f({iconName:"rotate01",value:l.rotate+"",showUnit:!1,onChange:s=>a({rotate:parseFloat(s)||0})}),M([{icon:"image-flip-horizontal",title:"Flip horizontal"}],{grow:!0,onPick:()=>ce(t,"x")}),M([{icon:"image-flip-vertical",title:"Flip vertical"}],{grow:!0,onPick:()=>ce(t,"y")})]))])),e.append(V("Layout",[h("Size",i("div",{class:"row"},[f({key:"W",value:n.layout.width,onChange:r("width")}),f({key:"H",value:n.layout.height,onChange:r("height")})])),h("Display",b({value:n.layout.display,options:["block","inline","inline-block","flex","inline-flex","grid","none"],onChange:r("display")})),i("div",{class:"row"},[h("Row Gap",f({iconName:"paragraph-spacing",value:n.layout.rowGap,showUnit:!1,sm:!0,onChange:r("row-gap")})),h("Column Gap",f({iconName:"letter-spacing",value:n.layout.columnGap,showUnit:!1,sm:!0,onChange:r("column-gap")}))]),i("div",{class:"row"},[h("Horizontal Align",b({value:n.layout.justify,options:[["flex-start","Start"],["center","Center"],["flex-end","End"],["space-between","Between"]],onChange:r("justify-content")})),h("Vertical Align",b({value:n.layout.align,options:[["flex-start","Start"],["center","Center"],["flex-end","End"],["stretch","Stretch"]],onChange:r("align-items")}))])])),e.append(V("Spacing",[h("Padding",i("div",{class:"row"},[f({iconName:"horizontal-resize",value:n.spacing.padding.left,onChange:s=>{r("padding-left")(s),r("padding-right")(s)}}),f({iconName:"vertical-resize",value:n.spacing.padding.top,onChange:s=>{r("padding-top")(s),r("padding-bottom")(s)}})])),h("Margin",i("div",{class:"row"},[f({iconName:"horizontal-resize",value:n.spacing.margin.left,onChange:s=>{r("margin-left")(s),r("margin-right")(s)}}),f({iconName:"vertical-resize",value:n.spacing.margin.top,onChange:s=>{r("margin-top")(s),r("margin-bottom")(s)}})])),ae({...n.spacing,width:n.layout.width,height:n.layout.height},(s,u)=>C(t,s,u))]));let c=[{key:"tl",prop:"border-top-left-radius",v:n.radius.tl},{key:"tr",prop:"border-top-right-radius",v:n.radius.tr},{key:"bl",prop:"border-bottom-left-radius",v:n.radius.bl},{key:"br",prop:"border-bottom-right-radius",v:n.radius.br}],g=new Set([n.radius.tl,n.radius.tr,n.radius.bl,n.radius.br]).size>1;e.append(V("Appearance",[i("div",{class:"row"},[h("Opacity",f({iconName:"transparency",value:String(Math.round((parseFloat(n.effects.opacity)||1)*100)),unit:"%",onChange:s=>r("opacity")((parseFloat(s)||100)/100)})),h("Corner",i("div",{class:"corner-mix"},[f({iconName:"full-screen",value:g?"mix":n.radius.all,showUnit:!1,onChange:r("border-radius")}),M([{icon:"full-screen",title:"Link corners"}],{onPick:()=>r("border-radius")(n.radius.tl)})]))]),i("div",{class:"corner-grid"},c.map(s=>f({iconName:"full-screen",value:s.v,showUnit:!1,onChange:r(s.prop)}))),h("",de("Fill",()=>r("background-color")("#ffffff"))),n.background.color&&n.background.color!=="rgba(0, 0, 0, 0)"?G(n.background.color,r("background-color")):null,h("",de("Stroke",()=>{r("border-style")("solid"),r("border-width")("1px"),r("border-color")("#ffffff")})),n.border.style!=="none"?G(n.border.color,r("border-color")):null])),e.append(V("Typography",[h("Typeface",b({value:pe(n.typography.fontFamily),options:[pe(n.typography.fontFamily),"Quicksand","Inter","Arial","Georgia","system-ui","monospace"],onChange:r("font-family")})),i("div",{class:"row"},[b({value:_e(n.typography.fontWeight),options:[["300","Light"],["400","Regular"],["500","Medium"],["600","SemiBold"],["700","Bold"],["800","Extra"]],onChange:r("font-weight")}),b({value:parseInt(n.typography.fontSize)+"",options:["10","12","13","14","16","18","20","24","32","48"].map(s=>[s,s]),onChange:s=>r("font-size")(s+"px")})]),i("div",{class:"row"},[h("Line Height",f({iconName:"paragraph-spacing",value:je(n.typography.lineHeight),showUnit:!1,sm:!0,onChange:r("line-height")})),h("Letter Spacing",f({iconName:"letter-spacing",value:n.typography.letterSpacing,showUnit:!1,sm:!0,onChange:r("letter-spacing")}))]),i("div",{class:"row"},[h("Paragraph Spacing",f({iconName:"expand-paragraph",value:Le(n.typography.marginBottom),sm:!0,onChange:r("margin-bottom")})),h("Alignment",M([{icon:"text-align-right",title:"Right",css:"right"},{icon:"text-align-center",title:"Center",css:"center"},{icon:"text-align-start",title:"Left",css:"left"},{icon:"text-align-justify",title:"Justify",css:"justify"}],{grow:!0,active:["right","center","left","justify"].indexOf(n.typography.textAlign),onPick:s=>r("text-align")(s.css)}))])]))}_code(e){let t=N();e.append(i("div",{class:"view-actions"},[i("button",{class:"btn primary",text:"Copy CSS",onclick:()=>this._copy()}),i("button",{class:"btn",text:"Reset",onclick:()=>{P(),this.render()}})]),t?i("pre",{class:"code",html:Se(t)}):i("div",{class:"empty",text:"No edits yet. Change a property in the Design view and the generated CSS appears here."}))}_html(e){let t=this.selected;if(!t)return e.append(i("div",{class:"empty",text:"No element selected."}));let n=t.cloneNode(!1);n.removeAttribute("data-inspect-id"),e.append(i("pre",{class:"code",html:ue(n.outerHTML.replace(/></,`>
  \u2026
<`))}))}_copy(){var t;let e=N();e&&((t=navigator.clipboard)==null||t.writeText(e).then(()=>this._toast("CSS copied")))}_toast(e){let t=i("div",{class:"toast","data-inspect-ui":"",text:e});this.root.appendChild(t),setTimeout(()=>t.remove(),1400)}_drag(){let e,t,n,r,l=!1;this.el.addEventListener("mousedown",c=>{if(!c.target.closest(".head")||c.target.closest(".hbtn"))return;l=!0;let s=this.el.getBoundingClientRect();e=c.clientX,t=c.clientY,n=s.left,r=s.top,this.el.style.right="auto",document.addEventListener("mousemove",a,!0),document.addEventListener("mouseup",p,!0),c.preventDefault()});let a=c=>{l&&(this.el.style.left=n+(c.clientX-e)+"px",this.el.style.top=Math.max(0,r+(c.clientY-t))+"px")},p=()=>{l=!1,document.removeEventListener("mousemove",a,!0),document.removeEventListener("mouseup",p,!0)}}};function U(o,e,t){return i("button",{class:"hbtn",title:e,onclick:t,html:x(o)})}function de(o,e){return i("div",{class:"addrow"},[i("span",{class:"k",text:o}),i("button",{class:"addbtn",title:"Add "+o,html:x("plus"),onclick:e})])}function Ve(o){let e=[],t=o,n=0;for(;t&&t.nodeType===1&&t!==document.documentElement&&n<3;)t.classList.length?e.unshift("."+t.classList[0]):e.unshift(t.tagName.toLowerCase()),t=t.parentElement,n++;return e}function ce(o,e){let t=getComputedStyle(o),n=t.transform==="none"?"":t.transform+" ";C(o,"transform",n+(e==="x"?"scaleX(-1)":"scaleY(-1)"))}function pe(o){return(o||"").split(",")[0].replace(/["']/g,"").trim()||"system-ui"}function _e(o){return String(o)}function je(o){return o==="normal"?"1.4":o}function Le(o){return o&&o!=="auto"?o:"0px"}function ue(o){return o.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function Se(o){return ue(o).replace(/^([^{\n]+)\{/gm,'<span class="sel">$1</span>{').replace(/^(\s+)([\w-]+)(:)/gm,'$1<span class="prop">$2</span>$3').replace(/: ([^;]+);/g,': <span class="val">$1</span>;')}var E=class{constructor(e,t){this.api=t,this.el=i("div",{class:"dock","data-inspect-ui":""}),e.appendChild(this.el),this.render(),d.subscribe(()=>this.sync())}render(){this.el.innerHTML="",this.pauseBtn=he("pause","Pause / resume picking",()=>d.set({active:!d.get().active}));let e=i("div",{class:"dock-group"},[k("undo-03","Undo",()=>{var n,r;return(r=(n=this.api).undo)==null?void 0:r.call(n)}),k("redo-01","Redo",()=>{var n,r;return(r=(n=this.api).redo)==null?void 0:r.call(n)}),X(),k("layer-bring-forward","Bring forward",()=>{var n,r;return(r=(n=this.api).bump)==null?void 0:r.call(n,1)}),k("layer-send-backward","Send backward",()=>{var n,r;return(r=(n=this.api).bump)==null?void 0:r.call(n,-1)}),X(),this.designBtn=k("component","Design",()=>d.set({view:"design",collapsed:!1})),this.codeBtn=k("file-diff","Generated CSS",()=>d.set({view:"code",collapsed:!1})),this.htmlBtn=k("html-file-01","HTML",()=>d.set({view:"html",collapsed:!1})),X(),k("laptop-phone-sync","Toggle responsive preview",()=>{var n,r;return(r=(n=this.api).toggleResponsive)==null?void 0:r.call(n)})]),t=he("cancel-01","Exit InspectCSS",()=>{var n;return(n=window.InspectCSS)==null?void 0:n.destroy()});this.el.append(this.pauseBtn,e,t),this.sync()}sync(){var t,n,r,l;let e=d.get();(t=this.pauseBtn)==null||t.classList.toggle("active",e.active),(n=this.designBtn)==null||n.classList.toggle("active",e.view==="design"),(r=this.codeBtn)==null||r.classList.toggle("active",e.view==="code"),(l=this.htmlBtn)==null||l.classList.toggle("active",e.view==="html")}};function he(o,e,t){return i("button",{class:"dock-circle",title:e,onclick:t,html:x(o)})}function k(o,e,t){return i("button",{class:"dock-btn",title:e,onclick:t,html:x(o)})}function X(){return i("div",{class:"dock-sep"})}var ge=`
