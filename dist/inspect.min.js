(()=>{var K={active:!1,hoverEl:null,selectedEl:null,pseudo:"none",view:"design",edits:new Map,panelPos:{x:null,y:16},collapsed:!1},S=new Set,d={get:()=>K,set(o){Object.assign(K,o),S.forEach(e=>e(K))},subscribe(o){return S.add(o),()=>S.delete(o)}};var me=0,U="data-inspect-id";function O(o){let e=o.getAttribute(U);return e||(e="ic-"+ ++me,o.setAttribute(U,e)),e}function Q(o){return`[${U}="${o}"]`}function v(o,e=2){if(o==null||Number.isNaN(o))return 0;let t=Math.pow(10,e);return Math.round(o*t)/t}function i(o,e={},t=[]){let r=document.createElement(o);for(let[n,l]of Object.entries(e))n==="class"?r.className=l:n==="style"&&typeof l=="object"?Object.assign(r.style,l):n==="html"?r.innerHTML=l:n==="text"?r.textContent=l:n.startsWith("on")&&typeof l=="function"?r.addEventListener(n.slice(2).toLowerCase(),l):l!==!1&&l!=null&&r.setAttribute(n,l===!0?"":l);for(let n of[].concat(t))n==null||n===!1||r.appendChild(typeof n=="string"?document.createTextNode(n):n);return r}function W(o){if(!o||o.nodeType!==1)return"";let e=o.tagName.toLowerCase();return o.id?e+="#"+o.id:o.classList.length&&(e+="."+o.classList[0]),e}function A(o){if(o==null)return{value:0,unit:"px"};let e=String(o).trim().match(/^(-?[\d.]+)\s*([a-z%]*)$/i);return e?{value:parseFloat(e[1]),unit:e[2]||"px"}:{value:o,unit:""}}function J(o){if(!o)return{hex:"#000000",alpha:1};if(o.startsWith("#"))return{hex:o,alpha:1};let e=o.match(/rgba?\(([^)]+)\)/i);if(!e)return{hex:"#000000",alpha:1};let t=e[1].split(",").map(c=>c.trim()),[r,n,l]=t.map(c=>parseInt(c,10)),a=t[3]!=null?parseFloat(t[3]):1;return{hex:"#"+[r,n,l].map(c=>Math.max(0,Math.min(255,c||0)).toString(16).padStart(2,"0")).join(""),alpha:a}}function _(o,e=1){let t=o.replace("#",""),r=t.length===3?t.split("").map(p=>p+p).join(""):t.padEnd(6,"0"),n=parseInt(r.slice(0,2),16),l=parseInt(r.slice(2,4),16),a=parseInt(r.slice(4,6),16);return e>=1?`rgb(${n}, ${l}, ${a})`:`rgba(${n}, ${l}, ${a}, ${v(e,3)})`}function B(o){return!!(o&&o.closest&&o.closest("[data-inspect-ui]"))}var j=class{constructor(e){this.el=i("div",{"data-inspect-ui":"",style:{position:"fixed",inset:"0",pointerEvents:"none",zIndex:"2147483646"}}),this.margin=this._box("rgba(246, 178, 107, 0.28)"),this.padding=this._box("rgba(147, 196, 125, 0.30)"),this.content=i("div",{style:this._boxStyle("transparent","#4c8dff")}),this.selected=i("div",{style:this._boxStyle("transparent","#7c5cff")}),this.badge=i("div",{"data-inspect-ui":"",style:{position:"fixed",font:"600 11px/1.4 ui-monospace, SFMono-Regular, Menlo, monospace",color:"#fff",background:"#4c8dff",padding:"2px 6px",borderRadius:"4px",whiteSpace:"nowrap",pointerEvents:"none",boxShadow:"0 1px 4px rgba(0,0,0,.3)"}}),this.el.append(this.margin,this.padding,this.content,this.selected,this.badge),e.appendChild(this.el),this.hideHover(),this.hideSelected()}_box(e){return i("div",{style:{position:"fixed",background:e,pointerEvents:"none"}})}_boxStyle(e,t){return{position:"fixed",background:e,outline:`1px solid ${t}`,outlineOffset:"-1px",pointerEvents:"none"}}_place(e,t){Object.assign(e.style,{left:t.left+"px",top:t.top+"px",width:Math.max(0,t.width)+"px",height:Math.max(0,t.height)+"px",display:"block"})}highlight(e){if(!e)return this.hideHover();let t=getComputedStyle(e),r=e.getBoundingClientRect(),n=$(t,"margin"),l=$(t,"padding");this._place(this.margin,{left:r.left-n.left,top:r.top-n.top,width:r.width+n.left+n.right,height:r.height+n.top+n.bottom}),this._place(this.content,r),this._place(this.padding,r),this.badge.textContent=`${v(r.width)} \xD7 ${v(r.height)}`,this.badge.style.display="block";let a=r.top>24?r.top-22:r.bottom+6;this.badge.style.left=Math.max(4,r.left)+"px",this.badge.style.top=a+"px"}select(e){if(!e)return this.hideSelected();this._place(this.selected,e.getBoundingClientRect())}hideHover(){[this.margin,this.padding,this.content,this.badge].forEach(e=>e.style.display="none")}hideSelected(){this.selected.style.display="none"}destroy(){this.el.remove()}};function $(o,e){let t=r=>parseFloat(o.getPropertyValue(`${e}-${r}`))||0;return{top:t("top"),right:t("right"),bottom:t("bottom"),left:t("left")}}var L=class{constructor(e,t){this.overlay=e,this.onSelect=t,this._onMove=this._onMove.bind(this),this._onClick=this._onClick.bind(this),this._onKey=this._onKey.bind(this),this._onScroll=this._onScroll.bind(this)}start(){document.addEventListener("mousemove",this._onMove,!0),document.addEventListener("click",this._onClick,!0),document.addEventListener("keydown",this._onKey,!0),window.addEventListener("scroll",this._onScroll,!0),window.addEventListener("resize",this._onScroll,!0),document.documentElement.style.cursor="crosshair"}stop(){document.removeEventListener("mousemove",this._onMove,!0),document.removeEventListener("click",this._onClick,!0),document.removeEventListener("keydown",this._onKey,!0),window.removeEventListener("scroll",this._onScroll,!0),window.removeEventListener("resize",this._onScroll,!0),document.documentElement.style.cursor="",this.overlay.hideHover(),d.set({hoverEl:null})}_target(e){let t=document.elementFromPoint(e.clientX,e.clientY);return!t||B(t)||t===document.documentElement||t===document.body?null:t}_onMove(e){let t=this._target(e);if(!t)return this.overlay.hideHover();t!==d.get().hoverEl&&(d.set({hoverEl:t}),this.overlay.highlight(t))}_onClick(e){if(B(e.target))return;let t=this._target(e);t&&(e.preventDefault(),e.stopPropagation(),this.onSelect(t))}_onKey(e){e.key==="Escape"&&(e.preventDefault(),d.set({active:!1}))}_onScroll(){let{hoverEl:e,selectedEl:t}=d.get();e&&this.overlay.highlight(e),t&&this.overlay.select(t)}};function xe(o){return o&&!/[^a-zA-Z0-9_-]/.test(o)&&!/^(is-|has-|js-)/.test(o)?!0:o&&!/[^a-zA-Z0-9_-]/.test(o)}function Ce(o){let e=1,t=o;for(;t=t.previousElementSibling;)t.tagName===o.tagName&&e++;return e}function we(o){let e=o.tagName.toLowerCase();if(o.id&&document.querySelectorAll("#"+CSS.escape(o.id)).length===1)return"#"+o.id;let t=Array.from(o.classList).filter(xe).slice(0,2);return t.length?e+"."+t.map(n=>n).join("."):`${e}:nth-of-type(${Ce(o)})`}function ee(o,e=4){if(!o||o.nodeType!==1)return"";let t=[],r=o;for(;r&&r.nodeType===1&&r!==document.documentElement;){let n=we(r);if(t.unshift(n),n.startsWith("#"))break;try{if(document.querySelectorAll(t.join(" > ")).length===1)break}catch{}if(r=r.parentElement,t.length>=e)break}return t.join(" > ")}var te="inspect-css-live-styles";function ke(){let o=document.getElementById(te);return o||(o=document.createElement("style"),o.id=te,o.setAttribute("data-inspect-ui",""),document.head.appendChild(o)),o}var y=[],z=[];function P(){let{edits:o}=d.get();return[...o.entries()].map(([e,t])=>[e,{inspectId:t.inspectId,pseudo:t.pseudo,selector:t.selector,props:[...t.props.entries()]}])}function oe(o){let e=new Map;for(let[t,r]of o)e.set(t,{inspectId:r.inspectId,pseudo:r.pseudo,selector:r.selector,props:new Map(r.props)});d.get().edits=e,R(),d.set({edits:e})}function be(){y.push(P()),y.length>100&&y.shift(),z.length=0}function re(){y.length&&(z.push(P()),oe(y.pop()))}function ne(){z.length&&(y.push(P()),oe(z.pop()))}function C(o,e,t){be();let r=O(o),{edits:n,pseudo:l}=d.get(),a=l==="none"?r:`${r}::${l}`,p=n.get(a);p||(p={inspectId:r,pseudo:l,selector:ee(o),props:new Map},n.set(a,p)),t===""||t==null?p.props.delete(e):p.props.set(e,t),p.props.size===0&&n.delete(a),R(),d.set({edits:n})}function N(o,e="none"){let t=o.getAttribute("data-inspect-id");if(!t)return new Map;let r=e==="none"?t:`${t}::${e}`,n=d.get().edits.get(r);return n?n.props:new Map}function R(){let{edits:o}=d.get(),e=[];for(let t of o.values()){if(t.props.size===0)continue;let r=Q(t.inspectId)+(t.pseudo!=="none"?":"+t.pseudo:""),n=[...t.props.entries()].map(([l,a])=>`  ${l}: ${a} !important;`).join(`
`);e.push(`${r} {
${n}
}`)}ke().textContent=e.join(`

`)}function Y(){let{edits:o}=d.get(),e=[];for(let t of o.values()){if(t.props.size===0)continue;let r=(t.selector||Q(t.inspectId))+(t.pseudo!=="none"?":"+t.pseudo:""),n=[...t.props.entries()].map(([l,a])=>`  ${l}: ${a};`).join(`
`);e.push(`${r} {
${n}
}`)}return e.join(`

`)}function q(){d.get().edits.clear(),R(),d.set({edits:d.get().edits})}function m(o,e,t,r=t){let n=N(o,d.get().pseudo).get(t);return n!=null?n:e.getPropertyValue(r).trim()}function G(o){let e=getComputedStyle(o),t=o.getBoundingClientRect();return{rect:t,tag:o.tagName.toLowerCase(),layout:{display:m(o,e,"display"),position:m(o,e,"position"),width:e.width,height:e.height,x:v(t.left+window.scrollX),y:v(t.top+window.scrollY),rowGap:e.rowGap==="normal"?"0":e.rowGap,columnGap:e.columnGap==="normal"?"0":e.columnGap,justify:m(o,e,"justify-content"),align:m(o,e,"align-items")},transform:ye(o,e),spacing:{margin:ie(e,"margin"),padding:ie(e,"padding")},radius:{all:m(o,e,"border-radius"),tl:e.borderTopLeftRadius,tr:e.borderTopRightRadius,br:e.borderBottomRightRadius,bl:e.borderBottomLeftRadius},typography:{fontFamily:e.fontFamily,fontSize:m(o,e,"font-size"),fontWeight:m(o,e,"font-weight"),lineHeight:e.lineHeight,letterSpacing:e.letterSpacing==="normal"?"0px":e.letterSpacing,textAlign:m(o,e,"text-align"),color:m(o,e,"color"),marginBottom:m(o,e,"margin-bottom")},background:{color:m(o,e,"background-color"),image:e.backgroundImage},border:{width:e.borderTopWidth,style:e.borderTopStyle,color:e.borderTopColor},effects:{opacity:m(o,e,"opacity"),boxShadow:e.boxShadow==="none"?"":e.boxShadow}}}function ie(o,e){return{top:o.getPropertyValue(`${e}-top`),right:o.getPropertyValue(`${e}-right`),bottom:o.getPropertyValue(`${e}-bottom`),left:o.getPropertyValue(`${e}-left`)}}function ye(o,e){let r=N(o,d.get().pseudo).get("transform")||e.transform,n={tx:0,ty:0,rotate:0};if(!r||r==="none")return n;let l=/translate\(\s*(-?[\d.]+)px\s*,\s*(-?[\d.]+)px\s*\)/.exec(r),a=/rotate\(\s*(-?[\d.]+)deg\s*\)/.exec(r);if(l&&(n.tx=parseFloat(l[1]),n.ty=parseFloat(l[2])),a&&(n.rotate=parseFloat(a[1])),l||a)return n;let p=/matrix\(([^)]+)\)/.exec(r);if(p){let[c,g,,,s,u]=p[1].split(",").map(parseFloat);n.tx=v(s),n.ty=v(u),n.rotate=v(Math.atan2(g,c)*(180/Math.PI))}return n}function se({tx:o=0,ty:e=0,rotate:t=0}){let r=[];return(o||e)&&r.push(`translate(${v(o)}px, ${v(e)}px)`),t&&r.push(`rotate(${v(t)}deg)`),r.length?r.join(" "):""}var Me={"align-bottom":`<svg preserveAspectRatio="xMidYMid meet" overflow="visible" style="display: block;" width="100%" height="100%" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
<g id="align-bottom">
...
</svg>`};function x(o){return Me[o]||""}function le(o){return i("span",{class:"fic",html:x(o)})}function Ve(){return i("span",{class:"chev-mini",html:x("chevron-down")})}function f({key:o,iconName:e,value:t,unit:r="px",onChange:n,showUnit:l=!0,sm:a=!1}){let p=A(t),c=i("input",{value:p.value,type:"text",inputmode:"decimal"}),g=l?i("span",{class:"unit",text:p.unit||r}):null,s=()=>{let u=c.value.trim();if(u==="")return n("");let w=/^-?[\d.]+$/.test(u);n(w&&l?u+((g==null?void 0:g.textContent)||r):u)};if(c.addEventListener("change",s),c.addEventListener("keydown",u=>{if(u.key==="Enter")return c.blur();if(u.key==="ArrowUp"||u.key==="ArrowDown"){let w=parseFloat(c.value)||0;c.value=+(w+(u.key==="ArrowUp"?1:-1)*(u.shiftKey?10:1)).toFixed(2),s(),u.preventDefault()}}),l&&g){let u=["px","%","em","rem","vw","vh"];g.style.cursor="pointer",g.addEventListener("click",()=>{g.textContent=u[(u.indexOf(g.textContent)+1)%u.length],s()})}return i("div",{class:"field"+(a?" sm":"")},[e?le(e):o?i("span",{class:"fk",text:o}):null,c,g])}function b({value:o,options:e,onChange:t,iconName:r,key:n,sm:l=!0}){let a=i("select",{});for(let p of e){let[c,g]=Array.isArray(p)?p:[p,p],s=i("option",{value:c,text:g});String(c)===String(o)&&(s.selected=!0),a.appendChild(s)}return a.addEventListener("change",()=>t(a.value)),i("div",{class:"field select-like"+(l?" sm":"")},[r?le(r):n?i("span",{class:"fk",text:n}):null,a,Ve()])}function M(o,{active:e=-1,grow:t=!1,onPick:r}={}){let n=i("div",{class:"iconrow"+(t?" grow":"")});return o.forEach((l,a)=>{let p=i("button",{class:"ibtn"+(a===e?" active":""),title:l.title||"",html:x(l.icon),onclick:()=>r==null?void 0:r(l,a,p)});n.appendChild(p)}),n}function T(o,e,{showPct:t=!0}={}){let r=J(o),n=r.hex,l=r.alpha===0?1:r.alpha,a=i("input",{type:"color",value:n}),p=i("div",{class:"swatch"},[a]);p.style.background=o&&o!=="rgba(0, 0, 0, 0)"?o:"transparent";let c=i("input",{class:"hex",value:n.replace("#","")}),g=t?i("span",{class:"pct",text:Math.round(l*100)+"%"}):null,s=u=>{let w=_(u,l);p.style.background=w,e(w)};return a.addEventListener("input",()=>{c.value=a.value.replace("#",""),s(a.value)}),c.addEventListener("change",()=>{let u=c.value.trim().replace(/^#/,"");/^([0-9a-f]{3}|[0-9a-f]{6})$/i.test(u)?(a.value="#"+u,s("#"+u)):e(c.value.trim())}),i("div",{class:"colorline"},[p,c,g])}function V(o,e,{open:t=!0}={}){let r=i("div",{class:"sec-content"},e),n=i("div",{class:"sec-head"},[i("span",{text:o}),i("span",{class:"chev",html:x("chevron-down")})]),l=i("div",{class:"section"+(t?"":" closed")},[n,r]);return n.addEventListener("click",()=>l.classList.toggle("closed")),l}function h(o,e){return i("div",{class:"stack"},[i("span",{class:"label",text:o}),e])}function ae(o,e){let t=(s,u,w,ve)=>{let H=i("input",{class:"edge "+ve,value:A(w).value});return H.addEventListener("change",()=>{let Z=H.value.trim();e(`${s}-${u}`,/^-?[\d.]+$/.test(Z)?Z+"px":Z)}),H},r={top:"top:2px;left:50%;transform:translateX(-50%)",bottom:"bottom:2px;left:50%;transform:translateX(-50%)",left:"left:2px;top:50%;transform:translateY(-50%)",right:"right:2px;top:50%;transform:translateY(-50%)"},n=(s,u)=>(s.setAttribute("style",r[u]),s),l=["top","bottom","left","right"].map(s=>n(t("margin",s,o.margin[s],"m-"+s),s)),a={top:"top:2px;left:50%;transform:translateX(-50%)",bottom:"bottom:2px;left:50%;transform:translateX(-50%)",left:"left:2px;top:50%;transform:translateY(-50%)",right:"right:2px;top:50%;transform:translateY(-50%)"},p=["top","bottom","left","right"].map(s=>{let u=t("padding",s,o.padding[s],"p-"+s);return u.setAttribute("style",a[s]),u}),c=i("div",{class:"center-size"},[i("span",{class:"tag",text:"Size"}),i("span",{text:A(o.width||"0").value+" \xD7 "+A(o.height||"0").value})]),g=i("div",{class:"ring pad"},[i("span",{class:"tag",text:"Padding"}),...p,c]);return i("div",{class:"boxeditor"},[i("span",{class:"tag",text:"Margin"}),...l,g])}var E=class{constructor(e){this.root=e,this.el=i("div",{class:"panel","data-inspect-ui":""}),e.appendChild(this.el),this._drag()}set(e){this.selected=e,this.render()}render(){let e=d.get();this.el.classList.toggle("hidden",e.collapsed),this.el.innerHTML="",this.el.append(this._head());let t=i("div",{class:"panel-body"});this.selected?e.view==="code"?this._code(t):e.view==="html"?this._html(t):this._design(t):t.append(i("div",{class:"empty",text:"Pick an element on the page to inspect and edit its styles."})),this.el.append(t)}_head(){let e=this.selected,t=e?G(e):null,r=e?Ae(e):[];return i("div",{class:"head"},[i("div",{class:"head-top"},[i("div",{class:"head-title",text:e?W(e)||t.tag:"InspectCSS"}),i("div",{class:"head-actions"},[X("delete02","Reset all edits",()=>{q(),this.render()},"danger"),X("minimize-screen","Collapse panel",()=>d.set({collapsed:!0})),X("x","Close",()=>{var n;return(n=window.InspectCSS)==null?void 0:n.destroy()})])]),e?i("div",{class:"crumb"},r.map(n=>i("span",{text:n}))):null,e?i("div",{class:"dims"},[i("span",{html:`<b>${v(t.rect.width)}</b> x <b>${v(t.rect.height)}</b> px`}),i("span",{html:`A <b>${parseInt(t.typography.fontSize)}px</b>`})]):i("div",{class:"crumb",text:"no selection"})])}_design(e){let t=this.selected,r=G(t),n=s=>u=>C(t,s,u),l=r.transform,a=s=>{Object.assign(l,s),C(t,"transform",se(l))},p=[{icon:"align-left",title:"Align left",css:["justify-content","flex-start"]},{icon:"align-bottom",title:"Align bottom",css:["align-items","flex-end"]},{icon:"align-right",title:"Align right",css:["justify-content","flex-end"]},{icon:"align-top",title:"Align top",css:["align-items","flex-start"]},{icon:"align-horizontal-center",title:"Center horizontally",css:["justify-content","center"]},{icon:"align-vertical-center",title:"Center vertically",css:["align-items","center"]}];e.append(V("Position",[h("Alignment",M(p,{grow:!0,onPick:s=>C(t,s.css[0],s.css[1])})),h("Position",i("div",{class:"row"},[f({key:"X",value:l.tx+"px",onChange:s=>a({tx:parseFloat(s)||0})}),f({key:"Y",value:l.ty+"px",onChange:s=>a({ty:parseFloat(s)||0})})])),h("Rotation",i("div",{class:"rot-row"},[f({iconName:"rotate01",value:l.rotate+"",showUnit:!1,onChange:s=>a({rotate:parseFloat(s)||0})}),M([{icon:"image-flip-horizontal",title:"Flip horizontal"}],{grow:!0,onPick:()=>ce(t,"x")}),M([{icon:"image-flip-vertical",title:"Flip vertical"}],{grow:!0,onPick:()=>ce(t,"y")})]))])),e.append(V("Layout",[h("Size",i("div",{class:"row"},[f({key:"W",value:r.layout.width,onChange:n("width")}),f({key:"H",value:r.layout.height,onChange:n("height")})])),h("Display",b({value:r.layout.display,options:["block","inline","inline-block","flex","inline-flex","grid","none"],onChange:n("display")})),i("div",{class:"row"},[h("Row Gap",f({iconName:"paragraph-spacing",value:r.layout.rowGap,showUnit:!1,sm:!0,onChange:n("row-gap")})),h("Column Gap",f({iconName:"letter-spacing",value:r.layout.columnGap,showUnit:!1,sm:!0,onChange:n("column-gap")}))]),i("div",{class:"row"},[h("Horizontal Align",b({value:r.layout.justify,options:[["flex-start","Start"],["center","Center"],["flex-end","End"],["space-between","Between"]],onChange:n("justify-content")})),h("Vertical Align",b({value:r.layout.align,options:[["flex-start","Start"],["center","Center"],["flex-end","End"],["stretch","Stretch"]],onChange:n("align-items")}))])])),e.append(V("Spacing",[h("Padding",i("div",{class:"row"},[f({iconName:"horizontal-resize",value:r.spacing.padding.left,onChange:s=>{n("padding-left")(s),n("padding-right")(s)}}),f({iconName:"vertical-resize",value:r.spacing.padding.top,onChange:s=>{n("padding-top")(s),n("padding-bottom")(s)}})])),h("Margin",i("div",{class:"row"},[f({iconName:"horizontal-resize",value:r.spacing.margin.left,onChange:s=>{n("margin-left")(s),n("margin-right")(s)}}),f({iconName:"vertical-resize",value:r.spacing.margin.top,onChange:s=>{n("margin-top")(s),n("margin-bottom")(s)}})])),ae({...r.spacing,width:r.layout.width,height:r.layout.height},(s,u)=>C(t,s,u))]));let c=[{key:"tl",prop:"border-top-left-radius",v:r.radius.tl},{key:"tr",prop:"border-top-right-radius",v:r.radius.tr},{key:"bl",prop:"border-bottom-left-radius",v:r.radius.bl},{key:"br",prop:"border-bottom-right-radius",v:r.radius.br}],g=new Set([r.radius.tl,r.radius.tr,r.radius.bl,r.radius.br]).size>1;e.append(V("Appearance",[i("div",{class:"row"},[h("Opacity",f({iconName:"transparency",value:String(Math.round((parseFloat(r.effects.opacity)||1)*100)),unit:"%",onChange:s=>n("opacity")((parseFloat(s)||100)/100)})),h("Corner",i("div",{class:"corner-mix"},[f({iconName:"full-screen",value:g?"mix":r.radius.all,showUnit:!1,onChange:n("border-radius")}),M([{icon:"full-screen",title:"Link corners"}],{onPick:()=>n("border-radius")(r.radius.tl)})]))]),i("div",{class:"corner-grid"},c.map(s=>f({iconName:"full-screen",value:s.v,showUnit:!1,onChange:n(s.prop)}))),h("",de("Fill",()=>n("background-color")("#ffffff"))),r.background.color&&r.background.color!=="rgba(0, 0, 0, 0)"?T(r.background.color,n("background-color")):null,h("",de("Stroke",()=>{n("border-style")("solid"),n("border-width")("1px"),n("border-color")("#ffffff")})),r.border.style!=="none"?T(r.border.color,n("border-color")):null])),e.append(V("Typography",[h("Typeface",b({value:pe(r.typography.fontFamily),options:[pe(r.typography.fontFamily),"Quicksand","Inter","Arial","Georgia","system-ui","monospace"],onChange:n("font-family")})),i("div",{class:"row"},[b({value:je(r.typography.fontWeight),options:[["300","Light"],["400","Regular"],["500","Medium"],["600","SemiBold"],["700","Bold"],["800","Extra"]],onChange:n("font-weight")}),b({value:parseInt(r.typography.fontSize)+"",options:["10","12","13","14","16","18","20","24","32","48"].map(s=>[s,s]),onChange:s=>n("font-size")(s+"px")})]),i("div",{class:"row"},[h("Line Height",f({iconName:"paragraph-spacing",value:Le(r.typography.lineHeight),showUnit:!1,sm:!0,onChange:n("line-height")})),h("Letter Spacing",f({iconName:"letter-spacing",value:r.typography.letterSpacing,showUnit:!1,sm:!0,onChange:n("letter-spacing")}))]),i("div",{class:"row"},[h("Paragraph Spacing",f({iconName:"expand-paragraph",value:ze(r.typography.marginBottom),sm:!0,onChange:n("margin-bottom")})),h("Alignment",M([{icon:"text-align-right",title:"Right",css:"right"},{icon:"text-align-center",title:"Center",css:"center"},{icon:"text-align-start",title:"Left",css:"left"},{icon:"text-align-justify",title:"Justify",css:"justify"}],{grow:!0,active:["right","center","left","justify"].indexOf(r.typography.textAlign),onPick:s=>n("text-align")(s.css)}))])]))}_code(e){let t=Y();e.append(i("div",{class:"view-actions"},[i("button",{class:"btn primary",text:"Copy CSS",onclick:()=>this._copy()}),i("button",{class:"btn",text:"Reset",onclick:()=>{q(),this.render()}})]),t?i("pre",{class:"code",html:Ee(t)}):i("div",{class:"empty",text:"No edits yet. Change a property in the Design view and the generated CSS appears here."}))}_html(e){let t=this.selected;if(!t)return e.append(i("div",{class:"empty",text:"No element selected."}));let r=t.cloneNode(!1);r.removeAttribute("data-inspect-id"),e.append(i("pre",{class:"code",html:ue(r.outerHTML.replace(/></,`>
  \u2026
<`))}))}_copy(){var t;let e=Y();e&&((t=navigator.clipboard)==null||t.writeText(e).then(()=>this._toast("CSS copied")))}_toast(e){let t=i("div",{class:"toast","data-inspect-ui":"",text:e});this.root.appendChild(t),setTimeout(()=>t.remove(),1400)}_drag(){let e,t,r,n,l=!1;this.el.addEventListener("mousedown",c=>{if(!c.target.closest(".head")||c.target.closest(".hbtn"))return;l=!0;let s=this.el.getBoundingClientRect();e=c.clientX,t=c.clientY,r=s.left,n=s.top,this.el.style.right="auto",document.addEventListener("mousemove",a,!0),document.addEventListener("mouseup",p,!0),c.preventDefault()});let a=c=>{l&&(this.el.style.left=r+(c.clientX-e)+"px",this.el.style.top=Math.max(0,n+(c.clientY-t))+"px")},p=()=>{l=!1,document.removeEventListener("mousemove",a,!0),document.removeEventListener("mouseup",p,!0)}}};function X(o,e,t,r=""){return i("button",{class:"hbtn"+(r?" "+r:""),title:e,onclick:t,html:x(o)})}function de(o,e){return i("div",{class:"addrow"},[i("span",{class:"k",text:o}),i("button",{class:"addbtn",title:"Add "+o,html:x("plus"),onclick:e})])}function Ae(o){let e=[],t=o,r=0;for(;t&&t.nodeType===1&&t!==document.documentElement&&r<3;)t.classList.length?e.unshift("."+t.classList[0]):e.unshift(t.tagName.toLowerCase()),t=t.parentElement,r++;return e}function ce(o,e){let t=getComputedStyle(o),r=t.transform==="none"?"":t.transform+" ";C(o,"transform",r+(e==="x"?"scaleX(-1)":"scaleY(-1)"))}function pe(o){return(o||"").split(",")[0].replace(/["']/g,"").trim()||"system-ui"}function je(o){return String(o)}function Le(o){return o==="normal"?"1.4":o}function ze(o){return o&&o!=="auto"?o:"0px"}function ue(o){return o.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function Ee(o){return ue(o).replace(/^([^{\n]+)\{/gm,'<span class="sel">$1</span>{').replace(/^(\s+)([\w-]+)(:)/gm,'$1<span class="prop">$2</span>$3').replace(/: ([^;]+);/g,': <span class="val">$1</span>;')}var I=class{constructor(e,t){this.api=t,this.el=i("div",{class:"dock","data-inspect-ui":""}),e.appendChild(this.el),this.render(),d.subscribe(()=>this.sync())}render(){this.el.innerHTML="",this.pauseBtn=he("pause","Pause / resume picking",()=>d.set({active:!d.get().active}));let e=i("div",{class:"dock-group"},[k("undo-03","Undo",()=>{var r,n;return(n=(r=this.api).undo)==null?void 0:n.call(r)}),k("redo-01","Redo",()=>{var r,n;return(n=(r=this.api).redo)==null?void 0:n.call(r)}),D(),k("layer-bring-forward","Bring forward",()=>{var r,n;return(n=(r=this.api).bump)==null?void 0:n.call(r,1)}),k("layer-send-backward","Send backward",()=>{var r,n;return(n=(r=this.api).bump)==null?void 0:n.call(r,-1)}),D(),this.designBtn=k("component","Design",()=>d.set({view:"design",collapsed:!1})),this.codeBtn=k("file-diff","Generated CSS",()=>d.set({view:"code",collapsed:!1})),this.htmlBtn=k("html-file-01","HTML",()=>d.set({view:"html",collapsed:!1})),D(),k("laptop-phone-sync","Toggle responsive preview",()=>{var r,n;return(n=(r=this.api).toggleResponsive)==null?void 0:n.call(r)})]),t=he("cancel-01","Exit InspectCSS",()=>{var r;return(r=window.InspectCSS)==null?void 0:r.destroy()});this.el.append(this.pauseBtn,e,t),this.sync()}sync(){var t,r,n,l;let e=d.get();(t=this.pauseBtn)==null||t.classList.toggle("active",e.active),(r=this.designBtn)==null||r.classList.toggle("active",e.view==="design"),(n=this.codeBtn)==null||n.classList.toggle("active",e.view==="code"),(l=this.htmlBtn)==null||l.classList.toggle("active",e.view==="html")}};function he(o,e,t){return i("button",{class:"dock-circle",title:e,onclick:t,html:x(o)})}function k(o,e,t){return i("button",{class:"dock-btn",title:e,onclick:t,html:x(o)})}function D(){return i("div",{class:"dock-sep"})}var ge=`@font-face {
...
`;var F=class{constructor(){this.host=document.createElement("div"),this.host.setAttribute("data-inspect-ui",""),this.host.style.cssText="all: initial; position: static;";let e=this.host.attachShadow({mode:"open"}),t=document.createElement("style");t.textContent=fe;let r=document.createElement("div");r.className="wrap",e.append(t,r),document.documentElement.appendChild(this.host),this.overlay=new j(document.documentElement),this.panel=new E(r),this.toolbar=new I(r,{undo:()=>{re(),this.panel.render()},redo:()=>{ne(),this.panel.render()},bump:n=>this.bumpZ(n),toggleResponsive:()=>this.toggleResponsive()}),this.inspector=new L(this.overlay,n=>this.select(n)),this._prevView=d.get().view,this._prevCollapsed=d.get().collapsed,this.unsub=d.subscribe(n=>this.onState(n)),this._track=()=>{this._raf||(this._raf=requestAnimationFrame(()=>{this._raf=0;let n=d.get();n.hoverEl&&this.overlay.highlight(n.hoverEl),n.selectedEl&&this.overlay.select(n.selectedEl)}))},window.addEventListener("scroll",this._track,!0),window.addEventListener("resize",this._track,!0),d.set({active:!0}),this.panel.render()}select(e){d.set({selectedEl:e,active:!1}),this.overlay.select(e),this.panel.set(e)}bumpZ(e){let t=d.get().selectedEl;if(!t)return;let r=parseInt(getComputedStyle(t).zIndex)||0;C(t,"position",getComputedStyle(t).position==="static"?"relative":getComputedStyle(t).position),C(t,"z-index",String(r+e)),this.panel.render()}toggleResponsive(){this._resp=!this._resp;let e=document.documentElement;this._resp?(e.style.maxWidth="420px",e.style.margin="0 auto",e.style.transition="max-width .2s"):(e.style.maxWidth="",e.style.margin="");let t=d.get();t.selectedEl&&this.overlay.select(t.selectedEl)}onState(e){e.active&&!this._picking?(this._picking=!0,this.inspector.start()):!e.active&&this._picking&&(this._picking=!1,this.inspector.stop()),e.selectedEl&&this.overlay.select(e.selectedEl),(e.view!==this._prevView||e.collapsed!==this._prevCollapsed)&&(this._prevView=e.view,this._prevCollapsed=e.collapsed,this.panel.render())}destroy(){var t;(t=this.unsub)==null||t.call(this),window.removeEventListener("scroll",this._track,!0),window.removeEventListener("resize",this._track,!0),this.inspector.stop(),this.overlay.destroy(),this.host.remove(),this.toggleResponsiveOff();let e=document.getElementById("inspect-css-live-styles");e&&e.remove(),delete window.InspectCSS}toggleResponsiveOff(){document.documentElement.style.maxWidth="",document.documentElement.style.margin=""}};function Ie(){if(window.InspectCSS){window.InspectCSS.destroy();return}let o=new F;window.InspectCSS={app:o,destroy:()=>o.destroy(),version:"0.3.0"}}Ie();})();
