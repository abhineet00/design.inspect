(()=>{var be={active:!1,hoverEl:null,selectedEl:null,pseudo:"none",view:"design",edits:new Map,panelPos:{x:null,y:16},collapsed:!1,editing:!1,dragging:!1,changeLog:[],promptDiff:!1,docked:!1,responsive:!1},ke=new Set,c={get:()=>be,set(o){Object.assign(be,o),ke.forEach(e=>e(be))},subscribe(o){return ke.add(o),()=>ke.delete(o)}};var pt=0,ye="data-inspect-id";function te(o){let e=o.getAttribute(ye);return e||(e="ic-"+ ++pt,o.setAttribute(ye,e)),e}function Ce(o){return`[${ye}="${o}"]`}function A(o,e=2){if(o==null||Number.isNaN(o))return 0;let t=Math.pow(10,e);return Math.round(o*t)/t}function s(o,e={},t=[]){let r=document.createElement(o);for(let[n,i]of Object.entries(e))n==="class"?r.className=i:n==="style"&&typeof i=="object"?Object.assign(r.style,i):n==="html"?r.innerHTML=i:n==="text"?r.textContent=i:n.startsWith("on")&&typeof i=="function"?r.addEventListener(n.slice(2).toLowerCase(),i):i!==!1&&i!=null&&r.setAttribute(n,i===!0?"":i);for(let n of[].concat(t))n==null||n===!1||r.appendChild(typeof n=="string"?document.createTextNode(n):n);return r}function z(o){if(!o||o.nodeType!==1)return"";let e=o.tagName.toLowerCase();return o.id?e+="#"+o.id:o.classList.length&&(e+="."+o.classList[0]),e}function W(o){if(o==null)return{value:0,unit:"px"};let e=String(o).trim().match(/^(-?[\d.]+)\s*([a-z%]*)$/i);return e?{value:parseFloat(e[1]),unit:e[2]||"px"}:{value:o,unit:""}}function Q(o){if(!o)return{hex:"#000000",alpha:1};if(o.startsWith("#"))return{hex:o,alpha:1};let e=o.match(/rgba?\(([^)]+)\)/i);if(!e)return{hex:"#000000",alpha:1};let t=e[1].split(",").map(a=>a.trim()),[r,n,i]=t.map(a=>parseInt(a,10)),l=t[3]!=null?parseFloat(t[3]):1;return{hex:"#"+[r,n,i].map(a=>Math.max(0,Math.min(255,a||0)).toString(16).padStart(2,"0")).join(""),alpha:l}}function J(o,e=1){let t=o.replace("#",""),r=t.length===3?t.split("").map(d=>d+d).join(""):t.padEnd(6,"0"),n=parseInt(r.slice(0,2),16),i=parseInt(r.slice(2,4),16),l=parseInt(r.slice(4,6),16);return e>=1?`rgb(${n}, ${i}, ${l})`:`rgba(${n}, ${i}, ${l}, ${A(e,3)})`}function I(o){return!!(o&&o.closest&&o.closest("[data-inspect-ui]"))}var oe=class{constructor(e){this.el=s("div",{"data-inspect-ui":"",style:{position:"fixed",inset:"0",pointerEvents:"none",zIndex:"2147483640"}}),this.margin=this._box("rgba(246, 178, 107, 0.28)"),this.padding=this._box("rgba(147, 196, 125, 0.30)"),this.content=s("div",{style:this._boxStyle("transparent","#4c8dff")}),this.selected=s("div",{style:this._boxStyle("transparent","#7c5cff")}),this.badge=s("div",{"data-inspect-ui":"",style:{position:"fixed",font:"500 12px/1.4 'Quicksand', -apple-system, 'Segoe UI', Roboto, sans-serif",color:"rgba(255,255,255,0.6)",background:"rgba(0,0,0,0.82)",border:"1px solid rgba(255,255,255,0.12)",padding:"4px 9px",borderRadius:"8px",whiteSpace:"nowrap",pointerEvents:"none",boxShadow:"0 6px 20px rgba(0,0,0,.45)",backdropFilter:"blur(6px)"}}),this.el.append(this.margin,this.padding,this.content,this.selected,this.badge),e.appendChild(this.el),this.hideHover(),this.hideSelected()}_box(e){return s("div",{style:{position:"fixed",background:e,pointerEvents:"none"}})}_boxStyle(e,t){return{position:"fixed",background:e,outline:`1px solid ${t}`,outlineOffset:"-1px",pointerEvents:"none"}}_place(e,t){Object.assign(e.style,{left:t.left+"px",top:t.top+"px",width:Math.max(0,t.width)+"px",height:Math.max(0,t.height)+"px",display:"block"})}highlight(e){if(!e)return this.hideHover();let t=getComputedStyle(e),r=e.getBoundingClientRect(),n=Pe(t,"margin"),i=Pe(t,"padding");this._place(this.margin,{left:r.left-n.left,top:r.top-n.top,width:r.width+n.left+n.right,height:r.height+n.top+n.bottom}),this._place(this.content,r),this._place(this.padding,r);let l=z(e);this.badge.innerHTML=`<span style="color:#58aeff">${ut(l)}</span><span style="opacity:.5">&nbsp;&nbsp;${A(r.width)} \xD7 ${A(r.height)}</span>`,this.badge.style.display="block";let d=r.top>24?r.top-22:r.bottom+6;this.badge.style.left=Math.max(4,r.left)+"px",this.badge.style.top=d+"px"}select(e){if(!e)return this.hideSelected();this._place(this.selected,e.getBoundingClientRect())}hideHover(){[this.margin,this.padding,this.content,this.badge].forEach(e=>e.style.display="none")}hideSelected(){this.selected.style.display="none"}destroy(){this.el.remove()}};function Pe(o,e){let t=r=>parseFloat(o.getPropertyValue(`${e}-${r}`))||0;return{top:t("top"),right:t("right"),bottom:t("bottom"),left:t("left")}}function ut(o){return String(o).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}var re=class{constructor(e,t){this.overlay=e,this.onSelect=t,this._onMove=this._onMove.bind(this),this._onClick=this._onClick.bind(this),this._onKey=this._onKey.bind(this),this._onScroll=this._onScroll.bind(this)}start(){document.addEventListener("mousemove",this._onMove,!0),document.addEventListener("click",this._onClick,!0),document.addEventListener("keydown",this._onKey,!0),window.addEventListener("scroll",this._onScroll,!0),window.addEventListener("resize",this._onScroll,!0),document.documentElement.style.cursor="crosshair"}stop(){document.removeEventListener("mousemove",this._onMove,!0),document.removeEventListener("click",this._onClick,!0),document.removeEventListener("keydown",this._onKey,!0),window.removeEventListener("scroll",this._onScroll,!0),window.removeEventListener("resize",this._onScroll,!0),document.documentElement.style.cursor="",this.overlay.hideHover(),c.set({hoverEl:null})}_target(e){let t=document.elementFromPoint(e.clientX,e.clientY);return!t||I(t)||t===document.documentElement||t===document.body?null:t}_onMove(e){if(c.get().editing||c.get().dragging)return;let t=document.elementFromPoint(e.clientX,e.clientY);if(!(t&&I(t))){if(!t||t===document.documentElement||t===document.body)return this.overlay.hideHover();t!==c.get().hoverEl&&(c.set({hoverEl:t}),this.overlay.highlight(t))}}_onClick(e){if(I(e.target)||c.get().editing||c.get().dragging)return;let t=this._target(e);t&&(e.preventDefault(),e.stopPropagation(),this.onSelect(t))}_onKey(e){e.key==="Escape"&&(e.preventDefault(),c.set({active:!1}))}_onScroll(){let{hoverEl:e,selectedEl:t}=c.get();e&&this.overlay.highlight(e),t&&this.overlay.select(t)}};function ht(o){return o&&!/[^a-zA-Z0-9_-]/.test(o)&&!/^(is-|has-|js-)/.test(o)?!0:o&&!/[^a-zA-Z0-9_-]/.test(o)}function gt(o){let e=1,t=o;for(;t=t.previousElementSibling;)t.tagName===o.tagName&&e++;return e}function ft(o){let e=o.tagName.toLowerCase();if(o.id&&document.querySelectorAll("#"+CSS.escape(o.id)).length===1)return"#"+o.id;let t=Array.from(o.classList).filter(ht).slice(0,2);return t.length?e+"."+t.map(n=>n).join("."):`${e}:nth-of-type(${gt(o)})`}function B(o,e=4){if(!o||o.nodeType!==1)return"";let t=[],r=o;for(;r&&r.nodeType===1&&r!==document.documentElement;){let n=ft(r);if(t.unshift(n),n.startsWith("#"))break;try{if(document.querySelectorAll(t.join(" > ")).length===1)break}catch{}if(r=r.parentElement,t.length>=e)break}return t.join(" > ")}function K(o){o.time=Date.now();let e=c.get().changeLog,t=e[e.length-1],r=o.type==="css"&&t&&t.type==="css"&&t.id===o.id&&t.prop===o.prop&&t.pseudo===o.pseudo,n=o.type==="text"&&t&&t.type==="text"&&t.id===o.id;r||n?(t.to=o.to,t.time=o.time):e.push(o),c.set({changeLog:e})}function Me(){return c.get().changeLog}function Ne(){let o=c.get().changeLog;o.length=0,c.set({changeLog:o})}function Ye(o){let e=c.get().changeLog,t=e.filter(r=>!(r.type==="move"&&r.id===o));e.length=0,e.push(...t),c.set({changeLog:e})}function Qe(o){return o.type==="text"?`text \u2192 "${mt(o.to,34)}"`:o.type==="move"?o.position?`moved ${o.position}`:"reordered among siblings":o.type==="delete"?"removed from the page":`${o.prop}: ${o.to}`}function qe(o=!1){let e=Me();if(!e.length)return"";let t=new Map;for(let i of e){let l=i.selector||i.label;t.has(l)||t.set(l,{label:i.label,selector:i.selector,css:new Map,text:null,movedTo:null,deleted:!1});let d=t.get(l);if(i.type==="css"){let a=i.pseudo&&i.pseudo!=="none"?`${i.prop} (:${i.pseudo})`:i.prop,u=d.css.get(a);d.css.set(a,{from:u?u.from:i.from,to:i.to})}else i.type==="text"?d.text={from:d.text?d.text.from:i.from,to:i.to}:i.type==="move"?d.movedTo=i.position||"to a new position":i.type==="delete"&&(d.deleted=!0)}let r=`Apply the following design changes to my web page, then return the updated HTML/CSS.
...
`),n++}return r+=`
Keep everything else unchanged.`,r.trim()}function mt(o,e){return o=String(o),o.length>e?o.slice(0,e)+"\u2026":o}var _=[],Ee=[];function U(o){_.push(o),_.length>200&&_.shift(),Ee.length=0}function Le(){let o=_.pop();return o?(o.undo(),Ee.push(o),o):null}function ne(){let o=Ee.pop();return o?(o.redo(),_.push(o),o):null}var Ge="inspect-css-live-styles";function vt(){let o=document.getElementById(Ge);return o||(o=document.createElement("style"),o.id=Ge,o.setAttribute("data-inspect-ui",""),document.head.appendChild(o)),o}function De(){let{edits:o}=c.get();return[...o.entries()].map(([e,t])=>[e,{inspectId:t.inspectId,pseudo:t.pseudo,selector:t.selector,props:[...t.props.entries()]}])}function Oe(o){let e=new Map;for(let[t,r]of o)e.set(t,{inspectId:r.inspectId,pseudo:r.pseudo,selector:r.selector,props:new Map(r.props)});c.get().edits=e,Xe(),c.set({edits:e})}function L(o,e,t){var g,f;let r=De(),n=te(o),{edits:i,pseudo:l}=c.get(),d=l==="none"?n:`${n}::${l}`,a=(f=(g=i.get(d))==null?void 0:g.props.get(e))!=null?f:getComputedStyle(o).getPropertyValue(e).trim(),u=i.get(d);u||(u={inspectId:n,pseudo:l,selector:B(o),props:new Map},i.set(d,u)),t===""||t==null?u.props.delete(e):u.props.set(e,t),u.props.size===0&&i.delete(d),Xe(),c.set({edits:i}),t!==""&&t!=null&&K({type:"css",id:n,prop:e,from:a,to:t,pseudo:l,label:z(o),selector:u.selector});let h=De();U({undo:()=>Oe(r),redo:()=>Oe(h)})}function Ve(o,e="none"){let t=o.getAttribute("data-inspect-id");if(!t)return new Map;let r=e==="none"?t:`${t}::${e}`,n=c.get().edits.get(r);return n?n.props:new Map}function Xe(){let{edits:o}=c.get(),e=[];for(let t of o.values()){if(t.props.size===0)continue;let r=Ce(t.inspectId)+(t.pseudo!=="none"?":"+t.pseudo:""),n=[...t.props.entries()].map(([i,l])=>`  ${i}: ${l} !important;`).join(`
`);e.push(`${r} {
${n}
}`)}vt().textContent=e.join(`
...
`)}function S(o,e,t,r=t){let n=Ve(o,c.get().pseudo).get(t);return n!=null?n:e.getPropertyValue(r).trim()}function je(o){let e=getComputedStyle(o),t=o.getBoundingClientRect();return{rect:t,tag:o.tagName.toLowerCase(),layout:{display:S(o,e,"display"),position:S(o,e,"position"),width:e.width,height:e.height,x:A(t.left+window.scrollX),y:A(t.top+window.scrollY),rowGap:e.rowGap==="normal"?"0":e.rowGap,columnGap:e.columnGap==="normal"?"0":e.columnGap,justify:S(o,e,"justify-content"),align:S(o,e,"align-items")},transform:xt(o,e),spacing:{margin:We(e,"margin"),padding:We(e,"padding")},radius:{all:S(o,e,"border-radius"),tl:e.borderTopLeftRadius,tr:e.borderTopRightRadius,br:e.borderBottomRightRadius,bl:e.borderBottomLeftRadius},typography:{fontFamily:e.fontFamily,fontSize:S(o,e,"font-size"),fontWeight:S(o,e,"font-weight"),lineHeight:e.lineHeight,letterSpacing:e.letterSpacing==="normal"?"0px":e.letterSpacing,textAlign:S(o,e,"text-align"),color:S(o,e,"color"),marginBottom:S(o,e,"margin-bottom")},background:{color:S(o,e,"background-color"),image:e.backgroundImage},border:{width:e.borderTopWidth,style:e.borderTopStyle,color:S(o,e,"border-top-color","border-top-color"),sides:{top:e.borderTopWidth,right:e.borderRightWidth,bottom:e.borderBottomWidth,left:e.borderLeftWidth},present:parseFloat(e.borderTopWidth)>0&&e.borderTopStyle!=="none"},effects:{opacity:S(o,e,"opacity"),boxShadow:e.boxShadow==="none"?"":e.boxShadow}}}function We(o,e){return{top:o.getPropertyValue(`${e}-top`),right:o.getPropertyValue(`${e}-right`),bottom:o.getPropertyValue(`${e}-bottom`),left:o.getPropertyValue(`${e}-left`)}}function xt(o,e){let r=Ve(o,c.get().pseudo).get("transform")||e.transform,n={tx:0,ty:0,rotate:0};if(!r||r==="none")return n;let i=/translate\(\s*(-?[\d.]+)px\s*,\s*(-?[\d.]+)px\s*\)/.exec(r),l=/rotate\(\s*(-?[\d.]+)deg\s*\)/.exec(r);if(i&&(n.tx=parseFloat(i[1]),n.ty=parseFloat(i[2])),l&&(n.rotate=parseFloat(l[1])),i||l)return n;let d=/matrix\(([^)]+)\)/.exec(r);if(d){let[a,u,,,h,g]=d[1].split(",").map(parseFloat);n.tx=A(h),n.ty=A(g),n.rotate=A(Math.atan2(u,a)*(180/Math.PI))}return n}function Je({tx:o=0,ty:e=0,rotate:t=0}){let r=[];return(o||e)&&r.push(`translate(${A(o)}px, ${A(e)}px)`),t&&r.push(`rotate(${A(t)}deg)`),r.length?r.join(" "):""}var wt=6e3,ie=o=>o.closest&&o.closest("[data-inspect-ui]");function ze(){let o=document.body?document.body.querySelectorAll("*"):[],e=[];for(let t=0;t<o.length&&e.length<wt;t++)ie(o[t])||e.push(o[t]);return e}function bt(o,e,t){let r=o.get(e);r?r.count++:o.set(e,{...t,count:1})}function kt(){let o=new Map,e=["color","background-color","border-top-color","border-right-color","border-bottom-color","border-left-color","outline-color","fill","stroke"];for(let t of ze()){let r=getComputedStyle(t);for(let n of e){let i=r.getPropertyValue(n).trim();if(!i||i==="none")continue;let{hex:l,alpha:d}=Q(i);if(d===0||l==="#000000"&&n==="fill")continue;let a=l+"|"+d;bt(o,a,{hex:l,alpha:d,css:i})}}return[...o.values()].sort((t,r)=>r.count-t.count).slice(0,80)}function yt(){let o=new Map;for(let e of ze()){if(![...e.childNodes].some(h=>h.nodeType===3&&h.textContent.trim()))continue;let r=getComputedStyle(e),n=(r.fontFamily||"").split(",")[0].replace(/["']/g,"").trim(),i=r.fontSize,l=r.fontWeight,d=`${n}|${i}|${l}`,a=e.textContent.trim().slice(0,40),u=o.get(d);u?u.count++:o.set(d,{family:n,size:i,weight:l,lineHeight:r.lineHeight,letterSpacing:r.letterSpacing,sample:a,count:1})}return[...o.values()].sort((e,t)=>parseFloat(t.size)-parseFloat(e.size)||t.count-e.count).slice(0,60)}function Ct(){let o=[],e=new Set;for(let t of document.querySelectorAll("svg")){if(ie(t))continue;let r=t.outerHTML;/xmlns=/.test(r)||(r=r.replace("<svg",'<svg xmlns="http://www.w3.org/2000/svg"'));let n=r.slice(0,400);if(e.has(n)||r.length>4e4)continue;e.add(n);let i=t.getBoundingClientRect();if(o.push({type:"inline",markup:r,w:Math.round(i.width),h:Math.round(i.height)}),o.length>120)break}for(let t of document.querySelectorAll('img[src$=".svg"], img[src*=".svg?"]'))ie(t)||e.has(t.src)||(e.add(t.src),o.push({type:"url",src:t.src,markup:""}));return o}function Mt(){let o=[],e=new Set,t=r=>{!r||e.has(r)||r.endsWith(".svg")||r.startsWith("data:image/svg")||(e.add(r),o.push({src:r}))};for(let r of document.querySelectorAll("img"))ie(r)||(r.currentSrc||r.src)&&t(r.currentSrc||r.src);for(let r of ze()){let n=getComputedStyle(r).backgroundImage;if(!n||n==="none")continue;let i,l=/url\((['"]?)([^'")]+)\1\)/g;for(;i=l.exec(n);)t(new URL(i[2],location.href).href);if(o.length>120)break}return o}function _e(){return{colors:kt(),typography:yt(),svgs:Ct(),images:Mt()}}var Se=new WeakMap;function F(o){return Se.has(o)||Se.set(o,Et(o)),Se.get(o)}function Et(o){let t=getComputedStyle(o).backgroundColor,r=[];if(t&&t!=="rgba(0, 0, 0, 0)"&&t!=="transparent"){let{hex:n,alpha:i}=Q(t);r.push({type:"solid",color:n,alpha:i==null?1:i})}return r}function P(o){var e,t;if(o.type==="solid"){let r=J(o.color,(e=o.alpha)!=null?e:1);return`linear-gradient(${r}, ${r})`}if(o.type==="linear"){let r=(o.stops||[]).map(n=>{var i;return`${J(n.color,(i=n.alpha)!=null?i:1)} ${n.pos}%`}).join(", ");return`linear-gradient(${(t=o.angle)!=null?t:180}deg, ${r})`}return o.type==="image"?`url("${o.url}")`:"none"}function $e(o){if(!o||!o.length)return{"background-image":"none","background-color":"rgba(0, 0, 0, 0)"};let e=[],t=[],r=[],n=[];for(let i of o)e.push(P(i)),t.push(i.type==="image"?i.fit||"cover":"auto"),r.push("no-repeat"),n.push("center");return{"background-image":e.join(", "),"background-size":t.join(", "),"background-repeat":r.join(", "),"background-position":n.join(", "),"background-color":"rgba(0, 0, 0, 0)"}}function He(o){return o.type==="solid"?o.color.replace("#","").toUpperCase():o.type==="linear"?"Gradient":o.type==="image"?"Image":""}function se(o){return o==="linear"?{type:"linear",angle:180,stops:[{color:"#58AEFF",alpha:1,pos:0},{color:"#FF8858",alpha:1,pos:100}]}:o==="image"?{type:"image",url:"",fit:"cover"}:{type:"solid",color:"#FFFFFF",alpha:1}}var Lt={"align-bottom":`<svg preserveAspectRatio="xMidYMid meet" overflow="visible" style="display: block;" width="100%" height="100%" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
<g id="align-bottom">
...
</svg>`,"sidebar-right-01":'<svg preserveAspectRatio="xMidYMid meet" overflow="visible" style="display: block;" width="100%" height="100%" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="sidebar-right-01"><path id="Vector" d="M14.6665 8C14.6665 5.50018 14.6665 4.25027 14.0299 3.37405C13.8243 3.09107 13.5755 2.84221 13.2925 2.63661C12.4163 2 11.1663 2 8.66654 2H7.3332C4.83338 2 3.58347 2 2.70725 2.63661C2.42427 2.84221 2.17541 3.09107 1.96981 3.37405C1.3332 4.25027 1.3332 5.50018 1.3332 8C1.3332 10.4998 1.3332 11.7497 1.96981 12.6259C2.17541 12.9089 2.42427 13.1578 2.70725 13.3634C3.58347 14 4.83338 14 7.3332 14H8.66654C11.1663 14 12.4163 14 13.2925 13.3634C13.5755 13.1578 13.8243 12.9089 14.0299 12.6259C14.6665 11.7497 14.6665 10.4998 14.6665 8Z" stroke="currentColor" stroke-linejoin="round"/><path id="Vector_2" d="M9.6668 2.33334V13.6667" stroke="currentColor" stroke-linejoin="round"/><path id="Vector_3" d="M12.6668 4.66666H11.6668" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/><path id="Vector_4" d="M12.6668 7.33334H11.6668" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/><path id="Vector_5" d="M5.3332 6.66666L6.1509 7.37146C6.49466 7.66773 6.66654 7.81593 6.66654 8C6.66654 8.18406 6.49466 8.33226 6.1509 8.62853L5.3332 9.33333" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/></g></svg>',"minus-sign":'<svg preserveAspectRatio="xMidYMid meet" overflow="visible" style="display: block;" width="100%" height="100%" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="minus-sign"><path id="Vector" d="M13.3333 8H2.66667" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/></g></svg>',square:'<svg preserveAspectRatio="xMidYMid meet" overflow="visible" style="display: block;" width="100%" height="100%" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="queue-02"><path id="Vector" d="M12 12H4C3.37146 12 3.05719 12 2.86193 11.8047C2.66667 11.6095 2.66667 11.2952 2.66667 10.6667C2.66667 10.0381 2.66667 9.72387 2.86193 9.5286C3.05719 9.33333 3.37146 9.33333 4 9.33333H12C12.6285 9.33333 12.9428 9.33333 13.1381 9.5286C13.3333 9.72387 13.3333 10.0381 13.3333 10.6667C13.3333 11.2952 13.3333 11.6095 13.1381 11.8047C12.9428 12 12.6285 12 12 12Z" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/><path id="Vector_2" d="M2.66667 6.66667H13.3333" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/><path id="Vector_3" d="M2.66667 4H13.3333" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/></g></svg>',"border-all-01":'<svg preserveAspectRatio="xMidYMid meet" overflow="visible" style="display: block;" width="100%" height="100%" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="border-all-01"><path id="Vector" d="M2.59416 2.59416C3.52166 1.66667 5.01444 1.66667 8 1.66667C10.9855 1.66667 12.4783 1.66667 13.4059 2.59416C14.3333 3.52166 14.3333 5.01444 14.3333 8C14.3333 10.9855 14.3333 12.4783 13.4059 13.4059C12.4783 14.3333 10.9855 14.3333 8 14.3333C5.01444 14.3333 3.52166 14.3333 2.59416 13.4059C1.66667 12.4783 1.66667 10.9855 1.66667 8C1.66667 5.01444 1.66667 3.52166 2.59416 2.59416Z" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/><path id="Vector_2" d="M8 1.66667V2.93333M8 13.0667V14.3333M6.1 8H9.9M13.0667 8H14.3333M1.66667 8H2.93333M8 6.09999V9.9" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/></g></svg>',"stroke-top":'<svg preserveAspectRatio="xMidYMid meet" overflow="visible" style="display: block;" width="100%" height="100%" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="stroke-top"><path id="Vector" d="M12.6666 4.66667V10C12.6666 11.8856 12.6666 12.8284 12.0808 13.4142C11.495 14 10.5522 14 8.66663 14H7.33329C5.44767 14 4.50487 14 3.91908 13.4142C3.33329 12.8284 3.33329 11.8856 3.33329 10V4.66667" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/><path id="Vector_2" d="M14 1.9987H1.99996" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/></g></svg>',"stroke-right":'<svg preserveAspectRatio="xMidYMid meet" overflow="visible" style="display: block;" width="100%" height="100%" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="stroke-right"><path id="Vector" d="M11.3334 12.6667H6.00008C4.11446 12.6667 3.17165 12.6667 2.58587 12.0809C2.00008 11.4951 2.00008 10.5523 2.00008 8.66667V7.33333C2.00008 5.44771 2.00008 4.50491 2.58587 3.91912C3.17165 3.33333 4.11446 3.33333 6.00008 3.33333H11.3334" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/><path id="Vector_2" d="M13.9988 14V2" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/></g></svg>',"stroke-left":'<svg preserveAspectRatio="xMidYMid meet" overflow="visible" style="display: block;" width="100%" height="100%" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="stroke-left"><path id="Vector" d="M4.66675 3.33333H10.0001C11.8857 3.33333 12.8285 3.33333 13.4143 3.91912C14.0001 4.50491 14.0001 5.44771 14.0001 7.33333V8.66667C14.0001 10.5523 14.0001 11.4951 13.4143 12.0809C12.8285 12.6667 11.8857 12.6667 10.0001 12.6667H4.66675" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/><path id="Vector_2" d="M2.00008 2V14" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/></g></svg>',"stroke-bottom":'<svg preserveAspectRatio="xMidYMid meet" overflow="visible" style="display: block;" width="100%" height="100%" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="stroke-bottom"><path id="Vector" d="M3.33341 11.3333V6C3.33341 4.11438 3.33341 3.17157 3.9192 2.58579C4.50499 2 5.44779 2 7.33341 2H8.66675C10.5523 2 11.4951 2 12.0809 2.58579C12.6667 3.17157 12.6667 4.11438 12.6667 6V11.3333" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/><path id="Vector_2" d="M2.00008 14H14.0001" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/></g></svg>',link:'<svg preserveAspectRatio="xMidYMid meet" overflow="visible" style="display: block;" width="100%" height="100%" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="link"><path id="Vector" d="M9.99724 11.3333H11.3306C13.1715 11.3333 14.6639 9.84093 14.6639 8C14.6639 6.15905 13.1715 4.66667 11.3306 4.66667H9.99724M5.99723 11.3333H4.6639C2.82295 11.3333 1.33057 9.84093 1.33057 8C1.33057 6.15905 2.82295 4.66667 4.6639 4.66667H5.99723" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/><path id="Vector_2" d="M5.6639 8H10.3306" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/></g></svg>',"link-off":'<svg preserveAspectRatio="xMidYMid meet" overflow="visible" style="display: block;" width="100%" height="100%" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="link-off"><path id="Vector" d="M1.99609 2L21.9961 22" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/><path id="Vector_2" d="M8.99609 17C7.62926 17 6.99609 17 6.99609 17C4.23467 17 1.99609 14.7614 1.99609 12C1.99609 9.23858 4.23467 7 6.99609 7" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/><path id="Vector_3" d="M20.9965 15C21.6241 14.1643 21.9961 13.1256 21.9961 12C21.9961 9.23858 19.7575 7 16.9961 7H13.4961" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/><path id="Vector_4" d="M16.9961 17H14.9961" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/><path id="Vector_5" d="M8.49609 12H11.9961" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></g></svg>'};function b(o){return Lt[o]||""}var Vt=["#FFFFFF","#151515","#58AEFF","#FF8858","#33D69F","#FFCB47","#E05151","#B36BFF"],G=null;function q(){if(!G)return;let{pop:o,onDoc:e,onKey:t}=G;o.remove(),document.removeEventListener("mousedown",e,!0),document.removeEventListener("keydown",t,!0),window.removeEventListener("scroll",e,!0),G=null}function tt(o,e,t){if(G&&G.anchor===o)return q();q();let r=o.getRootNode(),n=r.querySelector&&r.querySelector(".wrap")||document.body,i=JSON.parse(JSON.stringify(e)),l=()=>t(JSON.parse(JSON.stringify(i))),d=s("div",{class:"cpop-body"}),a=(x,E)=>s("button",{class:"cpop-tab"+(i.type===x?" on":""),text:E,onclick:()=>{i.type!==x&&(i=se(x),l(),f())}}),u=s("div",{class:"cpop-tabs"},[a("solid","Solid"),a("linear","Gradient"),a("image","Image")]),h=s("div",{class:"cpop","data-inspect-ui":""},[u,d]);n.appendChild(h);function g(){[...u.children].forEach(x=>x.classList.toggle("on",x.textContent.toLowerCase().startsWith(i.type==="linear"?"grad":i.type)))}function f(){g(),d.innerHTML="",i.type==="solid"?d.append(M()):i.type==="linear"?d.append(R()):d.append(w())}function M(){var V;let x=s("div",{class:"cpop-col"}),E=s("input",{type:"color",class:"cpop-color",value:et(i.color)});E.addEventListener("input",()=>{i.color=E.value.toUpperCase(),p.value=i.color.replace("#",""),l()});let p=s("input",{class:"cpop-hex",value:(i.color||"#FFFFFF").replace("#","")});p.addEventListener("change",()=>{let k=p.value.trim().replace(/^#/,"");/^([0-9a-f]{3}|[0-9a-f]{6})$/i.test(k)&&(i.color="#"+k.toUpperCase(),E.value="#"+k,l())});let m=s("input",{class:"cpop-alpha",value:Math.round(((V=i.alpha)!=null?V:1)*100)});return m.addEventListener("change",()=>{i.alpha=jt(parseFloat(m.value)/100),l()}),x.append(s("div",{class:"cpop-field"},[E,p,s("span",{class:"cpop-unit"},[m,s("span",{text:"%"})])]),s("div",{class:"cpop-presets"},Vt.map(k=>s("button",{class:"cpop-preset",style:{background:k},title:k,onclick:()=>{i.color=k,i.alpha=1,l(),f()}})))),x}function R(){var H;let x=s("div",{class:"cpop-col"}),E=s("div",{class:"cpop-gradient-preview"}),p=()=>{E.style.background=P(i)};p();let m=s("input",{class:"cpop-angle",value:(H=i.angle)!=null?H:180});m.addEventListener("change",()=>{i.angle=parseFloat(m.value)||0,l(),p()});let V=s("div",{class:"cpop-stops"}),k=()=>{V.innerHTML="",i.stops.forEach((j,ve)=>{let xe=s("input",{type:"color",class:"cpop-stop-color",value:et(j.color)});xe.addEventListener("input",()=>{j.color=xe.value.toUpperCase(),l(),p()});let we=s("input",{class:"cpop-stop-pos",value:j.pos});we.addEventListener("change",()=>{j.pos=At(parseFloat(we.value)||0,0,100),l(),p()});let ct=s("button",{class:"cpop-stop-del",html:b("minus-sign"),title:"Remove stop",onclick:()=>{i.stops.length>2&&(i.stops.splice(ve,1),l(),p(),k())}});V.append(s("div",{class:"cpop-stop"},[xe,s("span",{class:"cpop-stop-hex",text:(j.color||"").replace("#","")}),we,s("span",{class:"cpop-unit-s",text:"%"}),ct]))})};return k(),x.append(E,s("div",{class:"cpop-field cpop-angle-row"},[s("span",{class:"cpop-lab",text:"Angle"}),m,s("span",{class:"cpop-unit-s",text:"\xB0"})]),V,s("button",{class:"cpop-add",html:b("plus"),onclick:()=>{i.stops.push({color:"#FFFFFF",alpha:1,pos:100}),l(),p(),k()}},["Add stop"])),x}function w(){let x=s("div",{class:"cpop-col"}),E=s("input",{class:"cpop-url",placeholder:"Image URL",value:i.url||""});E.addEventListener("change",()=>{i.url=E.value.trim(),l()});let p=s("input",{type:"file",accept:"image/*",style:{display:"none"}});p.addEventListener("change",()=>{let H=p.files&&p.files[0];if(!H)return;let j=new FileReader;j.onload=()=>{i.url=j.result,E.value="uploaded image",l()},j.readAsDataURL(H)});let m=s("button",{class:"cpop-add",html:b("component"),onclick:()=>p.click()},["Upload"]),k=s("div",{class:"cpop-fits"},["cover","contain","fill"].map(H=>s("button",{class:"cpop-fit"+((i.fit||"cover")===H?" on":""),text:H,onclick:()=>{i.fit=H,l(),[...k.children].forEach(j=>j.classList.toggle("on",j.textContent===H))}})));return x.append(s("div",{class:"cpop-field"},[E]),s("div",{class:"cpop-imgrow"},[m,p]),k),x}f();let v=o.getBoundingClientRect();h.style.left=Math.round(Math.min(v.left,window.innerWidth-250))+"px",h.style.top=Math.round(v.bottom+6)+"px";let Z=h.getBoundingClientRect();Z.bottom>window.innerHeight-8&&(h.style.top=Math.round(v.top-Z.height-6)+"px");let X=x=>{!x.composedPath().includes(h)&&!x.composedPath().includes(o)&&q()},ee=x=>{x.key==="Escape"&&q()};setTimeout(()=>{document.addEventListener("mousedown",X,!0),document.addEventListener("keydown",ee,!0),window.addEventListener("scroll",X,!0)},0),G={pop:h,anchor:o,onDoc:X,onKey:ee}}function et(o){return/^#[0-9a-f]{6}$/i.test(o||"")?o:"#FFFFFF"}function At(o,e,t){return Math.max(e,Math.min(t,o))}function jt(o){return Math.max(0,Math.min(1,isFinite(o)?o:1))}function ot(o){return s("span",{class:"fic",html:b(o)})}function zt(){return s("span",{class:"chev-mini",html:b("chevron-down")})}var St=["px","%","em","rem","vw","vh","auto"];function Ht(o,e,t,r){o.classList.add("scrub"),o.addEventListener("mousedown",n=>{if(n.button!==0)return;n.preventDefault(),n.stopPropagation();let i=n.clientX,l=parseFloat(e.value)||0,d=!1,a=h=>{let g=h.clientX-i;!d&&Math.abs(g)<2||(d=!0,e.value=+(l+g*(h.shiftKey?10:1)).toFixed(2),t())},u=()=>{document.removeEventListener("mousemove",a,!0),document.removeEventListener("mouseup",u,!0),document.documentElement.style.cursor="",d&&(r==null||r())};document.addEventListener("mousemove",a,!0),document.addEventListener("mouseup",u,!0),document.documentElement.style.cursor="ew-resize"})}function It(o,e,t){o.addEventListener("mousedown",r=>{if(r.button!==0)return;let n=r.clientX,i=parseFloat(o.value)||0,l=!1,d=u=>{var g;let h=u.clientX-n;!l&&Math.abs(h)<3||(l||(l=!0,o.blur(),(g=window.getSelection())==null||g.removeAllRanges(),document.documentElement.style.cursor="ew-resize"),o.value=+(i+h*(u.shiftKey?10:1)).toFixed(2),e())},a=()=>{document.removeEventListener("mousemove",d,!0),document.removeEventListener("mouseup",a,!0),document.documentElement.style.cursor="",l&&(t==null||t())};document.addEventListener("mousemove",d,!0),document.addEventListener("mouseup",a,!0)})}function y({key:o,iconName:e,value:t,unit:r="px",onChange:n,showUnit:i=!0,sm:l=!1,scrub:d=!0,onDone:a}){let u=W(t),h=/[a-z%]/i.test(String(t!=null?t:"")),g=s("input",{value:u.value,type:"text",inputmode:"decimal"}),f=i?s("span",{class:"unit unit-pick",text:h?u.unit:r}):null,M=()=>{let w=g.value.trim();if(w==="")return n("");let v=/^-?[\d.]+$/.test(w);n(v&&i?w+((f==null?void 0:f.textContent)||r):w)};g.addEventListener("change",()=>{M(),a==null||a()}),g.addEventListener("keydown",w=>{if(w.key==="Enter")return g.blur();if(w.key==="ArrowUp"||w.key==="ArrowDown"){let v=parseFloat(g.value)||0;g.value=+(v+(w.key==="ArrowUp"?1:-1)*(w.shiftKey?10:1)).toFixed(2),M(),w.preventDefault()}}),i&&f&&f.addEventListener("mousedown",w=>{w.preventDefault(),w.stopPropagation(),rt(f,St.map(v=>[v,v]),f.textContent,v=>{f.textContent=v,M(),a==null||a()})});let R=e?ot(e):o?s("span",{class:"fk",text:o}):null;return R&&d&&Ht(R,g,M,a),s("div",{class:"field"+(l?" sm":"")},[R,g,f])}var Rt='<svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12.5l4.5 4.5L19 6.5"/></svg>',D=null;function $(){if(!D)return;let{menu:o,anchor:e,onDoc:t,onKey:r}=D;o.remove(),e.classList.remove("open"),document.removeEventListener("mousedown",t,!0),document.removeEventListener("keydown",r,!0),window.removeEventListener("scroll",t,!0),D=null}function rt(o,e,t,r){if(D&&D.anchor===o)return $();$();let n=o.getRootNode(),i=n.querySelector&&n.querySelector(".wrap")||document.body,l=s("div",{class:"dropdown-menu","data-inspect-ui":""},e.map(([f,M])=>{let R=String(f)===String(t),w=s("div",{class:"dropdown-item"+(R?" active":"")},[s("span",{text:M}),R?s("span",{class:"dropdown-check",html:Rt}):null]);return w.addEventListener("mousedown",v=>{v.preventDefault(),v.stopPropagation(),r(f),$()}),w}));i.appendChild(l);let d=o.getBoundingClientRect();l.style.left=Math.round(d.left)+"px",l.style.top=Math.round(d.bottom+4)+"px",l.style.minWidth=Math.round(d.width)+"px";let a=l.getBoundingClientRect();a.bottom>window.innerHeight-8&&(l.style.top=Math.round(d.top-a.height-4)+"px");let u=l.querySelector(".dropdown-item.active");u&&u.scrollIntoView({block:"nearest"}),o.classList.add("open");let h=f=>{!f.composedPath().includes(l)&&!f.composedPath().includes(o)&&$()},g=f=>{f.key==="Escape"&&$()};setTimeout(()=>{document.addEventListener("mousedown",h,!0),document.addEventListener("keydown",g,!0),window.addEventListener("scroll",h,!0)},0),D={menu:l,anchor:o,onDoc:h,onKey:g}}function N({value:o,options:e,onChange:t,iconName:r,key:n,sm:i=!0}){let l=e.map(g=>Array.isArray(g)?g:[g,g]),d=l.find(([g])=>String(g)===String(o)),a=s("span",{class:"sel-value",text:d?d[1]:o!=null?o:""}),u=s("div",{class:"field select-like"+(i?" sm":""),tabindex:"0"},[r?ot(r):n?s("span",{class:"fk",text:n}):null,a,zt()]),h=()=>rt(u,l,o,g=>{o=g;let f=l.find(([M])=>String(M)===String(g));a.textContent=f?f[1]:g,t(g)});return u.addEventListener("mousedown",g=>{g.preventDefault(),h()}),u.addEventListener("keydown",g=>{(g.key==="Enter"||g.key===" ")&&(g.preventDefault(),h())}),u}function Ie(o,e,t,r){return s("button",{class:"exp-btn"+(o?" on":""),title:t,html:b(e),onclick:r})}function le(o,e,{disabled:t=!1}={}){return s("div",{class:"sub-head"},[s("span",{class:"sub-label",text:o}),s("button",{class:"sub-add"+(t?" off":""),title:"Add "+o,html:b("plus"),onclick:t?null:e})])}function ae(o,{active:e=-1,grow:t=!1,seg:r=!1,onPick:n}={}){let i=s("div",{class:"iconrow"+(t?" grow":"")+(r?" seg":"")});return o.forEach((l,d)=>{let a=s("button",{class:"ibtn"+(d===e?" active":""),title:l.title||"",html:b(l.icon),onclick:()=>n==null?void 0:n(l,d,a)});i.appendChild(a)}),i}function nt(o,e){return s("button",{class:"link-toggle"+(o?" on":""),title:o?"Unlink width & height":"Link width & height (keep aspect ratio)",html:b(o?"link":"link-off"),onclick:e})}function Re(o,e,t){let r=Q(o),n=r.hex,i=r.alpha==null?1:r.alpha,l=s("input",{type:"color",value:n}),d=s("div",{class:"cr-swatch"},[l]);d.style.background=o&&o!=="rgba(0, 0, 0, 0)"?o:"transparent";let a=s("input",{class:"cr-hex",value:n.replace("#","").toUpperCase()}),u=s("input",{class:"cr-alpha",value:Math.round(i*100)}),h=g=>{let f=J(g,i);d.style.background=f,e(f)};return l.addEventListener("input",()=>{a.value=l.value.replace("#","").toUpperCase(),h(l.value)}),a.addEventListener("change",()=>{let g=a.value.trim().replace(/^#/,"");/^([0-9a-f]{3}|[0-9a-f]{6})$/i.test(g)&&(l.value="#"+g,h("#"+g))}),u.addEventListener("change",()=>{i=Math.max(0,Math.min(100,parseFloat(u.value)||0))/100,h("#"+a.value.trim().replace(/^#/,""))}),s("div",{class:"color-row"},[s("div",{class:"cr-main"},[d,a]),s("div",{class:"cr-pct"},[u,s("span",{class:"cr-unit",text:"%"})]),s("button",{class:"cr-del",title:"Remove",html:b("minus-sign"),onclick:t})])}function O(o,e,{open:t=!0}={}){let r=s("div",{class:"sec-content"},e),n=s("div",{class:"sec-head"},[s("span",{text:o}),s("span",{class:"chev",html:b("chevron-down")})]),i=s("div",{class:"section"+(t?"":" closed")},[n,r]);return n.addEventListener("click",()=>i.classList.toggle("closed")),i}function C(o,e){return s("div",{class:"stack"},[s("span",{class:"label",text:o}),e])}function it(o,e,t){let r=(d,a)=>{let u=s("input",{class:"sp-edge",value:W(o[d][a]).value}),h=()=>{let g=String(u.value).trim();e(`${d}-${a}`,/^-?[\d.]+$/.test(g)?g+"px":g)};return u.addEventListener("change",()=>{h(),t==null||t()}),It(u,h,t),u},n=(d,a,u,h)=>s("div",{class:a},[s("span",{class:"sp-tag",text:u}),r(d,"top"),s("div",{class:"sp-mid"},[r(d,"left"),h,r(d,"right")]),r(d,"bottom")]),i=s("div",{class:"sp-size"},[s("span",{class:"sp-tag",text:"Size"}),s("span",{html:`${W(o.width||"0").value} <span class="sp-x">x</span> ${W(o.height||"0").value}`})]),l=n("padding","sp-box sp-padding","Padding",i);return n("margin","sp-box sp-margin","Margin",l)}var ce=class{constructor(e,t={}){this.root=e,this.api=t,this.el=s("div",{class:"panel","data-inspect-ui":""}),e.appendChild(this.el),this._drag()}set(e){this.selected=e,this.render()}render(){let e=c.get();q();let t=this.el.querySelector(".panel-body"),r=t?t.scrollTop:0;this.el.classList.toggle("hidden",e.collapsed),this.el.innerHTML="",this.el.append(this._head());let n=s("div",{class:"panel-body"});e.view==="assets"?this._assets(n):e.view==="changes"?this._changes(n):e.view==="html"?this._html(n):this.selected?this._design(n):n.append(s("div",{class:"empty",text:"Pick an element on the page to inspect and edit its styles."})),this.el.append(n),n.scrollTop=r}_head(){let e=c.get();if(e.view==="assets"||e.view==="changes"){let i=e.view==="assets"?{title:"Assets",sub:"Everything this page uses"}:{title:"Changes",sub:"Every edit you make, ready to copy"};return s("div",{class:"head"},[s("div",{class:"head-top"},[s("div",{class:"head-id"},[s("div",{class:"head-title",text:i.title}),s("div",{class:"crumb",style:{color:"var(--muted)"},text:i.sub})]),s("div",{class:"head-actions"},[st(),Fe("x","Close panel",()=>c.set({collapsed:!0}))])])])}let t=this.selected,r=t?je(t):null,n=t?Bt(t):[];return s("div",{class:"head"},[s("div",{class:"head-top"},[s("div",{class:"head-id"},[s("div",{class:"head-title",text:t?z(t)||r.tag:"InspectCSS"}),t&&n.length?s("div",{class:"crumb"},n.map(i=>s("span",{text:i}))):null]),s("div",{class:"head-actions"},[t?Fe("delete02","Delete this element",()=>this._deleteSelected(),"danger"):null,st(),Fe("x","Close panel (Exit InspectCSS from the left dock)",()=>c.set({collapsed:!0}))])]),t?s("div",{class:"dims"},[s("span",{},[s("b",{text:`${A(r.rect.width)} x ${A(r.rect.height)} `}),s("span",{class:"mut",text:"px"})]),s("span",{},[s("span",{class:"mut",text:"A "}),s("b",{text:`${parseInt(r.typography.fontSize)}`}),s("span",{class:"mut",text:"px"})])]):s("div",{class:"crumb",text:"no selection"})])}_design(e){let t=this.selected,r=je(t),n=p=>m=>L(t,p,m),i=p=>m=>L(t,p,/^-?[\d.]+$/.test(String(m).trim())?m+"px":m),l=()=>this.render(),d=r.transform,a=p=>{Object.assign(d,p),L(t,"transform",Je(d))},u=[{icon:"align-left",title:"Align left",css:["justify-content","flex-start"]},{icon:"align-bottom",title:"Align bottom",css:["align-items","flex-end"]},{icon:"align-right",title:"Align right",css:["justify-content","flex-end"]},{icon:"align-top",title:"Align top",css:["align-items","flex-start"]},{icon:"align-horizontal-center",title:"Center horizontally",css:["justify-content","center"]},{icon:"align-vertical-center",title:"Center vertically",css:["align-items","center"]}];e.append(O("Position",[C("Alignment",ae(u,{grow:!0,seg:!0,onPick:p=>L(t,p.css[0],p.css[1])})),C("Position",s("div",{class:"row"},[y({key:"X",value:d.tx+"px",onChange:p=>a({tx:parseFloat(p)||0})}),y({key:"Y",value:d.ty+"px",onChange:p=>a({ty:parseFloat(p)||0})})])),C("Rotation",s("div",{class:"rot-row"},[y({iconName:"rotate01",value:d.rotate+"",showUnit:!1,scrub:!0,onChange:p=>a({rotate:parseFloat(p)||0})}),ae([{icon:"image-flip-horizontal",title:"Flip horizontal",axis:"x"},{icon:"image-flip-vertical",title:"Flip vertical",axis:"y"}],{grow:!0,seg:!0,onPick:p=>Kt(t,p.axis)})]))]));let h=!!this._sizeLinked,g=parseFloat(r.layout.width),f=parseFloat(r.layout.height),M=g>0&&f>0?g/f:0,R=p=>{L(t,"width",p);let m=parseFloat(p);h&&M&&isFinite(m)&&(L(t,"height",Math.round(m/M)+"px"),this.render())},w=p=>{L(t,"height",p);let m=parseFloat(p);h&&M&&isFinite(m)&&(L(t,"width",Math.round(m*M)+"px"),this.render())};e.append(O("Layout",[C("Size",s("div",{class:"size-row"},[y({key:"W",value:r.layout.width,onDone:l,onChange:R}),nt(h,()=>{this._sizeLinked=!h,this.render()}),y({key:"H",value:r.layout.height,onDone:l,onChange:w})])),C("Display",N({value:r.layout.display,options:["block","inline","inline-block","flex","inline-flex","grid","none"],onChange:n("display")})),s("div",{class:"row"},[C("Row Gap",y({iconName:"paragraph-spacing",value:r.layout.rowGap,showUnit:!1,sm:!0,onChange:i("row-gap")})),C("Column Gap",y({iconName:"letter-spacing",value:r.layout.columnGap,showUnit:!1,sm:!0,onChange:i("column-gap")}))]),s("div",{class:"row"},[C("Horizontal Align",N({value:r.layout.justify,options:[["flex-start","Start"],["center","Center"],["flex-end","End"],["space-between","Between"]],onChange:n("justify-content")})),C("Vertical Align",N({value:r.layout.align,options:[["flex-start","Start"],["center","Center"],["flex-end","End"],["stretch","Stretch"]],onChange:n("align-items")}))])])),e.append(O("Spacing",[C("Padding",s("div",{class:"row"},[y({iconName:"horizontal-resize",value:r.spacing.padding.left,onDone:l,onChange:p=>{n("padding-left")(p),n("padding-right")(p)}}),y({iconName:"vertical-resize",value:r.spacing.padding.top,onDone:l,onChange:p=>{n("padding-top")(p),n("padding-bottom")(p)}})])),C("Margin",s("div",{class:"row"},[y({iconName:"horizontal-resize",value:r.spacing.margin.left,onDone:l,onChange:p=>{n("margin-left")(p),n("margin-right")(p)}}),y({iconName:"vertical-resize",value:r.spacing.margin.top,onDone:l,onChange:p=>{n("margin-top")(p),n("margin-bottom")(p)}})])),it({...r.spacing,width:r.layout.width,height:r.layout.height},(p,m)=>L(t,p,m),l)]));let v=[],Z=!!this._cornerExpanded,X=new Set([r.radius.tl,r.radius.tr,r.radius.bl,r.radius.br]).size>1;if(v.push(s("div",{class:"row"},[C("Opacity",y({iconName:"transparency",value:String(Math.round((parseFloat(r.effects.opacity)||1)*100)),unit:"%",onChange:p=>n("opacity")((parseFloat(p)||100)/100)})),C("Corner",s("div",{class:"corner-mix"},[y({iconName:"full-screen",value:X?"mix":r.radius.all,showUnit:!1,onChange:i("border-radius")}),Ie(Z,"full-screen",Z?"Collapse corners":"Edit each corner",()=>{this._cornerExpanded=!Z,this.render()})]))])),Z){let p=[["border-top-left-radius",r.radius.tl],["border-top-right-radius",r.radius.tr],["border-bottom-left-radius",r.radius.bl],["border-bottom-right-radius",r.radius.br]];v.push(s("div",{class:"corner-grid"},p.map(([m,V])=>y({iconName:"full-screen",value:V,showUnit:!1,onChange:i(m)}))))}let ee=F(t),x=()=>{let p=$e(F(t));Object.entries(p).forEach(([m,V])=>L(t,m,V))};v.push(le("Fill",()=>{F(t).unshift(se("solid")),x(),this.render()})),ee.forEach((p,m)=>v.push(this._fillRow(t,m,x)));let E=r.border.present;if(v.push(le("Stroke",()=>{E||(L(t,"border-style","solid"),L(t,"border-width","1px"),Ft(r.border.color)||L(t,"border-color","#FFFFFF"),this.render())},{disabled:E})),E){v.push(Re(r.border.color,n("border-color"),()=>{L(t,"border-width","0px"),this.render()}));let p=r.border.sides,m=new Set([p.top,p.right,p.bottom,p.left]).size>1,V=!!this._strokeSidesExpanded;if(v.push(s("div",{class:"corner-mix"},[y({iconName:"square",value:m?"mix":parseFloat(r.border.width)+"",showUnit:!1,onChange:k=>L(t,"border-width",/^-?[\d.]+$/.test(String(k).trim())?k+"px":k)}),Ie(V,"border-all-01",V?"Collapse sides":"Edit each side",()=>{this._strokeSidesExpanded=!V,this.render()})])),V){let k=[["border-top-width","stroke-top",p.top],["border-right-width","stroke-right",p.right],["border-left-width","stroke-left",p.left],["border-bottom-width","stroke-bottom",p.bottom]];v.push(s("div",{class:"corner-grid"},k.map(([H,j,ve])=>y({iconName:j,value:parseFloat(ve)+"",showUnit:!1,onChange:i(H)}))))}}e.append(O("Appearance",v)),e.append(O("Typography",[C("Typeface",N({value:lt(r.typography.fontFamily),options:[lt(r.typography.fontFamily),"Quicksand","Inter","Arial","Georgia","system-ui","monospace"],onChange:n("font-family")})),s("div",{class:"row"},[N({value:Ut(r.typography.fontWeight),options:[["300","Light"],["400","Regular"],["500","Medium"],["600","SemiBold"],["700","Bold"],["800","Extra"]],onChange:n("font-weight")}),N({value:parseInt(r.typography.fontSize)+"",options:["10","12","13","14","16","18","20","24","32","48"].map(p=>[p,p]),onChange:p=>n("font-size")(p+"px")})]),s("div",{class:"row"},[C("Line Height",y({iconName:"paragraph-spacing",value:Tt(r.typography.lineHeight),showUnit:!1,sm:!0,onChange:n("line-height")})),C("Letter Spacing",y({iconName:"letter-spacing",value:r.typography.letterSpacing,showUnit:!1,sm:!0,onChange:i("letter-spacing")}))]),s("div",{class:"row"},[C("Paragraph Spacing",y({iconName:"expand-paragraph",value:Zt(r.typography.marginBottom),sm:!0,onChange:n("margin-bottom")})),C("Alignment",ae([{icon:"text-align-right",title:"Right",css:"right"},{icon:"text-align-center",title:"Center",css:"center"},{icon:"text-align-start",title:"Left",css:"left"},{icon:"text-align-justify",title:"Justify",css:"justify"}],{grow:!0,seg:!0,active:["right","center","left","justify"].indexOf(r.typography.textAlign),onPick:p=>n("text-align")(p.css)}))]),le("Fill",()=>{n("color")("#FFFFFF"),this.render()}),Re(r.typography.color,n("color"),()=>{L(t,"color","inherit"),this.render()})]))}_fillRow(e,t,r){var g;let n=F(e)[t],i=s("button",{class:"cr-swatch cr-swatch-btn",title:"Edit fill"});i.style.background=P(n);let l=s("span",{class:"cr-hex-text",text:He(n)}),d=s("div",{class:"cr-main cr-main-btn"},[i,l]),a=s("input",{class:"cr-alpha",value:Math.round(((g=n.alpha)!=null?g:1)*100)});a.addEventListener("change",()=>{let f=F(e)[t];f.alpha=Math.max(0,Math.min(100,parseFloat(a.value)||0))/100,r(),i.style.background=P(f)}),d.addEventListener("click",()=>tt(d,F(e)[t],f=>{var M;F(e)[t]=f,r(),i.style.background=P(f),l.textContent=He(f),a.value=Math.round(((M=f.alpha)!=null?M:1)*100)}));let u=s("button",{class:"cr-del",title:"Remove fill",html:b("minus-sign"),onclick:()=>{F(e).splice(t,1),r(),this.render()}}),h=[d];return n.type==="solid"&&h.push(s("div",{class:"cr-pct"},[a,s("span",{class:"cr-unit",text:"%"})])),h.push(u),s("div",{class:"color-row"},h)}_changes(e){let t=c.get(),r=Me(),n=Ae(),i=qe(t.promptDiff);if(e.append(s("div",{class:"view-actions"},[s("button",{class:"btn primary",text:"Copy CSS",onclick:()=>this._copy()}),s("button",{class:"btn",text:"Copy AI prompt",onclick:()=>{var d;i&&((d=navigator.clipboard)==null||d.writeText(i).then(()=>this._toast("AI prompt copied")))}}),s("button",{class:"btn",text:"Clear",onclick:()=>{Ne(),this.render()}})])),!r.length){e.append(s("div",{class:"empty",text:"No changes yet. Edit a property, colour or text and every change is logged here."}));return}e.append(Y("Generated CSS",0,n?s("pre",{class:"code",html:Yt(n)}):s("div",{class:"empty",text:"No CSS edits."})));let l=s("div",{class:"seg-toggle"},[s("button",{class:"seg-btn"+(t.promptDiff?"":" on"),text:"Final",onclick:d=>{d.stopPropagation(),c.set({promptDiff:!1}),this.render()}}),s("button",{class:"seg-btn"+(t.promptDiff?" on":""),text:"Diff",onclick:d=>{d.stopPropagation(),c.set({promptDiff:!0}),this.render()}})]);e.append(Y("AI prompt",0,s("div",{},[s("div",{class:"ai-row"},[s("div",{class:"ai-hint",text:"Paste into any AI to apply these changes."}),l]),s("pre",{class:"code ai-prompt",text:i})]),{closed:!0})),e.append(Y("Change log",r.length,s("div",{class:"log-list"},[...r].reverse().map(d=>s("div",{class:"log-item"},[s("span",{class:"log-el",text:d.label||d.selector}),s("span",{class:"log-desc",text:Qe(d)})]))),{closed:!0}))}_html(e){if(this._expanded=this._expanded||new Set,this._expanded.add(document.documentElement),this._expanded.add(document.body),this.selected){let i=this.selected.parentElement;for(;i;)this._expanded.add(i),i=i.parentElement}let t=s("div",{class:"domtree"});t.addEventListener("mouseleave",()=>{var i,l;return(l=(i=this.api).unhover)==null?void 0:l.call(i)}),this._renderNode(document.documentElement,t,0);let r=s("div",{class:"tree-footer"},[s("button",{class:"tree-btn",onclick:()=>c.set({view:"design"})},[s("span",{html:de.back}),"Back"]),s("button",{class:"tree-btn",onclick:()=>c.set({active:!0})},[s("span",{html:de.pick}),"Pick an element"])]);e.append(t,r);let n=t.querySelector(".tree-row.selected");n&&setTimeout(()=>n.scrollIntoView({block:"center"}),0)}_renderNode(e,t,r){if(e.nodeType!==1||e.hasAttribute&&e.hasAttribute("data-inspect-ui"))return;let n=[...e.children].filter(h=>!(h.hasAttribute&&h.hasAttribute("data-inspect-ui"))),i=n.length>0,l=this._expanded.has(e),d=r*14+8,a=s("span",{class:"tree-tw"+(i?"":" leaf"),html:i?l?de.caretDown:de.caretRight:""});a.addEventListener("click",h=>{h.stopPropagation(),i&&(l?this._expanded.delete(e):this._expanded.add(e),this.render())});let u=s("div",{class:"tree-row"+(e===this.selected?" selected":""),style:{paddingLeft:d+"px"}},[a,s("span",{class:"tree-tag",html:Pt(e,i&&!l)})]);u.addEventListener("mouseenter",()=>{var h,g;return(g=(h=this.api).hover)==null?void 0:g.call(h,e)}),u.addEventListener("click",()=>{var h,g;(g=(h=this.api).unhover)==null||g.call(h),this.api.pick?this.api.pick(e):(this.selected=e,c.set({selectedEl:e,view:"design"}),this.render())}),t.append(u),i&&l&&(n.forEach(h=>this._renderNode(h,t,r+1)),t.append(s("div",{class:"tree-row tree-close",style:{paddingLeft:d+"px"}},[s("span",{class:"tree-tag",html:Nt(e)})])))}_deleteSelected(){let e=this.selected;if(!e)return;let t=e.parentElement;if(!t)return;let r=e.nextElementSibling,n=z(e),i=B(e);e.remove(),K({type:"delete",id:e.getAttribute("data-inspect-id"),to:"removed",label:n,selector:i}),U({undo:()=>t.insertBefore(e,r),redo:()=>e.remove()});let l=t!==document.body&&t!==document.documentElement?t:null;this.selected=l,c.set({selectedEl:l}),this._toast("Element deleted"),this.render()}_copy(){var t;let e=Ae();e&&((t=navigator.clipboard)==null||t.writeText(e).then(()=>this._toast("CSS copied")))}_toast(e){let t=s("div",{class:"toast","data-inspect-ui":"",text:e});this.root.appendChild(t),setTimeout(()=>t.remove(),1400)}_assets(e){let t=this._assetCache||(this._assetCache=_e()),r=(a,u)=>{var h;(h=navigator.clipboard)==null||h.writeText(a),this._toast(u||"Copied")},n=s("div",{class:"asset-colors"},t.colors.map(a=>s("button",{class:"asset-swatch",title:`${a.hex} \xB7 used ${a.count}\xD7`,style:{background:a.css},onclick:()=>r(a.hex,a.hex+" copied")}))),i=s("div",{class:"asset-type-list"},t.typography.map(a=>s("button",{class:"asset-type",title:"Copy CSS",onclick:()=>r(`font-family: ${a.family};
font-size: ${a.size};
font-weight: ${a.weight};`,"Type style copied")},[s("div",{class:"asset-type-preview",style:{fontFamily:a.family,fontSize:"min("+a.size+", 28px)",fontWeight:a.weight},text:"Ag"}),s("div",{class:"asset-type-meta"},[s("div",{class:"asset-type-name",text:a.family}),s("div",{class:"asset-type-sub",text:`${parseInt(a.size)}px \xB7 ${a.weight}`})])]))),l=s("div",{class:"asset-grid"},t.svgs.map(a=>{let u=s("div",{class:"asset-thumb asset-svg",title:"Copy SVG"});return a.type==="inline"?u.innerHTML=a.markup:u.appendChild(s("img",{src:a.src,alt:""})),u.addEventListener("click",()=>r(a.markup||a.src,"SVG copied")),u})),d=s("div",{class:"asset-grid"},t.images.map(a=>{let u=s("div",{class:"asset-thumb",title:"Copy image URL"},[s("img",{src:a.src,alt:"",loading:"lazy"})]);return u.addEventListener("click",()=>r(a.src,"Image URL copied")),u}));e.append(s("div",{class:"view-actions"},[s("button",{class:"btn primary",text:"Rescan page",onclick:()=>{this._assetCache=null,this.render()}})]),Y("Colors",t.colors.length,n),Y("Typography",t.typography.length,i),Y("SVGs",t.svgs.length,l),Y("Images",t.images.length,d))}_drag(){let e,t,r,n,i=!1;this.el.addEventListener("mousedown",a=>{if(!a.target.closest(".head")||a.target.closest(".hbtn")||c.get().docked)return;i=!0;let h=this.el.getBoundingClientRect();e=a.clientX,t=a.clientY,r=h.left,n=h.top,this.el.style.right="auto",this.el.style.left=h.left+"px",this.el.style.top=h.top+"px",document.addEventListener("mousemove",l,!0),document.addEventListener("mouseup",d,!0),a.preventDefault()});let l=a=>{i&&(this.el.style.left=r+(a.clientX-e)+"px",this.el.style.top=Math.max(0,n+(a.clientY-t))+"px")},d=()=>{i=!1,document.removeEventListener("mousemove",l,!0),document.removeEventListener("mouseup",d,!0)}}};function Fe(o,e,t,r=""){return s("button",{class:"hbtn"+(r?" "+r:""),title:e,onclick:t,html:b(o)})}function st(){let o=c.get().docked;return s("button",{class:"hbtn"+(o?" active":""),title:o?"Undock panel (float)":"Dock panel to the side",onclick:()=>c.set({docked:!c.get().docked}),html:b("sidebar-right-01")})}function Ft(o){if(!o)return!1;let e=String(o).trim();if(e==="transparent"||e==="none")return!1;let t=e.match(/rgba?\(([^)]+)\)/i);if(t){let r=t[1].split(",")[3];return r==null||parseFloat(r)>0}return!0}function Y(o,e,t,{closed:r=!1}={}){let n=s("div",{class:"sec-head"},[s("span",{},[o,e?s("span",{class:"asset-count",text:String(e)}):null]),s("span",{class:"chev",html:b("chevron-down")})]),i=s("div",{class:"section"+(r?" closed":"")},[n,s("div",{class:"sec-content"},[t])]);return n.addEventListener("click",()=>i.classList.toggle("closed")),i}function Bt(o){let e=[],t=o,r=0;for(;t&&t.nodeType===1&&t!==document.documentElement&&r<3;)t.classList.length?e.unshift("."+t.classList[0]):e.unshift(t.tagName.toLowerCase()),t=t.parentElement,r++;return e}function Kt(o,e){let t=getComputedStyle(o),r=t.transform==="none"?"":t.transform+" ";L(o,"transform",r+(e==="x"?"scaleX(-1)":"scaleY(-1)"))}function lt(o){return(o||"").split(",")[0].replace(/["']/g,"").trim()||"system-ui"}function Ut(o){return String(o)}function Tt(o){return o==="normal"?"1.4":o}function Zt(o){return o&&o!=="auto"?o:"0px"}function Be(o){return o.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}var de={caretRight:'<svg width="10" height="10" viewBox="0 0 10 10" fill="currentColor"><path d="M3 1.5l4 3.5-4 3.5z"/></svg>',caretDown:'<svg width="10" height="10" viewBox="0 0 10 10" fill="currentColor"><path d="M1.5 3h7l-3.5 4z"/></svg>',back:'<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M15 6l-6 6 6 6"/></svg>',pick:'<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 3v3M12 18v3M3 12h3M18 12h3"/><circle cx="12" cy="12" r="4"/></svg>'};function Pt(o,e){let t=o.tagName.toLowerCase(),r="";for(let i of o.attributes){if(i.name.startsWith("data-inspect"))continue;let l=i.value.length>40?i.value.slice(0,40)+"\u2026":i.value;r+=` <span class="t-attr">${Be(i.name)}</span><span class="t-br">=</span><span class="t-val">"${Be(l)}"</span>`}let n=`<span class="t-br">&lt;</span><span class="t-tag">${t}</span>${r}<span class="t-br">&gt;</span>`;return e&&(n+=`<span class="t-ell">\u2026</span><span class="t-br">&lt;/</span><span class="t-tag">${t}</span><span class="t-br">&gt;</span>`),n}function Nt(o){return`<span class="t-br">&lt;/</span><span class="t-tag">${o.tagName.toLowerCase()}</span><span class="t-br">&gt;</span>`}function Yt(o){return Be(o).replace(/^([^{\n]+)\{/gm,'<span class="sel">$1</span>{').replace(/^(\s+)([\w-]+)(:)/gm,'$1<span class="prop">$2</span>$3').replace(/: ([^;]+);/g,': <span class="val">$1</span>;')}var pe=class{constructor(e,t){this.api=t,this.el=s("div",{class:"dock","data-inspect-ui":""}),e.appendChild(this.el),this.render(),c.subscribe(()=>this.sync())}render(){this.el.innerHTML="",this.pauseBtn=at("pause","Pause / resume picking",()=>c.set({active:!c.get().active}));let e=s("div",{class:"dock-group"},[T("undo-03","Undo",()=>{var r,n;return(n=(r=this.api).undo)==null?void 0:n.call(r)}),T("redo-01","Redo",()=>{var r,n;return(n=(r=this.api).redo)==null?void 0:n.call(r)}),Ke(),T("layer-bring-forward","Select parent element",()=>{var r,n;return(n=(r=this.api).selectParent)==null?void 0:n.call(r)}),T("layer-send-backward","Select child element",()=>{var r,n;return(n=(r=this.api).selectChild)==null?void 0:n.call(r)}),Ke(),this.assetsBtn=T("component","Assets (page colors, type, SVGs, images)",()=>{let r=c.get().view;c.set({view:r==="assets"?"design":"assets",collapsed:!1})}),this.codeBtn=T("file-diff","Changes & AI prompt",()=>c.set({view:"changes",collapsed:!1})),this.htmlBtn=T("html-file-01","HTML",()=>c.set({view:"html",collapsed:!1})),Ke(),this.respBtn=T("laptop-phone-sync","Toggle responsive preview",()=>{var r,n;return(n=(r=this.api).toggleResponsive)==null?void 0:n.call(r)})]),t=at("cancel-01","Exit InspectCSS",()=>{var r;return(r=window.InspectCSS)==null?void 0:r.destroy()});this.el.append(this.pauseBtn,e,t),this.sync()}sync(){var t,r,n,i,l;let e=c.get();(t=this.pauseBtn)==null||t.classList.toggle("active",e.active),(r=this.assetsBtn)==null||r.classList.toggle("active",e.view==="assets"),(n=this.codeBtn)==null||n.classList.toggle("active",e.view==="changes"),(i=this.htmlBtn)==null||i.classList.toggle("active",e.view==="html"),(l=this.respBtn)==null||l.classList.toggle("active",e.responsive)}};function at(o,e,t){return s("button",{class:"dock-circle",title:e,onclick:t,html:b(o)})}function T(o,e,t){return s("button",{class:"dock-btn",title:e,onclick:t,html:b(o)})}function Ke(){return s("div",{class:"dock-sep"})}var ue=class{constructor(e){this.root=e,this.el=s("div",{class:"tooltip","data-inspect-ui":""}),e.appendChild(this.el),e.addEventListener("pointerover",t=>this._over(t),!0),e.addEventListener("pointerout",t=>this._out(t),!0),e.addEventListener("pointerdown",()=>this.hide(),!0),document.addEventListener("pointerover",t=>this._over(t,!0),!0),document.addEventListener("pointerout",t=>this._out(t),!0),document.addEventListener("pointerdown",()=>this.hide(),!0)}_over(e,t=!1){let r=e.target.closest&&e.target.closest("[title],[data-tip]");if(!r||t&&!r.hasAttribute("data-inspect-ui")||!t&&!this.root.contains(r))return;if(r.hasAttribute("title")){let i=r.getAttribute("title");i&&r.setAttribute("data-tip",i),r.removeAttribute("title")}let n=r.getAttribute("data-tip");n&&this.show(n,r)}_out(e){let t=e.target.closest&&e.target.closest("[data-tip]");t&&!t.contains(e.relatedTarget)&&this.hide()}show(e,t){this.el.textContent=e,this.el.classList.add("show");let r=t.getBoundingClientRect(),n=this.el.getBoundingClientRect(),i=r.top-n.height-8,l=r.left+r.width/2-n.width/2;i<6&&(i=r.bottom+8),l=Math.max(6,Math.min(l,window.innerWidth-n.width-6)),this.el.style.left=Math.round(l)+"px",this.el.style.top=Math.round(i)+"px"}hide(){this.el.classList.remove("show")}};var he=class{constructor(e){this.onChange=e,this._onDblClick=this._onDblClick.bind(this),this._onKey=this._onKey.bind(this)}start(){document.addEventListener("dblclick",this._onDblClick,!0)}stop(){document.removeEventListener("dblclick",this._onDblClick,!0),this._finish()}_editable(e){if(!e||e.nodeType!==1||I(e))return null;let t=e;for(;t&&t!==document.body;){let r=[...t.childNodes].some(i=>i.nodeType===3&&i.textContent.trim()),n=![...t.children].some(i=>{let l=getComputedStyle(i).display;return l==="block"||l==="flex"||l==="grid"});if(r&&n)return t;t=t.parentElement}return e.matches("h1,h2,h3,h4,h5,h6,p,span,a,button,li,td,th,label,strong,em,small,div")?e:null}_onDblClick(e){var i,l;if(I(e.target))return;let t=this._editable(e.target);if(!t)return;e.preventDefault(),e.stopPropagation(),c.set({editing:!0,selectedEl:t}),this.el=t,this._origText=t.textContent,te(t),t.setAttribute("contenteditable","true"),t.setAttribute("data-inspect-editing",""),t.focus();let r=(i=document.caretRangeFromPoint)==null?void 0:i.call(document,e.clientX,e.clientY),n=window.getSelection();n.removeAllRanges(),r?n.addRange(r):(l=document.execCommand)==null||l.call(document,"selectAll",!1,null),t.addEventListener("blur",()=>this._finish(),{once:!0}),document.addEventListener("keydown",this._onKey,!0)}_onKey(e){this.el&&(e.key==="Escape"||e.key==="Enter"&&!e.shiftKey&&this.el.tagName!=="DIV")&&(e.preventDefault(),this.el.blur())}_finish(){var e;if(document.removeEventListener("keydown",this._onKey,!0),this.el){let t=this.el;t.removeAttribute("contenteditable"),t.removeAttribute("data-inspect-editing");let r=t.textContent;if(r!==this._origText){let n=this._origText,i=r;K({type:"text",id:t.getAttribute("data-inspect-id"),from:n,to:i,label:z(t),selector:B(t)}),U({undo:()=>{t.textContent=n},redo:()=>{t.textContent=i}})}this.el=null}c.get().editing&&c.set({editing:!1}),(e=this.onChange)==null||e.call(this)}};var Qt=4,Ue=new WeakMap;function Te(o){let e=o.nextElementSibling;for(;e&&I(e);)e=e.nextElementSibling;return e}function qt(o){let e=o.previousElementSibling;for(;e&&I(e);)e=e.previousElementSibling;return e}function Gt(o,e){if(o.length>=2){let n=o[0].getBoundingClientRect(),i=o[1].getBoundingClientRect(),l=Math.min(n.bottom,i.bottom)-Math.max(n.top,i.top),d=Math.min(n.right,i.right)-Math.max(n.left,i.left);if(l!==d)return l>d}let t=getComputedStyle(e);return/flex/.test(t.display)&&/row/.test(t.flexDirection)||t.display.includes("inline")||t.display==="grid"&&t.gridAutoFlow.includes("column")}function Dt(o){let e=Te(o);if(e)return`before ${z(e)}`;let t=qt(o);return t?`after ${z(t)}`:"to the only remaining slot"}var Ot='<svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M5 9l-3 3 3 3M9 5l3-3 3 3M15 19l-3 3-3-3M19 9l3 3-3 3M2 12h20M12 2v20"/></svg>',ge=class{constructor(e){this.onReorder=e,this.indicator=s("div",{"data-inspect-ui":"",style:{position:"fixed",background:"#58aeff",borderRadius:"2px",pointerEvents:"none",zIndex:"2147483644",display:"none",boxShadow:"0 0 6px rgba(88,174,255,.8)"}}),this.handle=s("div",{"data-inspect-ui":"",title:"Drag to reorder",html:Ot,style:{position:"fixed",width:"26px",height:"26px",borderRadius:"999px",display:"none",alignItems:"center",justifyContent:"center",background:"rgba(0,0,0,0.82)",border:"1px solid rgba(255,255,255,0.18)",color:"#fff",cursor:"grab",zIndex:"2147483645",boxShadow:"0 4px 14px rgba(0,0,0,.5)",backdropFilter:"blur(6px)"}}),document.documentElement.append(this.indicator,this.handle),this._down=this._down.bind(this),this._move=this._move.bind(this),this._up=this._up.bind(this),this._reposition=this._reposition.bind(this),this._sync=this._sync.bind(this)}start(){this.handle.addEventListener("mousedown",this._down,!0),this.handle.addEventListener("mouseenter",()=>this.handle.style.background="#58aeff"),this.handle.addEventListener("mouseleave",()=>this.handle.style.background="rgba(0,0,0,0.82)"),this.unsub=c.subscribe(this._sync),window.addEventListener("scroll",this._reposition,!0),window.addEventListener("resize",this._reposition,!0)}stop(){var e;(e=this.unsub)==null||e.call(this),window.removeEventListener("scroll",this._reposition,!0),window.removeEventListener("resize",this._reposition,!0),this.indicator.remove(),this.handle.remove()}_sync(){let e=c.get(),t=e.selectedEl&&!e.dragging&&!e.editing;this.handle.style.display=t?"flex":"none",t&&this._reposition()}_reposition(){let e=c.get().selectedEl;if(!e||this.dragging)return;let t=e.getBoundingClientRect();this.handle.style.left=Math.round(Math.max(4,t.left-8))+"px",this.handle.style.top=Math.round(Math.max(4,t.top-8))+"px"}_down(e){e.button===0&&(e.preventDefault(),e.stopPropagation(),c.get().selectedEl&&(this.sx=e.clientX,this.sy=e.clientY,this.armed=!0,this.dragging=!1,document.addEventListener("mousemove",this._move,!0),document.addEventListener("mouseup",this._up,!0)))}_move(e){if(this.armed){if(!this.dragging){if(Math.hypot(e.clientX-this.sx,e.clientY-this.sy)<Qt)return;this.dragging=!0,c.set({dragging:!0}),document.documentElement.style.cursor="grabbing",this.handle.style.display="none"}this._updateTarget(e)}}_updateTarget(e){let t=c.get().selectedEl,r=t==null?void 0:t.parentElement;if(!r)return;let n=[...r.children].filter(a=>!I(a)&&a!==t);if(!n.length){this.ref=void 0,this.indicator.style.display="none";return}let i=Gt(n,r),l=i?e.clientX:e.clientY,d=null;for(let a of n){let u=a.getBoundingClientRect(),h=i?u.left+u.width/2:u.top+u.height/2;if(l<h){d=a;break}}this.ref=d,this._drawLine(d,n,i)}_drawLine(e,t,r){let n=t[t.length-1],l=(e||n).getBoundingClientRect();if(r){let d;if(e){let a=t[t.indexOf(e)-1];d=a?(a.getBoundingClientRect().right+l.left)/2:l.left-2}else d=l.right+2;Object.assign(this.indicator.style,{display:"block",left:d-1.5+"px",top:l.top+"px",width:"3px",height:l.height+"px"})}else{let d;if(e){let a=t[t.indexOf(e)-1];d=a?(a.getBoundingClientRect().bottom+l.top)/2:l.top-2}else d=l.bottom+2;Object.assign(this.indicator.style,{display:"block",left:l.left+"px",top:d-1.5+"px",width:l.width+"px",height:"3px"})}}_up(){var t;document.removeEventListener("mousemove",this._move,!0),document.removeEventListener("mouseup",this._up,!0),this.indicator.style.display="none",document.documentElement.style.cursor="";let e=this.dragging;if(this.armed=!1,this.dragging=!1,e){let r=c.get().selectedEl,n=this.ref;if(r&&n!==void 0&&n!==r&&n!==r.nextElementSibling){let l=r.parentElement,d=r.nextElementSibling;Ue.has(r)||Ue.set(r,Te(r)),l.insertBefore(r,n||null);let a=r.getAttribute("data-inspect-id");Te(r)===Ue.get(r)?Ye(a):K({type:"move",id:a,to:"reordered",label:z(r),selector:B(r),position:Dt(r)}),U({undo:()=>l.insertBefore(r,d),redo:()=>l.insertBefore(r,n||null)})}c.set({dragging:!1}),this.ref=void 0;let i=l=>{l.stopPropagation(),l.preventDefault(),document.removeEventListener("click",i,!0)};document.addEventListener("click",i,!0),(t=this.onReorder)==null||t.call(this,r)}this._sync()}};var fe=class{constructor(){this.active=!1,this.width=0,this.handleR=this._makeHandle(),this.handleL=this._makeHandle(),this.label=s("div",{"data-inspect-ui":"",style:{position:"fixed",top:"10px",left:"50%",transform:"translateX(-50%)",zIndex:"2147483645",display:"none",background:"rgba(0,0,0,0.82)",color:"#fff",font:"500 12px 'Quicksand', -apple-system, sans-serif",padding:"4px 10px",borderRadius:"8px",border:"1px solid rgba(255,255,255,0.14)",pointerEvents:"none"}}),document.documentElement.append(this.handleR,this.handleL,this.label),this._down=this._down.bind(this),this._move=this._move.bind(this),this._up=this._up.bind(this),this._reposition=this._reposition.bind(this),this.handleR.addEventListener("mousedown",this._down),this.handleL.addEventListener("mousedown",this._down)}_makeHandle(){let e=s("div",{"data-inspect-ui":"",style:{position:"fixed",top:"0",bottom:"0",width:"12px",cursor:"ew-resize",zIndex:"2147483645",display:"none"}});return e.appendChild(s("div",{style:{position:"absolute",top:"50%",left:"50%",transform:"translate(-50%,-50%)",width:"6px",height:"54px",borderRadius:"4px",background:"#58aeff",boxShadow:"0 0 8px rgba(88,174,255,.7)"}})),e}toggle(){return this.active?this.disable():this.enable(),this.active}enable(){this.active=!0,this.width=Math.min(1024,window.innerWidth-40),this._apply(),this.handleR.style.display="block",this.handleL.style.display="block",this.label.style.display="block",window.addEventListener("resize",this._reposition)}disable(){this.active=!1;let e=document.documentElement;e.style.width="",e.style.margin="",e.style.transition="",this.handleR.style.display="none",this.handleL.style.display="none",this.label.style.display="none",window.removeEventListener("resize",this._reposition)}_apply(){let e=document.documentElement;e.style.width=this.width+"px",e.style.margin="0 auto",this._reposition()}_reposition(){let e=(window.innerWidth+this.width)/2,t=(window.innerWidth-this.width)/2;this.handleR.style.left=e-6+"px",this.handleL.style.left=t-6+"px",this.label.textContent=Math.round(this.width)+" px"}_down(e){e.preventDefault(),this.dragging=!0,document.addEventListener("mousemove",this._move,!0),document.addEventListener("mouseup",this._up,!0),document.documentElement.style.userSelect="none"}_move(e){if(!this.dragging)return;let t=2*Math.abs(e.clientX-window.innerWidth/2);this.width=Math.max(320,Math.min(t,window.innerWidth)),this._apply()}_up(){this.dragging=!1,document.removeEventListener("mousemove",this._move,!0),document.removeEventListener("mouseup",this._up,!0),document.documentElement.style.userSelect=""}destroy(){this.disable(),this.handleR.remove(),this.handleL.remove(),this.label.remove()}};var me=`@font-face {
