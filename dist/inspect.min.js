(()=>{var U={active:!1,hoverEl:null,selectedEl:null,pseudo:"none",view:"design",edits:new Map,panelPos:{x:null,y:16},collapsed:!1},Q=new Set,p={get:()=>U,set(r){Object.assign(U,r),Q.forEach(e=>e(U))},subscribe(r){return Q.add(r),()=>Q.delete(r)}};var xe=0,B="data-inspect-id";function J(r){let e=r.getAttribute(B);return e||(e="ic-"+ ++xe,r.setAttribute(B,e)),e}function R(r){return`[${B}="${r}"]`}function v(r,e=2){if(r==null||Number.isNaN(r))return 0;let t=Math.pow(10,e);return Math.round(r*t)/t}function i(r,e={},t=[]){let o=document.createElement(r);for(let[n,s]of Object.entries(e))n==="class"?o.className=s:n==="style"&&typeof s=="object"?Object.assign(o.style,s):n==="html"?o.innerHTML=s:n==="text"?o.textContent=s:n.startsWith("on")&&typeof s=="function"?o.addEventListener(n.slice(2).toLowerCase(),s):s!==!1&&s!=null&&o.setAttribute(n,s===!0?"":s);for(let n of[].concat(t))n==null||n===!1||o.appendChild(typeof n=="string"?document.createTextNode(n):n);return o}function _(r){if(!r||r.nodeType!==1)return"";let e=r.tagName.toLowerCase();return r.id?e+="#"+r.id:r.classList.length&&(e+="."+r.classList[0]),e}function A(r){if(r==null)return{value:0,unit:"px"};let e=String(r).trim().match(/^(-?[\d.]+)\s*([a-z%]*)$/i);return e?{value:parseFloat(e[1]),unit:e[2]||"px"}:{value:r,unit:""}}function L(r){if(!r)return{hex:"#000000",alpha:1};if(r.startsWith("#"))return{hex:r,alpha:1};let e=r.match(/rgba?\(([^)]+)\)/i);if(!e)return{hex:"#000000",alpha:1};let t=e[1].split(",").map(l=>l.trim()),[o,n,s]=t.map(l=>parseInt(l,10)),a=t[3]!=null?parseFloat(t[3]):1;return{hex:"#"+[o,n,s].map(l=>Math.max(0,Math.min(255,l||0)).toString(16).padStart(2,"0")).join(""),alpha:a}}function $(r,e=1){let t=r.replace("#",""),o=t.length===3?t.split("").map(c=>c+c).join(""):t.padEnd(6,"0"),n=parseInt(o.slice(0,2),16),s=parseInt(o.slice(2,4),16),a=parseInt(o.slice(4,6),16);return e>=1?`rgb(${n}, ${s}, ${a})`:`rgba(${n}, ${s}, ${a}, ${v(e,3)})`}function P(r){return!!(r&&r.closest&&r.closest("[data-inspect-ui]"))}var z=class{constructor(e){this.el=i("div",{"data-inspect-ui":"",style:{position:"fixed",inset:"0",pointerEvents:"none",zIndex:"2147483646"}}),this.margin=this._box("rgba(246, 178, 107, 0.28)"),this.padding=this._box("rgba(147, 196, 125, 0.30)"),this.content=i("div",{style:this._boxStyle("transparent","#4c8dff")}),this.selected=i("div",{style:this._boxStyle("transparent","#7c5cff")}),this.badge=i("div",{"data-inspect-ui":"",style:{position:"fixed",font:"600 11px/1.4 ui-monospace, SFMono-Regular, Menlo, monospace",color:"#fff",background:"#4c8dff",padding:"2px 6px",borderRadius:"4px",whiteSpace:"nowrap",pointerEvents:"none",boxShadow:"0 1px 4px rgba(0,0,0,.3)"}}),this.el.append(this.margin,this.padding,this.content,this.selected,this.badge),e.appendChild(this.el),this.hideHover(),this.hideSelected()}_box(e){return i("div",{style:{position:"fixed",background:e,pointerEvents:"none"}})}_boxStyle(e,t){return{position:"fixed",background:e,outline:`1px solid ${t}`,outlineOffset:"-1px",pointerEvents:"none"}}_place(e,t){Object.assign(e.style,{left:t.left+"px",top:t.top+"px",width:Math.max(0,t.width)+"px",height:Math.max(0,t.height)+"px",display:"block"})}highlight(e){if(!e)return this.hideHover();let t=getComputedStyle(e),o=e.getBoundingClientRect(),n=ee(t,"margin"),s=ee(t,"padding");this._place(this.margin,{left:o.left-n.left,top:o.top-n.top,width:o.width+n.left+n.right,height:o.height+n.top+n.bottom}),this._place(this.content,o),this._place(this.padding,o),this.badge.textContent=`${v(o.width)} \xD7 ${v(o.height)}`,this.badge.style.display="block";let a=o.top>24?o.top-22:o.bottom+6;this.badge.style.left=Math.max(4,o.left)+"px",this.badge.style.top=a+"px"}select(e){if(!e)return this.hideSelected();this._place(this.selected,e.getBoundingClientRect())}hideHover(){[this.margin,this.padding,this.content,this.badge].forEach(e=>e.style.display="none")}hideSelected(){this.selected.style.display="none"}destroy(){this.el.remove()}};function ee(r,e){let t=o=>parseFloat(r.getPropertyValue(`${e}-${o}`))||0;return{top:t("top"),right:t("right"),bottom:t("bottom"),left:t("left")}}var E=class{constructor(e,t){this.overlay=e,this.onSelect=t,this._onMove=this._onMove.bind(this),this._onClick=this._onClick.bind(this),this._onKey=this._onKey.bind(this),this._onScroll=this._onScroll.bind(this)}start(){document.addEventListener("mousemove",this._onMove,!0),document.addEventListener("click",this._onClick,!0),document.addEventListener("keydown",this._onKey,!0),window.addEventListener("scroll",this._onScroll,!0),window.addEventListener("resize",this._onScroll,!0),document.documentElement.style.cursor="crosshair"}stop(){document.removeEventListener("mousemove",this._onMove,!0),document.removeEventListener("click",this._onClick,!0),document.removeEventListener("keydown",this._onKey,!0),window.removeEventListener("scroll",this._onScroll,!0),window.removeEventListener("resize",this._onScroll,!0),document.documentElement.style.cursor="",this.overlay.hideHover(),p.set({hoverEl:null})}_target(e){let t=document.elementFromPoint(e.clientX,e.clientY);return!t||P(t)||t===document.documentElement||t===document.body?null:t}_onMove(e){let t=this._target(e);if(!t)return this.overlay.hideHover();t!==p.get().hoverEl&&(p.set({hoverEl:t}),this.overlay.highlight(t))}_onClick(e){if(P(e.target))return;let t=this._target(e);t&&(e.preventDefault(),e.stopPropagation(),this.onSelect(t))}_onKey(e){e.key==="Escape"&&(e.preventDefault(),p.set({active:!1}))}_onScroll(){let{hoverEl:e,selectedEl:t}=p.get();e&&this.overlay.highlight(e),t&&this.overlay.select(t)}};function we(r){return r&&!/[^a-zA-Z0-9_-]/.test(r)&&!/^(is-|has-|js-)/.test(r)?!0:r&&!/[^a-zA-Z0-9_-]/.test(r)}function Ce(r){let e=1,t=r;for(;t=t.previousElementSibling;)t.tagName===r.tagName&&e++;return e}function ke(r){let e=r.tagName.toLowerCase();if(r.id&&document.querySelectorAll("#"+CSS.escape(r.id)).length===1)return"#"+r.id;let t=Array.from(r.classList).filter(we).slice(0,2);return t.length?e+"."+t.map(n=>n).join("."):`${e}:nth-of-type(${Ce(r)})`}function te(r,e=4){if(!r||r.nodeType!==1)return"";let t=[],o=r;for(;o&&o.nodeType===1&&o!==document.documentElement;){let n=ke(o);if(t.unshift(n),n.startsWith("#"))break;try{if(document.querySelectorAll(t.join(" > ")).length===1)break}catch{}if(o=o.parentElement,t.length>=e)break}return t.join(" > ")}var oe="inspect-css-live-styles";function be(){let r=document.getElementById(oe);return r||(r=document.createElement("style"),r.id=oe,r.setAttribute("data-inspect-ui",""),document.head.appendChild(r)),r}var b=[],I=[];function N(){let{edits:r}=p.get();return[...r.entries()].map(([e,t])=>[e,{inspectId:t.inspectId,pseudo:t.pseudo,selector:t.selector,props:[...t.props.entries()]}])}function re(r){let e=new Map;for(let[t,o]of r)e.set(t,{inspectId:o.inspectId,pseudo:o.pseudo,selector:o.selector,props:new Map(o.props)});p.get().edits=e,Y(),p.set({edits:e})}function ye(){b.push(N()),b.length>100&&b.shift(),I.length=0}function ne(){b.length&&(I.push(N()),re(b.pop()))}function ie(){I.length&&(b.push(N()),re(I.pop()))}function y(r,e,t){ye();let o=J(r),{edits:n,pseudo:s}=p.get(),a=s==="none"?o:`${o}::${s}`,c=n.get(a);c||(c={inspectId:o,pseudo:s,selector:te(r),props:new Map},n.set(a,c)),t===""||t==null?c.props.delete(e):c.props.set(e,t),c.props.size===0&&n.delete(a),Y(),p.set({edits:n})}function q(r,e="none"){let t=r.getAttribute("data-inspect-id");if(!t)return new Map;let o=e==="none"?t:`${t}::${e}`,n=p.get().edits.get(o);return n?n.props:new Map}function Y(){let{edits:r}=p.get(),e=[];for(let t of r.values()){if(t.props.size===0)continue;let o=R(t.inspectId)+(t.pseudo!=="none"?":"+t.pseudo:""),n=[...t.props.entries()].map(([s,a])=>`  ${s}: ${a} !important;`).join(`
`);e.push(`${o} {
${n}
}`)}be().textContent=e.join(`

`)}function T(){let{edits:r}=p.get(),e=[];for(let t of r.values()){if(t.props.size===0)continue;let o=(t.selector||R(t.inspectId))+(t.pseudo!=="none"?":"+t.pseudo:""),n=[...t.props.entries()].map(([s,a])=>`  ${s}: ${a};`).join(`
`);e.push(`${o} {
${n}
}`)}return e.join(`

`)}function G(){p.get().edits.clear(),Y(),p.set({edits:p.get().edits})}function m(r,e,t,o=t){let n=q(r,p.get().pseudo).get(t);return n!=null?n:e.getPropertyValue(o).trim()}function O(r){let e=getComputedStyle(r),t=r.getBoundingClientRect();return{rect:t,tag:r.tagName.toLowerCase(),layout:{display:m(r,e,"display"),position:m(r,e,"position"),width:e.width,height:e.height,x:v(t.left+window.scrollX),y:v(t.top+window.scrollY),rowGap:e.rowGap==="normal"?"0":e.rowGap,columnGap:e.columnGap==="normal"?"0":e.columnGap,justify:m(r,e,"justify-content"),align:m(r,e,"align-items")},transform:Me(r,e),spacing:{margin:se(e,"margin"),padding:se(e,"padding")},radius:{all:m(r,e,"border-radius"),tl:e.borderTopLeftRadius,tr:e.borderTopRightRadius,br:e.borderBottomRightRadius,bl:e.borderBottomLeftRadius},typography:{fontFamily:e.fontFamily,fontSize:m(r,e,"font-size"),fontWeight:m(r,e,"font-weight"),lineHeight:e.lineHeight,letterSpacing:e.letterSpacing==="normal"?"0px":e.letterSpacing,textAlign:m(r,e,"text-align"),color:m(r,e,"color"),marginBottom:m(r,e,"margin-bottom")},background:{color:m(r,e,"background-color"),image:e.backgroundImage},border:{width:e.borderTopWidth,style:e.borderTopStyle,color:e.borderTopColor},effects:{opacity:m(r,e,"opacity"),boxShadow:e.boxShadow==="none"?"":e.boxShadow}}}function se(r,e){return{top:r.getPropertyValue(`${e}-top`),right:r.getPropertyValue(`${e}-right`),bottom:r.getPropertyValue(`${e}-bottom`),left:r.getPropertyValue(`${e}-left`)}}function Me(r,e){let o=q(r,p.get().pseudo).get("transform")||e.transform,n={tx:0,ty:0,rotate:0};if(!o||o==="none")return n;let s=/translate\(\s*(-?[\d.]+)px\s*,\s*(-?[\d.]+)px\s*\)/.exec(o),a=/rotate\(\s*(-?[\d.]+)deg\s*\)/.exec(o);if(s&&(n.tx=parseFloat(s[1]),n.ty=parseFloat(s[2])),a&&(n.rotate=parseFloat(a[1])),s||a)return n;let c=/matrix\(([^)]+)\)/.exec(o);if(c){let[l,u,,,d,h]=c[1].split(",").map(parseFloat);n.tx=v(d),n.ty=v(h),n.rotate=v(Math.atan2(u,l)*(180/Math.PI))}return n}function le({tx:r=0,ty:e=0,rotate:t=0}){let o=[];return(r||e)&&o.push(`translate(${v(r)}px, ${v(e)}px)`),t&&o.push(`rotate(${v(t)}deg)`),o.length?o.join(" "):""}var Ve=6e3,S=r=>r.closest&&r.closest("[data-inspect-ui]");function X(){let r=document.body?document.body.querySelectorAll("*"):[],e=[];for(let t=0;t<r.length&&e.length<Ve;t++)S(r[t])||e.push(r[t]);return e}function Ae(r,e,t){let o=r.get(e);o?o.count++:r.set(e,{...t,count:1})}function je(){let r=new Map,e=["color","background-color","border-top-color","border-right-color","border-bottom-color","border-left-color","outline-color","fill","stroke"];for(let t of X()){let o=getComputedStyle(t);for(let n of e){let s=o.getPropertyValue(n).trim();if(!s||s==="none")continue;let{hex:a,alpha:c}=L(s);if(c===0||a==="#000000"&&n==="fill")continue;let l=a+"|"+c;Ae(r,l,{hex:a,alpha:c,css:s})}}return[...r.values()].sort((t,o)=>o.count-t.count).slice(0,80)}function Le(){let r=new Map;for(let e of X()){if(![...e.childNodes].some(d=>d.nodeType===3&&d.textContent.trim()))continue;let o=getComputedStyle(e),n=(o.fontFamily||"").split(",")[0].replace(/["']/g,"").trim(),s=o.fontSize,a=o.fontWeight,c=`${n}|${s}|${a}`,l=e.textContent.trim().slice(0,40),u=r.get(c);u?u.count++:r.set(c,{family:n,size:s,weight:a,lineHeight:o.lineHeight,letterSpacing:o.letterSpacing,sample:l,count:1})}return[...r.values()].sort((e,t)=>parseFloat(t.size)-parseFloat(e.size)||t.count-e.count).slice(0,60)}function ze(){let r=[],e=new Set;for(let t of document.querySelectorAll("svg")){if(S(t))continue;let o=t.outerHTML;/xmlns=/.test(o)||(o=o.replace("<svg",'<svg xmlns="http://www.w3.org/2000/svg"'));let n=o.slice(0,400);if(e.has(n)||o.length>4e4)continue;e.add(n);let s=t.getBoundingClientRect();if(r.push({type:"inline",markup:o,w:Math.round(s.width),h:Math.round(s.height)}),r.length>120)break}for(let t of document.querySelectorAll('img[src$=".svg"], img[src*=".svg?"]'))S(t)||e.has(t.src)||(e.add(t.src),r.push({type:"url",src:t.src,markup:""}));return r}function Ee(){let r=[],e=new Set,t=o=>{!o||e.has(o)||o.endsWith(".svg")||o.startsWith("data:image/svg")||(e.add(o),r.push({src:o}))};for(let o of document.querySelectorAll("img"))S(o)||(o.currentSrc||o.src)&&t(o.currentSrc||o.src);for(let o of X()){let n=getComputedStyle(o).backgroundImage;if(!n||n==="none")continue;let s,a=/url\((['"]?)([^'")]+)\1\)/g;for(;s=a.exec(n);)t(new URL(s[2],location.href).href);if(r.length>120)break}return r}function ae(){return{colors:je(),typography:Le(),svgs:ze(),images:Ee()}}var Ie={"align-bottom":`<svg preserveAspectRatio="xMidYMid meet" overflow="visible" style="display: block;" width="100%" height="100%" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
<g id="align-bottom">
...
</svg>`};function x(r){return Ie[r]||""}function de(r){return i("span",{class:"fic",html:x(r)})}function Se(){return i("span",{class:"chev-mini",html:x("chevron-down")})}function f({key:r,iconName:e,value:t,unit:o="px",onChange:n,showUnit:s=!0,sm:a=!1}){let c=A(t),l=i("input",{value:c.value,type:"text",inputmode:"decimal"}),u=s?i("span",{class:"unit",text:c.unit||o}):null,d=()=>{let h=l.value.trim();if(h==="")return n("");let k=/^-?[\d.]+$/.test(h);n(k&&s?h+((u==null?void 0:u.textContent)||o):h)};if(l.addEventListener("change",d),l.addEventListener("keydown",h=>{if(h.key==="Enter")return l.blur();if(h.key==="ArrowUp"||h.key==="ArrowDown"){let k=parseFloat(l.value)||0;l.value=+(k+(h.key==="ArrowUp"?1:-1)*(h.shiftKey?10:1)).toFixed(2),d(),h.preventDefault()}}),s&&u){let h=["px","%","em","rem","vw","vh"];u.style.cursor="pointer",u.addEventListener("click",()=>{u.textContent=h[(h.indexOf(u.textContent)+1)%h.length],d()})}return i("div",{class:"field"+(a?" sm":"")},[e?de(e):r?i("span",{class:"fk",text:r}):null,l,u])}function C({value:r,options:e,onChange:t,iconName:o,key:n,sm:s=!0}){let a=i("select",{});for(let c of e){let[l,u]=Array.isArray(c)?c:[c,c],d=i("option",{value:l,text:u});String(l)===String(r)&&(d.selected=!0),a.appendChild(d)}return a.addEventListener("change",()=>t(a.value)),i("div",{class:"field select-like"+(s?" sm":"")},[o?de(o):n?i("span",{class:"fk",text:n}):null,a,Se()])}function M(r,{active:e=-1,grow:t=!1,seg:o=!1,onPick:n}={}){let s=i("div",{class:"iconrow"+(t?" grow":"")+(o?" seg":"")});return r.forEach((a,c)=>{let l=i("button",{class:"ibtn"+(c===e?" active":""),title:a.title||"",html:x(a.icon),onclick:()=>n==null?void 0:n(a,c,l)});s.appendChild(l)}),s}function D(r,e,{showPct:t=!0}={}){let o=L(r),n=o.hex,s=o.alpha===0?1:o.alpha,a=i("input",{type:"color",value:n}),c=i("div",{class:"swatch"},[a]);c.style.background=r&&r!=="rgba(0, 0, 0, 0)"?r:"transparent";let l=i("input",{class:"hex",value:n.replace("#","")}),u=t?i("span",{class:"pct",text:Math.round(s*100)+"%"}):null,d=h=>{let k=$(h,s);c.style.background=k,e(k)};return a.addEventListener("input",()=>{l.value=a.value.replace("#",""),d(a.value)}),l.addEventListener("change",()=>{let h=l.value.trim().replace(/^#/,"");/^([0-9a-f]{3}|[0-9a-f]{6})$/i.test(h)?(a.value="#"+h,d("#"+h)):e(l.value.trim())}),i("div",{class:"colorline"},[c,l,u])}function V(r,e,{open:t=!0}={}){let o=i("div",{class:"sec-content"},e),n=i("div",{class:"sec-head"},[i("span",{text:r}),i("span",{class:"chev",html:x("chevron-down")})]),s=i("div",{class:"section"+(t?"":" closed")},[n,o]);return n.addEventListener("click",()=>s.classList.toggle("closed")),s}function g(r,e){return i("div",{class:"stack"},[i("span",{class:"label",text:r}),e])}function ce(r,e){let t=(a,c)=>{let l=i("input",{class:"sp-edge",value:A(r[a][c]).value});return l.addEventListener("change",()=>{let u=l.value.trim();e(`${a}-${c}`,/^-?[\d.]+$/.test(u)?u+"px":u)}),l},o=(a,c,l,u)=>i("div",{class:c},[i("span",{class:"sp-tag",text:l}),t(a,"top"),i("div",{class:"sp-mid"},[t(a,"left"),u,t(a,"right")]),t(a,"bottom")]),n=i("div",{class:"sp-size"},[i("span",{class:"sp-tag",text:"Size"}),i("span",{html:`${A(r.width||"0").value} <span class="sp-x">x</span> ${A(r.height||"0").value}`})]),s=o("padding","sp-box sp-padding","Padding",n);return o("margin","sp-box sp-margin","Margin",s)}var Z=class{constructor(e){this.root=e,this.el=i("div",{class:"panel","data-inspect-ui":""}),e.appendChild(this.el),this._drag()}set(e){this.selected=e,this.render()}render(){let e=p.get();this.el.classList.toggle("hidden",e.collapsed),this.el.innerHTML="",this.el.append(this._head());let t=i("div",{class:"panel-body"});e.view==="assets"?this._assets(t):this.selected?e.view==="code"?this._code(t):e.view==="html"?this._html(t):this._design(t):t.append(i("div",{class:"empty",text:"Pick an element on the page to inspect and edit its styles."})),this.el.append(t)}_head(){if(p.get().view==="assets")return i("div",{class:"head"},[i("div",{class:"head-top"},[i("div",{class:"head-title",text:"Assets"}),i("div",{class:"head-actions"},[j("minimize-screen","Collapse panel",()=>p.set({collapsed:!0})),j("x","Close",()=>{var s;return(s=window.InspectCSS)==null?void 0:s.destroy()})])]),i("div",{class:"crumb",style:{color:"var(--muted)"},text:"Everything this page uses"})]);let t=this.selected,o=t?O(t):null,n=t?He(t):[];return i("div",{class:"head"},[i("div",{class:"head-top"},[i("div",{class:"head-title",text:t?_(t)||o.tag:"InspectCSS"}),i("div",{class:"head-actions"},[j("delete02","Reset all edits",()=>{G(),this.render()},"danger"),j("minimize-screen","Collapse panel",()=>p.set({collapsed:!0})),j("x","Close",()=>{var s;return(s=window.InspectCSS)==null?void 0:s.destroy()})])]),t?i("div",{class:"crumb"},n.map(s=>i("span",{text:s}))):null,t?i("div",{class:"dims"},[i("span",{html:`<b>${v(o.rect.width)}</b> x <b>${v(o.rect.height)}</b> px`}),i("span",{html:`A <b>${parseInt(o.typography.fontSize)}px</b>`})]):i("div",{class:"crumb",text:"no selection"})])}_design(e){let t=this.selected,o=O(t),n=d=>h=>y(t,d,h),s=o.transform,a=d=>{Object.assign(s,d),y(t,"transform",le(s))},c=[{icon:"align-left",title:"Align left",css:["justify-content","flex-start"]},{icon:"align-bottom",title:"Align bottom",css:["align-items","flex-end"]},{icon:"align-right",title:"Align right",css:["justify-content","flex-end"]},{icon:"align-top",title:"Align top",css:["align-items","flex-start"]},{icon:"align-horizontal-center",title:"Center horizontally",css:["justify-content","center"]},{icon:"align-vertical-center",title:"Center vertically",css:["align-items","center"]}];e.append(V("Position",[g("Alignment",M(c,{grow:!0,seg:!0,onPick:d=>y(t,d.css[0],d.css[1])})),g("Position",i("div",{class:"row"},[f({key:"X",value:s.tx+"px",onChange:d=>a({tx:parseFloat(d)||0})}),f({key:"Y",value:s.ty+"px",onChange:d=>a({ty:parseFloat(d)||0})})])),g("Rotation",i("div",{class:"rot-row"},[f({iconName:"rotate01",value:s.rotate+"",showUnit:!1,onChange:d=>a({rotate:parseFloat(d)||0})}),M([{icon:"image-flip-horizontal",title:"Flip horizontal"}],{grow:!0,onPick:()=>ue(t,"x")}),M([{icon:"image-flip-vertical",title:"Flip vertical"}],{grow:!0,onPick:()=>ue(t,"y")})]))])),e.append(V("Layout",[g("Size",i("div",{class:"row"},[f({key:"W",value:o.layout.width,onChange:n("width")}),f({key:"H",value:o.layout.height,onChange:n("height")})])),g("Display",C({value:o.layout.display,options:["block","inline","inline-block","flex","inline-flex","grid","none"],onChange:n("display")})),i("div",{class:"row"},[g("Row Gap",f({iconName:"paragraph-spacing",value:o.layout.rowGap,showUnit:!1,sm:!0,onChange:n("row-gap")})),g("Column Gap",f({iconName:"letter-spacing",value:o.layout.columnGap,showUnit:!1,sm:!0,onChange:n("column-gap")}))]),i("div",{class:"row"},[g("Horizontal Align",C({value:o.layout.justify,options:[["flex-start","Start"],["center","Center"],["flex-end","End"],["space-between","Between"]],onChange:n("justify-content")})),g("Vertical Align",C({value:o.layout.align,options:[["flex-start","Start"],["center","Center"],["flex-end","End"],["stretch","Stretch"]],onChange:n("align-items")}))])])),e.append(V("Spacing",[g("Padding",i("div",{class:"row"},[f({iconName:"horizontal-resize",value:o.spacing.padding.left,onChange:d=>{n("padding-left")(d),n("padding-right")(d)}}),f({iconName:"vertical-resize",value:o.spacing.padding.top,onChange:d=>{n("padding-top")(d),n("padding-bottom")(d)}})])),g("Margin",i("div",{class:"row"},[f({iconName:"horizontal-resize",value:o.spacing.margin.left,onChange:d=>{n("margin-left")(d),n("margin-right")(d)}}),f({iconName:"vertical-resize",value:o.spacing.margin.top,onChange:d=>{n("margin-top")(d),n("margin-bottom")(d)}})])),ce({...o.spacing,width:o.layout.width,height:o.layout.height},(d,h)=>y(t,d,h))]));let l=[{key:"tl",prop:"border-top-left-radius",v:o.radius.tl},{key:"tr",prop:"border-top-right-radius",v:o.radius.tr},{key:"bl",prop:"border-bottom-left-radius",v:o.radius.bl},{key:"br",prop:"border-bottom-right-radius",v:o.radius.br}],u=new Set([o.radius.tl,o.radius.tr,o.radius.bl,o.radius.br]).size>1;e.append(V("Appearance",[i("div",{class:"row"},[g("Opacity",f({iconName:"transparency",value:String(Math.round((parseFloat(o.effects.opacity)||1)*100)),unit:"%",onChange:d=>n("opacity")((parseFloat(d)||100)/100)})),g("Corner",i("div",{class:"corner-mix"},[f({iconName:"full-screen",value:u?"mix":o.radius.all,showUnit:!1,onChange:n("border-radius")}),M([{icon:"full-screen",title:"Link corners"}],{onPick:()=>n("border-radius")(o.radius.tl)})]))]),i("div",{class:"corner-grid"},l.map(d=>f({iconName:"full-screen",value:d.v,showUnit:!1,onChange:n(d.prop)}))),pe("Fill",()=>{this._fillOpen=!this._fillOpen,this.render()}),this._fillOpen?D(o.background.color,n("background-color")):null,pe("Stroke",()=>{this._strokeOpen=!this._strokeOpen,this.render()}),this._strokeOpen?D(o.border.color,n("border-color")):null])),e.append(V("Typography",[g("Typeface",C({value:he(o.typography.fontFamily),options:[he(o.typography.fontFamily),"Quicksand","Inter","Arial","Georgia","system-ui","monospace"],onChange:n("font-family")})),i("div",{class:"row"},[C({value:Ze(o.typography.fontWeight),options:[["300","Light"],["400","Regular"],["500","Medium"],["600","SemiBold"],["700","Bold"],["800","Extra"]],onChange:n("font-weight")}),C({value:parseInt(o.typography.fontSize)+"",options:["10","12","13","14","16","18","20","24","32","48"].map(d=>[d,d]),onChange:d=>n("font-size")(d+"px")})]),i("div",{class:"row"},[g("Line Height",f({iconName:"paragraph-spacing",value:Ke(o.typography.lineHeight),showUnit:!1,sm:!0,onChange:n("line-height")})),g("Letter Spacing",f({iconName:"letter-spacing",value:o.typography.letterSpacing,showUnit:!1,sm:!0,onChange:n("letter-spacing")}))]),i("div",{class:"row"},[g("Paragraph Spacing",f({iconName:"expand-paragraph",value:Ue(o.typography.marginBottom),sm:!0,onChange:n("margin-bottom")})),g("Alignment",M([{icon:"text-align-right",title:"Right",css:"right"},{icon:"text-align-center",title:"Center",css:"center"},{icon:"text-align-start",title:"Left",css:"left"},{icon:"text-align-justify",title:"Justify",css:"justify"}],{grow:!0,seg:!0,active:["right","center","left","justify"].indexOf(o.typography.textAlign),onPick:d=>n("text-align")(d.css)}))])]))}_code(e){let t=T();e.append(i("div",{class:"view-actions"},[i("button",{class:"btn primary",text:"Copy CSS",onclick:()=>this._copy()}),i("button",{class:"btn",text:"Reset",onclick:()=>{G(),this.render()}})]),t?i("pre",{class:"code",html:Qe(t)}):i("div",{class:"empty",text:"No edits yet. Change a property in the Design view and the generated CSS appears here."}))}_html(e){let t=this.selected;if(!t)return e.append(i("div",{class:"empty",text:"No element selected."}));let o=t.cloneNode(!1);o.removeAttribute("data-inspect-id"),e.append(i("pre",{class:"code",html:ge(o.outerHTML.replace(/></,`>
  \u2026
<`))}))}_copy(){var t;let e=T();e&&((t=navigator.clipboard)==null||t.writeText(e).then(()=>this._toast("CSS copied")))}_toast(e){let t=i("div",{class:"toast","data-inspect-ui":"",text:e});this.root.appendChild(t),setTimeout(()=>t.remove(),1400)}_assets(e){let t=this._assetCache||(this._assetCache=ae()),o=(l,u)=>{var d;(d=navigator.clipboard)==null||d.writeText(l),this._toast(u||"Copied")},n=i("div",{class:"asset-colors"},t.colors.map(l=>i("button",{class:"asset-swatch",title:`${l.hex} \xB7 used ${l.count}\xD7`,style:{background:l.css},onclick:()=>o(l.hex,l.hex+" copied")}))),s=i("div",{class:"asset-type-list"},t.typography.map(l=>i("button",{class:"asset-type",title:"Copy CSS",onclick:()=>o(`font-family: ${l.family};
font-size: ${l.size};
font-weight: ${l.weight};`,"Type style copied")},[i("div",{class:"asset-type-preview",style:{fontFamily:l.family,fontSize:"min("+l.size+", 28px)",fontWeight:l.weight},text:"Ag"}),i("div",{class:"asset-type-meta"},[i("div",{class:"asset-type-name",text:l.family}),i("div",{class:"asset-type-sub",text:`${parseInt(l.size)}px \xB7 ${l.weight}`})])]))),a=i("div",{class:"asset-grid"},t.svgs.map(l=>{let u=i("div",{class:"asset-thumb asset-svg",title:"Copy SVG"});return l.type==="inline"?u.innerHTML=l.markup:u.appendChild(i("img",{src:l.src,alt:""})),u.addEventListener("click",()=>o(l.markup||l.src,"SVG copied")),u})),c=i("div",{class:"asset-grid"},t.images.map(l=>{let u=i("div",{class:"asset-thumb",title:"Copy image URL"},[i("img",{src:l.src,alt:"",loading:"lazy"})]);return u.addEventListener("click",()=>o(l.src,"Image URL copied")),u}));e.append(i("div",{class:"view-actions"},[i("button",{class:"btn primary",text:"Rescan page",onclick:()=>{this._assetCache=null,this.render()}})]),H("Colors",t.colors.length,n),H("Typography",t.typography.length,s),H("SVGs",t.svgs.length,a),H("Images",t.images.length,c))}_drag(){let e,t,o,n,s=!1;this.el.addEventListener("mousedown",l=>{if(!l.target.closest(".head")||l.target.closest(".hbtn"))return;s=!0;let d=this.el.getBoundingClientRect();e=l.clientX,t=l.clientY,o=d.left,n=d.top,this.el.style.right="auto",document.addEventListener("mousemove",a,!0),document.addEventListener("mouseup",c,!0),l.preventDefault()});let a=l=>{s&&(this.el.style.left=o+(l.clientX-e)+"px",this.el.style.top=Math.max(0,n+(l.clientY-t))+"px")},c=()=>{s=!1,document.removeEventListener("mousemove",a,!0),document.removeEventListener("mouseup",c,!0)}}};function j(r,e,t,o=""){return i("button",{class:"hbtn"+(o?" "+o:""),title:e,onclick:t,html:x(r)})}function pe(r,e){return i("div",{class:"addrow"},[i("span",{class:"k",text:r}),i("button",{class:"addbtn",title:"Add "+r,html:x("plus"),onclick:e})])}function H(r,e,t){let o=i("div",{class:"sec-head"},[i("span",{},[r,i("span",{class:"asset-count",text:String(e)})]),i("span",{class:"chev",html:x("chevron-down")})]),n=i("div",{class:"section"},[o,i("div",{class:"sec-content"},[t])]);return o.addEventListener("click",()=>n.classList.toggle("closed")),n}function He(r){let e=[],t=r,o=0;for(;t&&t.nodeType===1&&t!==document.documentElement&&o<3;)t.classList.length?e.unshift("."+t.classList[0]):e.unshift(t.tagName.toLowerCase()),t=t.parentElement,o++;return e}function ue(r,e){let t=getComputedStyle(r),o=t.transform==="none"?"":t.transform+" ";y(r,"transform",o+(e==="x"?"scaleX(-1)":"scaleY(-1)"))}function he(r){return(r||"").split(",")[0].replace(/["']/g,"").trim()||"system-ui"}function Ze(r){return String(r)}function Ke(r){return r==="normal"?"1.4":r}function Ue(r){return r&&r!=="auto"?r:"0px"}function ge(r){return r.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function Qe(r){return ge(r).replace(/^([^{\n]+)\{/gm,'<span class="sel">$1</span>{').replace(/^(\s+)([\w-]+)(:)/gm,'$1<span class="prop">$2</span>$3').replace(/: ([^;]+);/g,': <span class="val">$1</span>;')}var K=class{constructor(e,t){this.api=t,this.el=i("div",{class:"dock","data-inspect-ui":""}),e.appendChild(this.el),this.render(),p.subscribe(()=>this.sync())}render(){this.el.innerHTML="",this.pauseBtn=fe("pause","Pause / resume picking",()=>p.set({active:!p.get().active}));let e=i("div",{class:"dock-group"},[w("undo-03","Undo",()=>{var o,n;return(n=(o=this.api).undo)==null?void 0:n.call(o)}),w("redo-01","Redo",()=>{var o,n;return(n=(o=this.api).redo)==null?void 0:n.call(o)}),F(),w("layer-send-backward","Select parent element",()=>{var o,n;return(n=(o=this.api).selectParent)==null?void 0:n.call(o)}),w("layer-bring-forward","Select child element",()=>{var o,n;return(n=(o=this.api).selectChild)==null?void 0:n.call(o)}),F(),this.assetsBtn=w("component","Assets (page colors, type, SVGs, images)",()=>{let o=p.get().view;p.set({view:o==="assets"?"design":"assets",collapsed:!1})}),this.codeBtn=w("file-diff","Generated CSS",()=>p.set({view:"code",collapsed:!1})),this.htmlBtn=w("html-file-01","HTML",()=>p.set({view:"html",collapsed:!1})),F(),w("laptop-phone-sync","Toggle responsive preview",()=>{var o,n;return(n=(o=this.api).toggleResponsive)==null?void 0:n.call(o)})]),t=fe("cancel-01","Exit InspectCSS",()=>{var o;return(o=window.InspectCSS)==null?void 0:o.destroy()});this.el.append(this.pauseBtn,e,t),this.sync()}sync(){var t,o,n,s;let e=p.get();(t=this.pauseBtn)==null||t.classList.toggle("active",e.active),(o=this.assetsBtn)==null||o.classList.toggle("active",e.view==="assets"),(n=this.codeBtn)==null||n.classList.toggle("active",e.view==="code"),(s=this.htmlBtn)==null||s.classList.toggle("active",e.view==="html")}};function fe(r,e,t){return i("button",{class:"dock-circle",title:e,onclick:t,html:x(r)})}function w(r,e,t){return i("button",{class:"dock-btn",title:e,onclick:t,html:x(r)})}function F(){return i("div",{class:"dock-sep"})}var ve=`@font-face {
