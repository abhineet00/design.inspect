...
`),n++}return r+=`
Keep everything else unchanged.`,r.trim()}function mt(o,e){return o=String(o),o.length>e?o.slice(0,e)+"\u2026":o}var _=[],Ee=[];function U(o){_.push(o),_.length>200&&_.shift(),Ee.length=0}function Le(){let o=_.pop();return o?(o.undo(),Ee.push(o),o):null}function ne(){let o=Ee.pop();return o?(o.redo(),_.push(o),o):null}var De="inspect-css-live-styles";function vt(){let o=document.getElementById(De);return o||(o=document.createElement("style"),o.id=De,o.setAttribute("data-inspect-ui",""),document.head.appendChild(o)),o}function Ge(){let{edits:o}=c.get();return[...o.entries()].map(([e,t])=>[e,{inspectId:t.inspectId,pseudo:t.pseudo,selector:t.selector,props:[...t.props.entries()]}])}function Oe(o){let e=new Map;for(let[t,r]of o)e.set(t,{inspectId:r.inspectId,pseudo:r.pseudo,selector:r.selector,props:new Map(r.props)});c.get().edits=e,Xe(),c.set({edits:e})}function L(o,e,t){var g,f;let r=Ge(),n=te(o),{edits:i,pseudo:l}=c.get(),d=l==="none"?n:`${n}::${l}`,a=(f=(g=i.get(d))==null?void 0:g.props.get(e))!=null?f:getComputedStyle(o).getPropertyValue(e).trim(),u=i.get(d);u||(u={inspectId:n,pseudo:l,selector:B(o),props:new Map},i.set(d,u)),t===""||t==null?u.props.delete(e):u.props.set(e,t),u.props.size===0&&i.delete(d),Xe(),c.set({edits:i}),t!==""&&t!=null&&K({type:"css",id:n,prop:e,from:a,to:t,pseudo:l,label:z(o),selector:u.selector});let h=Ge();U({undo:()=>Oe(r),redo:()=>Oe(h)})}function Ve(o,e="none"){let t=o.getAttribute("data-inspect-id");if(!t)return new Map;let r=e==="none"?t:`${t}::${e}`,n=c.get().edits.get(r);return n?n.props:new Map}function Xe(){let{edits:o}=c.get(),e=[];for(let t of o.values()){if(t.props.size===0)continue;let r=Ce(t.inspectId)+(t.pseudo!=="none"?":"+t.pseudo:""),n=[...t.props.entries()].map(([i,l])=>`  ${i}: ${l} !important;`).join(`
`);e.push(`${r} {
${n}
