...
`),r++}return n+=`
Keep everything else unchanged.`,n.trim()}function mt(o,e){return o=String(o),o.length>e?o.slice(0,e)+"\u2026":o}var _=[],Ee=[];function U(o){_.push(o),_.length>200&&_.shift(),Ee.length=0}function Le(){let o=_.pop();return o?(o.undo(),Ee.push(o),o):null}function re(){let o=Ee.pop();return o?(o.redo(),_.push(o),o):null}var De="inspect-css-live-styles";function vt(){let o=document.getElementById(De);return o||(o=document.createElement("style"),o.id=De,o.setAttribute("data-inspect-ui",""),document.head.appendChild(o)),o}function Ge(){let{edits:o}=c.get();return[...o.entries()].map(([e,t])=>[e,{inspectId:t.inspectId,pseudo:t.pseudo,selector:t.selector,props:[...t.props.entries()]}])}function Oe(o){let e=new Map;for(let[t,n]of o)e.set(t,{inspectId:n.inspectId,pseudo:n.pseudo,selector:n.selector,props:new Map(n.props)});c.get().edits=e,Xe(),c.set({edits:e})}function L(o,e,t){var g,f;let n=Ge(),r=te(o),{edits:i,pseudo:l}=c.get(),d=l==="none"?r:`${r}::${l}`,a=(f=(g=i.get(d))==null?void 0:g.props.get(e))!=null?f:getComputedStyle(o).getPropertyValue(e).trim(),u=i.get(d);u||(u={inspectId:r,pseudo:l,selector:B(o),props:new Map},i.set(d,u)),t===""||t==null?u.props.delete(e):u.props.set(e,t),u.props.size===0&&i.delete(d),Xe(),c.set({edits:i}),t!==""&&t!=null&&K({type:"css",id:r,prop:e,from:a,to:t,pseudo:l,label:z(o),selector:u.selector});let h=Ge();U({undo:()=>Oe(n),redo:()=>Oe(h)})}function Ve(o,e="none"){let t=o.getAttribute("data-inspect-id");if(!t)return new Map;let n=e==="none"?t:`${t}::${e}`,r=c.get().edits.get(n);return r?r.props:new Map}function Xe(){let{edits:o}=c.get(),e=[];for(let t of o.values()){if(t.props.size===0)continue;let n=Ce(t.inspectId)+(t.pseudo!=="none"?":"+t.pseudo:""),r=[...t.props.entries()].map(([i,l])=>`  ${i}: ${l} !important;`).join(`
`);e.push(`${n} {
${r}
}`)}vt().textContent=e.join(`

`)}function Ae(){let{edits:o}=c.get(),e=[];for(let t of o.values()){if(t.props.size===0)continue;let n=(t.selector||Ce(t.inspectId))+(t.pseudo!=="none"?":"+t.pseudo:""),r=[...t.props.entries()].map(([i,l])=>`  ${i}: ${l};`).join(`
`);e.push(`${n} {
${r}
}`)}return e.join(`

`)}function S(o,e,t,n=t){let r=Ve(o,c.get().pseudo).get(t);return r!=null?r:e.getPropertyValue(n).trim()}function je(o){let e=getComputedStyle(o),t=o.getBoundingClientRect();return{rect:t,tag:o.tagName.toLowerCase(),layout:{display:S(o,e,"display"),position:S(o,e,"position"),width:e.width,height:e.height,x:A(t.left+window.scrollX),y:A(t.top+window.scrollY),rowGap:e.rowGap==="normal"?"0":e.rowGap,columnGap:e.columnGap==="normal"?"0":e.columnGap,justify:S(o,e,"justify-content"),align:S(o,e,"align-items")},transform:xt(o,e),spacing:{margin:We(e,"margin"),padding:We(e,"padding")},radius:{all:S(o,e,"border-radius"),tl:e.borderTopLeftRadius,tr:e.borderTopRightRadius,br:e.borderBottomRightRadius,bl:e.borderBottomLeftRadius},typography:{fontFamily:e.fontFamily,fontSize:S(o,e,"font-size"),fontWeight:S(o,e,"font-weight"),lineHeight:e.lineHeight,letterSpacing:e.letterSpacing==="normal"?"0px":e.letterSpacing,textAlign:S(o,e,"text-align"),color:S(o,e,"color"),marginBottom:S(o,e,"margin-bottom")},background:{color:S(o,e,"background-color"),image:e.backgroundImage},border:{width:e.borderTopWidth,style:e.borderTopStyle,color:S(o,e,"border-top-color","border-top-color"),sides:{top:e.borderTopWidth,right:e.borderRightWidth,bottom:e.borderBottomWidth,left:e.borderLeftWidth},present:parseFloat(e.borderTopWidth)>0&&e.borderTopStyle!=="none"},effects:{opacity:S(o,e,"opacity"),boxShadow:e.boxShadow==="none"?"":e.boxShadow}}}function We(o,e){return{top:o.getPropertyValue(`${e}-top`),right:o.getPropertyValue(`${e}-right`),bottom:o.getPropertyValue(`${e}-bottom`),left:o.getPropertyValue(`${e}-left`)}}function xt(o,e){let n=Ve(o,c.get().pseudo).get("transform")||e.transform,r={tx:0,ty:0,rotate:0};if(!n||n==="none")return r;let i=/translate\(\s*(-?[\d.]+)px\s*,\s*(-?[\d.]+)px\s*\)/.exec(n),l=/rotate\(\s*(-?[\d.]+)deg\s*\)/.exec(n);if(i&&(r.tx=parseFloat(i[1]),r.ty=parseFloat(i[2])),l&&(r.rotate=parseFloat(l[1])),i||l)return r;let d=/matrix\(([^)]+)\)/.exec(n);if(d){let[a,u,,,h,g]=d[1].split(",").map(parseFloat);r.tx=A(h),r.ty=A(g),r.rotate=A(Math.atan2(u,a)*(180/Math.PI))}return r}function Je({tx:o=0,ty:e=0,rotate:t=0}){let n=[];return(o||e)&&n.push(`translate(${A(o)}px, ${A(e)}px)`),t&&n.push(`rotate(${A(t)}deg)`),n.length?n.join(" "):""}var wt=6e3,ie=o=>o.closest&&o.closest("[data-inspect-ui]");function ze(){let o=document.body?document.body.querySelectorAll("*"):[],e=[];for(let t=0;t<o.length&&e.length<wt;t++)ie(o[t])||e.push(o[t]);return e}function bt(o,e,t){let n=o.get(e);n?n.count++:o.set(e,{...t,count:1})}function kt(){let o=new Map,e=["color","background-color","border-top-color","border-right-color","border-bottom-color","border-left-color","outline-color","fill","stroke"];for(let t of ze()){let n=getComputedStyle(t);for(let r of e){let i=n.getPropertyValue(r).trim();if(!i||i==="none")continue;let{hex:l,alpha:d}=Y(i);if(d===0||l==="#000000"&&r==="fill")continue;let a=l+"|"+d;bt(o,a,{hex:l,alpha:d,css:i})}}return[...o.values()].sort((t,n)=>n.count-t.count).slice(0,80)}function yt(){let o=new Map;for(let e of ze()){if(![...e.childNodes].some(h=>h.nodeType===3&&h.textContent.trim()))continue;let n=getComputedStyle(e),r=(n.fontFamily||"").split(",")[0].replace(/["']/g,"").trim(),i=n.fontSize,l=n.fontWeight,d=`${r}|${i}|${l}`,a=e.textContent.trim().slice(0,40),u=o.get(d);u?u.count++:o.set(d,{family:r,size:i,weight:l,lineHeight:n.lineHeight,letterSpacing:n.letterSpacing,sample:a,count:1})}return[...o.values()].sort((e,t)=>parseFloat(t.size)-parseFloat(e.size)||t.count-e.count).slice(0,60)}function Ct(){let o=[],e=new Set;for(let t of document.querySelectorAll("svg")){if(ie(t))continue;let n=t.outerHTML;/xmlns=/.test(n)||(n=n.replace("<svg",'<svg xmlns="http://www.w3.org/2000/svg"'));let r=n.slice(0,400);if(e.has(r)||n.length>4e4)continue;e.add(r);let i=t.getBoundingClientRect();if(o.push({type:"inline",markup:n,w:Math.round(i.width),h:Math.round(i.height)}),o.length>120)break}for(let t of document.querySelectorAll('img[src$=".svg"], img[src*=".svg?"]'))ie(t)||e.has(t.src)||(e.add(t.src),o.push({type:"url",src:t.src,markup:""}));return o}function Mt(){let o=[],e=new Set,t=n=>{!n||e.has(n)||n.endsWith(".svg")||n.startsWith("data:image/svg")||(e.add(n),o.push({src:n}))};for(let n of document.querySelectorAll("img"))ie(n)||(n.currentSrc||n.src)&&t(n.currentSrc||n.src);for(let n of ze()){let r=getComputedStyle(n).backgroundImage;if(!r||r==="none")continue;let i,l=/url\((['"]?)([^'")]+)\1\)/g;for(;i=l.exec(r);)t(new URL(i[2],location.href).href);if(o.length>120)break}return o}function _e(){return{colors:kt(),typography:yt(),svgs:Ct(),images:Mt()}}var Se=new WeakMap;function F(o){return Se.has(o)||Se.set(o,Et(o)),Se.get(o)}function Et(o){let t=getComputedStyle(o).backgroundColor,n=[];if(t&&t!=="rgba(0, 0, 0, 0)"&&t!=="transparent"){let{hex:r,alpha:i}=Y(t);n.push({type:"solid",color:r,alpha:i==null?1:i})}return n}function P(o){var e,t;if(o.type==="solid"){let n=J(o.color,(e=o.alpha)!=null?e:1);return`linear-gradient(${n}, ${n})`}if(o.type==="linear"){let n=(o.stops||[]).map(r=>{var i;return`${J(r.color,(i=r.alpha)!=null?i:1)} ${r.pos}%`}).join(", ");return`linear-gradient(${(t=o.angle)!=null?t:180}deg, ${n})`}return o.type==="image"?`url("${o.url}")`:"none"}function $e(o){if(!o||!o.length)return{"background-image":"none","background-color":"rgba(0, 0, 0, 0)"};let e=[],t=[],n=[],r=[];for(let i of o)e.push(P(i)),t.push(i.type==="image"?i.fit||"cover":"auto"),n.push("no-repeat"),r.push("center");return{"background-image":e.join(", "),"background-size":t.join(", "),"background-repeat":n.join(", "),"background-position":r.join(", "),"background-color":"rgba(0, 0, 0, 0)"}}function He(o){return o.type==="solid"?o.color.replace("#","").toUpperCase():o.type==="linear"?"Gradient":o.type==="image"?"Image":""}function se(o){return o==="linear"?{type:"linear",angle:180,stops:[{color:"#58AEFF",alpha:1,pos:0},{color:"#FF8858",alpha:1,pos:100}]}:o==="image"?{type:"image",url:"",fit:"cover"}:{type:"solid",color:"#FFFFFF",alpha:1}}var Lt={"align-bottom":`<svg preserveAspectRatio="xMidYMid meet" overflow="visible" style="display: block;" width="100%" height="100%" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
<g id="align-bottom">
...
`;var Te=class{constructor(){this.host=document.createElement("div"),this.host.setAttribute("data-inspect-ui",""),this.host.style.cssText="all: initial; position: static;";let e=this.host.attachShadow({mode:"open"}),t=document.createElement("style");t.textContent=dt;let n=document.createElement("div");n.className="wrap",e.append(t,n),document.documentElement.appendChild(this.host),this.fontStyle=document.createElement("style"),this.fontStyle.setAttribute("data-inspect-ui",""),this.fontStyle.textContent=me,document.head.appendChild(this.fontStyle),this.overlay=new oe(document.documentElement),this.panel=new ce(n,{hover:r=>this.overlay.highlight(r),unhover:()=>{c.get().active||this.overlay.hideHover()},pick:r=>this.select(r)}),this.tooltip=new ue(n),this.toolbar=new pe(n,{undo:()=>{Le(),this._afterHistory()},redo:()=>{re(),this._afterHistory()},selectParent:()=>this.selectRelative("parent"),selectChild:()=>this.selectRelative("child"),toggleResponsive:()=>this.toggleResponsive()}),this.inspector=new ne(this.overlay,r=>this.select(r)),this.textEditor=new he(()=>this.panel.render()),this.dragMove=new ge(r=>{r&&(this.overlay.select(r),this.panel.render())}),this.responsive=new fe,this.textEditor.start(),this.dragMove.start(),this._prevView=c.get().view,this._prevCollapsed=c.get().collapsed,this._prevDocked=c.get().docked,this.unsub=c.subscribe(r=>this.onState(r)),this._track=()=>{this._raf||(this._raf=requestAnimationFrame(()=>{this._raf=0;let r=c.get();r.hoverEl&&this.overlay.highlight(r.hoverEl),r.selectedEl&&this.overlay.select(r.selectedEl)}))},window.addEventListener("scroll",this._track,!0),window.addEventListener("resize",this._track,!0),this._keyHandler=r=>this._onKey(r),window.addEventListener("keydown",this._keyHandler,!0),c.set({active:!0}),this.panel.render()}select(e){c.set({selectedEl:e,collapsed:!1,view:"design"}),this.overlay.select(e),this.panel.set(e)}_afterHistory(){let e=c.get();e.selectedEl&&document.contains(e.selectedEl)?this.overlay.select(e.selectedEl):(this.overlay.hideSelected(),c.set({selectedEl:null})),this.panel.render()}_onKey(e){if(c.get().editing)return;let t=(e.target.tagName||"").toLowerCase();t==="input"||t==="textarea"||e.target.isContentEditable||((e.ctrlKey||e.metaKey)&&e.key.toLowerCase()==="z"?(e.preventDefault(),e.shiftKey?re():Le(),this._afterHistory()):(e.ctrlKey||e.metaKey)&&e.key.toLowerCase()==="y"&&(e.preventDefault(),re(),this._afterHistory()))}selectRelative(e){let t=c.get().selectedEl;if(!t)return;let n=null;if(e==="parent"){if(n=t.parentElement,!n||n===document.documentElement||n===document.body)return}else if(n=[...t.children].find(r=>!r.closest("[data-inspect-ui]")),!n)return;c.set({view:"design",collapsed:!1}),this.select(n)}toggleResponsive(){let e=this.responsive.toggle();c.set({responsive:e});let t=c.get();t.selectedEl&&this.overlay.select(t.selectedEl)}onState(e){if(e.active&&!this._picking?(this._picking=!0,this.inspector.start()):!e.active&&this._picking&&(this._picking=!1,this.inspector.stop()),e.selectedEl&&document.contains(e.selectedEl)?this.overlay.select(e.selectedEl):this.overlay.hideSelected(),this.panel.el.classList.toggle("drag-hidden",!!e.dragging),e.docked!==this._prevDocked){this._prevDocked=e.docked,this.panel.el.classList.toggle("docked",e.docked),document.documentElement.style.transition="margin-right .2s ease";let t=Math.round(this.panel.el.getBoundingClientRect().width)||340;document.documentElement.style.marginRight=e.docked?t+"px":"",this.panel.render()}(e.view!==this._prevView||e.collapsed!==this._prevCollapsed)&&(e.view==="assets"&&this._prevView!=="assets"&&(this.panel._assetCache=null),this._prevView=e.view,this._prevCollapsed=e.collapsed,this.panel.render())}destroy(){var t,n;(t=this.unsub)==null||t.call(this),window.removeEventListener("scroll",this._track,!0),window.removeEventListener("resize",this._track,!0),window.removeEventListener("keydown",this._keyHandler,!0),this.textEditor.stop(),this.dragMove.stop(),this.responsive.destroy(),this.inspector.stop(),this.overlay.destroy(),this.host.remove(),(n=this.fontStyle)==null||n.remove(),this.toggleResponsiveOff();let e=document.getElementById("inspect-css-live-styles");e&&e.remove(),delete window.InspectCSS}toggleResponsiveOff(){document.documentElement.style.maxWidth="",document.documentElement.style.margin="",document.documentElement.style.marginRight=""}};function Xt(){if(window.InspectCSS){window.InspectCSS.destroy();return}let o=new Te;window.InspectCSS={app:o,destroy:()=>o.destroy(),version:"0.11.0"}}Xt();})();
