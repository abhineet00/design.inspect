(()=>{var H={active:!1,hoverEl:null,selectedEl:null,pseudo:"none",view:"design",edits:new Map,panelPos:{x:null,y:16},collapsed:!1},Z=new Set,c={get:()=>H,set(o){Object.assign(H,o),Z.forEach(e=>e(H))},subscribe(o){return Z.add(o),()=>Z.delete(o)}};var ge=0,K="data-inspect-id";function D(o){let e=o.getAttribute(K);return e||(e="ic-"+ ++ge,o.setAttribute(K,e)),e}function S(o){return`[${K}="${o}"]`}function v(o,e=2){if(o==null||Number.isNaN(o))return 0;let t=Math.pow(10,e);return Math.round(o*t)/t}function i(o,e={},t=[]){let r=document.createElement(o);for(let[n,s]of Object.entries(e))n==="class"?r.className=s:n==="style"&&typeof s=="object"?Object.assign(r.style,s):n==="html"?r.innerHTML=s:n==="text"?r.textContent=s:n.startsWith("on")&&typeof s=="function"?r.addEventListener(n.slice(2).toLowerCase(),s):s!==!1&&s!=null&&r.setAttribute(n,s===!0?"":s);for(let n of[].concat(t))n==null||n===!1||r.appendChild(typeof n=="string"?document.createTextNode(n):n);return r}function X(o){if(!o||o.nodeType!==1)return"";let e=o.tagName.toLowerCase();return o.id?e+="#"+o.id:o.classList.length&&(e+="."+o.classList[0]),e}function A(o){if(o==null)return{value:0,unit:"px"};let e=String(o).trim().match(/^(-?[\d.]+)\s*([a-z%]*)$/i);return e?{value:parseFloat(e[1]),unit:e[2]||"px"}:{value:o,unit:""}}function F(o){if(!o)return{hex:"#000000",alpha:1};if(o.startsWith("#"))return{hex:o,alpha:1};let e=o.match(/rgba?\(([^)]+)\)/i);if(!e)return{hex:"#000000",alpha:1};let t=e[1].split(",").map(d=>d.trim()),[r,n,s]=t.map(d=>parseInt(d,10)),a=t[3]!=null?parseFloat(t[3]):1;return{hex:"#"+[r,n,s].map(d=>Math.max(0,Math.min(255,d||0)).toString(16).padStart(2,"0")).join(""),alpha:a}}function W(o,e=1){let t=o.replace("#",""),r=t.length===3?t.split("").map(p=>p+p).join(""):t.padEnd(6,"0"),n=parseInt(r.slice(0,2),16),s=parseInt(r.slice(2,4),16),a=parseInt(r.slice(4,6),16);return e>=1?`rgb(${n}, ${s}, ${a})`:`rgba(${n}, ${s}, ${a}, ${v(e,3)})`}function U(o){return!!(o&&o.closest&&o.closest("[data-inspect-ui]"))}var j=class{constructor(e){this.el=i("div",{"data-inspect-ui":"",style:{position:"fixed",inset:"0",pointerEvents:"none",zIndex:"2147483646"}}),this.margin=this._box("rgba(246, 178, 107, 0.28)"),this.padding=this._box("rgba(147, 196, 125, 0.30)"),this.content=i("div",{style:this._boxStyle("transparent","#4c8dff")}),this.selected=i("div",{style:this._boxStyle("transparent","#7c5cff")}),this.badge=i("div",{"data-inspect-ui":"",style:{position:"fixed",font:"600 11px/1.4 ui-monospace, SFMono-Regular, Menlo, monospace",color:"#fff",background:"#4c8dff",padding:"2px 6px",borderRadius:"4px",whiteSpace:"nowrap",pointerEvents:"none",boxShadow:"0 1px 4px rgba(0,0,0,.3)"}}),this.el.append(this.margin,this.padding,this.content,this.selected,this.badge),e.appendChild(this.el),this.hideHover(),this.hideSelected()}_box(e){return i("div",{style:{position:"fixed",background:e,pointerEvents:"none"}})}_boxStyle(e,t){return{position:"fixed",background:e,outline:`1px solid ${t}`,outlineOffset:"-1px",pointerEvents:"none"}}_place(e,t){Object.assign(e.style,{left:t.left+"px",top:t.top+"px",width:Math.max(0,t.width)+"px",height:Math.max(0,t.height)+"px",display:"block"})}highlight(e){if(!e)return this.hideHover();let t=getComputedStyle(e),r=e.getBoundingClientRect(),n=J(t,"margin"),s=J(t,"padding");this._place(this.margin,{left:r.left-n.left,top:r.top-n.top,width:r.width+n.left+n.right,height:r.height+n.top+n.bottom}),this._place(this.content,r),this._place(this.padding,r),this.badge.textContent=`${v(r.width)} \xD7 ${v(r.height)}`,this.badge.style.display="block";let a=r.top>24?r.top-22:r.bottom+6;this.badge.style.left=Math.max(4,r.left)+"px",this.badge.style.top=a+"px"}select(e){if(!e)return this.hideSelected();this._place(this.selected,e.getBoundingClientRect())}hideHover(){[this.margin,this.padding,this.content,this.badge].forEach(e=>e.style.display="none")}hideSelected(){this.selected.style.display="none"}destroy(){this.el.remove()}};function J(o,e){let t=r=>parseFloat(o.getPropertyValue(`${e}-${r}`))||0;return{top:t("top"),right:t("right"),bottom:t("bottom"),left:t("left")}}var L=class{constructor(e,t){this.overlay=e,this.onSelect=t,this._onMove=this._onMove.bind(this),this._onClick=this._onClick.bind(this),this._onKey=this._onKey.bind(this),this._onScroll=this._onScroll.bind(this)}start(){document.addEventListener("mousemove",this._onMove,!0),document.addEventListener("click",this._onClick,!0),document.addEventListener("keydown",this._onKey,!0),window.addEventListener("scroll",this._onScroll,!0),window.addEventListener("resize",this._onScroll,!0),document.documentElement.style.cursor="crosshair"}stop(){document.removeEventListener("mousemove",this._onMove,!0),document.removeEventListener("click",this._onClick,!0),document.removeEventListener("keydown",this._onKey,!0),window.removeEventListener("scroll",this._onScroll,!0),window.removeEventListener("resize",this._onScroll,!0),document.documentElement.style.cursor="",this.overlay.hideHover(),c.set({hoverEl:null})}_target(e){let t=document.elementFromPoint(e.clientX,e.clientY);return!t||U(t)||t===document.documentElement||t===document.body?null:t}_onMove(e){let t=this._target(e);if(!t)return this.overlay.hideHover();t!==c.get().hoverEl&&(c.set({hoverEl:t}),this.overlay.highlight(t))}_onClick(e){if(U(e.target))return;let t=this._target(e);t&&(e.preventDefault(),e.stopPropagation(),this.onSelect(t))}_onKey(e){e.key==="Escape"&&(e.preventDefault(),c.set({active:!1}))}_onScroll(){let{hoverEl:e,selectedEl:t}=c.get();e&&this.overlay.highlight(e),t&&this.overlay.select(t)}};function fe(o){return o&&!/[^a-zA-Z0-9_-]/.test(o)&&!/^(is-|has-|js-)/.test(o)?!0:o&&!/[^a-zA-Z0-9_-]/.test(o)}function ve(o){let e=1,t=o;for(;t=t.previousElementSibling;)t.tagName===o.tagName&&e++;return e}function me(o){let e=o.tagName.toLowerCase();if(o.id&&document.querySelectorAll("#"+CSS.escape(o.id)).length===1)return"#"+o.id;let t=Array.from(o.classList).filter(fe).slice(0,2);return t.length?e+"."+t.map(n=>n).join("."):`${e}:nth-of-type(${ve(o)})`}function _(o,e=4){if(!o||o.nodeType!==1)return"";let t=[],r=o;for(;r&&r.nodeType===1&&r!==document.documentElement;){let n=me(r);if(t.unshift(n),n.startsWith("#"))break;try{if(document.querySelectorAll(t.join(" > ")).length===1)break}catch{}if(r=r.parentElement,t.length>=e)break}return t.join(" > ")}var $="inspect-css-live-styles";function xe(){let o=document.getElementById($);return o||(o=document.createElement("style"),o.id=$,o.setAttribute("data-inspect-ui",""),document.head.appendChild(o)),o}var y=[],z=[];function Q(){let{edits:o}=c.get();return[...o.entries()].map(([e,t])=>[e,{inspectId:t.inspectId,pseudo:t.pseudo,selector:t.selector,props:[...t.props.entries()]}])}function ee(o){let e=new Map;for(let[t,r]of o)e.set(t,{inspectId:r.inspectId,pseudo:r.pseudo,selector:r.selector,props:new Map(r.props)});c.get().edits=e,P(),c.set({edits:e})}function Ce(){y.push(Q()),y.length>100&&y.shift(),z.length=0}function te(){y.length&&(z.push(Q()),ee(y.pop()))}function oe(){z.length&&(y.push(Q()),ee(z.pop()))}function C(o,e,t){Ce();let r=D(o),{edits:n,pseudo:s}=c.get(),a=s==="none"?r:`${r}::${s}`,p=n.get(a);p||(p={inspectId:r,pseudo:s,selector:_(o),props:new Map},n.set(a,p)),t===""||t==null?p.props.delete(e):p.props.set(e,t),p.props.size===0&&n.delete(a),P(),c.set({edits:n})}function B(o,e="none"){let t=o.getAttribute("data-inspect-id");if(!t)return new Map;let r=e==="none"?t:`${t}::${e}`,n=c.get().edits.get(r);return n?n.props:new Map}function P(){let{edits:o}=c.get(),e=[];for(let t of o.values()){if(t.props.size===0)continue;let r=S(t.inspectId)+(t.pseudo!=="none"?":"+t.pseudo:""),n=[...t.props.entries()].map(([s,a])=>`  ${s}: ${a} !important;`).join(`
`);e.push(`${r} {
${n}
}`)}xe().textContent=e.join(`

`)}function N(){let{edits:o}=c.get(),e=[];for(let t of o.values()){if(t.props.size===0)continue;let r=(t.selector||S(t.inspectId))+(t.pseudo!=="none"?":"+t.pseudo:""),n=[...t.props.entries()].map(([s,a])=>`  ${s}: ${a};`).join(`
`);e.push(`${r} {
${n}
}`)}return e.join(`

`)}function R(){c.get().edits.clear(),P(),c.set({edits:c.get().edits})}function m(o,e,t,r=t){let n=B(o,c.get().pseudo).get(t);return n!=null?n:e.getPropertyValue(r).trim()}function Y(o){let e=getComputedStyle(o),t=o.getBoundingClientRect();return{rect:t,tag:o.tagName.toLowerCase(),layout:{display:m(o,e,"display"),position:m(o,e,"position"),width:e.width,height:e.height,x:v(t.left+window.scrollX),y:v(t.top+window.scrollY),rowGap:e.rowGap==="normal"?"0":e.rowGap,columnGap:e.columnGap==="normal"?"0":e.columnGap,justify:m(o,e,"justify-content"),align:m(o,e,"align-items")},transform:we(o,e),spacing:{margin:re(e,"margin"),padding:re(e,"padding")},radius:{all:m(o,e,"border-radius"),tl:e.borderTopLeftRadius,tr:e.borderTopRightRadius,br:e.borderBottomRightRadius,bl:e.borderBottomLeftRadius},typography:{fontFamily:e.fontFamily,fontSize:m(o,e,"font-size"),fontWeight:m(o,e,"font-weight"),lineHeight:e.lineHeight,letterSpacing:e.letterSpacing==="normal"?"0px":e.letterSpacing,textAlign:m(o,e,"text-align"),color:m(o,e,"color"),marginBottom:m(o,e,"margin-bottom")},background:{color:m(o,e,"background-color"),image:e.backgroundImage},border:{width:e.borderTopWidth,style:e.borderTopStyle,color:e.borderTopColor},effects:{opacity:m(o,e,"opacity"),boxShadow:e.boxShadow==="none"?"":e.boxShadow}}}function re(o,e){return{top:o.getPropertyValue(`${e}-top`),right:o.getPropertyValue(`${e}-right`),bottom:o.getPropertyValue(`${e}-bottom`),left:o.getPropertyValue(`${e}-left`)}}function we(o,e){let r=B(o,c.get().pseudo).get("transform")||e.transform,n={tx:0,ty:0,rotate:0};if(!r||r==="none")return n;let s=/translate\(\s*(-?[\d.]+)px\s*,\s*(-?[\d.]+)px\s*\)/.exec(r),a=/rotate\(\s*(-?[\d.]+)deg\s*\)/.exec(r);if(s&&(n.tx=parseFloat(s[1]),n.ty=parseFloat(s[2])),a&&(n.rotate=parseFloat(a[1])),s||a)return n;let p=/matrix\(([^)]+)\)/.exec(r);if(p){let[d,h,,,l,u]=p[1].split(",").map(parseFloat);n.tx=v(l),n.ty=v(u),n.rotate=v(Math.atan2(h,d)*(180/Math.PI))}return n}function ne({tx:o=0,ty:e=0,rotate:t=0}){let r=[];return(o||e)&&r.push(`translate(${v(o)}px, ${v(e)}px)`),t&&r.push(`rotate(${v(t)}deg)`),r.length?r.join(" "):""}var ke={"align-bottom":`<svg preserveAspectRatio="xMidYMid meet" overflow="visible" style="display: block;" width="100%" height="100%" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
<g id="align-bottom">
...
</svg>`};function x(o){return ke[o]||""}function ie(o){return i("span",{class:"fic",html:x(o)})}function be(){return i("span",{class:"chev-mini",html:x("chevron-down")})}function f({key:o,iconName:e,value:t,unit:r="px",onChange:n,showUnit:s=!0,sm:a=!1}){let p=A(t),d=i("input",{value:p.value,type:"text",inputmode:"decimal"}),h=s?i("span",{class:"unit",text:p.unit||r}):null,l=()=>{let u=d.value.trim();if(u==="")return n("");let b=/^-?[\d.]+$/.test(u);n(b&&s?u+((h==null?void 0:h.textContent)||r):u)};if(d.addEventListener("change",l),d.addEventListener("keydown",u=>{if(u.key==="Enter")return d.blur();if(u.key==="ArrowUp"||u.key==="ArrowDown"){let b=parseFloat(d.value)||0;d.value=+(b+(u.key==="ArrowUp"?1:-1)*(u.shiftKey?10:1)).toFixed(2),l(),u.preventDefault()}}),s&&h){let u=["px","%","em","rem","vw","vh"];h.style.cursor="pointer",h.addEventListener("click",()=>{h.textContent=u[(u.indexOf(h.textContent)+1)%u.length],l()})}return i("div",{class:"field"+(a?" sm":"")},[e?ie(e):o?i("span",{class:"fk",text:o}):null,d,h])}function k({value:o,options:e,onChange:t,iconName:r,key:n,sm:s=!0}){let a=i("select",{});for(let p of e){let[d,h]=Array.isArray(p)?p:[p,p],l=i("option",{value:d,text:h});String(d)===String(o)&&(l.selected=!0),a.appendChild(l)}return a.addEventListener("change",()=>t(a.value)),i("div",{class:"field select-like"+(s?" sm":"")},[r?ie(r):n?i("span",{class:"fk",text:n}):null,a,be()])}function M(o,{active:e=-1,grow:t=!1,seg:r=!1,onPick:n}={}){let s=i("div",{class:"iconrow"+(t?" grow":"")+(r?" seg":"")});return o.forEach((a,p)=>{let d=i("button",{class:"ibtn"+(p===e?" active":""),title:a.title||"",html:x(a.icon),onclick:()=>n==null?void 0:n(a,p,d)});s.appendChild(d)}),s}function q(o,e,{showPct:t=!0}={}){let r=F(o),n=r.hex,s=r.alpha===0?1:r.alpha,a=i("input",{type:"color",value:n}),p=i("div",{class:"swatch"},[a]);p.style.background=o&&o!=="rgba(0, 0, 0, 0)"?o:"transparent";let d=i("input",{class:"hex",value:n.replace("#","")}),h=t?i("span",{class:"pct",text:Math.round(s*100)+"%"}):null,l=u=>{let b=W(u,s);p.style.background=b,e(b)};return a.addEventListener("input",()=>{d.value=a.value.replace("#",""),l(a.value)}),d.addEventListener("change",()=>{let u=d.value.trim().replace(/^#/,"");/^([0-9a-f]{3}|[0-9a-f]{6})$/i.test(u)?(a.value="#"+u,l("#"+u)):e(d.value.trim())}),i("div",{class:"colorline"},[p,d,h])}function V(o,e,{open:t=!0}={}){let r=i("div",{class:"sec-content"},e),n=i("div",{class:"sec-head"},[i("span",{text:o}),i("span",{class:"chev",html:x("chevron-down")})]),s=i("div",{class:"section"+(t?"":" closed")},[n,r]);return n.addEventListener("click",()=>s.classList.toggle("closed")),s}function g(o,e){return i("div",{class:"stack"},[i("span",{class:"label",text:o}),e])}function se(o,e){let t=(a,p)=>{let d=i("input",{class:"sp-edge",value:A(o[a][p]).value});return d.addEventListener("change",()=>{let h=d.value.trim();e(`${a}-${p}`,/^-?[\d.]+$/.test(h)?h+"px":h)}),d},r=(a,p,d,h)=>i("div",{class:p},[i("span",{class:"sp-tag",text:d}),t(a,"top"),i("div",{class:"sp-mid"},[t(a,"left"),h,t(a,"right")]),t(a,"bottom")]),n=i("div",{class:"sp-size"},[i("span",{class:"sp-tag",text:"Size"}),i("span",{html:`${A(o.width||"0").value} <span class="sp-x">x</span> ${A(o.height||"0").value}`})]),s=r("padding","sp-box sp-padding","Padding",n);return r("margin","sp-box sp-margin","Margin",s)}var E=class{constructor(e){this.root=e,this.el=i("div",{class:"panel","data-inspect-ui":""}),e.appendChild(this.el),this._drag()}set(e){this.selected=e,this.render()}render(){let e=c.get();this.el.classList.toggle("hidden",e.collapsed),this.el.innerHTML="",this.el.append(this._head());let t=i("div",{class:"panel-body"});this.selected?e.view==="code"?this._code(t):e.view==="html"?this._html(t):this._design(t):t.append(i("div",{class:"empty",text:"Pick an element on the page to inspect and edit its styles."})),this.el.append(t)}_head(){let e=this.selected,t=e?Y(e):null,r=e?ye(e):[];return i("div",{class:"head"},[i("div",{class:"head-top"},[i("div",{class:"head-title",text:e?X(e)||t.tag:"InspectCSS"}),i("div",{class:"head-actions"},[G("delete02","Reset all edits",()=>{R(),this.render()},"danger"),G("minimize-screen","Collapse panel",()=>c.set({collapsed:!0})),G("x","Close",()=>{var n;return(n=window.InspectCSS)==null?void 0:n.destroy()})])]),e?i("div",{class:"crumb"},r.map(n=>i("span",{text:n}))):null,e?i("div",{class:"dims"},[i("span",{html:`<b>${v(t.rect.width)}</b> x <b>${v(t.rect.height)}</b> px`}),i("span",{html:`A <b>${parseInt(t.typography.fontSize)}px</b>`})]):i("div",{class:"crumb",text:"no selection"})])}_design(e){let t=this.selected,r=Y(t),n=l=>u=>C(t,l,u),s=r.transform,a=l=>{Object.assign(s,l),C(t,"transform",ne(s))},p=[{icon:"align-left",title:"Align left",css:["justify-content","flex-start"]},{icon:"align-bottom",title:"Align bottom",css:["align-items","flex-end"]},{icon:"align-right",title:"Align right",css:["justify-content","flex-end"]},{icon:"align-top",title:"Align top",css:["align-items","flex-start"]},{icon:"align-horizontal-center",title:"Center horizontally",css:["justify-content","center"]},{icon:"align-vertical-center",title:"Center vertically",css:["align-items","center"]}];e.append(V("Position",[g("Alignment",M(p,{grow:!0,seg:!0,onPick:l=>C(t,l.css[0],l.css[1])})),g("Position",i("div",{class:"row"},[f({key:"X",value:s.tx+"px",onChange:l=>a({tx:parseFloat(l)||0})}),f({key:"Y",value:s.ty+"px",onChange:l=>a({ty:parseFloat(l)||0})})])),g("Rotation",i("div",{class:"rot-row"},[f({iconName:"rotate01",value:s.rotate+"",showUnit:!1,onChange:l=>a({rotate:parseFloat(l)||0})}),M([{icon:"image-flip-horizontal",title:"Flip horizontal"}],{grow:!0,onPick:()=>ae(t,"x")}),M([{icon:"image-flip-vertical",title:"Flip vertical"}],{grow:!0,onPick:()=>ae(t,"y")})]))])),e.append(V("Layout",[g("Size",i("div",{class:"row"},[f({key:"W",value:r.layout.width,onChange:n("width")}),f({key:"H",value:r.layout.height,onChange:n("height")})])),g("Display",k({value:r.layout.display,options:["block","inline","inline-block","flex","inline-flex","grid","none"],onChange:n("display")})),i("div",{class:"row"},[g("Row Gap",f({iconName:"paragraph-spacing",value:r.layout.rowGap,showUnit:!1,sm:!0,onChange:n("row-gap")})),g("Column Gap",f({iconName:"letter-spacing",value:r.layout.columnGap,showUnit:!1,sm:!0,onChange:n("column-gap")}))]),i("div",{class:"row"},[g("Horizontal Align",k({value:r.layout.justify,options:[["flex-start","Start"],["center","Center"],["flex-end","End"],["space-between","Between"]],onChange:n("justify-content")})),g("Vertical Align",k({value:r.layout.align,options:[["flex-start","Start"],["center","Center"],["flex-end","End"],["stretch","Stretch"]],onChange:n("align-items")}))])])),e.append(V("Spacing",[g("Padding",i("div",{class:"row"},[f({iconName:"horizontal-resize",value:r.spacing.padding.left,onChange:l=>{n("padding-left")(l),n("padding-right")(l)}}),f({iconName:"vertical-resize",value:r.spacing.padding.top,onChange:l=>{n("padding-top")(l),n("padding-bottom")(l)}})])),g("Margin",i("div",{class:"row"},[f({iconName:"horizontal-resize",value:r.spacing.margin.left,onChange:l=>{n("margin-left")(l),n("margin-right")(l)}}),f({iconName:"vertical-resize",value:r.spacing.margin.top,onChange:l=>{n("margin-top")(l),n("margin-bottom")(l)}})])),se({...r.spacing,width:r.layout.width,height:r.layout.height},(l,u)=>C(t,l,u))]));let d=[{key:"tl",prop:"border-top-left-radius",v:r.radius.tl},{key:"tr",prop:"border-top-right-radius",v:r.radius.tr},{key:"bl",prop:"border-bottom-left-radius",v:r.radius.bl},{key:"br",prop:"border-bottom-right-radius",v:r.radius.br}],h=new Set([r.radius.tl,r.radius.tr,r.radius.bl,r.radius.br]).size>1;e.append(V("Appearance",[i("div",{class:"row"},[g("Opacity",f({iconName:"transparency",value:String(Math.round((parseFloat(r.effects.opacity)||1)*100)),unit:"%",onChange:l=>n("opacity")((parseFloat(l)||100)/100)})),g("Corner",i("div",{class:"corner-mix"},[f({iconName:"full-screen",value:h?"mix":r.radius.all,showUnit:!1,onChange:n("border-radius")}),M([{icon:"full-screen",title:"Link corners"}],{onPick:()=>n("border-radius")(r.radius.tl)})]))]),i("div",{class:"corner-grid"},d.map(l=>f({iconName:"full-screen",value:l.v,showUnit:!1,onChange:n(l.prop)}))),le("Fill",()=>{this._fillOpen=!this._fillOpen,this.render()}),this._fillOpen?q(r.background.color,n("background-color")):null,le("Stroke",()=>{this._strokeOpen=!this._strokeOpen,this.render()}),this._strokeOpen?q(r.border.color,n("border-color")):null])),e.append(V("Typography",[g("Typeface",k({value:de(r.typography.fontFamily),options:[de(r.typography.fontFamily),"Quicksand","Inter","Arial","Georgia","system-ui","monospace"],onChange:n("font-family")})),i("div",{class:"row"},[k({value:Me(r.typography.fontWeight),options:[["300","Light"],["400","Regular"],["500","Medium"],["600","SemiBold"],["700","Bold"],["800","Extra"]],onChange:n("font-weight")}),k({value:parseInt(r.typography.fontSize)+"",options:["10","12","13","14","16","18","20","24","32","48"].map(l=>[l,l]),onChange:l=>n("font-size")(l+"px")})]),i("div",{class:"row"},[g("Line Height",f({iconName:"paragraph-spacing",value:Ve(r.typography.lineHeight),showUnit:!1,sm:!0,onChange:n("line-height")})),g("Letter Spacing",f({iconName:"letter-spacing",value:r.typography.letterSpacing,showUnit:!1,sm:!0,onChange:n("letter-spacing")}))]),i("div",{class:"row"},[g("Paragraph Spacing",f({iconName:"expand-paragraph",value:Ae(r.typography.marginBottom),sm:!0,onChange:n("margin-bottom")})),g("Alignment",M([{icon:"text-align-right",title:"Right",css:"right"},{icon:"text-align-center",title:"Center",css:"center"},{icon:"text-align-start",title:"Left",css:"left"},{icon:"text-align-justify",title:"Justify",css:"justify"}],{grow:!0,seg:!0,active:["right","center","left","justify"].indexOf(r.typography.textAlign),onPick:l=>n("text-align")(l.css)}))])]))}_code(e){let t=N();e.append(i("div",{class:"view-actions"},[i("button",{class:"btn primary",text:"Copy CSS",onclick:()=>this._copy()}),i("button",{class:"btn",text:"Reset",onclick:()=>{R(),this.render()}})]),t?i("pre",{class:"code",html:je(t)}):i("div",{class:"empty",text:"No edits yet. Change a property in the Design view and the generated CSS appears here."}))}_html(e){let t=this.selected;if(!t)return e.append(i("div",{class:"empty",text:"No element selected."}));let r=t.cloneNode(!1);r.removeAttribute("data-inspect-id"),e.append(i("pre",{class:"code",html:ce(r.outerHTML.replace(/></,`>
  \u2026
<`))}))}_copy(){var t;let e=N();e&&((t=navigator.clipboard)==null||t.writeText(e).then(()=>this._toast("CSS copied")))}_toast(e){let t=i("div",{class:"toast","data-inspect-ui":"",text:e});this.root.appendChild(t),setTimeout(()=>t.remove(),1400)}_drag(){let e,t,r,n,s=!1;this.el.addEventListener("mousedown",d=>{if(!d.target.closest(".head")||d.target.closest(".hbtn"))return;s=!0;let l=this.el.getBoundingClientRect();e=d.clientX,t=d.clientY,r=l.left,n=l.top,this.el.style.right="auto",document.addEventListener("mousemove",a,!0),document.addEventListener("mouseup",p,!0),d.preventDefault()});let a=d=>{s&&(this.el.style.left=r+(d.clientX-e)+"px",this.el.style.top=Math.max(0,n+(d.clientY-t))+"px")},p=()=>{s=!1,document.removeEventListener("mousemove",a,!0),document.removeEventListener("mouseup",p,!0)}}};function G(o,e,t,r=""){return i("button",{class:"hbtn"+(r?" "+r:""),title:e,onclick:t,html:x(o)})}function le(o,e){return i("div",{class:"addrow"},[i("span",{class:"k",text:o}),i("button",{class:"addbtn",title:"Add "+o,html:x("plus"),onclick:e})])}function ye(o){let e=[],t=o,r=0;for(;t&&t.nodeType===1&&t!==document.documentElement&&r<3;)t.classList.length?e.unshift("."+t.classList[0]):e.unshift(t.tagName.toLowerCase()),t=t.parentElement,r++;return e}function ae(o,e){let t=getComputedStyle(o),r=t.transform==="none"?"":t.transform+" ";C(o,"transform",r+(e==="x"?"scaleX(-1)":"scaleY(-1)"))}function de(o){return(o||"").split(",")[0].replace(/["']/g,"").trim()||"system-ui"}function Me(o){return String(o)}function Ve(o){return o==="normal"?"1.4":o}function Ae(o){return o&&o!=="auto"?o:"0px"}function ce(o){return o.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function je(o){return ce(o).replace(/^([^{\n]+)\{/gm,'<span class="sel">$1</span>{').replace(/^(\s+)([\w-]+)(:)/gm,'$1<span class="prop">$2</span>$3').replace(/: ([^;]+);/g,': <span class="val">$1</span>;')}var I=class{constructor(e,t){this.api=t,this.el=i("div",{class:"dock","data-inspect-ui":""}),e.appendChild(this.el),this.render(),c.subscribe(()=>this.sync())}render(){this.el.innerHTML="",this.pauseBtn=pe("pause","Pause / resume picking",()=>c.set({active:!c.get().active}));let e=i("div",{class:"dock-group"},[w("undo-03","Undo",()=>{var r,n;return(n=(r=this.api).undo)==null?void 0:n.call(r)}),w("redo-01","Redo",()=>{var r,n;return(n=(r=this.api).redo)==null?void 0:n.call(r)}),T(),w("layer-bring-forward","Bring forward",()=>{var r,n;return(n=(r=this.api).bump)==null?void 0:n.call(r,1)}),w("layer-send-backward","Send backward",()=>{var r,n;return(n=(r=this.api).bump)==null?void 0:n.call(r,-1)}),T(),this.designBtn=w("component","Design",()=>c.set({view:"design",collapsed:!1})),this.codeBtn=w("file-diff","Generated CSS",()=>c.set({view:"code",collapsed:!1})),this.htmlBtn=w("html-file-01","HTML",()=>c.set({view:"html",collapsed:!1})),T(),w("laptop-phone-sync","Toggle responsive preview",()=>{var r,n;return(n=(r=this.api).toggleResponsive)==null?void 0:n.call(r)})]),t=pe("cancel-01","Exit InspectCSS",()=>{var r;return(r=window.InspectCSS)==null?void 0:r.destroy()});this.el.append(this.pauseBtn,e,t),this.sync()}sync(){var t,r,n,s;let e=c.get();(t=this.pauseBtn)==null||t.classList.toggle("active",e.active),(r=this.designBtn)==null||r.classList.toggle("active",e.view==="design"),(n=this.codeBtn)==null||n.classList.toggle("active",e.view==="code"),(s=this.htmlBtn)==null||s.classList.toggle("active",e.view==="html")}};function pe(o,e,t){return i("button",{class:"dock-circle",title:e,onclick:t,html:x(o)})}function w(o,e,t){return i("button",{class:"dock-btn",title:e,onclick:t,html:x(o)})}function T(){return i("div",{class:"dock-sep"})}var ue=`@font-face {
...
`;var O=class{constructor(){this.host=document.createElement("div"),this.host.setAttribute("data-inspect-ui",""),this.host.style.cssText="all: initial; position: static;";let e=this.host.attachShadow({mode:"open"}),t=document.createElement("style");t.textContent=he;let r=document.createElement("div");r.className="wrap",e.append(t,r),document.documentElement.appendChild(this.host),this.overlay=new j(document.documentElement),this.panel=new E(r),this.toolbar=new I(r,{undo:()=>{te(),this.panel.render()},redo:()=>{oe(),this.panel.render()},bump:n=>this.bumpZ(n),toggleResponsive:()=>this.toggleResponsive()}),this.inspector=new L(this.overlay,n=>this.select(n)),this._prevView=c.get().view,this._prevCollapsed=c.get().collapsed,this.unsub=c.subscribe(n=>this.onState(n)),this._track=()=>{this._raf||(this._raf=requestAnimationFrame(()=>{this._raf=0;let n=c.get();n.hoverEl&&this.overlay.highlight(n.hoverEl),n.selectedEl&&this.overlay.select(n.selectedEl)}))},window.addEventListener("scroll",this._track,!0),window.addEventListener("resize",this._track,!0),c.set({active:!0}),this.panel.render()}select(e){c.set({selectedEl:e,active:!1}),this.overlay.select(e),this.panel.set(e)}bumpZ(e){let t=c.get().selectedEl;if(!t)return;let r=parseInt(getComputedStyle(t).zIndex)||0;C(t,"position",getComputedStyle(t).position==="static"?"relative":getComputedStyle(t).position),C(t,"z-index",String(r+e)),this.panel.render()}toggleResponsive(){this._resp=!this._resp;let e=document.documentElement;this._resp?(e.style.maxWidth="420px",e.style.margin="0 auto",e.style.transition="max-width .2s"):(e.style.maxWidth="",e.style.margin="");let t=c.get();t.selectedEl&&this.overlay.select(t.selectedEl)}onState(e){e.active&&!this._picking?(this._picking=!0,this.inspector.start()):!e.active&&this._picking&&(this._picking=!1,this.inspector.stop()),e.selectedEl&&this.overlay.select(e.selectedEl),(e.view!==this._prevView||e.collapsed!==this._prevCollapsed)&&(this._prevView=e.view,this._prevCollapsed=e.collapsed,this.panel.render())}destroy(){var t;(t=this.unsub)==null||t.call(this),window.removeEventListener("scroll",this._track,!0),window.removeEventListener("resize",this._track,!0),this.inspector.stop(),this.overlay.destroy(),this.host.remove(),this.toggleResponsiveOff();let e=document.getElementById("inspect-css-live-styles");e&&e.remove(),delete window.InspectCSS}toggleResponsiveOff(){document.documentElement.style.maxWidth="",document.documentElement.style.margin=""}};function Le(){if(window.InspectCSS){window.InspectCSS.destroy();return}let o=new O;window.InspectCSS={app:o,destroy:()=>o.destroy(),version:"0.3.0"}}Le();})();
