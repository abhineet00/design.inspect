(()=>{var T={active:!1,hoverEl:null,selectedEl:null,pseudo:"none",view:"design",edits:new Map,panelPos:{x:null,y:16},collapsed:!1,editing:!1,dragging:!1},q=new Set,c={get:()=>T,set(n){Object.assign(T,n),q.forEach(e=>e(T))},subscribe(n){return q.add(n),()=>q.delete(n)}};var ke=0,G="data-inspect-id";function ne(n){let e=n.getAttribute(G);return e||(e="ic-"+ ++ke,n.setAttribute(G,e)),e}function D(n){return`[${G}="${n}"]`}function m(n,e=2){if(n==null||Number.isNaN(n))return 0;let t=Math.pow(10,e);return Math.round(n*t)/t}function i(n,e={},t=[]){let o=document.createElement(n);for(let[r,s]of Object.entries(e))r==="class"?o.className=s:r==="style"&&typeof s=="object"?Object.assign(o.style,s):r==="html"?o.innerHTML=s:r==="text"?o.textContent=s:r.startsWith("on")&&typeof s=="function"?o.addEventListener(r.slice(2).toLowerCase(),s):s!==!1&&s!=null&&o.setAttribute(r,s===!0?"":s);for(let r of[].concat(t))r==null||r===!1||o.appendChild(typeof r=="string"?document.createTextNode(r):r);return o}function j(n){if(!n||n.nodeType!==1)return"";let e=n.tagName.toLowerCase();return n.id?e+="#"+n.id:n.classList.length&&(e+="."+n.classList[0]),e}function L(n){if(n==null)return{value:0,unit:"px"};let e=String(n).trim().match(/^(-?[\d.]+)\s*([a-z%]*)$/i);return e?{value:parseFloat(e[1]),unit:e[2]||"px"}:{value:n,unit:""}}function z(n){if(!n)return{hex:"#000000",alpha:1};if(n.startsWith("#"))return{hex:n,alpha:1};let e=n.match(/rgba?\(([^)]+)\)/i);if(!e)return{hex:"#000000",alpha:1};let t=e[1].split(",").map(l=>l.trim()),[o,r,s]=t.map(l=>parseInt(l,10)),a=t[3]!=null?parseFloat(t[3]):1;return{hex:"#"+[o,r,s].map(l=>Math.max(0,Math.min(255,l||0)).toString(16).padStart(2,"0")).join(""),alpha:a}}function re(n,e=1){let t=n.replace("#",""),o=t.length===3?t.split("").map(p=>p+p).join(""):t.padEnd(6,"0"),r=parseInt(o.slice(0,2),16),s=parseInt(o.slice(2,4),16),a=parseInt(o.slice(4,6),16);return e>=1?`rgb(${r}, ${s}, ${a})`:`rgba(${r}, ${s}, ${a}, ${m(e,3)})`}function C(n){return!!(n&&n.closest&&n.closest("[data-inspect-ui]"))}var I=class{constructor(e){this.el=i("div",{"data-inspect-ui":"",style:{position:"fixed",inset:"0",pointerEvents:"none",zIndex:"2147483640"}}),this.margin=this._box("rgba(246, 178, 107, 0.28)"),this.padding=this._box("rgba(147, 196, 125, 0.30)"),this.content=i("div",{style:this._boxStyle("transparent","#4c8dff")}),this.selected=i("div",{style:this._boxStyle("transparent","#7c5cff")}),this.badge=i("div",{"data-inspect-ui":"",style:{position:"fixed",font:"500 12px/1.4 'Quicksand', -apple-system, 'Segoe UI', Roboto, sans-serif",color:"rgba(255,255,255,0.6)",background:"rgba(0,0,0,0.82)",border:"1px solid rgba(255,255,255,0.12)",padding:"4px 9px",borderRadius:"8px",whiteSpace:"nowrap",pointerEvents:"none",boxShadow:"0 6px 20px rgba(0,0,0,.45)",backdropFilter:"blur(6px)"}}),this.el.append(this.margin,this.padding,this.content,this.selected,this.badge),e.appendChild(this.el),this.hideHover(),this.hideSelected()}_box(e){return i("div",{style:{position:"fixed",background:e,pointerEvents:"none"}})}_boxStyle(e,t){return{position:"fixed",background:e,outline:`1px solid ${t}`,outlineOffset:"-1px",pointerEvents:"none"}}_place(e,t){Object.assign(e.style,{left:t.left+"px",top:t.top+"px",width:Math.max(0,t.width)+"px",height:Math.max(0,t.height)+"px",display:"block"})}highlight(e){if(!e)return this.hideHover();let t=getComputedStyle(e),o=e.getBoundingClientRect(),r=ie(t,"margin"),s=ie(t,"padding");this._place(this.margin,{left:o.left-r.left,top:o.top-r.top,width:o.width+r.left+r.right,height:o.height+r.top+r.bottom}),this._place(this.content,o),this._place(this.padding,o);let a=j(e);this.badge.innerHTML=`<span style="color:#58aeff">${ye(a)}</span><span style="opacity:.5">&nbsp;&nbsp;${m(o.width)} \xD7 ${m(o.height)}</span>`,this.badge.style.display="block";let p=o.top>24?o.top-22:o.bottom+6;this.badge.style.left=Math.max(4,o.left)+"px",this.badge.style.top=p+"px"}select(e){if(!e)return this.hideSelected();this._place(this.selected,e.getBoundingClientRect())}hideHover(){[this.margin,this.padding,this.content,this.badge].forEach(e=>e.style.display="none")}hideSelected(){this.selected.style.display="none"}destroy(){this.el.remove()}};function ie(n,e){let t=o=>parseFloat(n.getPropertyValue(`${e}-${o}`))||0;return{top:t("top"),right:t("right"),bottom:t("bottom"),left:t("left")}}function ye(n){return String(n).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}var S=class{constructor(e,t){this.overlay=e,this.onSelect=t,this._onMove=this._onMove.bind(this),this._onClick=this._onClick.bind(this),this._onKey=this._onKey.bind(this),this._onScroll=this._onScroll.bind(this)}start(){document.addEventListener("mousemove",this._onMove,!0),document.addEventListener("click",this._onClick,!0),document.addEventListener("keydown",this._onKey,!0),window.addEventListener("scroll",this._onScroll,!0),window.addEventListener("resize",this._onScroll,!0),document.documentElement.style.cursor="crosshair"}stop(){document.removeEventListener("mousemove",this._onMove,!0),document.removeEventListener("click",this._onClick,!0),document.removeEventListener("keydown",this._onKey,!0),window.removeEventListener("scroll",this._onScroll,!0),window.removeEventListener("resize",this._onScroll,!0),document.documentElement.style.cursor="",this.overlay.hideHover(),c.set({hoverEl:null})}_target(e){let t=document.elementFromPoint(e.clientX,e.clientY);return!t||C(t)||t===document.documentElement||t===document.body?null:t}_onMove(e){if(c.get().editing||c.get().dragging)return;let t=this._target(e);if(!t)return this.overlay.hideHover();t!==c.get().hoverEl&&(c.set({hoverEl:t}),this.overlay.highlight(t))}_onClick(e){if(C(e.target)||c.get().editing||c.get().dragging)return;let t=this._target(e);t&&(e.preventDefault(),e.stopPropagation(),this.onSelect(t))}_onKey(e){e.key==="Escape"&&(e.preventDefault(),c.set({active:!1}))}_onScroll(){let{hoverEl:e,selectedEl:t}=c.get();e&&this.overlay.highlight(e),t&&this.overlay.select(t)}};function Me(n){return n&&!/[^a-zA-Z0-9_-]/.test(n)&&!/^(is-|has-|js-)/.test(n)?!0:n&&!/[^a-zA-Z0-9_-]/.test(n)}function Ve(n){let e=1,t=n;for(;t=t.previousElementSibling;)t.tagName===n.tagName&&e++;return e}function Ae(n){let e=n.tagName.toLowerCase();if(n.id&&document.querySelectorAll("#"+CSS.escape(n.id)).length===1)return"#"+n.id;let t=Array.from(n.classList).filter(Me).slice(0,2);return t.length?e+"."+t.map(r=>r).join("."):`${e}:nth-of-type(${Ve(n)})`}function se(n,e=4){if(!n||n.nodeType!==1)return"";let t=[],o=n;for(;o&&o.nodeType===1&&o!==document.documentElement;){let r=Ae(o);if(t.unshift(r),r.startsWith("#"))break;try{if(document.querySelectorAll(t.join(" > ")).length===1)break}catch{}if(o=o.parentElement,t.length>=e)break}return t.join(" > ")}var le="inspect-css-live-styles";function Le(){let n=document.getElementById(le);return n||(n=document.createElement("style"),n.id=le,n.setAttribute("data-inspect-ui",""),document.head.appendChild(n)),n}var y=[],H=[];function O(){let{edits:n}=c.get();return[...n.entries()].map(([e,t])=>[e,{inspectId:t.inspectId,pseudo:t.pseudo,selector:t.selector,props:[...t.props.entries()]}])}function ae(n){let e=new Map;for(let[t,o]of n)e.set(t,{inspectId:o.inspectId,pseudo:o.pseudo,selector:o.selector,props:new Map(o.props)});c.get().edits=e,F(),c.set({edits:e})}function Ee(){y.push(O()),y.length>100&&y.shift(),H.length=0}function de(){y.length&&(H.push(O()),ae(y.pop()))}function ce(){H.length&&(y.push(O()),ae(H.pop()))}function M(n,e,t){Ee();let o=ne(n),{edits:r,pseudo:s}=c.get(),a=s==="none"?o:`${o}::${s}`,p=r.get(a);p||(p={inspectId:o,pseudo:s,selector:se(n),props:new Map},r.set(a,p)),t===""||t==null?p.props.delete(e):p.props.set(e,t),p.props.size===0&&r.delete(a),F(),c.set({edits:r})}function X(n,e="none"){let t=n.getAttribute("data-inspect-id");if(!t)return new Map;let o=e==="none"?t:`${t}::${e}`,r=c.get().edits.get(o);return r?r.props:new Map}function F(){let{edits:n}=c.get(),e=[];for(let t of n.values()){if(t.props.size===0)continue;let o=D(t.inspectId)+(t.pseudo!=="none"?":"+t.pseudo:""),r=[...t.props.entries()].map(([s,a])=>`  ${s}: ${a} !important;`).join(`
`);e.push(`${o} {
${r}
}`)}Le().textContent=e.join(`

`)}function W(){let{edits:n}=c.get(),e=[];for(let t of n.values()){if(t.props.size===0)continue;let o=(t.selector||D(t.inspectId))+(t.pseudo!=="none"?":"+t.pseudo:""),r=[...t.props.entries()].map(([s,a])=>`  ${s}: ${a};`).join(`
`);e.push(`${o} {
${r}
}`)}return e.join(`

`)}function J(){c.get().edits.clear(),F(),c.set({edits:c.get().edits})}function x(n,e,t,o=t){let r=X(n,c.get().pseudo).get(t);return r!=null?r:e.getPropertyValue(o).trim()}function _(n){let e=getComputedStyle(n),t=n.getBoundingClientRect();return{rect:t,tag:n.tagName.toLowerCase(),layout:{display:x(n,e,"display"),position:x(n,e,"position"),width:e.width,height:e.height,x:m(t.left+window.scrollX),y:m(t.top+window.scrollY),rowGap:e.rowGap==="normal"?"0":e.rowGap,columnGap:e.columnGap==="normal"?"0":e.columnGap,justify:x(n,e,"justify-content"),align:x(n,e,"align-items")},transform:je(n,e),spacing:{margin:pe(e,"margin"),padding:pe(e,"padding")},radius:{all:x(n,e,"border-radius"),tl:e.borderTopLeftRadius,tr:e.borderTopRightRadius,br:e.borderBottomRightRadius,bl:e.borderBottomLeftRadius},typography:{fontFamily:e.fontFamily,fontSize:x(n,e,"font-size"),fontWeight:x(n,e,"font-weight"),lineHeight:e.lineHeight,letterSpacing:e.letterSpacing==="normal"?"0px":e.letterSpacing,textAlign:x(n,e,"text-align"),color:x(n,e,"color"),marginBottom:x(n,e,"margin-bottom")},background:{color:x(n,e,"background-color"),image:e.backgroundImage},border:{width:e.borderTopWidth,style:e.borderTopStyle,color:e.borderTopColor},effects:{opacity:x(n,e,"opacity"),boxShadow:e.boxShadow==="none"?"":e.boxShadow}}}function pe(n,e){return{top:n.getPropertyValue(`${e}-top`),right:n.getPropertyValue(`${e}-right`),bottom:n.getPropertyValue(`${e}-bottom`),left:n.getPropertyValue(`${e}-left`)}}function je(n,e){let o=X(n,c.get().pseudo).get("transform")||e.transform,r={tx:0,ty:0,rotate:0};if(!o||o==="none")return r;let s=/translate\(\s*(-?[\d.]+)px\s*,\s*(-?[\d.]+)px\s*\)/.exec(o),a=/rotate\(\s*(-?[\d.]+)deg\s*\)/.exec(o);if(s&&(r.tx=parseFloat(s[1]),r.ty=parseFloat(s[2])),a&&(r.rotate=parseFloat(a[1])),s||a)return r;let p=/matrix\(([^)]+)\)/.exec(o);if(p){let[l,h,,,d,v]=p[1].split(",").map(parseFloat);r.tx=m(d),r.ty=m(v),r.rotate=m(Math.atan2(h,l)*(180/Math.PI))}return r}function he({tx:n=0,ty:e=0,rotate:t=0}){let o=[];return(n||e)&&o.push(`translate(${m(n)}px, ${m(e)}px)`),t&&o.push(`rotate(${m(t)}deg)`),o.length?o.join(" "):""}var ze=6e3,K=n=>n.closest&&n.closest("[data-inspect-ui]");function $(){let n=document.body?document.body.querySelectorAll("*"):[],e=[];for(let t=0;t<n.length&&e.length<ze;t++)K(n[t])||e.push(n[t]);return e}function Ie(n,e,t){let o=n.get(e);o?o.count++:n.set(e,{...t,count:1})}function Se(){let n=new Map,e=["color","background-color","border-top-color","border-right-color","border-bottom-color","border-left-color","outline-color","fill","stroke"];for(let t of $()){let o=getComputedStyle(t);for(let r of e){let s=o.getPropertyValue(r).trim();if(!s||s==="none")continue;let{hex:a,alpha:p}=z(s);if(p===0||a==="#000000"&&r==="fill")continue;let l=a+"|"+p;Ie(n,l,{hex:a,alpha:p,css:s})}}return[...n.values()].sort((t,o)=>o.count-t.count).slice(0,80)}function He(){let n=new Map;for(let e of $()){if(![...e.childNodes].some(d=>d.nodeType===3&&d.textContent.trim()))continue;let o=getComputedStyle(e),r=(o.fontFamily||"").split(",")[0].replace(/["']/g,"").trim(),s=o.fontSize,a=o.fontWeight,p=`${r}|${s}|${a}`,l=e.textContent.trim().slice(0,40),h=n.get(p);h?h.count++:n.set(p,{family:r,size:s,weight:a,lineHeight:o.lineHeight,letterSpacing:o.letterSpacing,sample:l,count:1})}return[...n.values()].sort((e,t)=>parseFloat(t.size)-parseFloat(e.size)||t.count-e.count).slice(0,60)}function Ke(){let n=[],e=new Set;for(let t of document.querySelectorAll("svg")){if(K(t))continue;let o=t.outerHTML;/xmlns=/.test(o)||(o=o.replace("<svg",'<svg xmlns="http://www.w3.org/2000/svg"'));let r=o.slice(0,400);if(e.has(r)||o.length>4e4)continue;e.add(r);let s=t.getBoundingClientRect();if(n.push({type:"inline",markup:o,w:Math.round(s.width),h:Math.round(s.height)}),n.length>120)break}for(let t of document.querySelectorAll('img[src$=".svg"], img[src*=".svg?"]'))K(t)||e.has(t.src)||(e.add(t.src),n.push({type:"url",src:t.src,markup:""}));return n}function Ze(){let n=[],e=new Set,t=o=>{!o||e.has(o)||o.endsWith(".svg")||o.startsWith("data:image/svg")||(e.add(o),n.push({src:o}))};for(let o of document.querySelectorAll("img"))K(o)||(o.currentSrc||o.src)&&t(o.currentSrc||o.src);for(let o of $()){let r=getComputedStyle(o).backgroundImage;if(!r||r==="none")continue;let s,a=/url\((['"]?)([^'")]+)\1\)/g;for(;s=a.exec(r);)t(new URL(s[2],location.href).href);if(n.length>120)break}return n}function ue(){return{colors:Se(),typography:He(),svgs:Ke(),images:Ze()}}var Ue={"align-bottom":`<svg preserveAspectRatio="xMidYMid meet" overflow="visible" style="display: block;" width="100%" height="100%" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
<g id="align-bottom">
...
</svg>`};function w(n){return Ue[n]||""}function ge(n){return i("span",{class:"fic",html:w(n)})}function Re(){return i("span",{class:"chev-mini",html:w("chevron-down")})}function f({key:n,iconName:e,value:t,unit:o="px",onChange:r,showUnit:s=!0,sm:a=!1}){let p=L(t),l=/[a-z%]/i.test(String(t!=null?t:"")),h=i("input",{value:p.value,type:"text",inputmode:"decimal"}),d=s?i("span",{class:"unit",text:l?p.unit:o}):null,v=()=>{let g=h.value.trim();if(g==="")return r("");let Y=/^-?[\d.]+$/.test(g);r(Y&&s?g+((d==null?void 0:d.textContent)||o):g)};if(h.addEventListener("change",v),h.addEventListener("keydown",g=>{if(g.key==="Enter")return h.blur();if(g.key==="ArrowUp"||g.key==="ArrowDown"){let Y=parseFloat(h.value)||0;h.value=+(Y+(g.key==="ArrowUp"?1:-1)*(g.shiftKey?10:1)).toFixed(2),v(),g.preventDefault()}}),s&&d){let g=["px","%","em","rem","vw","vh"];d.style.cursor="pointer",d.addEventListener("click",()=>{d.textContent=g[(g.indexOf(d.textContent)+1)%g.length],v()})}return i("div",{class:"field"+(a?" sm":"")},[e?ge(e):n?i("span",{class:"fk",text:n}):null,h,d])}function k({value:n,options:e,onChange:t,iconName:o,key:r,sm:s=!0}){let a=i("select",{});for(let p of e){let[l,h]=Array.isArray(p)?p:[p,p],d=i("option",{value:l,text:h});String(l)===String(n)&&(d.selected=!0),a.appendChild(d)}return a.addEventListener("change",()=>t(a.value)),i("div",{class:"field select-like"+(s?" sm":"")},[o?ge(o):r?i("span",{class:"fk",text:r}):null,a,Re()])}function V(n,{active:e=-1,grow:t=!1,seg:o=!1,onPick:r}={}){let s=i("div",{class:"iconrow"+(t?" grow":"")+(o?" seg":"")});return n.forEach((a,p)=>{let l=i("button",{class:"ibtn"+(p===e?" active":""),title:a.title||"",html:w(a.icon),onclick:()=>r==null?void 0:r(a,p,l)});s.appendChild(l)}),s}function ee(n,e,{showPct:t=!0}={}){let o=z(n),r=o.hex,s=o.alpha===0?1:o.alpha,a=i("input",{type:"color",value:r}),p=i("div",{class:"swatch"},[a]);p.style.background=n&&n!=="rgba(0, 0, 0, 0)"?n:"transparent";let l=i("input",{class:"hex",value:r.replace("#","")}),h=t?i("span",{class:"pct",text:Math.round(s*100)+"%"}):null,d=v=>{let g=re(v,s);p.style.background=g,e(g)};return a.addEventListener("input",()=>{l.value=a.value.replace("#",""),d(a.value)}),l.addEventListener("change",()=>{let v=l.value.trim().replace(/^#/,"");/^([0-9a-f]{3}|[0-9a-f]{6})$/i.test(v)?(a.value="#"+v,d("#"+v)):e(l.value.trim())}),i("div",{class:"colorline"},[p,l,h])}function A(n,e,{open:t=!0}={}){let o=i("div",{class:"sec-content"},e),r=i("div",{class:"sec-head"},[i("span",{text:n}),i("span",{class:"chev",html:w("chevron-down")})]),s=i("div",{class:"section"+(t?"":" closed")},[r,o]);return r.addEventListener("click",()=>s.classList.toggle("closed")),s}function u(n,e){return i("div",{class:"stack"},[i("span",{class:"label",text:n}),e])}function fe(n,e){let t=(a,p)=>{let l=i("input",{class:"sp-edge",value:L(n[a][p]).value});return l.addEventListener("change",()=>{let h=l.value.trim();e(`${a}-${p}`,/^-?[\d.]+$/.test(h)?h+"px":h)}),l},o=(a,p,l,h)=>i("div",{class:p},[i("span",{class:"sp-tag",text:l}),t(a,"top"),i("div",{class:"sp-mid"},[t(a,"left"),h,t(a,"right")]),t(a,"bottom")]),r=i("div",{class:"sp-size"},[i("span",{class:"sp-tag",text:"Size"}),i("span",{html:`${L(n.width||"0").value} <span class="sp-x">x</span> ${L(n.height||"0").value}`})]),s=o("padding","sp-box sp-padding","Padding",r);return o("margin","sp-box sp-margin","Margin",s)}var U=class{constructor(e){this.root=e,this.el=i("div",{class:"panel","data-inspect-ui":""}),e.appendChild(this.el),this._drag()}set(e){this.selected=e,this.render()}render(){let e=c.get();this.el.classList.toggle("hidden",e.collapsed),this.el.innerHTML="",this.el.append(this._head());let t=i("div",{class:"panel-body"});e.view==="assets"?this._assets(t):this.selected?e.view==="code"?this._code(t):e.view==="html"?this._html(t):this._design(t):t.append(i("div",{class:"empty",text:"Pick an element on the page to inspect and edit its styles."})),this.el.append(t)}_head(){if(c.get().view==="assets")return i("div",{class:"head"},[i("div",{class:"head-top"},[i("div",{class:"head-title",text:"Assets"}),i("div",{class:"head-actions"},[E("minimize-screen","Collapse panel",()=>c.set({collapsed:!0})),E("x","Close",()=>{var s;return(s=window.InspectCSS)==null?void 0:s.destroy()})])]),i("div",{class:"crumb",style:{color:"var(--muted)"},text:"Everything this page uses"})]);let t=this.selected,o=t?_(t):null,r=t?Be(t):[];return i("div",{class:"head"},[i("div",{class:"head-top"},[i("div",{class:"head-title",text:t?j(t)||o.tag:"InspectCSS"}),i("div",{class:"head-actions"},[E("delete02","Reset all edits",()=>{J(),this.render()},"danger"),E("minimize-screen","Collapse panel",()=>c.set({collapsed:!0})),E("x","Close",()=>{var s;return(s=window.InspectCSS)==null?void 0:s.destroy()})])]),t?i("div",{class:"crumb"},r.map(s=>i("span",{text:s}))):null,t?i("div",{class:"dims"},[i("span",{html:`<b>${m(o.rect.width)}</b> x <b>${m(o.rect.height)}</b> px`}),i("span",{html:`A <b>${parseInt(o.typography.fontSize)}px</b>`})]):i("div",{class:"crumb",text:"no selection"})])}_design(e){let t=this.selected,o=_(t),r=d=>v=>M(t,d,v),s=o.transform,a=d=>{Object.assign(s,d),M(t,"transform",he(s))},p=[{icon:"align-left",title:"Align left",css:["justify-content","flex-start"]},{icon:"align-bottom",title:"Align bottom",css:["align-items","flex-end"]},{icon:"align-right",title:"Align right",css:["justify-content","flex-end"]},{icon:"align-top",title:"Align top",css:["align-items","flex-start"]},{icon:"align-horizontal-center",title:"Center horizontally",css:["justify-content","center"]},{icon:"align-vertical-center",title:"Center vertically",css:["align-items","center"]}];e.append(A("Position",[u("Alignment",V(p,{grow:!0,seg:!0,onPick:d=>M(t,d.css[0],d.css[1])})),u("Position",i("div",{class:"row"},[f({key:"X",value:s.tx+"px",onChange:d=>a({tx:parseFloat(d)||0})}),f({key:"Y",value:s.ty+"px",onChange:d=>a({ty:parseFloat(d)||0})})])),u("Rotation",i("div",{class:"rot-row"},[f({iconName:"rotate01",value:s.rotate+"",showUnit:!1,onChange:d=>a({rotate:parseFloat(d)||0})}),V([{icon:"image-flip-horizontal",title:"Flip horizontal"}],{grow:!0,onPick:()=>ve(t,"x")}),V([{icon:"image-flip-vertical",title:"Flip vertical"}],{grow:!0,onPick:()=>ve(t,"y")})]))])),e.append(A("Layout",[u("Size",i("div",{class:"row"},[f({key:"W",value:o.layout.width,onChange:r("width")}),f({key:"H",value:o.layout.height,onChange:r("height")})])),u("Display",k({value:o.layout.display,options:["block","inline","inline-block","flex","inline-flex","grid","none"],onChange:r("display")})),i("div",{class:"row"},[u("Row Gap",f({iconName:"paragraph-spacing",value:o.layout.rowGap,showUnit:!1,sm:!0,onChange:r("row-gap")})),u("Column Gap",f({iconName:"letter-spacing",value:o.layout.columnGap,showUnit:!1,sm:!0,onChange:r("column-gap")}))]),i("div",{class:"row"},[u("Horizontal Align",k({value:o.layout.justify,options:[["flex-start","Start"],["center","Center"],["flex-end","End"],["space-between","Between"]],onChange:r("justify-content")})),u("Vertical Align",k({value:o.layout.align,options:[["flex-start","Start"],["center","Center"],["flex-end","End"],["stretch","Stretch"]],onChange:r("align-items")}))])])),e.append(A("Spacing",[u("Padding",i("div",{class:"row"},[f({iconName:"horizontal-resize",value:o.spacing.padding.left,onChange:d=>{r("padding-left")(d),r("padding-right")(d)}}),f({iconName:"vertical-resize",value:o.spacing.padding.top,onChange:d=>{r("padding-top")(d),r("padding-bottom")(d)}})])),u("Margin",i("div",{class:"row"},[f({iconName:"horizontal-resize",value:o.spacing.margin.left,onChange:d=>{r("margin-left")(d),r("margin-right")(d)}}),f({iconName:"vertical-resize",value:o.spacing.margin.top,onChange:d=>{r("margin-top")(d),r("margin-bottom")(d)}})])),fe({...o.spacing,width:o.layout.width,height:o.layout.height},(d,v)=>M(t,d,v))]));let l=[{key:"tl",prop:"border-top-left-radius",v:o.radius.tl},{key:"tr",prop:"border-top-right-radius",v:o.radius.tr},{key:"bl",prop:"border-bottom-left-radius",v:o.radius.bl},{key:"br",prop:"border-bottom-right-radius",v:o.radius.br}],h=new Set([o.radius.tl,o.radius.tr,o.radius.bl,o.radius.br]).size>1;e.append(A("Appearance",[i("div",{class:"row"},[u("Opacity",f({iconName:"transparency",value:String(Math.round((parseFloat(o.effects.opacity)||1)*100)),unit:"%",onChange:d=>r("opacity")((parseFloat(d)||100)/100)})),u("Corner",i("div",{class:"corner-mix"},[f({iconName:"full-screen",value:h?"mix":o.radius.all,showUnit:!1,onChange:r("border-radius")}),V([{icon:"full-screen",title:"Link corners"}],{onPick:()=>r("border-radius")(o.radius.tl)})]))]),i("div",{class:"corner-grid"},l.map(d=>f({iconName:"full-screen",value:d.v,showUnit:!1,onChange:r(d.prop)}))),me("Fill",()=>{this._fillOpen=!this._fillOpen,this.render()}),this._fillOpen?ee(o.background.color,r("background-color")):null,me("Stroke",()=>{this._strokeOpen=!this._strokeOpen,this.render()}),this._strokeOpen?ee(o.border.color,r("border-color")):null])),e.append(A("Typography",[u("Typeface",k({value:xe(o.typography.fontFamily),options:[xe(o.typography.fontFamily),"Quicksand","Inter","Arial","Georgia","system-ui","monospace"],onChange:r("font-family")})),i("div",{class:"row"},[k({value:Qe(o.typography.fontWeight),options:[["300","Light"],["400","Regular"],["500","Medium"],["600","SemiBold"],["700","Bold"],["800","Extra"]],onChange:r("font-weight")}),k({value:parseInt(o.typography.fontSize)+"",options:["10","12","13","14","16","18","20","24","32","48"].map(d=>[d,d]),onChange:d=>r("font-size")(d+"px")})]),i("div",{class:"row"},[u("Line Height",f({iconName:"paragraph-spacing",value:Pe(o.typography.lineHeight),showUnit:!1,sm:!0,onChange:r("line-height")})),u("Letter Spacing",f({iconName:"letter-spacing",value:o.typography.letterSpacing,showUnit:!1,sm:!0,onChange:r("letter-spacing")}))]),i("div",{class:"row"},[u("Paragraph Spacing",f({iconName:"expand-paragraph",value:Ne(o.typography.marginBottom),sm:!0,onChange:r("margin-bottom")})),u("Alignment",V([{icon:"text-align-right",title:"Right",css:"right"},{icon:"text-align-center",title:"Center",css:"center"},{icon:"text-align-start",title:"Left",css:"left"},{icon:"text-align-justify",title:"Justify",css:"justify"}],{grow:!0,seg:!0,active:["right","center","left","justify"].indexOf(o.typography.textAlign),onPick:d=>r("text-align")(d.css)}))])]))}_code(e){let t=W();e.append(i("div",{class:"view-actions"},[i("button",{class:"btn primary",text:"Copy CSS",onclick:()=>this._copy()}),i("button",{class:"btn",text:"Reset",onclick:()=>{J(),this.render()}})]),t?i("pre",{class:"code",html:Ye(t)}):i("div",{class:"empty",text:"No edits yet. Change a property in the Design view and the generated CSS appears here."}))}_html(e){let t=this.selected;if(!t)return e.append(i("div",{class:"empty",text:"No element selected."}));let o=t.cloneNode(!1);o.removeAttribute("data-inspect-id"),e.append(i("pre",{class:"code",html:we(o.outerHTML.replace(/></,`>
  \u2026
<`))}))}_copy(){var t;let e=W();e&&((t=navigator.clipboard)==null||t.writeText(e).then(()=>this._toast("CSS copied")))}_toast(e){let t=i("div",{class:"toast","data-inspect-ui":"",text:e});this.root.appendChild(t),setTimeout(()=>t.remove(),1400)}_assets(e){let t=this._assetCache||(this._assetCache=ue()),o=(l,h)=>{var d;(d=navigator.clipboard)==null||d.writeText(l),this._toast(h||"Copied")},r=i("div",{class:"asset-colors"},t.colors.map(l=>i("button",{class:"asset-swatch",title:`${l.hex} \xB7 used ${l.count}\xD7`,style:{background:l.css},onclick:()=>o(l.hex,l.hex+" copied")}))),s=i("div",{class:"asset-type-list"},t.typography.map(l=>i("button",{class:"asset-type",title:"Copy CSS",onclick:()=>o(`font-family: ${l.family};
font-size: ${l.size};
font-weight: ${l.weight};`,"Type style copied")},[i("div",{class:"asset-type-preview",style:{fontFamily:l.family,fontSize:"min("+l.size+", 28px)",fontWeight:l.weight},text:"Ag"}),i("div",{class:"asset-type-meta"},[i("div",{class:"asset-type-name",text:l.family}),i("div",{class:"asset-type-sub",text:`${parseInt(l.size)}px \xB7 ${l.weight}`})])]))),a=i("div",{class:"asset-grid"},t.svgs.map(l=>{let h=i("div",{class:"asset-thumb asset-svg",title:"Copy SVG"});return l.type==="inline"?h.innerHTML=l.markup:h.appendChild(i("img",{src:l.src,alt:""})),h.addEventListener("click",()=>o(l.markup||l.src,"SVG copied")),h})),p=i("div",{class:"asset-grid"},t.images.map(l=>{let h=i("div",{class:"asset-thumb",title:"Copy image URL"},[i("img",{src:l.src,alt:"",loading:"lazy"})]);return h.addEventListener("click",()=>o(l.src,"Image URL copied")),h}));e.append(i("div",{class:"view-actions"},[i("button",{class:"btn primary",text:"Rescan page",onclick:()=>{this._assetCache=null,this.render()}})]),Z("Colors",t.colors.length,r),Z("Typography",t.typography.length,s),Z("SVGs",t.svgs.length,a),Z("Images",t.images.length,p))}_drag(){let e,t,o,r,s=!1;this.el.addEventListener("mousedown",l=>{if(!l.target.closest(".head")||l.target.closest(".hbtn"))return;s=!0;let d=this.el.getBoundingClientRect();e=l.clientX,t=l.clientY,o=d.left,r=d.top,this.el.style.right="auto",document.addEventListener("mousemove",a,!0),document.addEventListener("mouseup",p,!0),l.preventDefault()});let a=l=>{s&&(this.el.style.left=o+(l.clientX-e)+"px",this.el.style.top=Math.max(0,r+(l.clientY-t))+"px")},p=()=>{s=!1,document.removeEventListener("mousemove",a,!0),document.removeEventListener("mouseup",p,!0)}}};function E(n,e,t,o=""){return i("button",{class:"hbtn"+(o?" "+o:""),title:e,onclick:t,html:w(n)})}function me(n,e){return i("div",{class:"addrow"},[i("span",{class:"k",text:n}),i("button",{class:"addbtn",title:"Add "+n,html:w("plus"),onclick:e})])}function Z(n,e,t){let o=i("div",{class:"sec-head"},[i("span",{},[n,i("span",{class:"asset-count",text:String(e)})]),i("span",{class:"chev",html:w("chevron-down")})]),r=i("div",{class:"section"},[o,i("div",{class:"sec-content"},[t])]);return o.addEventListener("click",()=>r.classList.toggle("closed")),r}function Be(n){let e=[],t=n,o=0;for(;t&&t.nodeType===1&&t!==document.documentElement&&o<3;)t.classList.length?e.unshift("."+t.classList[0]):e.unshift(t.tagName.toLowerCase()),t=t.parentElement,o++;return e}function ve(n,e){let t=getComputedStyle(n),o=t.transform==="none"?"":t.transform+" ";M(n,"transform",o+(e==="x"?"scaleX(-1)":"scaleY(-1)"))}function xe(n){return(n||"").split(",")[0].replace(/["']/g,"").trim()||"system-ui"}function Qe(n){return String(n)}function Pe(n){return n==="normal"?"1.4":n}function Ne(n){return n&&n!=="auto"?n:"0px"}function we(n){return n.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function Ye(n){return we(n).replace(/^([^{\n]+)\{/gm,'<span class="sel">$1</span>{').replace(/^(\s+)([\w-]+)(:)/gm,'$1<span class="prop">$2</span>$3').replace(/: ([^;]+);/g,': <span class="val">$1</span>;')}var R=class{constructor(e,t){this.api=t,this.el=i("div",{class:"dock","data-inspect-ui":""}),e.appendChild(this.el),this.render(),c.subscribe(()=>this.sync())}render(){this.el.innerHTML="",this.pauseBtn=Ce("pause","Pause / resume picking",()=>c.set({active:!c.get().active}));let e=i("div",{class:"dock-group"},[b("undo-03","Undo",()=>{var o,r;return(r=(o=this.api).undo)==null?void 0:r.call(o)}),b("redo-01","Redo",()=>{var o,r;return(r=(o=this.api).redo)==null?void 0:r.call(o)}),te(),b("layer-send-backward","Select parent element",()=>{var o,r;return(r=(o=this.api).selectParent)==null?void 0:r.call(o)}),b("layer-bring-forward","Select child element",()=>{var o,r;return(r=(o=this.api).selectChild)==null?void 0:r.call(o)}),te(),this.assetsBtn=b("component","Assets (page colors, type, SVGs, images)",()=>{let o=c.get().view;c.set({view:o==="assets"?"design":"assets",collapsed:!1})}),this.codeBtn=b("file-diff","Generated CSS",()=>c.set({view:"code",collapsed:!1})),this.htmlBtn=b("html-file-01","HTML",()=>c.set({view:"html",collapsed:!1})),te(),b("laptop-phone-sync","Toggle responsive preview",()=>{var o,r;return(r=(o=this.api).toggleResponsive)==null?void 0:r.call(o)})]),t=Ce("cancel-01","Exit InspectCSS",()=>{var o;return(o=window.InspectCSS)==null?void 0:o.destroy()});this.el.append(this.pauseBtn,e,t),this.sync()}sync(){var t,o,r,s;let e=c.get();(t=this.pauseBtn)==null||t.classList.toggle("active",e.active),(o=this.assetsBtn)==null||o.classList.toggle("active",e.view==="assets"),(r=this.codeBtn)==null||r.classList.toggle("active",e.view==="code"),(s=this.htmlBtn)==null||s.classList.toggle("active",e.view==="html")}};function Ce(n,e,t){return i("button",{class:"dock-circle",title:e,onclick:t,html:w(n)})}function b(n,e,t){return i("button",{class:"dock-btn",title:e,onclick:t,html:w(n)})}function te(){return i("div",{class:"dock-sep"})}var B=class{constructor(e){this.root=e,this.el=i("div",{class:"tooltip","data-inspect-ui":""}),e.appendChild(this.el),e.addEventListener("pointerover",t=>this._over(t),!0),e.addEventListener("pointerout",t=>this._out(t),!0),e.addEventListener("pointerdown",()=>this.hide(),!0)}_over(e){let t=e.target.closest&&e.target.closest("[title],[data-tip]");if(!t||!this.root.contains(t))return;if(t.hasAttribute("title")){let r=t.getAttribute("title");r&&t.setAttribute("data-tip",r),t.removeAttribute("title")}let o=t.getAttribute("data-tip");o&&this.show(o,t)}_out(e){let t=e.target.closest&&e.target.closest("[data-tip]");t&&!t.contains(e.relatedTarget)&&this.hide()}show(e,t){this.el.textContent=e,this.el.classList.add("show");let o=t.getBoundingClientRect(),r=this.el.getBoundingClientRect(),s=o.top-r.height-8,a=o.left+o.width/2-r.width/2;s<6&&(s=o.bottom+8),a=Math.max(6,Math.min(a,window.innerWidth-r.width-6)),this.el.style.left=Math.round(a)+"px",this.el.style.top=Math.round(s)+"px"}hide(){this.el.classList.remove("show")}};var Q=class{constructor(e){this.onChange=e,this._onDblClick=this._onDblClick.bind(this),this._onKey=this._onKey.bind(this)}start(){document.addEventListener("dblclick",this._onDblClick,!0)}stop(){document.removeEventListener("dblclick",this._onDblClick,!0),this._finish()}_editable(e){if(!e||e.nodeType!==1||C(e))return null;let t=e;for(;t&&t!==document.body;){let o=[...t.childNodes].some(s=>s.nodeType===3&&s.textContent.trim()),r=![...t.children].some(s=>{let a=getComputedStyle(s).display;return a==="block"||a==="flex"||a==="grid"});if(o&&r)return t;t=t.parentElement}return e.matches("h1,h2,h3,h4,h5,h6,p,span,a,button,li,td,th,label,strong,em,small,div")?e:null}_onDblClick(e){var s,a;if(C(e.target))return;let t=this._editable(e.target);if(!t)return;e.preventDefault(),e.stopPropagation(),c.set({editing:!0,selectedEl:t}),this.el=t,this._prevWS=t.style.whiteSpace,t.setAttribute("contenteditable","true"),t.setAttribute("data-inspect-editing",""),t.focus();let o=(s=document.caretRangeFromPoint)==null?void 0:s.call(document,e.clientX,e.clientY),r=window.getSelection();r.removeAllRanges(),o?r.addRange(o):(a=document.execCommand)==null||a.call(document,"selectAll",!1,null),t.addEventListener("blur",()=>this._finish(),{once:!0}),document.addEventListener("keydown",this._onKey,!0)}_onKey(e){this.el&&(e.key==="Escape"||e.key==="Enter"&&!e.shiftKey&&this.el.tagName!=="DIV")&&(e.preventDefault(),this.el.blur())}_finish(){var e;document.removeEventListener("keydown",this._onKey,!0),this.el&&(this.el.removeAttribute("contenteditable"),this.el.removeAttribute("data-inspect-editing"),this.el=null),c.get().editing&&c.set({editing:!1}),(e=this.onChange)==null||e.call(this)}};var Te=5,P=class{constructor(e){this.onReorder=e,this.indicator=i("div",{"data-inspect-ui":"",style:{position:"fixed",background:"#58aeff",borderRadius:"2px",pointerEvents:"none",zIndex:"2147483645",display:"none",boxShadow:"0 0 6px rgba(88,174,255,.8)"}}),document.documentElement.appendChild(this.indicator),this._down=this._down.bind(this),this._move=this._move.bind(this),this._up=this._up.bind(this)}start(){document.addEventListener("mousedown",this._down,!0)}stop(){document.removeEventListener("mousedown",this._down,!0),this.indicator.remove()}_down(e){if(e.button!==0||C(e.target))return;let t=c.get().selectedEl;if(!t)return;let o=document.elementFromPoint(e.clientX,e.clientY);!o||o!==t&&!t.contains(o)||(this.sx=e.clientX,this.sy=e.clientY,this.armed=!0,this.dragging=!1,document.addEventListener("mousemove",this._move,!0),document.addEventListener("mouseup",this._up,!0))}_move(e){if(this.armed){if(!this.dragging){if(Math.hypot(e.clientX-this.sx,e.clientY-this.sy)<Te)return;this.dragging=!0,c.set({dragging:!0}),document.documentElement.style.cursor="grabbing"}this._updateTarget(e)}}_updateTarget(e){let t=c.get().selectedEl,o=t==null?void 0:t.parentElement;if(!o)return;let r=[...o.children].filter(d=>!C(d)),s=document.elementFromPoint(e.clientX,e.clientY),a=r.find(d=>d===s||d.contains(s));if(!a||a===t)return this.ref=void 0,this.indicator.style.display="none";let p=/row/.test(getComputedStyle(o).flexDirection)||getComputedStyle(o).display.includes("inline"),l=a.getBoundingClientRect(),h=p?e.clientX>l.left+l.width/2:e.clientY>l.top+l.height/2;if(this.ref=h?a.nextElementSibling:a,this.ref===t&&(this.ref=h?t.nextElementSibling:t),p){let d=h?l.right:l.left;Object.assign(this.indicator.style,{display:"block",left:d-1+"px",top:l.top+"px",width:"3px",height:l.height+"px"})}else{let d=h?l.bottom:l.top;Object.assign(this.indicator.style,{display:"block",left:l.left+"px",top:d-1+"px",width:l.width+"px",height:"3px"})}}_up(){var t;document.removeEventListener("mousemove",this._move,!0),document.removeEventListener("mouseup",this._up,!0),this.indicator.style.display="none",document.documentElement.style.cursor="";let e=this.dragging;if(this.armed=!1,this.dragging=!1,e){let o=c.get().selectedEl;o&&this.ref!==void 0&&this.ref!==o&&o.parentElement.insertBefore(o,this.ref||null),c.set({dragging:!1}),this.ref=void 0;let r=s=>{s.stopPropagation(),s.preventDefault(),document.removeEventListener("click",r,!0)};document.addEventListener("click",r,!0),(t=this.onReorder)==null||t.call(this,o)}}};var N=`@font-face {
