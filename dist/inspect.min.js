(()=>{var Q={active:!1,hoverEl:null,selectedEl:null,pseudo:"none",view:"design",edits:new Map,panelPos:{x:null,y:16},collapsed:!1},B=new Set,p={get:()=>Q,set(r){Object.assign(Q,r),B.forEach(e=>e(Q))},subscribe(r){return B.add(r),()=>B.delete(r)}};var we=0,R="data-inspect-id";function _(r){let e=r.getAttribute(R);return e||(e="ic-"+ ++we,r.setAttribute(R,e)),e}function P(r){return`[${R}="${r}"]`}function v(r,e=2){if(r==null||Number.isNaN(r))return 0;let t=Math.pow(10,e);return Math.round(r*t)/t}function i(r,e={},t=[]){let o=document.createElement(r);for(let[n,s]of Object.entries(e))n==="class"?o.className=s:n==="style"&&typeof s=="object"?Object.assign(o.style,s):n==="html"?o.innerHTML=s:n==="text"?o.textContent=s:n.startsWith("on")&&typeof s=="function"?o.addEventListener(n.slice(2).toLowerCase(),s):s!==!1&&s!=null&&o.setAttribute(n,s===!0?"":s);for(let n of[].concat(t))n==null||n===!1||o.appendChild(typeof n=="string"?document.createTextNode(n):n);return o}function $(r){if(!r||r.nodeType!==1)return"";let e=r.tagName.toLowerCase();return r.id?e+="#"+r.id:r.classList.length&&(e+="."+r.classList[0]),e}function A(r){if(r==null)return{value:0,unit:"px"};let e=String(r).trim().match(/^(-?[\d.]+)\s*([a-z%]*)$/i);return e?{value:parseFloat(e[1]),unit:e[2]||"px"}:{value:r,unit:""}}function L(r){if(!r)return{hex:"#000000",alpha:1};if(r.startsWith("#"))return{hex:r,alpha:1};let e=r.match(/rgba?\(([^)]+)\)/i);if(!e)return{hex:"#000000",alpha:1};let t=e[1].split(",").map(l=>l.trim()),[o,n,s]=t.map(l=>parseInt(l,10)),d=t[3]!=null?parseFloat(t[3]):1;return{hex:"#"+[o,n,s].map(l=>Math.max(0,Math.min(255,l||0)).toString(16).padStart(2,"0")).join(""),alpha:d}}function ee(r,e=1){let t=r.replace("#",""),o=t.length===3?t.split("").map(c=>c+c).join(""):t.padEnd(6,"0"),n=parseInt(o.slice(0,2),16),s=parseInt(o.slice(2,4),16),d=parseInt(o.slice(4,6),16);return e>=1?`rgb(${n}, ${s}, ${d})`:`rgba(${n}, ${s}, ${d}, ${v(e,3)})`}function N(r){return!!(r&&r.closest&&r.closest("[data-inspect-ui]"))}var z=class{constructor(e){this.el=i("div",{"data-inspect-ui":"",style:{position:"fixed",inset:"0",pointerEvents:"none",zIndex:"2147483640"}}),this.margin=this._box("rgba(246, 178, 107, 0.28)"),this.padding=this._box("rgba(147, 196, 125, 0.30)"),this.content=i("div",{style:this._boxStyle("transparent","#4c8dff")}),this.selected=i("div",{style:this._boxStyle("transparent","#7c5cff")}),this.badge=i("div",{"data-inspect-ui":"",style:{position:"fixed",font:"600 11px/1.4 ui-monospace, SFMono-Regular, Menlo, monospace",color:"#fff",background:"#4c8dff",padding:"2px 6px",borderRadius:"4px",whiteSpace:"nowrap",pointerEvents:"none",boxShadow:"0 1px 4px rgba(0,0,0,.3)"}}),this.el.append(this.margin,this.padding,this.content,this.selected,this.badge),e.appendChild(this.el),this.hideHover(),this.hideSelected()}_box(e){return i("div",{style:{position:"fixed",background:e,pointerEvents:"none"}})}_boxStyle(e,t){return{position:"fixed",background:e,outline:`1px solid ${t}`,outlineOffset:"-1px",pointerEvents:"none"}}_place(e,t){Object.assign(e.style,{left:t.left+"px",top:t.top+"px",width:Math.max(0,t.width)+"px",height:Math.max(0,t.height)+"px",display:"block"})}highlight(e){if(!e)return this.hideHover();let t=getComputedStyle(e),o=e.getBoundingClientRect(),n=te(t,"margin"),s=te(t,"padding");this._place(this.margin,{left:o.left-n.left,top:o.top-n.top,width:o.width+n.left+n.right,height:o.height+n.top+n.bottom}),this._place(this.content,o),this._place(this.padding,o),this.badge.textContent=`${v(o.width)} \xD7 ${v(o.height)}`,this.badge.style.display="block";let d=o.top>24?o.top-22:o.bottom+6;this.badge.style.left=Math.max(4,o.left)+"px",this.badge.style.top=d+"px"}select(e){if(!e)return this.hideSelected();this._place(this.selected,e.getBoundingClientRect())}hideHover(){[this.margin,this.padding,this.content,this.badge].forEach(e=>e.style.display="none")}hideSelected(){this.selected.style.display="none"}destroy(){this.el.remove()}};function te(r,e){let t=o=>parseFloat(r.getPropertyValue(`${e}-${o}`))||0;return{top:t("top"),right:t("right"),bottom:t("bottom"),left:t("left")}}var E=class{constructor(e,t){this.overlay=e,this.onSelect=t,this._onMove=this._onMove.bind(this),this._onClick=this._onClick.bind(this),this._onKey=this._onKey.bind(this),this._onScroll=this._onScroll.bind(this)}start(){document.addEventListener("mousemove",this._onMove,!0),document.addEventListener("click",this._onClick,!0),document.addEventListener("keydown",this._onKey,!0),window.addEventListener("scroll",this._onScroll,!0),window.addEventListener("resize",this._onScroll,!0),document.documentElement.style.cursor="crosshair"}stop(){document.removeEventListener("mousemove",this._onMove,!0),document.removeEventListener("click",this._onClick,!0),document.removeEventListener("keydown",this._onKey,!0),window.removeEventListener("scroll",this._onScroll,!0),window.removeEventListener("resize",this._onScroll,!0),document.documentElement.style.cursor="",this.overlay.hideHover(),p.set({hoverEl:null})}_target(e){let t=document.elementFromPoint(e.clientX,e.clientY);return!t||N(t)||t===document.documentElement||t===document.body?null:t}_onMove(e){let t=this._target(e);if(!t)return this.overlay.hideHover();t!==p.get().hoverEl&&(p.set({hoverEl:t}),this.overlay.highlight(t))}_onClick(e){if(N(e.target))return;let t=this._target(e);t&&(e.preventDefault(),e.stopPropagation(),this.onSelect(t))}_onKey(e){e.key==="Escape"&&(e.preventDefault(),p.set({active:!1}))}_onScroll(){let{hoverEl:e,selectedEl:t}=p.get();e&&this.overlay.highlight(e),t&&this.overlay.select(t)}};function Ce(r){return r&&!/[^a-zA-Z0-9_-]/.test(r)&&!/^(is-|has-|js-)/.test(r)?!0:r&&!/[^a-zA-Z0-9_-]/.test(r)}function ke(r){let e=1,t=r;for(;t=t.previousElementSibling;)t.tagName===r.tagName&&e++;return e}function be(r){let e=r.tagName.toLowerCase();if(r.id&&document.querySelectorAll("#"+CSS.escape(r.id)).length===1)return"#"+r.id;let t=Array.from(r.classList).filter(Ce).slice(0,2);return t.length?e+"."+t.map(n=>n).join("."):`${e}:nth-of-type(${ke(r)})`}function oe(r,e=4){if(!r||r.nodeType!==1)return"";let t=[],o=r;for(;o&&o.nodeType===1&&o!==document.documentElement;){let n=be(o);if(t.unshift(n),n.startsWith("#"))break;try{if(document.querySelectorAll(t.join(" > ")).length===1)break}catch{}if(o=o.parentElement,t.length>=e)break}return t.join(" > ")}var re="inspect-css-live-styles";function ye(){let r=document.getElementById(re);return r||(r=document.createElement("style"),r.id=re,r.setAttribute("data-inspect-ui",""),document.head.appendChild(r)),r}var b=[],I=[];function q(){let{edits:r}=p.get();return[...r.entries()].map(([e,t])=>[e,{inspectId:t.inspectId,pseudo:t.pseudo,selector:t.selector,props:[...t.props.entries()]}])}function ne(r){let e=new Map;for(let[t,o]of r)e.set(t,{inspectId:o.inspectId,pseudo:o.pseudo,selector:o.selector,props:new Map(o.props)});p.get().edits=e,T(),p.set({edits:e})}function Me(){b.push(q()),b.length>100&&b.shift(),I.length=0}function ie(){b.length&&(I.push(q()),ne(b.pop()))}function se(){I.length&&(b.push(q()),ne(I.pop()))}function y(r,e,t){Me();let o=_(r),{edits:n,pseudo:s}=p.get(),d=s==="none"?o:`${o}::${s}`,c=n.get(d);c||(c={inspectId:o,pseudo:s,selector:oe(r),props:new Map},n.set(d,c)),t===""||t==null?c.props.delete(e):c.props.set(e,t),c.props.size===0&&n.delete(d),T(),p.set({edits:n})}function Y(r,e="none"){let t=r.getAttribute("data-inspect-id");if(!t)return new Map;let o=e==="none"?t:`${t}::${e}`,n=p.get().edits.get(o);return n?n.props:new Map}function T(){let{edits:r}=p.get(),e=[];for(let t of r.values()){if(t.props.size===0)continue;let o=P(t.inspectId)+(t.pseudo!=="none"?":"+t.pseudo:""),n=[...t.props.entries()].map(([s,d])=>`  ${s}: ${d} !important;`).join(`
`);e.push(`${o} {
${n}
}`)}ye().textContent=e.join(`

`)}function G(){let{edits:r}=p.get(),e=[];for(let t of r.values()){if(t.props.size===0)continue;let o=(t.selector||P(t.inspectId))+(t.pseudo!=="none"?":"+t.pseudo:""),n=[...t.props.entries()].map(([s,d])=>`  ${s}: ${d};`).join(`
`);e.push(`${o} {
${n}
}`)}return e.join(`

`)}function O(){p.get().edits.clear(),T(),p.set({edits:p.get().edits})}function x(r,e,t,o=t){let n=Y(r,p.get().pseudo).get(t);return n!=null?n:e.getPropertyValue(o).trim()}function X(r){let e=getComputedStyle(r),t=r.getBoundingClientRect();return{rect:t,tag:r.tagName.toLowerCase(),layout:{display:x(r,e,"display"),position:x(r,e,"position"),width:e.width,height:e.height,x:v(t.left+window.scrollX),y:v(t.top+window.scrollY),rowGap:e.rowGap==="normal"?"0":e.rowGap,columnGap:e.columnGap==="normal"?"0":e.columnGap,justify:x(r,e,"justify-content"),align:x(r,e,"align-items")},transform:Ve(r,e),spacing:{margin:le(e,"margin"),padding:le(e,"padding")},radius:{all:x(r,e,"border-radius"),tl:e.borderTopLeftRadius,tr:e.borderTopRightRadius,br:e.borderBottomRightRadius,bl:e.borderBottomLeftRadius},typography:{fontFamily:e.fontFamily,fontSize:x(r,e,"font-size"),fontWeight:x(r,e,"font-weight"),lineHeight:e.lineHeight,letterSpacing:e.letterSpacing==="normal"?"0px":e.letterSpacing,textAlign:x(r,e,"text-align"),color:x(r,e,"color"),marginBottom:x(r,e,"margin-bottom")},background:{color:x(r,e,"background-color"),image:e.backgroundImage},border:{width:e.borderTopWidth,style:e.borderTopStyle,color:e.borderTopColor},effects:{opacity:x(r,e,"opacity"),boxShadow:e.boxShadow==="none"?"":e.boxShadow}}}function le(r,e){return{top:r.getPropertyValue(`${e}-top`),right:r.getPropertyValue(`${e}-right`),bottom:r.getPropertyValue(`${e}-bottom`),left:r.getPropertyValue(`${e}-left`)}}function Ve(r,e){let o=Y(r,p.get().pseudo).get("transform")||e.transform,n={tx:0,ty:0,rotate:0};if(!o||o==="none")return n;let s=/translate\(\s*(-?[\d.]+)px\s*,\s*(-?[\d.]+)px\s*\)/.exec(o),d=/rotate\(\s*(-?[\d.]+)deg\s*\)/.exec(o);if(s&&(n.tx=parseFloat(s[1]),n.ty=parseFloat(s[2])),d&&(n.rotate=parseFloat(d[1])),s||d)return n;let c=/matrix\(([^)]+)\)/.exec(o);if(c){let[l,u,,,a,m]=c[1].split(",").map(parseFloat);n.tx=v(a),n.ty=v(m),n.rotate=v(Math.atan2(u,l)*(180/Math.PI))}return n}function ae({tx:r=0,ty:e=0,rotate:t=0}){let o=[];return(r||e)&&o.push(`translate(${v(r)}px, ${v(e)}px)`),t&&o.push(`rotate(${v(t)}deg)`),o.length?o.join(" "):""}var Ae=6e3,S=r=>r.closest&&r.closest("[data-inspect-ui]");function D(){let r=document.body?document.body.querySelectorAll("*"):[],e=[];for(let t=0;t<r.length&&e.length<Ae;t++)S(r[t])||e.push(r[t]);return e}function je(r,e,t){let o=r.get(e);o?o.count++:r.set(e,{...t,count:1})}function Le(){let r=new Map,e=["color","background-color","border-top-color","border-right-color","border-bottom-color","border-left-color","outline-color","fill","stroke"];for(let t of D()){let o=getComputedStyle(t);for(let n of e){let s=o.getPropertyValue(n).trim();if(!s||s==="none")continue;let{hex:d,alpha:c}=L(s);if(c===0||d==="#000000"&&n==="fill")continue;let l=d+"|"+c;je(r,l,{hex:d,alpha:c,css:s})}}return[...r.values()].sort((t,o)=>o.count-t.count).slice(0,80)}function ze(){let r=new Map;for(let e of D()){if(![...e.childNodes].some(a=>a.nodeType===3&&a.textContent.trim()))continue;let o=getComputedStyle(e),n=(o.fontFamily||"").split(",")[0].replace(/["']/g,"").trim(),s=o.fontSize,d=o.fontWeight,c=`${n}|${s}|${d}`,l=e.textContent.trim().slice(0,40),u=r.get(c);u?u.count++:r.set(c,{family:n,size:s,weight:d,lineHeight:o.lineHeight,letterSpacing:o.letterSpacing,sample:l,count:1})}return[...r.values()].sort((e,t)=>parseFloat(t.size)-parseFloat(e.size)||t.count-e.count).slice(0,60)}function Ee(){let r=[],e=new Set;for(let t of document.querySelectorAll("svg")){if(S(t))continue;let o=t.outerHTML;/xmlns=/.test(o)||(o=o.replace("<svg",'<svg xmlns="http://www.w3.org/2000/svg"'));let n=o.slice(0,400);if(e.has(n)||o.length>4e4)continue;e.add(n);let s=t.getBoundingClientRect();if(r.push({type:"inline",markup:o,w:Math.round(s.width),h:Math.round(s.height)}),r.length>120)break}for(let t of document.querySelectorAll('img[src$=".svg"], img[src*=".svg?"]'))S(t)||e.has(t.src)||(e.add(t.src),r.push({type:"url",src:t.src,markup:""}));return r}function Ie(){let r=[],e=new Set,t=o=>{!o||e.has(o)||o.endsWith(".svg")||o.startsWith("data:image/svg")||(e.add(o),r.push({src:o}))};for(let o of document.querySelectorAll("img"))S(o)||(o.currentSrc||o.src)&&t(o.currentSrc||o.src);for(let o of D()){let n=getComputedStyle(o).backgroundImage;if(!n||n==="none")continue;let s,d=/url\((['"]?)([^'")]+)\1\)/g;for(;s=d.exec(n);)t(new URL(s[2],location.href).href);if(r.length>120)break}return r}function de(){return{colors:Le(),typography:ze(),svgs:Ee(),images:Ie()}}var Se={"align-bottom":`<svg preserveAspectRatio="xMidYMid meet" overflow="visible" style="display: block;" width="100%" height="100%" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
<g id="align-bottom">
...
</svg>`};function w(r){return Se[r]||""}function ce(r){return i("span",{class:"fic",html:w(r)})}function He(){return i("span",{class:"chev-mini",html:w("chevron-down")})}function f({key:r,iconName:e,value:t,unit:o="px",onChange:n,showUnit:s=!0,sm:d=!1}){let c=A(t),l=/[a-z%]/i.test(String(t!=null?t:"")),u=i("input",{value:c.value,type:"text",inputmode:"decimal"}),a=s?i("span",{class:"unit",text:l?c.unit:o}):null,m=()=>{let g=u.value.trim();if(g==="")return n("");let U=/^-?[\d.]+$/.test(g);n(U&&s?g+((a==null?void 0:a.textContent)||o):g)};if(u.addEventListener("change",m),u.addEventListener("keydown",g=>{if(g.key==="Enter")return u.blur();if(g.key==="ArrowUp"||g.key==="ArrowDown"){let U=parseFloat(u.value)||0;u.value=+(U+(g.key==="ArrowUp"?1:-1)*(g.shiftKey?10:1)).toFixed(2),m(),g.preventDefault()}}),s&&a){let g=["px","%","em","rem","vw","vh"];a.style.cursor="pointer",a.addEventListener("click",()=>{a.textContent=g[(g.indexOf(a.textContent)+1)%g.length],m()})}return i("div",{class:"field"+(d?" sm":"")},[e?ce(e):r?i("span",{class:"fk",text:r}):null,u,a])}function k({value:r,options:e,onChange:t,iconName:o,key:n,sm:s=!0}){let d=i("select",{});for(let c of e){let[l,u]=Array.isArray(c)?c:[c,c],a=i("option",{value:l,text:u});String(l)===String(r)&&(a.selected=!0),d.appendChild(a)}return d.addEventListener("change",()=>t(d.value)),i("div",{class:"field select-like"+(s?" sm":"")},[o?ce(o):n?i("span",{class:"fk",text:n}):null,d,He()])}function M(r,{active:e=-1,grow:t=!1,seg:o=!1,onPick:n}={}){let s=i("div",{class:"iconrow"+(t?" grow":"")+(o?" seg":"")});return r.forEach((d,c)=>{let l=i("button",{class:"ibtn"+(c===e?" active":""),title:d.title||"",html:w(d.icon),onclick:()=>n==null?void 0:n(d,c,l)});s.appendChild(l)}),s}function F(r,e,{showPct:t=!0}={}){let o=L(r),n=o.hex,s=o.alpha===0?1:o.alpha,d=i("input",{type:"color",value:n}),c=i("div",{class:"swatch"},[d]);c.style.background=r&&r!=="rgba(0, 0, 0, 0)"?r:"transparent";let l=i("input",{class:"hex",value:n.replace("#","")}),u=t?i("span",{class:"pct",text:Math.round(s*100)+"%"}):null,a=m=>{let g=ee(m,s);c.style.background=g,e(g)};return d.addEventListener("input",()=>{l.value=d.value.replace("#",""),a(d.value)}),l.addEventListener("change",()=>{let m=l.value.trim().replace(/^#/,"");/^([0-9a-f]{3}|[0-9a-f]{6})$/i.test(m)?(d.value="#"+m,a("#"+m)):e(l.value.trim())}),i("div",{class:"colorline"},[c,l,u])}function V(r,e,{open:t=!0}={}){let o=i("div",{class:"sec-content"},e),n=i("div",{class:"sec-head"},[i("span",{text:r}),i("span",{class:"chev",html:w("chevron-down")})]),s=i("div",{class:"section"+(t?"":" closed")},[n,o]);return n.addEventListener("click",()=>s.classList.toggle("closed")),s}function h(r,e){return i("div",{class:"stack"},[i("span",{class:"label",text:r}),e])}function pe(r,e){let t=(d,c)=>{let l=i("input",{class:"sp-edge",value:A(r[d][c]).value});return l.addEventListener("change",()=>{let u=l.value.trim();e(`${d}-${c}`,/^-?[\d.]+$/.test(u)?u+"px":u)}),l},o=(d,c,l,u)=>i("div",{class:c},[i("span",{class:"sp-tag",text:l}),t(d,"top"),i("div",{class:"sp-mid"},[t(d,"left"),u,t(d,"right")]),t(d,"bottom")]),n=i("div",{class:"sp-size"},[i("span",{class:"sp-tag",text:"Size"}),i("span",{html:`${A(r.width||"0").value} <span class="sp-x">x</span> ${A(r.height||"0").value}`})]),s=o("padding","sp-box sp-padding","Padding",n);return o("margin","sp-box sp-margin","Margin",s)}var Z=class{constructor(e){this.root=e,this.el=i("div",{class:"panel","data-inspect-ui":""}),e.appendChild(this.el),this._drag()}set(e){this.selected=e,this.render()}render(){let e=p.get();this.el.classList.toggle("hidden",e.collapsed),this.el.innerHTML="",this.el.append(this._head());let t=i("div",{class:"panel-body"});e.view==="assets"?this._assets(t):this.selected?e.view==="code"?this._code(t):e.view==="html"?this._html(t):this._design(t):t.append(i("div",{class:"empty",text:"Pick an element on the page to inspect and edit its styles."})),this.el.append(t)}_head(){if(p.get().view==="assets")return i("div",{class:"head"},[i("div",{class:"head-top"},[i("div",{class:"head-title",text:"Assets"}),i("div",{class:"head-actions"},[j("minimize-screen","Collapse panel",()=>p.set({collapsed:!0})),j("x","Close",()=>{var s;return(s=window.InspectCSS)==null?void 0:s.destroy()})])]),i("div",{class:"crumb",style:{color:"var(--muted)"},text:"Everything this page uses"})]);let t=this.selected,o=t?X(t):null,n=t?Ze(t):[];return i("div",{class:"head"},[i("div",{class:"head-top"},[i("div",{class:"head-title",text:t?$(t)||o.tag:"InspectCSS"}),i("div",{class:"head-actions"},[j("delete02","Reset all edits",()=>{O(),this.render()},"danger"),j("minimize-screen","Collapse panel",()=>p.set({collapsed:!0})),j("x","Close",()=>{var s;return(s=window.InspectCSS)==null?void 0:s.destroy()})])]),t?i("div",{class:"crumb"},n.map(s=>i("span",{text:s}))):null,t?i("div",{class:"dims"},[i("span",{html:`<b>${v(o.rect.width)}</b> x <b>${v(o.rect.height)}</b> px`}),i("span",{html:`A <b>${parseInt(o.typography.fontSize)}px</b>`})]):i("div",{class:"crumb",text:"no selection"})])}_design(e){let t=this.selected,o=X(t),n=a=>m=>y(t,a,m),s=o.transform,d=a=>{Object.assign(s,a),y(t,"transform",ae(s))},c=[{icon:"align-left",title:"Align left",css:["justify-content","flex-start"]},{icon:"align-bottom",title:"Align bottom",css:["align-items","flex-end"]},{icon:"align-right",title:"Align right",css:["justify-content","flex-end"]},{icon:"align-top",title:"Align top",css:["align-items","flex-start"]},{icon:"align-horizontal-center",title:"Center horizontally",css:["justify-content","center"]},{icon:"align-vertical-center",title:"Center vertically",css:["align-items","center"]}];e.append(V("Position",[h("Alignment",M(c,{grow:!0,seg:!0,onPick:a=>y(t,a.css[0],a.css[1])})),h("Position",i("div",{class:"row"},[f({key:"X",value:s.tx+"px",onChange:a=>d({tx:parseFloat(a)||0})}),f({key:"Y",value:s.ty+"px",onChange:a=>d({ty:parseFloat(a)||0})})])),h("Rotation",i("div",{class:"rot-row"},[f({iconName:"rotate01",value:s.rotate+"",showUnit:!1,onChange:a=>d({rotate:parseFloat(a)||0})}),M([{icon:"image-flip-horizontal",title:"Flip horizontal"}],{grow:!0,onPick:()=>he(t,"x")}),M([{icon:"image-flip-vertical",title:"Flip vertical"}],{grow:!0,onPick:()=>he(t,"y")})]))])),e.append(V("Layout",[h("Size",i("div",{class:"row"},[f({key:"W",value:o.layout.width,onChange:n("width")}),f({key:"H",value:o.layout.height,onChange:n("height")})])),h("Display",k({value:o.layout.display,options:["block","inline","inline-block","flex","inline-flex","grid","none"],onChange:n("display")})),i("div",{class:"row"},[h("Row Gap",f({iconName:"paragraph-spacing",value:o.layout.rowGap,showUnit:!1,sm:!0,onChange:n("row-gap")})),h("Column Gap",f({iconName:"letter-spacing",value:o.layout.columnGap,showUnit:!1,sm:!0,onChange:n("column-gap")}))]),i("div",{class:"row"},[h("Horizontal Align",k({value:o.layout.justify,options:[["flex-start","Start"],["center","Center"],["flex-end","End"],["space-between","Between"]],onChange:n("justify-content")})),h("Vertical Align",k({value:o.layout.align,options:[["flex-start","Start"],["center","Center"],["flex-end","End"],["stretch","Stretch"]],onChange:n("align-items")}))])])),e.append(V("Spacing",[h("Padding",i("div",{class:"row"},[f({iconName:"horizontal-resize",value:o.spacing.padding.left,onChange:a=>{n("padding-left")(a),n("padding-right")(a)}}),f({iconName:"vertical-resize",value:o.spacing.padding.top,onChange:a=>{n("padding-top")(a),n("padding-bottom")(a)}})])),h("Margin",i("div",{class:"row"},[f({iconName:"horizontal-resize",value:o.spacing.margin.left,onChange:a=>{n("margin-left")(a),n("margin-right")(a)}}),f({iconName:"vertical-resize",value:o.spacing.margin.top,onChange:a=>{n("margin-top")(a),n("margin-bottom")(a)}})])),pe({...o.spacing,width:o.layout.width,height:o.layout.height},(a,m)=>y(t,a,m))]));let l=[{key:"tl",prop:"border-top-left-radius",v:o.radius.tl},{key:"tr",prop:"border-top-right-radius",v:o.radius.tr},{key:"bl",prop:"border-bottom-left-radius",v:o.radius.bl},{key:"br",prop:"border-bottom-right-radius",v:o.radius.br}],u=new Set([o.radius.tl,o.radius.tr,o.radius.bl,o.radius.br]).size>1;e.append(V("Appearance",[i("div",{class:"row"},[h("Opacity",f({iconName:"transparency",value:String(Math.round((parseFloat(o.effects.opacity)||1)*100)),unit:"%",onChange:a=>n("opacity")((parseFloat(a)||100)/100)})),h("Corner",i("div",{class:"corner-mix"},[f({iconName:"full-screen",value:u?"mix":o.radius.all,showUnit:!1,onChange:n("border-radius")}),M([{icon:"full-screen",title:"Link corners"}],{onPick:()=>n("border-radius")(o.radius.tl)})]))]),i("div",{class:"corner-grid"},l.map(a=>f({iconName:"full-screen",value:a.v,showUnit:!1,onChange:n(a.prop)}))),ue("Fill",()=>{this._fillOpen=!this._fillOpen,this.render()}),this._fillOpen?F(o.background.color,n("background-color")):null,ue("Stroke",()=>{this._strokeOpen=!this._strokeOpen,this.render()}),this._strokeOpen?F(o.border.color,n("border-color")):null])),e.append(V("Typography",[h("Typeface",k({value:ge(o.typography.fontFamily),options:[ge(o.typography.fontFamily),"Quicksand","Inter","Arial","Georgia","system-ui","monospace"],onChange:n("font-family")})),i("div",{class:"row"},[k({value:Ke(o.typography.fontWeight),options:[["300","Light"],["400","Regular"],["500","Medium"],["600","SemiBold"],["700","Bold"],["800","Extra"]],onChange:n("font-weight")}),k({value:parseInt(o.typography.fontSize)+"",options:["10","12","13","14","16","18","20","24","32","48"].map(a=>[a,a]),onChange:a=>n("font-size")(a+"px")})]),i("div",{class:"row"},[h("Line Height",f({iconName:"paragraph-spacing",value:Ue(o.typography.lineHeight),showUnit:!1,sm:!0,onChange:n("line-height")})),h("Letter Spacing",f({iconName:"letter-spacing",value:o.typography.letterSpacing,showUnit:!1,sm:!0,onChange:n("letter-spacing")}))]),i("div",{class:"row"},[h("Paragraph Spacing",f({iconName:"expand-paragraph",value:Qe(o.typography.marginBottom),sm:!0,onChange:n("margin-bottom")})),h("Alignment",M([{icon:"text-align-right",title:"Right",css:"right"},{icon:"text-align-center",title:"Center",css:"center"},{icon:"text-align-start",title:"Left",css:"left"},{icon:"text-align-justify",title:"Justify",css:"justify"}],{grow:!0,seg:!0,active:["right","center","left","justify"].indexOf(o.typography.textAlign),onPick:a=>n("text-align")(a.css)}))])]))}_code(e){let t=G();e.append(i("div",{class:"view-actions"},[i("button",{class:"btn primary",text:"Copy CSS",onclick:()=>this._copy()}),i("button",{class:"btn",text:"Reset",onclick:()=>{O(),this.render()}})]),t?i("pre",{class:"code",html:Be(t)}):i("div",{class:"empty",text:"No edits yet. Change a property in the Design view and the generated CSS appears here."}))}_html(e){let t=this.selected;if(!t)return e.append(i("div",{class:"empty",text:"No element selected."}));let o=t.cloneNode(!1);o.removeAttribute("data-inspect-id"),e.append(i("pre",{class:"code",html:fe(o.outerHTML.replace(/></,`>
  \u2026
<`))}))}_copy(){var t;let e=G();e&&((t=navigator.clipboard)==null||t.writeText(e).then(()=>this._toast("CSS copied")))}_toast(e){let t=i("div",{class:"toast","data-inspect-ui":"",text:e});this.root.appendChild(t),setTimeout(()=>t.remove(),1400)}_assets(e){let t=this._assetCache||(this._assetCache=de()),o=(l,u)=>{var a;(a=navigator.clipboard)==null||a.writeText(l),this._toast(u||"Copied")},n=i("div",{class:"asset-colors"},t.colors.map(l=>i("button",{class:"asset-swatch",title:`${l.hex} \xB7 used ${l.count}\xD7`,style:{background:l.css},onclick:()=>o(l.hex,l.hex+" copied")}))),s=i("div",{class:"asset-type-list"},t.typography.map(l=>i("button",{class:"asset-type",title:"Copy CSS",onclick:()=>o(`font-family: ${l.family};
font-size: ${l.size};
font-weight: ${l.weight};`,"Type style copied")},[i("div",{class:"asset-type-preview",style:{fontFamily:l.family,fontSize:"min("+l.size+", 28px)",fontWeight:l.weight},text:"Ag"}),i("div",{class:"asset-type-meta"},[i("div",{class:"asset-type-name",text:l.family}),i("div",{class:"asset-type-sub",text:`${parseInt(l.size)}px \xB7 ${l.weight}`})])]))),d=i("div",{class:"asset-grid"},t.svgs.map(l=>{let u=i("div",{class:"asset-thumb asset-svg",title:"Copy SVG"});return l.type==="inline"?u.innerHTML=l.markup:u.appendChild(i("img",{src:l.src,alt:""})),u.addEventListener("click",()=>o(l.markup||l.src,"SVG copied")),u})),c=i("div",{class:"asset-grid"},t.images.map(l=>{let u=i("div",{class:"asset-thumb",title:"Copy image URL"},[i("img",{src:l.src,alt:"",loading:"lazy"})]);return u.addEventListener("click",()=>o(l.src,"Image URL copied")),u}));e.append(i("div",{class:"view-actions"},[i("button",{class:"btn primary",text:"Rescan page",onclick:()=>{this._assetCache=null,this.render()}})]),H("Colors",t.colors.length,n),H("Typography",t.typography.length,s),H("SVGs",t.svgs.length,d),H("Images",t.images.length,c))}_drag(){let e,t,o,n,s=!1;this.el.addEventListener("mousedown",l=>{if(!l.target.closest(".head")||l.target.closest(".hbtn"))return;s=!0;let a=this.el.getBoundingClientRect();e=l.clientX,t=l.clientY,o=a.left,n=a.top,this.el.style.right="auto",document.addEventListener("mousemove",d,!0),document.addEventListener("mouseup",c,!0),l.preventDefault()});let d=l=>{s&&(this.el.style.left=o+(l.clientX-e)+"px",this.el.style.top=Math.max(0,n+(l.clientY-t))+"px")},c=()=>{s=!1,document.removeEventListener("mousemove",d,!0),document.removeEventListener("mouseup",c,!0)}}};function j(r,e,t,o=""){return i("button",{class:"hbtn"+(o?" "+o:""),title:e,onclick:t,html:w(r)})}function ue(r,e){return i("div",{class:"addrow"},[i("span",{class:"k",text:r}),i("button",{class:"addbtn",title:"Add "+r,html:w("plus"),onclick:e})])}function H(r,e,t){let o=i("div",{class:"sec-head"},[i("span",{},[r,i("span",{class:"asset-count",text:String(e)})]),i("span",{class:"chev",html:w("chevron-down")})]),n=i("div",{class:"section"},[o,i("div",{class:"sec-content"},[t])]);return o.addEventListener("click",()=>n.classList.toggle("closed")),n}function Ze(r){let e=[],t=r,o=0;for(;t&&t.nodeType===1&&t!==document.documentElement&&o<3;)t.classList.length?e.unshift("."+t.classList[0]):e.unshift(t.tagName.toLowerCase()),t=t.parentElement,o++;return e}function he(r,e){let t=getComputedStyle(r),o=t.transform==="none"?"":t.transform+" ";y(r,"transform",o+(e==="x"?"scaleX(-1)":"scaleY(-1)"))}function ge(r){return(r||"").split(",")[0].replace(/["']/g,"").trim()||"system-ui"}function Ke(r){return String(r)}function Ue(r){return r==="normal"?"1.4":r}function Qe(r){return r&&r!=="auto"?r:"0px"}function fe(r){return r.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function Be(r){return fe(r).replace(/^([^{\n]+)\{/gm,'<span class="sel">$1</span>{').replace(/^(\s+)([\w-]+)(:)/gm,'$1<span class="prop">$2</span>$3').replace(/: ([^;]+);/g,': <span class="val">$1</span>;')}var K=class{constructor(e,t){this.api=t,this.el=i("div",{class:"dock","data-inspect-ui":""}),e.appendChild(this.el),this.render(),p.subscribe(()=>this.sync())}render(){this.el.innerHTML="",this.pauseBtn=ve("pause","Pause / resume picking",()=>p.set({active:!p.get().active}));let e=i("div",{class:"dock-group"},[C("undo-03","Undo",()=>{var o,n;return(n=(o=this.api).undo)==null?void 0:n.call(o)}),C("redo-01","Redo",()=>{var o,n;return(n=(o=this.api).redo)==null?void 0:n.call(o)}),W(),C("layer-send-backward","Select parent element",()=>{var o,n;return(n=(o=this.api).selectParent)==null?void 0:n.call(o)}),C("layer-bring-forward","Select child element",()=>{var o,n;return(n=(o=this.api).selectChild)==null?void 0:n.call(o)}),W(),this.assetsBtn=C("component","Assets (page colors, type, SVGs, images)",()=>{let o=p.get().view;p.set({view:o==="assets"?"design":"assets",collapsed:!1})}),this.codeBtn=C("file-diff","Generated CSS",()=>p.set({view:"code",collapsed:!1})),this.htmlBtn=C("html-file-01","HTML",()=>p.set({view:"html",collapsed:!1})),W(),C("laptop-phone-sync","Toggle responsive preview",()=>{var o,n;return(n=(o=this.api).toggleResponsive)==null?void 0:n.call(o)})]),t=ve("cancel-01","Exit InspectCSS",()=>{var o;return(o=window.InspectCSS)==null?void 0:o.destroy()});this.el.append(this.pauseBtn,e,t),this.sync()}sync(){var t,o,n,s;let e=p.get();(t=this.pauseBtn)==null||t.classList.toggle("active",e.active),(o=this.assetsBtn)==null||o.classList.toggle("active",e.view==="assets"),(n=this.codeBtn)==null||n.classList.toggle("active",e.view==="code"),(s=this.htmlBtn)==null||s.classList.toggle("active",e.view==="html")}};function ve(r,e,t){return i("button",{class:"dock-circle",title:e,onclick:t,html:w(r)})}function C(r,e,t){return i("button",{class:"dock-btn",title:e,onclick:t,html:w(r)})}function W(){return i("div",{class:"dock-sep"})}var me=`@font-face {
...
`;var J=class{constructor(){this.host=document.createElement("div"),this.host.setAttribute("data-inspect-ui",""),this.host.style.cssText="all: initial; position: static;";let e=this.host.attachShadow({mode:"open"}),t=document.createElement("style");t.textContent=xe;let o=document.createElement("div");o.className="wrap",e.append(t,o),document.documentElement.appendChild(this.host),this.overlay=new z(document.documentElement),this.panel=new Z(o),this.toolbar=new K(o,{undo:()=>{ie(),this.panel.render()},redo:()=>{se(),this.panel.render()},selectParent:()=>this.selectRelative("parent"),selectChild:()=>this.selectRelative("child"),toggleResponsive:()=>this.toggleResponsive()}),this.inspector=new E(this.overlay,n=>this.select(n)),this._prevView=p.get().view,this._prevCollapsed=p.get().collapsed,this.unsub=p.subscribe(n=>this.onState(n)),this._track=()=>{this._raf||(this._raf=requestAnimationFrame(()=>{this._raf=0;let n=p.get();n.hoverEl&&this.overlay.highlight(n.hoverEl),n.selectedEl&&this.overlay.select(n.selectedEl)}))},window.addEventListener("scroll",this._track,!0),window.addEventListener("resize",this._track,!0),p.set({active:!0}),this.panel.render()}select(e){p.set({selectedEl:e}),this.overlay.select(e),this.panel.set(e)}selectRelative(e){let t=p.get().selectedEl;if(!t)return;let o=null;if(e==="parent"){if(o=t.parentElement,!o||o===document.documentElement||o===document.body)return}else if(o=[...t.children].find(n=>!n.closest("[data-inspect-ui]")),!o)return;p.set({view:"design",collapsed:!1}),this.select(o)}toggleResponsive(){this._resp=!this._resp;let e=document.documentElement;this._resp?(e.style.maxWidth="420px",e.style.margin="0 auto",e.style.transition="max-width .2s"):(e.style.maxWidth="",e.style.margin="");let t=p.get();t.selectedEl&&this.overlay.select(t.selectedEl)}onState(e){e.active&&!this._picking?(this._picking=!0,this.inspector.start()):!e.active&&this._picking&&(this._picking=!1,this.inspector.stop()),e.selectedEl&&this.overlay.select(e.selectedEl),(e.view!==this._prevView||e.collapsed!==this._prevCollapsed)&&(e.view==="assets"&&this._prevView!=="assets"&&(this.panel._assetCache=null),this._prevView=e.view,this._prevCollapsed=e.collapsed,this.panel.render())}destroy(){var t;(t=this.unsub)==null||t.call(this),window.removeEventListener("scroll",this._track,!0),window.removeEventListener("resize",this._track,!0),this.inspector.stop(),this.overlay.destroy(),this.host.remove(),this.toggleResponsiveOff();let e=document.getElementById("inspect-css-live-styles");e&&e.remove(),delete window.InspectCSS}toggleResponsiveOff(){document.documentElement.style.maxWidth="",document.documentElement.style.margin=""}};function Re(){if(window.InspectCSS){window.InspectCSS.destroy();return}let r=new J;window.InspectCSS={app:r,destroy:()=>r.destroy(),version:"0.4.0"}}Re();})();
