...
`),n++}return r+=`
Keep everything else unchanged.`,r.trim()}function vt(o,e){return o=String(o),o.length>e?o.slice(0,e)+"\u2026":o}var te=[],Ee=[];function P(o){te.push(o),te.length>200&&te.shift(),Ee.length=0}function Le(){let o=te.pop();return o?(o.undo(),Ee.push(o),o):null}function se(){let o=Ee.pop();return o?(o.redo(),te.push(o),o):null}var Ge="inspect-css-live-styles";function xt(){let o=document.getElementById(Ge);return o||(o=document.createElement("style"),o.id=Ge,o.setAttribute("data-inspect-ui",""),document.head.appendChild(o)),o}function De(){let{edits:o}=c.get();return[...o.entries()].map(([e,t])=>[e,{inspectId:t.inspectId,pseudo:t.pseudo,selector:t.selector,props:[...t.props.entries()]}])}function Oe(o){let e=new Map;for(let[t,r]of o)e.set(t,{inspectId:r.inspectId,pseudo:r.pseudo,selector:r.selector,props:new Map(r.props)});c.get().edits=e,Xe(),c.set({edits:e})}function L(o,e,t){var h,f;let r=De(),n=re(o),{edits:i,pseudo:l}=c.get(),d=l==="none"?n:`${n}::${l}`,a=(f=(h=i.get(d))==null?void 0:h.props.get(e))!=null?f:getComputedStyle(o).getPropertyValue(e).trim(),p=i.get(d);p||(p={inspectId:n,pseudo:l,selector:T(o),props:new Map},i.set(d,p)),t===""||t==null?p.props.delete(e):p.props.set(e,t),p.props.size===0&&i.delete(d),Xe(),c.set({edits:i}),t!==""&&t!=null&&Z({type:"css",id:n,prop:e,from:a,to:t,pseudo:l,label:H(o),selector:p.selector});let u=De();P({undo:()=>Oe(r),redo:()=>Oe(u)})}function Ve(o,e="none"){let t=o.getAttribute("data-inspect-id");if(!t)return new Map;let r=e==="none"?t:`${t}::${e}`,n=c.get().edits.get(r);return n?n.props:new Map}function Xe(){let{edits:o}=c.get(),e=[];for(let t of o.values()){if(t.props.size===0)continue;let r=Ce(t.inspectId)+(t.pseudo!=="none"?":"+t.pseudo:""),n=[...t.props.entries()].map(([i,l])=>`  ${i}: ${l} !important;`).join(`
`);e.push(`${r} {
${n}
}`)}xt().textContent=e.join(`

`)}function Ae(){let{edits:o}=c.get(),e=[];for(let t of o.values()){if(t.props.size===0)continue;let r=(t.selector||Ce(t.inspectId))+(t.pseudo!=="none"?":"+t.pseudo:""),n=[...t.props.entries()].map(([i,l])=>`  ${i}: ${l};`).join(`
`);e.push(`${r} {
${n}
}`)}return e.join(`

`)}function I(o,e,t,r=t){let n=Ve(o,c.get().pseudo).get(t);return n!=null?n:e.getPropertyValue(r).trim()}function je(o){let e=getComputedStyle(o),t=o.getBoundingClientRect();return{rect:t,tag:o.tagName.toLowerCase(),layout:{display:I(o,e,"display"),position:I(o,e,"position"),width:e.width,height:e.height,x:z(t.left+window.scrollX),y:z(t.top+window.scrollY),rowGap:e.rowGap==="normal"?"0":e.rowGap,columnGap:e.columnGap==="normal"?"0":e.columnGap,justify:I(o,e,"justify-content"),align:I(o,e,"align-items")},transform:wt(o,e),spacing:{margin:We(e,"margin"),padding:We(e,"padding")},radius:{all:I(o,e,"border-radius"),tl:e.borderTopLeftRadius,tr:e.borderTopRightRadius,br:e.borderBottomRightRadius,bl:e.borderBottomLeftRadius},typography:{fontFamily:e.fontFamily,fontSize:I(o,e,"font-size"),fontWeight:I(o,e,"font-weight"),lineHeight:e.lineHeight,letterSpacing:e.letterSpacing==="normal"?"0px":e.letterSpacing,textAlign:I(o,e,"text-align"),color:I(o,e,"color"),marginBottom:I(o,e,"margin-bottom")},background:{color:I(o,e,"background-color"),image:e.backgroundImage},border:{width:e.borderTopWidth,style:e.borderTopStyle,color:I(o,e,"border-top-color","border-top-color"),sides:{top:e.borderTopWidth,right:e.borderRightWidth,bottom:e.borderBottomWidth,left:e.borderLeftWidth},present:parseFloat(e.borderTopWidth)>0&&e.borderTopStyle!=="none"},effects:{opacity:I(o,e,"opacity"),boxShadow:e.boxShadow==="none"?"":e.boxShadow}}}function We(o,e){return{top:o.getPropertyValue(`${e}-top`),right:o.getPropertyValue(`${e}-right`),bottom:o.getPropertyValue(`${e}-bottom`),left:o.getPropertyValue(`${e}-left`)}}function wt(o,e){let r=Ve(o,c.get().pseudo).get("transform")||e.transform,n={tx:0,ty:0,rotate:0};if(!r||r==="none")return n;let i=/translate\(\s*(-?[\d.]+)px\s*,\s*(-?[\d.]+)px\s*\)/.exec(r),l=/rotate\(\s*(-?[\d.]+)deg\s*\)/.exec(r);if(i&&(n.tx=parseFloat(i[1]),n.ty=parseFloat(i[2])),l&&(n.rotate=parseFloat(l[1])),i||l)return n;let d=/matrix\(([^)]+)\)/.exec(r);if(d){let[a,p,,,u,h]=d[1].split(",").map(parseFloat);n.tx=z(u),n.ty=z(h),n.rotate=z(Math.atan2(p,a)*(180/Math.PI))}return n}function Je({tx:o=0,ty:e=0,rotate:t=0}){let r=[];return(o||e)&&r.push(`translate(${z(o)}px, ${z(e)}px)`),t&&r.push(`rotate(${z(t)}deg)`),r.length?r.join(" "):""}var bt=6e3,le=o=>o.closest&&o.closest("[data-inspect-ui]");function ze(){let o=document.body?document.body.querySelectorAll("*"):[],e=[];for(let t=0;t<o.length&&e.length<bt;t++)le(o[t])||e.push(o[t]);return e}function kt(o,e,t){let r=o.get(e);r?r.count++:o.set(e,{...t,count:1})}function yt(){let o=new Map,e=["color","background-color","border-top-color","border-right-color","border-bottom-color","border-left-color","outline-color","fill","stroke"];for(let t of ze()){let r=getComputedStyle(t);for(let n of e){let i=r.getPropertyValue(n).trim();if(!i||i==="none")continue;let{hex:l,alpha:d}=D(i);if(d===0||l==="#000000"&&n==="fill")continue;let a=l+"|"+d;kt(o,a,{hex:l,alpha:d,css:i})}}return[...o.values()].sort((t,r)=>r.count-t.count).slice(0,80)}function Ct(){let o=new Map;for(let e of ze()){if(![...e.childNodes].some(u=>u.nodeType===3&&u.textContent.trim()))continue;let r=getComputedStyle(e),n=(r.fontFamily||"").split(",")[0].replace(/["']/g,"").trim(),i=r.fontSize,l=r.fontWeight,d=`${n}|${i}|${l}`,a=e.textContent.trim().slice(0,40),p=o.get(d);p?p.count++:o.set(d,{family:n,size:i,weight:l,lineHeight:r.lineHeight,letterSpacing:r.letterSpacing,sample:a,count:1})}return[...o.values()].sort((e,t)=>parseFloat(t.size)-parseFloat(e.size)||t.count-e.count).slice(0,60)}function Mt(){let o=[],e=new Set;for(let t of document.querySelectorAll("svg")){if(le(t))continue;let r=t.outerHTML;/xmlns=/.test(r)||(r=r.replace("<svg",'<svg xmlns="http://www.w3.org/2000/svg"'));let n=r.slice(0,400);if(e.has(n)||r.length>4e4)continue;e.add(n);let i=t.getBoundingClientRect();if(o.push({type:"inline",markup:r,w:Math.round(i.width),h:Math.round(i.height)}),o.length>120)break}for(let t of document.querySelectorAll('img[src$=".svg"], img[src*=".svg?"]'))le(t)||e.has(t.src)||(e.add(t.src),o.push({type:"url",src:t.src,markup:""}));return o}function Et(){let o=[],e=new Set,t=r=>{!r||e.has(r)||r.endsWith(".svg")||r.startsWith("data:image/svg")||(e.add(r),o.push({src:r}))};for(let r of document.querySelectorAll("img"))le(r)||(r.currentSrc||r.src)&&t(r.currentSrc||r.src);for(let r of ze()){let n=getComputedStyle(r).backgroundImage;if(!n||n==="none")continue;let i,l=/url\((['"]?)([^'")]+)\1\)/g;for(;i=l.exec(n);)t(new URL(i[2],location.href).href);if(o.length>120)break}return o}function _e(){return{colors:yt(),typography:Ct(),svgs:Mt(),images:Et()}}var Se=new WeakMap;function B(o){return Se.has(o)||Se.set(o,Lt(o)),Se.get(o)}function Lt(o){let t=getComputedStyle(o).backgroundColor,r=[];if(t&&t!=="rgba(0, 0, 0, 0)"&&t!=="transparent"){let{hex:n,alpha:i}=D(t);r.push({type:"solid",color:n,alpha:i==null?1:i})}return r}function Q(o){var e,t;if(o.type==="solid"){let r=ee(o.color,(e=o.alpha)!=null?e:1);return`linear-gradient(${r}, ${r})`}if(o.type==="linear"){let r=(o.stops||[]).map(n=>{var i;return`${ee(n.color,(i=n.alpha)!=null?i:1)} ${n.pos}%`}).join(", ");return`linear-gradient(${(t=o.angle)!=null?t:180}deg, ${r})`}return o.type==="image"?`url("${o.url}")`:"none"}function $e(o){if(!o||!o.length)return{"background-image":"none","background-color":"rgba(0, 0, 0, 0)"};let e=[],t=[],r=[],n=[];for(let i of o)e.push(Q(i)),t.push(i.type==="image"?i.fit||"cover":"auto"),r.push("no-repeat"),n.push("center");return{"background-image":e.join(", "),"background-size":t.join(", "),"background-repeat":r.join(", "),"background-position":n.join(", "),"background-color":"rgba(0, 0, 0, 0)"}}function He(o){return o.type==="solid"?o.color.replace("#","").toUpperCase():o.type==="linear"?"Gradient":o.type==="image"?"Image":""}function ae(o){return o==="linear"?{type:"linear",angle:180,stops:[{color:"#58AEFF",alpha:1,pos:0},{color:"#FF8858",alpha:1,pos:100}]}:o==="image"?{type:"image",url:"",fit:"cover"}:{type:"solid",color:"#FFFFFF",alpha:1}}var Vt={"align-bottom":`<svg preserveAspectRatio="xMidYMid meet" overflow="visible" style="display: block;" width="100%" height="100%" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
<g id="align-bottom">
