(()=>{var se={active:!1,hoverEl:null,selectedEl:null,pseudo:"none",view:"design",edits:new Map,panelPos:{x:null,y:16},collapsed:!1,editing:!1,dragging:!1,changeLog:[],promptDiff:!1,docked:!1,responsive:!1},le=new Set,c={get:()=>se,set(r){Object.assign(se,r),le.forEach(e=>e(se))},subscribe(r){return le.add(r),()=>le.delete(r)}};var _e=0,ae="data-inspect-id";function Y(r){let e=r.getAttribute(ae);return e||(e="ic-"+ ++_e,r.setAttribute(ae,e)),e}function de(r){return`[${ae}="${r}"]`}function k(r,e=2){if(r==null||Number.isNaN(r))return 0;let t=Math.pow(10,e);return Math.round(r*t)/t}function s(r,e={},t=[]){let o=document.createElement(r);for(let[n,i]of Object.entries(e))n==="class"?o.className=i:n==="style"&&typeof i=="object"?Object.assign(o.style,i):n==="html"?o.innerHTML=i:n==="text"?o.textContent=i:n.startsWith("on")&&typeof i=="function"?o.addEventListener(n.slice(2).toLowerCase(),i):i!==!1&&i!=null&&o.setAttribute(n,i===!0?"":i);for(let n of[].concat(t))n==null||n===!1||o.appendChild(typeof n=="string"?document.createTextNode(n):n);return o}function V(r){if(!r||r.nodeType!==1)return"";let e=r.tagName.toLowerCase();return r.id?e+="#"+r.id:r.classList.length&&(e+="."+r.classList[0]),e}function T(r){if(r==null)return{value:0,unit:"px"};let e=String(r).trim().match(/^(-?[\d.]+)\s*([a-z%]*)$/i);return e?{value:parseFloat(e[1]),unit:e[2]||"px"}:{value:r,unit:""}}function q(r){if(!r)return{hex:"#000000",alpha:1};if(r.startsWith("#"))return{hex:r,alpha:1};let e=r.match(/rgba?\(([^)]+)\)/i);if(!e)return{hex:"#000000",alpha:1};let t=e[1].split(",").map(a=>a.trim()),[o,n,i]=t.map(a=>parseInt(a,10)),l=t[3]!=null?parseFloat(t[3]):1;return{hex:"#"+[o,n,i].map(a=>Math.max(0,Math.min(255,a||0)).toString(16).padStart(2,"0")).join(""),alpha:l}}function Ee(r,e=1){let t=r.replace("#",""),o=t.length===3?t.split("").map(d=>d+d).join(""):t.padEnd(6,"0"),n=parseInt(o.slice(0,2),16),i=parseInt(o.slice(2,4),16),l=parseInt(o.slice(4,6),16);return e>=1?`rgb(${n}, ${i}, ${l})`:`rgba(${n}, ${i}, ${l}, ${k(e,3)})`}function L(r){return!!(r&&r.closest&&r.closest("[data-inspect-ui]"))}var F=class{constructor(e){this.el=s("div",{"data-inspect-ui":"",style:{position:"fixed",inset:"0",pointerEvents:"none",zIndex:"2147483640"}}),this.margin=this._box("rgba(246, 178, 107, 0.28)"),this.padding=this._box("rgba(147, 196, 125, 0.30)"),this.content=s("div",{style:this._boxStyle("transparent","#4c8dff")}),this.selected=s("div",{style:this._boxStyle("transparent","#7c5cff")}),this.badge=s("div",{"data-inspect-ui":"",style:{position:"fixed",font:"500 12px/1.4 'Quicksand', -apple-system, 'Segoe UI', Roboto, sans-serif",color:"rgba(255,255,255,0.6)",background:"rgba(0,0,0,0.82)",border:"1px solid rgba(255,255,255,0.12)",padding:"4px 9px",borderRadius:"8px",whiteSpace:"nowrap",pointerEvents:"none",boxShadow:"0 6px 20px rgba(0,0,0,.45)",backdropFilter:"blur(6px)"}}),this.el.append(this.margin,this.padding,this.content,this.selected,this.badge),e.appendChild(this.el),this.hideHover(),this.hideSelected()}_box(e){return s("div",{style:{position:"fixed",background:e,pointerEvents:"none"}})}_boxStyle(e,t){return{position:"fixed",background:e,outline:`1px solid ${t}`,outlineOffset:"-1px",pointerEvents:"none"}}_place(e,t){Object.assign(e.style,{left:t.left+"px",top:t.top+"px",width:Math.max(0,t.width)+"px",height:Math.max(0,t.height)+"px",display:"block"})}highlight(e){if(!e)return this.hideHover();let t=getComputedStyle(e),o=e.getBoundingClientRect(),n=Le(t,"margin"),i=Le(t,"padding");this._place(this.margin,{left:o.left-n.left,top:o.top-n.top,width:o.width+n.left+n.right,height:o.height+n.top+n.bottom}),this._place(this.content,o),this._place(this.padding,o);let l=V(e);this.badge.innerHTML=`<span style="color:#58aeff">${$e(l)}</span><span style="opacity:.5">&nbsp;&nbsp;${k(o.width)} \xD7 ${k(o.height)}</span>`,this.badge.style.display="block";let d=o.top>24?o.top-22:o.bottom+6;this.badge.style.left=Math.max(4,o.left)+"px",this.badge.style.top=d+"px"}select(e){if(!e)return this.hideSelected();this._place(this.selected,e.getBoundingClientRect())}hideHover(){[this.margin,this.padding,this.content,this.badge].forEach(e=>e.style.display="none")}hideSelected(){this.selected.style.display="none"}destroy(){this.el.remove()}};function Le(r,e){let t=o=>parseFloat(r.getPropertyValue(`${e}-${o}`))||0;return{top:t("top"),right:t("right"),bottom:t("bottom"),left:t("left")}}function $e(r){return String(r).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}var G=class{constructor(e,t){this.overlay=e,this.onSelect=t,this._onMove=this._onMove.bind(this),this._onClick=this._onClick.bind(this),this._onKey=this._onKey.bind(this),this._onScroll=this._onScroll.bind(this)}start(){document.addEventListener("mousemove",this._onMove,!0),document.addEventListener("click",this._onClick,!0),document.addEventListener("keydown",this._onKey,!0),window.addEventListener("scroll",this._onScroll,!0),window.addEventListener("resize",this._onScroll,!0),document.documentElement.style.cursor="crosshair"}stop(){document.removeEventListener("mousemove",this._onMove,!0),document.removeEventListener("click",this._onClick,!0),document.removeEventListener("keydown",this._onKey,!0),window.removeEventListener("scroll",this._onScroll,!0),window.removeEventListener("resize",this._onScroll,!0),document.documentElement.style.cursor="",this.overlay.hideHover(),c.set({hoverEl:null})}_target(e){let t=document.elementFromPoint(e.clientX,e.clientY);return!t||L(t)||t===document.documentElement||t===document.body?null:t}_onMove(e){if(c.get().editing||c.get().dragging)return;let t=this._target(e);if(!t)return this.overlay.hideHover();t!==c.get().hoverEl&&(c.set({hoverEl:t}),this.overlay.highlight(t))}_onClick(e){if(L(e.target)||c.get().editing||c.get().dragging)return;let t=this._target(e);t&&(e.preventDefault(),e.stopPropagation(),this.onSelect(t))}_onKey(e){e.key==="Escape"&&(e.preventDefault(),c.set({active:!1}))}_onScroll(){let{hoverEl:e,selectedEl:t}=c.get();e&&this.overlay.highlight(e),t&&this.overlay.select(t)}};function et(r){return r&&!/[^a-zA-Z0-9_-]/.test(r)&&!/^(is-|has-|js-)/.test(r)?!0:r&&!/[^a-zA-Z0-9_-]/.test(r)}function tt(r){let e=1,t=r;for(;t=t.previousElementSibling;)t.tagName===r.tagName&&e++;return e}function ot(r){let e=r.tagName.toLowerCase();if(r.id&&document.querySelectorAll("#"+CSS.escape(r.id)).length===1)return"#"+r.id;let t=Array.from(r.classList).filter(et).slice(0,2);return t.length?e+"."+t.map(n=>n).join("."):`${e}:nth-of-type(${tt(r)})`}function j(r,e=4){if(!r||r.nodeType!==1)return"";let t=[],o=r;for(;o&&o.nodeType===1&&o!==document.documentElement;){let n=ot(o);if(t.unshift(n),n.startsWith("#"))break;try{if(document.querySelectorAll(t.join(" > ")).length===1)break}catch{}if(o=o.parentElement,t.length>=e)break}return t.join(" > ")}function z(r){r.time=Date.now();let e=c.get().changeLog,t=e[e.length-1],o=r.type==="css"&&t&&t.type==="css"&&t.id===r.id&&t.prop===r.prop&&t.pseudo===r.pseudo,n=r.type==="text"&&t&&t.type==="text"&&t.id===r.id;o||n?(t.to=r.to,t.time=r.time):e.push(r),c.set({changeLog:e})}function ce(){return c.get().changeLog}function Ae(){let r=c.get().changeLog;r.length=0,c.set({changeLog:r})}function je(r){let e=c.get().changeLog,t=e.filter(o=>!(o.type==="move"&&o.id===r));e.length=0,e.push(...t),c.set({changeLog:e})}function ze(r){return r.type==="text"?`text \u2192 "${rt(r.to,34)}"`:r.type==="move"?r.position?`moved ${r.position}`:"reordered among siblings":r.type==="delete"?"removed from the page":`${r.prop}: ${r.to}`}function Se(r=!1){let e=ce();if(!e.length)return"";let t=new Map;for(let i of e){let l=i.selector||i.label;t.has(l)||t.set(l,{label:i.label,selector:i.selector,css:new Map,text:null,movedTo:null,deleted:!1});let d=t.get(l);if(i.type==="css"){let a=i.pseudo&&i.pseudo!=="none"?`${i.prop} (:${i.pseudo})`:i.prop,p=d.css.get(a);d.css.set(a,{from:p?p.from:i.from,to:i.to})}else i.type==="text"?d.text={from:d.text?d.text.from:i.from,to:i.to}:i.type==="move"?d.movedTo=i.position||"to a new position":i.type==="delete"&&(d.deleted=!0)}let o=`Apply the following design changes to my web page, then return the updated HTML/CSS.

`,n=1;for(let i of t.values()){if(o+=`${n}. Element \`${i.selector||i.label}\`:
`,i.deleted){o+=`   - remove this element from the page
`,n++;continue}for(let[l,d]of i.css)o+=r?`   - change ${l} from ${d.from||"default"} to ${d.to}
`:`   - set ${l} to ${d.to}
`;i.text!=null&&(o+=r?`   - change its text from "${i.text.from}" to "${i.text.to}"
`:`   - change its text to: "${i.text.to}"
`),i.movedTo&&(o+=`   - move it ${i.movedTo} (relative to its siblings)
`),n++}return o+=`
Keep everything else unchanged.`,o.trim()}function rt(r,e){return r=String(r),r.length>e?r.slice(0,e)+"\u2026":r}var P=[],pe=[];function S(r){P.push(r),P.length>200&&P.shift(),pe.length=0}function he(){let r=P.pop();return r?(r.undo(),pe.push(r),r):null}function D(){let r=pe.pop();return r?(r.redo(),P.push(r),r):null}var He="inspect-css-live-styles";function nt(){let r=document.getElementById(He);return r||(r=document.createElement("style"),r.id=He,r.setAttribute("data-inspect-ui",""),document.head.appendChild(r)),r}function Ie(){let{edits:r}=c.get();return[...r.entries()].map(([e,t])=>[e,{inspectId:t.inspectId,pseudo:t.pseudo,selector:t.selector,props:[...t.props.entries()]}])}function Re(r){let e=new Map;for(let[t,o]of r)e.set(t,{inspectId:o.inspectId,pseudo:o.pseudo,selector:o.selector,props:new Map(o.props)});c.get().edits=e,Be(),c.set({edits:e})}function y(r,e,t){var h,f;let o=Ie(),n=Y(r),{edits:i,pseudo:l}=c.get(),d=l==="none"?n:`${n}::${l}`,a=(f=(h=i.get(d))==null?void 0:h.props.get(e))!=null?f:getComputedStyle(r).getPropertyValue(e).trim(),p=i.get(d);p||(p={inspectId:n,pseudo:l,selector:j(r),props:new Map},i.set(d,p)),t===""||t==null?p.props.delete(e):p.props.set(e,t),p.props.size===0&&i.delete(d),Be(),c.set({edits:i}),t!==""&&t!=null&&z({type:"css",id:n,prop:e,from:a,to:t,pseudo:l,label:V(r),selector:p.selector});let u=Ie();S({undo:()=>Re(o),redo:()=>Re(u)})}function ue(r,e="none"){let t=r.getAttribute("data-inspect-id");if(!t)return new Map;let o=e==="none"?t:`${t}::${e}`,n=c.get().edits.get(o);return n?n.props:new Map}function Be(){let{edits:r}=c.get(),e=[];for(let t of r.values()){if(t.props.size===0)continue;let o=de(t.inspectId)+(t.pseudo!=="none"?":"+t.pseudo:""),n=[...t.props.entries()].map(([i,l])=>`  ${i}: ${l} !important;`).join(`
`);e.push(`${o} {
${n}
}`)}nt().textContent=e.join(`

`)}function ge(){let{edits:r}=c.get(),e=[];for(let t of r.values()){if(t.props.size===0)continue;let o=(t.selector||de(t.inspectId))+(t.pseudo!=="none"?":"+t.pseudo:""),n=[...t.props.entries()].map(([i,l])=>`  ${i}: ${l};`).join(`
`);e.push(`${o} {
${n}
}`)}return e.join(`

`)}function E(r,e,t,o=t){let n=ue(r,c.get().pseudo).get(t);return n!=null?n:e.getPropertyValue(o).trim()}function fe(r){let e=getComputedStyle(r),t=r.getBoundingClientRect();return{rect:t,tag:r.tagName.toLowerCase(),layout:{display:E(r,e,"display"),position:E(r,e,"position"),width:e.width,height:e.height,x:k(t.left+window.scrollX),y:k(t.top+window.scrollY),rowGap:e.rowGap==="normal"?"0":e.rowGap,columnGap:e.columnGap==="normal"?"0":e.columnGap,justify:E(r,e,"justify-content"),align:E(r,e,"align-items")},transform:it(r,e),spacing:{margin:Ke(e,"margin"),padding:Ke(e,"padding")},radius:{all:E(r,e,"border-radius"),tl:e.borderTopLeftRadius,tr:e.borderTopRightRadius,br:e.borderBottomRightRadius,bl:e.borderBottomLeftRadius},typography:{fontFamily:e.fontFamily,fontSize:E(r,e,"font-size"),fontWeight:E(r,e,"font-weight"),lineHeight:e.lineHeight,letterSpacing:e.letterSpacing==="normal"?"0px":e.letterSpacing,textAlign:E(r,e,"text-align"),color:E(r,e,"color"),marginBottom:E(r,e,"margin-bottom")},background:{color:E(r,e,"background-color"),image:e.backgroundImage},border:{width:e.borderTopWidth,style:e.borderTopStyle,color:E(r,e,"border-top-color","border-top-color"),sides:{top:e.borderTopWidth,right:e.borderRightWidth,bottom:e.borderBottomWidth,left:e.borderLeftWidth},present:parseFloat(e.borderTopWidth)>0&&e.borderTopStyle!=="none"},effects:{opacity:E(r,e,"opacity"),boxShadow:e.boxShadow==="none"?"":e.boxShadow}}}function Ke(r,e){return{top:r.getPropertyValue(`${e}-top`),right:r.getPropertyValue(`${e}-right`),bottom:r.getPropertyValue(`${e}-bottom`),left:r.getPropertyValue(`${e}-left`)}}function it(r,e){let o=ue(r,c.get().pseudo).get("transform")||e.transform,n={tx:0,ty:0,rotate:0};if(!o||o==="none")return n;let i=/translate\(\s*(-?[\d.]+)px\s*,\s*(-?[\d.]+)px\s*\)/.exec(o),l=/rotate\(\s*(-?[\d.]+)deg\s*\)/.exec(o);if(i&&(n.tx=parseFloat(i[1]),n.ty=parseFloat(i[2])),l&&(n.rotate=parseFloat(l[1])),i||l)return n;let d=/matrix\(([^)]+)\)/.exec(o);if(d){let[a,p,,,u,h]=d[1].split(",").map(parseFloat);n.tx=k(u),n.ty=k(h),n.rotate=k(Math.atan2(p,a)*(180/Math.PI))}return n}function Ue({tx:r=0,ty:e=0,rotate:t=0}){let o=[];return(r||e)&&o.push(`translate(${k(r)}px, ${k(e)}px)`),t&&o.push(`rotate(${k(t)}deg)`),o.length?o.join(" "):""}var st=6e3,X=r=>r.closest&&r.closest("[data-inspect-ui]");function me(){let r=document.body?document.body.querySelectorAll("*"):[],e=[];for(let t=0;t<r.length&&e.length<st;t++)X(r[t])||e.push(r[t]);return e}function lt(r,e,t){let o=r.get(e);o?o.count++:r.set(e,{...t,count:1})}function at(){let r=new Map,e=["color","background-color","border-top-color","border-right-color","border-bottom-color","border-left-color","outline-color","fill","stroke"];for(let t of me()){let o=getComputedStyle(t);for(let n of e){let i=o.getPropertyValue(n).trim();if(!i||i==="none")continue;let{hex:l,alpha:d}=q(i);if(d===0||l==="#000000"&&n==="fill")continue;let a=l+"|"+d;lt(r,a,{hex:l,alpha:d,css:i})}}return[...r.values()].sort((t,o)=>o.count-t.count).slice(0,80)}function dt(){let r=new Map;for(let e of me()){if(![...e.childNodes].some(u=>u.nodeType===3&&u.textContent.trim()))continue;let o=getComputedStyle(e),n=(o.fontFamily||"").split(",")[0].replace(/["']/g,"").trim(),i=o.fontSize,l=o.fontWeight,d=`${n}|${i}|${l}`,a=e.textContent.trim().slice(0,40),p=r.get(d);p?p.count++:r.set(d,{family:n,size:i,weight:l,lineHeight:o.lineHeight,letterSpacing:o.letterSpacing,sample:a,count:1})}return[...r.values()].sort((e,t)=>parseFloat(t.size)-parseFloat(e.size)||t.count-e.count).slice(0,60)}function ct(){let r=[],e=new Set;for(let t of document.querySelectorAll("svg")){if(X(t))continue;let o=t.outerHTML;/xmlns=/.test(o)||(o=o.replace("<svg",'<svg xmlns="http://www.w3.org/2000/svg"'));let n=o.slice(0,400);if(e.has(n)||o.length>4e4)continue;e.add(n);let i=t.getBoundingClientRect();if(r.push({type:"inline",markup:o,w:Math.round(i.width),h:Math.round(i.height)}),r.length>120)break}for(let t of document.querySelectorAll('img[src$=".svg"], img[src*=".svg?"]'))X(t)||e.has(t.src)||(e.add(t.src),r.push({type:"url",src:t.src,markup:""}));return r}function pt(){let r=[],e=new Set,t=o=>{!o||e.has(o)||o.endsWith(".svg")||o.startsWith("data:image/svg")||(e.add(o),r.push({src:o}))};for(let o of document.querySelectorAll("img"))X(o)||(o.currentSrc||o.src)&&t(o.currentSrc||o.src);for(let o of me()){let n=getComputedStyle(o).backgroundImage;if(!n||n==="none")continue;let i,l=/url\((['"]?)([^'")]+)\1\)/g;for(;i=l.exec(n);)t(new URL(i[2],location.href).href);if(r.length>120)break}return r}function Ze(){return{colors:at(),typography:dt(),svgs:ct(),images:pt()}}var ht={"align-bottom":`<svg preserveAspectRatio="xMidYMid meet" overflow="visible" style="display: block;" width="100%" height="100%" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
<g id="align-bottom">
...
</svg>`,"sidebar-right-01":'<svg preserveAspectRatio="xMidYMid meet" overflow="visible" style="display: block;" width="100%" height="100%" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="sidebar-right-01"><path id="Vector" d="M14.6665 8C14.6665 5.50018 14.6665 4.25027 14.0299 3.37405C13.8243 3.09107 13.5755 2.84221 13.2925 2.63661C12.4163 2 11.1663 2 8.66654 2H7.3332C4.83338 2 3.58347 2 2.70725 2.63661C2.42427 2.84221 2.17541 3.09107 1.96981 3.37405C1.3332 4.25027 1.3332 5.50018 1.3332 8C1.3332 10.4998 1.3332 11.7497 1.96981 12.6259C2.17541 12.9089 2.42427 13.1578 2.70725 13.3634C3.58347 14 4.83338 14 7.3332 14H8.66654C11.1663 14 12.4163 14 13.2925 13.3634C13.5755 13.1578 13.8243 12.9089 14.0299 12.6259C14.6665 11.7497 14.6665 10.4998 14.6665 8Z" stroke="currentColor" stroke-linejoin="round"/><path id="Vector_2" d="M9.6668 2.33334V13.6667" stroke="currentColor" stroke-linejoin="round"/><path id="Vector_3" d="M12.6668 4.66666H11.6668" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/><path id="Vector_4" d="M12.6668 7.33334H11.6668" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/><path id="Vector_5" d="M5.3332 6.66666L6.1509 7.37146C6.49466 7.66773 6.66654 7.81593 6.66654 8C6.66654 8.18406 6.49466 8.33226 6.1509 8.62853L5.3332 9.33333" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/></g></svg>',"minus-sign":'<svg preserveAspectRatio="xMidYMid meet" overflow="visible" style="display: block;" width="100%" height="100%" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="minus-sign"><path id="Vector" d="M13.3333 8H2.66667" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/></g></svg>',square:'<svg preserveAspectRatio="xMidYMid meet" overflow="visible" style="display: block;" width="100%" height="100%" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="queue-02"><path id="Vector" d="M12 12H4C3.37146 12 3.05719 12 2.86193 11.8047C2.66667 11.6095 2.66667 11.2952 2.66667 10.6667C2.66667 10.0381 2.66667 9.72387 2.86193 9.5286C3.05719 9.33333 3.37146 9.33333 4 9.33333H12C12.6285 9.33333 12.9428 9.33333 13.1381 9.5286C13.3333 9.72387 13.3333 10.0381 13.3333 10.6667C13.3333 11.2952 13.3333 11.6095 13.1381 11.8047C12.9428 12 12.6285 12 12 12Z" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/><path id="Vector_2" d="M2.66667 6.66667H13.3333" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/><path id="Vector_3" d="M2.66667 4H13.3333" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/></g></svg>',"border-all-01":'<svg preserveAspectRatio="xMidYMid meet" overflow="visible" style="display: block;" width="100%" height="100%" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="border-all-01"><path id="Vector" d="M2.59416 2.59416C3.52166 1.66667 5.01444 1.66667 8 1.66667C10.9855 1.66667 12.4783 1.66667 13.4059 2.59416C14.3333 3.52166 14.3333 5.01444 14.3333 8C14.3333 10.9855 14.3333 12.4783 13.4059 13.4059C12.4783 14.3333 10.9855 14.3333 8 14.3333C5.01444 14.3333 3.52166 14.3333 2.59416 13.4059C1.66667 12.4783 1.66667 10.9855 1.66667 8C1.66667 5.01444 1.66667 3.52166 2.59416 2.59416Z" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/><path id="Vector_2" d="M8 1.66667V2.93333M8 13.0667V14.3333M6.1 8H9.9M13.0667 8H14.3333M1.66667 8H2.93333M8 6.09999V9.9" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/></g></svg>',"stroke-top":'<svg preserveAspectRatio="xMidYMid meet" overflow="visible" style="display: block;" width="100%" height="100%" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="stroke-top"><path id="Vector" d="M12.6666 4.66667V10C12.6666 11.8856 12.6666 12.8284 12.0808 13.4142C11.495 14 10.5522 14 8.66663 14H7.33329C5.44767 14 4.50487 14 3.91908 13.4142C3.33329 12.8284 3.33329 11.8856 3.33329 10V4.66667" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/><path id="Vector_2" d="M14 1.9987H1.99996" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/></g></svg>',"stroke-right":'<svg preserveAspectRatio="xMidYMid meet" overflow="visible" style="display: block;" width="100%" height="100%" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="stroke-right"><path id="Vector" d="M11.3334 12.6667H6.00008C4.11446 12.6667 3.17165 12.6667 2.58587 12.0809C2.00008 11.4951 2.00008 10.5523 2.00008 8.66667V7.33333C2.00008 5.44771 2.00008 4.50491 2.58587 3.91912C3.17165 3.33333 4.11446 3.33333 6.00008 3.33333H11.3334" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/><path id="Vector_2" d="M13.9988 14V2" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/></g></svg>',"stroke-left":'<svg preserveAspectRatio="xMidYMid meet" overflow="visible" style="display: block;" width="100%" height="100%" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="stroke-left"><path id="Vector" d="M4.66675 3.33333H10.0001C11.8857 3.33333 12.8285 3.33333 13.4143 3.91912C14.0001 4.50491 14.0001 5.44771 14.0001 7.33333V8.66667C14.0001 10.5523 14.0001 11.4951 13.4143 12.0809C12.8285 12.6667 11.8857 12.6667 10.0001 12.6667H4.66675" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/><path id="Vector_2" d="M2.00008 2V14" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/></g></svg>',"stroke-bottom":'<svg preserveAspectRatio="xMidYMid meet" overflow="visible" style="display: block;" width="100%" height="100%" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="stroke-bottom"><path id="Vector" d="M3.33341 11.3333V6C3.33341 4.11438 3.33341 3.17157 3.9192 2.58579C4.50499 2 5.44779 2 7.33341 2H8.66675C10.5523 2 11.4951 2 12.0809 2.58579C12.6667 3.17157 12.6667 4.11438 12.6667 6V11.3333" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/><path id="Vector_2" d="M2.00008 14H14.0001" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/></g></svg>',link:'<svg preserveAspectRatio="xMidYMid meet" overflow="visible" style="display: block;" width="100%" height="100%" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="link"><path id="Vector" d="M9.99724 11.3333H11.3306C13.1715 11.3333 14.6639 9.84093 14.6639 8C14.6639 6.15905 13.1715 4.66667 11.3306 4.66667H9.99724M5.99723 11.3333H4.6639C2.82295 11.3333 1.33057 9.84093 1.33057 8C1.33057 6.15905 2.82295 4.66667 4.6639 4.66667H5.99723" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/><path id="Vector_2" d="M5.6639 8H10.3306" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/></g></svg>',"link-off":'<svg preserveAspectRatio="xMidYMid meet" overflow="visible" style="display: block;" width="100%" height="100%" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="link-off"><path id="Vector" d="M1.99609 2L21.9961 22" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/><path id="Vector_2" d="M8.99609 17C7.62926 17 6.99609 17 6.99609 17C4.23467 17 1.99609 14.7614 1.99609 12C1.99609 9.23858 4.23467 7 6.99609 7" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/><path id="Vector_3" d="M20.9965 15C21.6241 14.1643 21.9961 13.1256 21.9961 12C21.9961 9.23858 19.7575 7 16.9961 7H13.4961" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/><path id="Vector_4" d="M16.9961 17H14.9961" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/><path id="Vector_5" d="M8.49609 12H11.9961" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></g></svg>'};function C(r){return ht[r]||""}function Te(r){return s("span",{class:"fic",html:C(r)})}function ut(){return s("span",{class:"chev-mini",html:C("chevron-down")})}var gt=["px","%","em","rem","vw","vh","auto"];function ft(r,e,t,o){r.classList.add("scrub"),r.addEventListener("mousedown",n=>{if(n.button!==0)return;n.preventDefault(),n.stopPropagation();let i=n.clientX,l=parseFloat(e.value)||0,d=!1,a=u=>{let h=u.clientX-i;!d&&Math.abs(h)<2||(d=!0,e.value=+(l+h*(u.shiftKey?10:1)).toFixed(2),t())},p=()=>{document.removeEventListener("mousemove",a,!0),document.removeEventListener("mouseup",p,!0),document.documentElement.style.cursor="",d&&(o==null||o())};document.addEventListener("mousemove",a,!0),document.addEventListener("mouseup",p,!0),document.documentElement.style.cursor="ew-resize"})}function mt(r,e,t){r.addEventListener("mousedown",o=>{if(o.button!==0)return;let n=o.clientX,i=parseFloat(r.value)||0,l=!1,d=p=>{var h;let u=p.clientX-n;!l&&Math.abs(u)<3||(l||(l=!0,r.blur(),(h=window.getSelection())==null||h.removeAllRanges(),document.documentElement.style.cursor="ew-resize"),r.value=+(i+u*(p.shiftKey?10:1)).toFixed(2),e())},a=()=>{document.removeEventListener("mousemove",d,!0),document.removeEventListener("mouseup",a,!0),document.documentElement.style.cursor="",l&&(t==null||t())};document.addEventListener("mousemove",d,!0),document.addEventListener("mouseup",a,!0)})}function v({key:r,iconName:e,value:t,unit:o="px",onChange:n,showUnit:i=!0,sm:l=!1,scrub:d=!0,onDone:a}){let p=T(t),u=/[a-z%]/i.test(String(t!=null?t:"")),h=s("input",{value:p.value,type:"text",inputmode:"decimal"}),f=i?s("span",{class:"unit unit-pick",text:u?p.unit:o}):null,M=()=>{let x=h.value.trim();if(x==="")return n("");let m=/^-?[\d.]+$/.test(x);n(m&&i?x+((f==null?void 0:f.textContent)||o):x)};h.addEventListener("change",()=>{M(),a==null||a()}),h.addEventListener("keydown",x=>{if(x.key==="Enter")return h.blur();if(x.key==="ArrowUp"||x.key==="ArrowDown"){let m=parseFloat(h.value)||0;h.value=+(m+(x.key==="ArrowUp"?1:-1)*(x.shiftKey?10:1)).toFixed(2),M(),x.preventDefault()}}),i&&f&&f.addEventListener("mousedown",x=>{x.preventDefault(),x.stopPropagation(),Pe(f,gt.map(m=>[m,m]),f.textContent,m=>{f.textContent=m,M(),a==null||a()})});let A=e?Te(e):r?s("span",{class:"fk",text:r}):null;return A&&d&&ft(A,h,M,a),s("div",{class:"field"+(l?" sm":"")},[A,h,f])}var vt='<svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12.5l4.5 4.5L19 6.5"/></svg>',K=null;function N(){if(!K)return;let{menu:r,anchor:e,onDoc:t,onKey:o}=K;r.remove(),e.classList.remove("open"),document.removeEventListener("mousedown",t,!0),document.removeEventListener("keydown",o,!0),window.removeEventListener("scroll",t,!0),K=null}function Pe(r,e,t,o){if(K&&K.anchor===r)return N();N();let n=r.getRootNode(),i=n.querySelector&&n.querySelector(".wrap")||document.body,l=s("div",{class:"dropdown-menu","data-inspect-ui":""},e.map(([f,M])=>{let A=String(f)===String(t),x=s("div",{class:"dropdown-item"+(A?" active":"")},[s("span",{text:M}),A?s("span",{class:"dropdown-check",html:vt}):null]);return x.addEventListener("mousedown",m=>{m.preventDefault(),m.stopPropagation(),o(f),N()}),x}));i.appendChild(l);let d=r.getBoundingClientRect();l.style.left=Math.round(d.left)+"px",l.style.top=Math.round(d.bottom+4)+"px",l.style.minWidth=Math.round(d.width)+"px";let a=l.getBoundingClientRect();a.bottom>window.innerHeight-8&&(l.style.top=Math.round(d.top-a.height-4)+"px");let p=l.querySelector(".dropdown-item.active");p&&p.scrollIntoView({block:"nearest"}),r.classList.add("open");let u=f=>{!f.composedPath().includes(l)&&!f.composedPath().includes(r)&&N()},h=f=>{f.key==="Escape"&&N()};setTimeout(()=>{document.addEventListener("mousedown",u,!0),document.addEventListener("keydown",h,!0),window.addEventListener("scroll",u,!0)},0),K={menu:l,anchor:r,onDoc:u,onKey:h}}function I({value:r,options:e,onChange:t,iconName:o,key:n,sm:i=!0}){let l=e.map(h=>Array.isArray(h)?h:[h,h]),d=l.find(([h])=>String(h)===String(r)),a=s("span",{class:"sel-value",text:d?d[1]:r!=null?r:""}),p=s("div",{class:"field select-like"+(i?" sm":""),tabindex:"0"},[o?Te(o):n?s("span",{class:"fk",text:n}):null,a,ut()]),u=()=>Pe(p,l,r,h=>{r=h;let f=l.find(([M])=>String(M)===String(h));a.textContent=f?f[1]:h,t(h)});return p.addEventListener("mousedown",h=>{h.preventDefault(),u()}),p.addEventListener("keydown",h=>{(h.key==="Enter"||h.key===" ")&&(h.preventDefault(),u())}),p}function ve(r,e,t,o){return s("button",{class:"exp-btn"+(r?" on":""),title:t,html:C(e),onclick:o})}function xe(r,e,{disabled:t=!1}={}){return s("div",{class:"sub-head"},[s("span",{class:"sub-label",text:r}),s("button",{class:"sub-add"+(t?" off":""),title:"Add "+r,html:C("plus"),onclick:t?null:e})])}function O(r,{active:e=-1,grow:t=!1,seg:o=!1,onPick:n}={}){let i=s("div",{class:"iconrow"+(t?" grow":"")+(o?" seg":"")});return r.forEach((l,d)=>{let a=s("button",{class:"ibtn"+(d===e?" active":""),title:l.title||"",html:C(l.icon),onclick:()=>n==null?void 0:n(l,d,a)});i.appendChild(a)}),i}function Ne(r,e){return s("button",{class:"link-toggle"+(r?" on":""),title:r?"Unlink width & height":"Link width & height (keep aspect ratio)",html:C(r?"link":"link-off"),onclick:e})}function we(r,e,t){let o=q(r),n=o.hex,i=o.alpha==null?1:o.alpha,l=s("input",{type:"color",value:n}),d=s("div",{class:"cr-swatch"},[l]);d.style.background=r&&r!=="rgba(0, 0, 0, 0)"?r:"transparent";let a=s("input",{class:"cr-hex",value:n.replace("#","").toUpperCase()}),p=s("input",{class:"cr-alpha",value:Math.round(i*100)}),u=h=>{let f=Ee(h,i);d.style.background=f,e(f)};return l.addEventListener("input",()=>{a.value=l.value.replace("#","").toUpperCase(),u(l.value)}),a.addEventListener("change",()=>{let h=a.value.trim().replace(/^#/,"");/^([0-9a-f]{3}|[0-9a-f]{6})$/i.test(h)&&(l.value="#"+h,u("#"+h))}),p.addEventListener("change",()=>{i=Math.max(0,Math.min(100,parseFloat(p.value)||0))/100,u("#"+a.value.trim().replace(/^#/,""))}),s("div",{class:"color-row"},[s("div",{class:"cr-main"},[d,a]),s("div",{class:"cr-pct"},[p,s("span",{class:"cr-unit",text:"%"})]),s("button",{class:"cr-del",title:"Remove",html:C("minus-sign"),onclick:t})])}function U(r,e,{open:t=!0}={}){let o=s("div",{class:"sec-content"},e),n=s("div",{class:"sec-head"},[s("span",{text:r}),s("span",{class:"chev",html:C("chevron-down")})]),i=s("div",{class:"section"+(t?"":" closed")},[n,o]);return n.addEventListener("click",()=>i.classList.toggle("closed")),i}function w(r,e){return s("div",{class:"stack"},[s("span",{class:"label",text:r}),e])}function Qe(r,e,t){let o=(d,a)=>{let p=s("input",{class:"sp-edge",value:T(r[d][a]).value}),u=()=>{let h=String(p.value).trim();e(`${d}-${a}`,/^-?[\d.]+$/.test(h)?h+"px":h)};return p.addEventListener("change",()=>{u(),t==null||t()}),mt(p,u,t),p},n=(d,a,p,u)=>s("div",{class:a},[s("span",{class:"sp-tag",text:p}),o(d,"top"),s("div",{class:"sp-mid"},[o(d,"left"),u,o(d,"right")]),o(d,"bottom")]),i=s("div",{class:"sp-size"},[s("span",{class:"sp-tag",text:"Size"}),s("span",{html:`${T(r.width||"0").value} <span class="sp-x">x</span> ${T(r.height||"0").value}`})]),l=n("padding","sp-box sp-padding","Padding",i);return n("margin","sp-box sp-margin","Margin",l)}var J=class{constructor(e,t={}){this.root=e,this.api=t,this.el=s("div",{class:"panel","data-inspect-ui":""}),e.appendChild(this.el),this._drag()}set(e){this.selected=e,this.render()}render(){let e=c.get(),t=this.el.querySelector(".panel-body"),o=t?t.scrollTop:0;this.el.classList.toggle("hidden",e.collapsed),this.el.innerHTML="",this.el.append(this._head());let n=s("div",{class:"panel-body"});e.view==="assets"?this._assets(n):e.view==="changes"?this._changes(n):this.selected?e.view==="html"?this._html(n):this._design(n):n.append(s("div",{class:"empty",text:"Pick an element on the page to inspect and edit its styles."})),this.el.append(n),n.scrollTop=o}_head(){let e=c.get();if(e.view==="assets"||e.view==="changes"){let i=e.view==="assets"?{title:"Assets",sub:"Everything this page uses"}:{title:"Changes",sub:"Every edit you make, ready to copy"};return s("div",{class:"head"},[s("div",{class:"head-top"},[s("div",{class:"head-title",text:i.title}),s("div",{class:"head-actions"},[Ye(),be("x","Close panel",()=>c.set({collapsed:!0}))])]),s("div",{class:"crumb",style:{color:"var(--muted)"},text:i.sub})])}let t=this.selected,o=t?fe(t):null,n=t?xt(t):[];return s("div",{class:"head"},[s("div",{class:"head-top"},[s("div",{class:"head-title",text:t?V(t)||o.tag:"InspectCSS"}),s("div",{class:"head-actions"},[be("delete02","Delete this element",()=>this._deleteSelected(),"danger"),Ye(),be("x","Close panel (Exit InspectCSS from the left dock)",()=>c.set({collapsed:!0}))])]),t?s("div",{class:"crumb"},n.map(i=>s("span",{text:i}))):null,t?s("div",{class:"dims"},[s("span",{html:`<b>${k(o.rect.width)}</b> x <b>${k(o.rect.height)}</b> px`}),s("span",{html:`A <b>${parseInt(o.typography.fontSize)}px</b>`})]):s("div",{class:"crumb",text:"no selection"})])}_design(e){let t=this.selected,o=fe(t),n=g=>b=>y(t,g,b),i=g=>b=>y(t,g,/^-?[\d.]+$/.test(String(b).trim())?b+"px":b),l=()=>this.render(),d=o.transform,a=g=>{Object.assign(d,g),y(t,"transform",Ue(d))},p=[{icon:"align-left",title:"Align left",css:["justify-content","flex-start"]},{icon:"align-bottom",title:"Align bottom",css:["align-items","flex-end"]},{icon:"align-right",title:"Align right",css:["justify-content","flex-end"]},{icon:"align-top",title:"Align top",css:["align-items","flex-start"]},{icon:"align-horizontal-center",title:"Center horizontally",css:["justify-content","center"]},{icon:"align-vertical-center",title:"Center vertically",css:["align-items","center"]}];e.append(U("Position",[w("Alignment",O(p,{grow:!0,seg:!0,onPick:g=>y(t,g.css[0],g.css[1])})),w("Position",s("div",{class:"row"},[v({key:"X",value:d.tx+"px",onChange:g=>a({tx:parseFloat(g)||0})}),v({key:"Y",value:d.ty+"px",onChange:g=>a({ty:parseFloat(g)||0})})])),w("Rotation",s("div",{class:"rot-row"},[v({iconName:"rotate01",value:d.rotate+"",showUnit:!1,scrub:!0,onChange:g=>a({rotate:parseFloat(g)||0})}),O([{icon:"image-flip-horizontal",title:"Flip horizontal",axis:"x"},{icon:"image-flip-vertical",title:"Flip vertical",axis:"y"}],{grow:!0,onPick:g=>wt(t,g.axis)})]))]));let u=!!this._sizeLinked,h=parseFloat(o.layout.width),f=parseFloat(o.layout.height),M=h>0&&f>0?h/f:0,A=g=>{y(t,"width",g);let b=parseFloat(g);u&&M&&isFinite(b)&&(y(t,"height",Math.round(b/M)+"px"),this.render())},x=g=>{y(t,"height",g);let b=parseFloat(g);u&&M&&isFinite(b)&&(y(t,"width",Math.round(b*M)+"px"),this.render())};e.append(U("Layout",[w("Size",s("div",{class:"size-row"},[v({key:"W",value:o.layout.width,onDone:l,onChange:A}),Ne(u,()=>{this._sizeLinked=!u,this.render()}),v({key:"H",value:o.layout.height,onDone:l,onChange:x})])),w("Display",I({value:o.layout.display,options:["block","inline","inline-block","flex","inline-flex","grid","none"],onChange:n("display")})),s("div",{class:"row"},[w("Row Gap",v({iconName:"paragraph-spacing",value:o.layout.rowGap,showUnit:!1,sm:!0,onChange:i("row-gap")})),w("Column Gap",v({iconName:"letter-spacing",value:o.layout.columnGap,showUnit:!1,sm:!0,onChange:i("column-gap")}))]),s("div",{class:"row"},[w("Horizontal Align",I({value:o.layout.justify,options:[["flex-start","Start"],["center","Center"],["flex-end","End"],["space-between","Between"]],onChange:n("justify-content")})),w("Vertical Align",I({value:o.layout.align,options:[["flex-start","Start"],["center","Center"],["flex-end","End"],["stretch","Stretch"]],onChange:n("align-items")}))])])),e.append(U("Spacing",[w("Padding",s("div",{class:"row"},[v({iconName:"horizontal-resize",value:o.spacing.padding.left,onDone:l,onChange:g=>{n("padding-left")(g),n("padding-right")(g)}}),v({iconName:"vertical-resize",value:o.spacing.padding.top,onDone:l,onChange:g=>{n("padding-top")(g),n("padding-bottom")(g)}})])),w("Margin",s("div",{class:"row"},[v({iconName:"horizontal-resize",value:o.spacing.margin.left,onDone:l,onChange:g=>{n("margin-left")(g),n("margin-right")(g)}}),v({iconName:"vertical-resize",value:o.spacing.margin.top,onDone:l,onChange:g=>{n("margin-top")(g),n("margin-bottom")(g)}})])),Qe({...o.spacing,width:o.layout.width,height:o.layout.height},(g,b)=>y(t,g,b),l)]));let m=[],Q=!!this._cornerExpanded,Xe=new Set([o.radius.tl,o.radius.tr,o.radius.bl,o.radius.br]).size>1;if(m.push(s("div",{class:"row"},[w("Opacity",v({iconName:"transparency",value:String(Math.round((parseFloat(o.effects.opacity)||1)*100)),unit:"%",onChange:g=>n("opacity")((parseFloat(g)||100)/100)})),w("Corner",s("div",{class:"corner-mix"},[v({iconName:"full-screen",value:Xe?"mix":o.radius.all,showUnit:!1,onChange:i("border-radius")}),ve(Q,"full-screen",Q?"Collapse corners":"Edit each corner",()=>{this._cornerExpanded=!Q,this.render()})]))])),Q){let g=[["border-top-left-radius",o.radius.tl],["border-top-right-radius",o.radius.tr],["border-bottom-left-radius",o.radius.bl],["border-bottom-right-radius",o.radius.br]];m.push(s("div",{class:"corner-grid"},g.map(([b,B])=>v({iconName:"full-screen",value:B,showUnit:!1,onChange:i(b)}))))}let ne=qe(o.background.color);m.push(xe("Fill",()=>{ne||(n("background-color")("#FFFFFF"),this.render())},{disabled:ne})),ne&&m.push(we(o.background.color,n("background-color"),()=>{n("background-color")("rgba(0, 0, 0, 0)"),this.render()}));let ie=o.border.present;if(m.push(xe("Stroke",()=>{ie||(y(t,"border-style","solid"),y(t,"border-width","1px"),qe(o.border.color)||y(t,"border-color","#FFFFFF"),this.render())},{disabled:ie})),ie){m.push(we(o.border.color,n("border-color"),()=>{y(t,"border-width","0px"),this.render()}));let g=o.border.sides,b=new Set([g.top,g.right,g.bottom,g.left]).size>1,B=!!this._strokeSidesExpanded;if(m.push(s("div",{class:"corner-mix"},[v({iconName:"square",value:b?"mix":parseFloat(o.border.width)+"",showUnit:!1,onChange:Z=>y(t,"border-width",/^-?[\d.]+$/.test(String(Z).trim())?Z+"px":Z)}),ve(B,"border-all-01",B?"Collapse sides":"Edit each side",()=>{this._strokeSidesExpanded=!B,this.render()})])),B){let Z=[["border-top-width","stroke-top",g.top],["border-right-width","stroke-right",g.right],["border-left-width","stroke-left",g.left],["border-bottom-width","stroke-bottom",g.bottom]];m.push(s("div",{class:"corner-grid"},Z.map(([Oe,We,Je])=>v({iconName:We,value:parseFloat(Je)+"",showUnit:!1,onChange:i(Oe)}))))}}e.append(U("Appearance",m)),e.append(U("Typography",[w("Typeface",I({value:Fe(o.typography.fontFamily),options:[Fe(o.typography.fontFamily),"Quicksand","Inter","Arial","Georgia","system-ui","monospace"],onChange:n("font-family")})),s("div",{class:"row"},[I({value:bt(o.typography.fontWeight),options:[["300","Light"],["400","Regular"],["500","Medium"],["600","SemiBold"],["700","Bold"],["800","Extra"]],onChange:n("font-weight")}),I({value:parseInt(o.typography.fontSize)+"",options:["10","12","13","14","16","18","20","24","32","48"].map(g=>[g,g]),onChange:g=>n("font-size")(g+"px")})]),s("div",{class:"row"},[w("Line Height",v({iconName:"paragraph-spacing",value:kt(o.typography.lineHeight),showUnit:!1,sm:!0,onChange:n("line-height")})),w("Letter Spacing",v({iconName:"letter-spacing",value:o.typography.letterSpacing,showUnit:!1,sm:!0,onChange:i("letter-spacing")}))]),s("div",{class:"row"},[w("Paragraph Spacing",v({iconName:"expand-paragraph",value:yt(o.typography.marginBottom),sm:!0,onChange:n("margin-bottom")})),w("Alignment",O([{icon:"text-align-right",title:"Right",css:"right"},{icon:"text-align-center",title:"Center",css:"center"},{icon:"text-align-start",title:"Left",css:"left"},{icon:"text-align-justify",title:"Justify",css:"justify"}],{grow:!0,seg:!0,active:["right","center","left","justify"].indexOf(o.typography.textAlign),onPick:g=>n("text-align")(g.css)}))])]))}_changes(e){let t=c.get(),o=ce(),n=ge(),i=Se(t.promptDiff);if(e.append(s("div",{class:"view-actions"},[s("button",{class:"btn primary",text:"Copy CSS",onclick:()=>this._copy()}),s("button",{class:"btn",text:"Copy AI prompt",onclick:()=>{var d;i&&((d=navigator.clipboard)==null||d.writeText(i).then(()=>this._toast("AI prompt copied")))}}),s("button",{class:"btn",text:"Clear",onclick:()=>{Ae(),this.render()}})])),!o.length){e.append(s("div",{class:"empty",text:"No changes yet. Edit a property, colour or text and every change is logged here."}));return}e.append(R("Change log",o.length,s("div",{class:"log-list"},[...o].reverse().map(d=>s("div",{class:"log-item"},[s("span",{class:"log-el",text:d.label||d.selector}),s("span",{class:"log-desc",text:ze(d)})])))));let l=s("div",{class:"seg-toggle"},[s("button",{class:"seg-btn"+(t.promptDiff?"":" on"),text:"Final",onclick:()=>{c.get().promptDiff=!1,c.set({promptDiff:!1}),this.render()}}),s("button",{class:"seg-btn"+(t.promptDiff?" on":""),text:"Diff",onclick:()=>{c.get().promptDiff=!0,c.set({promptDiff:!0}),this.render()}})]);e.append(R("AI prompt",0,s("div",{},[s("div",{class:"ai-row"},[s("div",{class:"ai-hint",text:"Paste into any AI to apply these changes."}),l]),s("pre",{class:"code ai-prompt",text:i})]))),e.append(R("Generated CSS",0,n?s("pre",{class:"code",html:Vt(n)}):s("div",{class:"empty",text:"No CSS edits."})))}_html(e){if(this._expanded=this._expanded||new Set,this._expanded.add(document.documentElement),this._expanded.add(document.body),this.selected){let i=this.selected.parentElement;for(;i;)this._expanded.add(i),i=i.parentElement}let t=s("div",{class:"domtree"});this._renderNode(document.documentElement,t,0);let o=s("div",{class:"tree-footer"},[s("button",{class:"tree-btn",onclick:()=>c.set({view:"design"})},[s("span",{html:W.back}),"Back"]),s("button",{class:"tree-btn",onclick:()=>c.set({active:!0})},[s("span",{html:W.pick}),"Pick an element"])]);e.append(t,o);let n=t.querySelector(".tree-row.selected");n&&setTimeout(()=>n.scrollIntoView({block:"center"}),0)}_renderNode(e,t,o){if(e.nodeType!==1||e.hasAttribute&&e.hasAttribute("data-inspect-ui"))return;let n=[...e.children].filter(u=>!(u.hasAttribute&&u.hasAttribute("data-inspect-ui"))),i=n.length>0,l=this._expanded.has(e),d=o*14+8,a=s("span",{class:"tree-tw"+(i?"":" leaf"),html:i?l?W.caretDown:W.caretRight:""});a.addEventListener("click",u=>{u.stopPropagation(),i&&(l?this._expanded.delete(e):this._expanded.add(e),this.render())});let p=s("div",{class:"tree-row"+(e===this.selected?" selected":""),style:{paddingLeft:d+"px"}},[a,s("span",{class:"tree-tag",html:Ct(e,i&&!l)})]);p.addEventListener("mouseenter",()=>{var u,h;return(h=(u=this.api).hover)==null?void 0:h.call(u,e)}),p.addEventListener("mouseleave",()=>{var u,h;return(h=(u=this.api).unhover)==null?void 0:h.call(u)}),p.addEventListener("click",()=>{var u,h;(h=(u=this.api).unhover)==null||h.call(u),this.api.pick?this.api.pick(e):(this.selected=e,c.set({selectedEl:e,view:"design"}),this.render())}),t.append(p),i&&l&&(n.forEach(u=>this._renderNode(u,t,o+1)),t.append(s("div",{class:"tree-row tree-close",style:{paddingLeft:d+"px"}},[s("span",{class:"tree-tag",html:Mt(e)})])))}_deleteSelected(){let e=this.selected;if(!e)return;let t=e.parentElement;if(!t)return;let o=e.nextElementSibling,n=V(e),i=j(e);e.remove(),z({type:"delete",id:e.getAttribute("data-inspect-id"),to:"removed",label:n,selector:i}),S({undo:()=>t.insertBefore(e,o),redo:()=>e.remove()});let l=t!==document.body&&t!==document.documentElement?t:null;this.selected=l,c.set({selectedEl:l}),this._toast("Element deleted"),this.render()}_copy(){var t;let e=ge();e&&((t=navigator.clipboard)==null||t.writeText(e).then(()=>this._toast("CSS copied")))}_toast(e){let t=s("div",{class:"toast","data-inspect-ui":"",text:e});this.root.appendChild(t),setTimeout(()=>t.remove(),1400)}_assets(e){let t=this._assetCache||(this._assetCache=Ze()),o=(a,p)=>{var u;(u=navigator.clipboard)==null||u.writeText(a),this._toast(p||"Copied")},n=s("div",{class:"asset-colors"},t.colors.map(a=>s("button",{class:"asset-swatch",title:`${a.hex} \xB7 used ${a.count}\xD7`,style:{background:a.css},onclick:()=>o(a.hex,a.hex+" copied")}))),i=s("div",{class:"asset-type-list"},t.typography.map(a=>s("button",{class:"asset-type",title:"Copy CSS",onclick:()=>o(`font-family: ${a.family};
font-size: ${a.size};
font-weight: ${a.weight};`,"Type style copied")},[s("div",{class:"asset-type-preview",style:{fontFamily:a.family,fontSize:"min("+a.size+", 28px)",fontWeight:a.weight},text:"Ag"}),s("div",{class:"asset-type-meta"},[s("div",{class:"asset-type-name",text:a.family}),s("div",{class:"asset-type-sub",text:`${parseInt(a.size)}px \xB7 ${a.weight}`})])]))),l=s("div",{class:"asset-grid"},t.svgs.map(a=>{let p=s("div",{class:"asset-thumb asset-svg",title:"Copy SVG"});return a.type==="inline"?p.innerHTML=a.markup:p.appendChild(s("img",{src:a.src,alt:""})),p.addEventListener("click",()=>o(a.markup||a.src,"SVG copied")),p})),d=s("div",{class:"asset-grid"},t.images.map(a=>{let p=s("div",{class:"asset-thumb",title:"Copy image URL"},[s("img",{src:a.src,alt:"",loading:"lazy"})]);return p.addEventListener("click",()=>o(a.src,"Image URL copied")),p}));e.append(s("div",{class:"view-actions"},[s("button",{class:"btn primary",text:"Rescan page",onclick:()=>{this._assetCache=null,this.render()}})]),R("Colors",t.colors.length,n),R("Typography",t.typography.length,i),R("SVGs",t.svgs.length,l),R("Images",t.images.length,d))}_drag(){let e,t,o,n,i=!1;this.el.addEventListener("mousedown",a=>{if(!a.target.closest(".head")||a.target.closest(".hbtn")||c.get().docked)return;i=!0;let u=this.el.getBoundingClientRect();e=a.clientX,t=a.clientY,o=u.left,n=u.top,this.el.style.right="auto",this.el.style.left=u.left+"px",this.el.style.top=u.top+"px",document.addEventListener("mousemove",l,!0),document.addEventListener("mouseup",d,!0),a.preventDefault()});let l=a=>{i&&(this.el.style.left=o+(a.clientX-e)+"px",this.el.style.top=Math.max(0,n+(a.clientY-t))+"px")},d=()=>{i=!1,document.removeEventListener("mousemove",l,!0),document.removeEventListener("mouseup",d,!0)}}};function be(r,e,t,o=""){return s("button",{class:"hbtn"+(o?" "+o:""),title:e,onclick:t,html:C(r)})}function Ye(){let r=c.get().docked;return s("button",{class:"hbtn"+(r?" active":""),title:r?"Undock panel (float)":"Dock panel to the side",onclick:()=>c.set({docked:!c.get().docked}),html:C("sidebar-right-01")})}function qe(r){if(!r)return!1;let e=String(r).trim();if(e==="transparent"||e==="none")return!1;let t=e.match(/rgba?\(([^)]+)\)/i);if(t){let o=t[1].split(",")[3];return o==null||parseFloat(o)>0}return!0}function R(r,e,t){let o=s("div",{class:"sec-head"},[s("span",{},[r,e?s("span",{class:"asset-count",text:String(e)}):null]),s("span",{class:"chev",html:C("chevron-down")})]),n=s("div",{class:"section"},[o,s("div",{class:"sec-content"},[t])]);return o.addEventListener("click",()=>n.classList.toggle("closed")),n}function xt(r){let e=[],t=r,o=0;for(;t&&t.nodeType===1&&t!==document.documentElement&&o<3;)t.classList.length?e.unshift("."+t.classList[0]):e.unshift(t.tagName.toLowerCase()),t=t.parentElement,o++;return e}function wt(r,e){let t=getComputedStyle(r),o=t.transform==="none"?"":t.transform+" ";y(r,"transform",o+(e==="x"?"scaleX(-1)":"scaleY(-1)"))}function Fe(r){return(r||"").split(",")[0].replace(/["']/g,"").trim()||"system-ui"}function bt(r){return String(r)}function kt(r){return r==="normal"?"1.4":r}function yt(r){return r&&r!=="auto"?r:"0px"}function ke(r){return r.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}var W={caretRight:'<svg width="10" height="10" viewBox="0 0 10 10" fill="currentColor"><path d="M3 1.5l4 3.5-4 3.5z"/></svg>',caretDown:'<svg width="10" height="10" viewBox="0 0 10 10" fill="currentColor"><path d="M1.5 3h7l-3.5 4z"/></svg>',back:'<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M15 6l-6 6 6 6"/></svg>',pick:'<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 3v3M12 18v3M3 12h3M18 12h3"/><circle cx="12" cy="12" r="4"/></svg>'};function Ct(r,e){let t=r.tagName.toLowerCase(),o="";for(let i of r.attributes){if(i.name.startsWith("data-inspect"))continue;let l=i.value.length>40?i.value.slice(0,40)+"\u2026":i.value;o+=` <span class="t-attr">${ke(i.name)}</span><span class="t-br">=</span><span class="t-val">"${ke(l)}"</span>`}let n=`<span class="t-br">&lt;</span><span class="t-tag">${t}</span>${o}<span class="t-br">&gt;</span>`;return e&&(n+=`<span class="t-ell">\u2026</span><span class="t-br">&lt;/</span><span class="t-tag">${t}</span><span class="t-br">&gt;</span>`),n}function Mt(r){return`<span class="t-br">&lt;/</span><span class="t-tag">${r.tagName.toLowerCase()}</span><span class="t-br">&gt;</span>`}function Vt(r){return ke(r).replace(/^([^{\n]+)\{/gm,'<span class="sel">$1</span>{').replace(/^(\s+)([\w-]+)(:)/gm,'$1<span class="prop">$2</span>$3').replace(/: ([^;]+);/g,': <span class="val">$1</span>;')}var _=class{constructor(e,t){this.api=t,this.el=s("div",{class:"dock","data-inspect-ui":""}),e.appendChild(this.el),this.render(),c.subscribe(()=>this.sync())}render(){this.el.innerHTML="",this.pauseBtn=Ge("pause","Pause / resume picking",()=>c.set({active:!c.get().active}));let e=s("div",{class:"dock-group"},[H("undo-03","Undo",()=>{var o,n;return(n=(o=this.api).undo)==null?void 0:n.call(o)}),H("redo-01","Redo",()=>{var o,n;return(n=(o=this.api).redo)==null?void 0:n.call(o)}),ye(),H("layer-bring-forward","Select parent element",()=>{var o,n;return(n=(o=this.api).selectParent)==null?void 0:n.call(o)}),H("layer-send-backward","Select child element",()=>{var o,n;return(n=(o=this.api).selectChild)==null?void 0:n.call(o)}),ye(),this.assetsBtn=H("component","Assets (page colors, type, SVGs, images)",()=>{let o=c.get().view;c.set({view:o==="assets"?"design":"assets",collapsed:!1})}),this.codeBtn=H("file-diff","Changes & AI prompt",()=>c.set({view:"changes",collapsed:!1})),this.htmlBtn=H("html-file-01","HTML",()=>c.set({view:"html",collapsed:!1})),ye(),this.respBtn=H("laptop-phone-sync","Toggle responsive preview",()=>{var o,n;return(n=(o=this.api).toggleResponsive)==null?void 0:n.call(o)})]),t=Ge("cancel-01","Exit InspectCSS",()=>{var o;return(o=window.InspectCSS)==null?void 0:o.destroy()});this.el.append(this.pauseBtn,e,t),this.sync()}sync(){var t,o,n,i,l;let e=c.get();(t=this.pauseBtn)==null||t.classList.toggle("active",e.active),(o=this.assetsBtn)==null||o.classList.toggle("active",e.view==="assets"),(n=this.codeBtn)==null||n.classList.toggle("active",e.view==="changes"),(i=this.htmlBtn)==null||i.classList.toggle("active",e.view==="html"),(l=this.respBtn)==null||l.classList.toggle("active",e.responsive)}};function Ge(r,e,t){return s("button",{class:"dock-circle",title:e,onclick:t,html:C(r)})}function H(r,e,t){return s("button",{class:"dock-btn",title:e,onclick:t,html:C(r)})}function ye(){return s("div",{class:"dock-sep"})}var $=class{constructor(e){this.root=e,this.el=s("div",{class:"tooltip","data-inspect-ui":""}),e.appendChild(this.el),e.addEventListener("pointerover",t=>this._over(t),!0),e.addEventListener("pointerout",t=>this._out(t),!0),e.addEventListener("pointerdown",()=>this.hide(),!0),document.addEventListener("pointerover",t=>this._over(t,!0),!0),document.addEventListener("pointerout",t=>this._out(t),!0),document.addEventListener("pointerdown",()=>this.hide(),!0)}_over(e,t=!1){let o=e.target.closest&&e.target.closest("[title],[data-tip]");if(!o||t&&!o.hasAttribute("data-inspect-ui")||!t&&!this.root.contains(o))return;if(o.hasAttribute("title")){let i=o.getAttribute("title");i&&o.setAttribute("data-tip",i),o.removeAttribute("title")}let n=o.getAttribute("data-tip");n&&this.show(n,o)}_out(e){let t=e.target.closest&&e.target.closest("[data-tip]");t&&!t.contains(e.relatedTarget)&&this.hide()}show(e,t){this.el.textContent=e,this.el.classList.add("show");let o=t.getBoundingClientRect(),n=this.el.getBoundingClientRect(),i=o.top-n.height-8,l=o.left+o.width/2-n.width/2;i<6&&(i=o.bottom+8),l=Math.max(6,Math.min(l,window.innerWidth-n.width-6)),this.el.style.left=Math.round(l)+"px",this.el.style.top=Math.round(i)+"px"}hide(){this.el.classList.remove("show")}};var ee=class{constructor(e){this.onChange=e,this._onDblClick=this._onDblClick.bind(this),this._onKey=this._onKey.bind(this)}start(){document.addEventListener("dblclick",this._onDblClick,!0)}stop(){document.removeEventListener("dblclick",this._onDblClick,!0),this._finish()}_editable(e){if(!e||e.nodeType!==1||L(e))return null;let t=e;for(;t&&t!==document.body;){let o=[...t.childNodes].some(i=>i.nodeType===3&&i.textContent.trim()),n=![...t.children].some(i=>{let l=getComputedStyle(i).display;return l==="block"||l==="flex"||l==="grid"});if(o&&n)return t;t=t.parentElement}return e.matches("h1,h2,h3,h4,h5,h6,p,span,a,button,li,td,th,label,strong,em,small,div")?e:null}_onDblClick(e){var i,l;if(L(e.target))return;let t=this._editable(e.target);if(!t)return;e.preventDefault(),e.stopPropagation(),c.set({editing:!0,selectedEl:t}),this.el=t,this._origText=t.textContent,Y(t),t.setAttribute("contenteditable","true"),t.setAttribute("data-inspect-editing",""),t.focus();let o=(i=document.caretRangeFromPoint)==null?void 0:i.call(document,e.clientX,e.clientY),n=window.getSelection();n.removeAllRanges(),o?n.addRange(o):(l=document.execCommand)==null||l.call(document,"selectAll",!1,null),t.addEventListener("blur",()=>this._finish(),{once:!0}),document.addEventListener("keydown",this._onKey,!0)}_onKey(e){this.el&&(e.key==="Escape"||e.key==="Enter"&&!e.shiftKey&&this.el.tagName!=="DIV")&&(e.preventDefault(),this.el.blur())}_finish(){var e;if(document.removeEventListener("keydown",this._onKey,!0),this.el){let t=this.el;t.removeAttribute("contenteditable"),t.removeAttribute("data-inspect-editing");let o=t.textContent;if(o!==this._origText){let n=this._origText,i=o;z({type:"text",id:t.getAttribute("data-inspect-id"),from:n,to:i,label:V(t),selector:j(t)}),S({undo:()=>{t.textContent=n},redo:()=>{t.textContent=i}})}this.el=null}c.get().editing&&c.set({editing:!1}),(e=this.onChange)==null||e.call(this)}};var Et=4,Ce=new WeakMap;function Me(r){let e=r.nextElementSibling;for(;e&&L(e);)e=e.nextElementSibling;return e}function Lt(r){let e=r.previousElementSibling;for(;e&&L(e);)e=e.previousElementSibling;return e}function At(r,e){if(r.length>=2){let n=r[0].getBoundingClientRect(),i=r[1].getBoundingClientRect(),l=Math.min(n.bottom,i.bottom)-Math.max(n.top,i.top),d=Math.min(n.right,i.right)-Math.max(n.left,i.left);if(l!==d)return l>d}let t=getComputedStyle(e);return/flex/.test(t.display)&&/row/.test(t.flexDirection)||t.display.includes("inline")||t.display==="grid"&&t.gridAutoFlow.includes("column")}function jt(r){let e=Me(r);if(e)return`before ${V(e)}`;let t=Lt(r);return t?`after ${V(t)}`:"to the only remaining slot"}var zt='<svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M5 9l-3 3 3 3M9 5l3-3 3 3M15 19l-3 3-3-3M19 9l3 3-3 3M2 12h20M12 2v20"/></svg>',te=class{constructor(e){this.onReorder=e,this.indicator=s("div",{"data-inspect-ui":"",style:{position:"fixed",background:"#58aeff",borderRadius:"2px",pointerEvents:"none",zIndex:"2147483644",display:"none",boxShadow:"0 0 6px rgba(88,174,255,.8)"}}),this.handle=s("div",{"data-inspect-ui":"",title:"Drag to reorder",html:zt,style:{position:"fixed",width:"26px",height:"26px",borderRadius:"999px",display:"none",alignItems:"center",justifyContent:"center",background:"rgba(0,0,0,0.82)",border:"1px solid rgba(255,255,255,0.18)",color:"#fff",cursor:"grab",zIndex:"2147483645",boxShadow:"0 4px 14px rgba(0,0,0,.5)",backdropFilter:"blur(6px)"}}),document.documentElement.append(this.indicator,this.handle),this._down=this._down.bind(this),this._move=this._move.bind(this),this._up=this._up.bind(this),this._reposition=this._reposition.bind(this),this._sync=this._sync.bind(this)}start(){this.handle.addEventListener("mousedown",this._down,!0),this.handle.addEventListener("mouseenter",()=>this.handle.style.background="#58aeff"),this.handle.addEventListener("mouseleave",()=>this.handle.style.background="rgba(0,0,0,0.82)"),this.unsub=c.subscribe(this._sync),window.addEventListener("scroll",this._reposition,!0),window.addEventListener("resize",this._reposition,!0)}stop(){var e;(e=this.unsub)==null||e.call(this),window.removeEventListener("scroll",this._reposition,!0),window.removeEventListener("resize",this._reposition,!0),this.indicator.remove(),this.handle.remove()}_sync(){let e=c.get(),t=e.selectedEl&&!e.dragging&&!e.editing;this.handle.style.display=t?"flex":"none",t&&this._reposition()}_reposition(){let e=c.get().selectedEl;if(!e||this.dragging)return;let t=e.getBoundingClientRect();this.handle.style.left=Math.round(Math.max(4,t.left-8))+"px",this.handle.style.top=Math.round(Math.max(4,t.top-8))+"px"}_down(e){e.button===0&&(e.preventDefault(),e.stopPropagation(),c.get().selectedEl&&(this.sx=e.clientX,this.sy=e.clientY,this.armed=!0,this.dragging=!1,document.addEventListener("mousemove",this._move,!0),document.addEventListener("mouseup",this._up,!0)))}_move(e){if(this.armed){if(!this.dragging){if(Math.hypot(e.clientX-this.sx,e.clientY-this.sy)<Et)return;this.dragging=!0,c.set({dragging:!0}),document.documentElement.style.cursor="grabbing",this.handle.style.display="none"}this._updateTarget(e)}}_updateTarget(e){let t=c.get().selectedEl,o=t==null?void 0:t.parentElement;if(!o)return;let n=[...o.children].filter(a=>!L(a)&&a!==t);if(!n.length){this.ref=void 0,this.indicator.style.display="none";return}let i=At(n,o),l=i?e.clientX:e.clientY,d=null;for(let a of n){let p=a.getBoundingClientRect(),u=i?p.left+p.width/2:p.top+p.height/2;if(l<u){d=a;break}}this.ref=d,this._drawLine(d,n,i)}_drawLine(e,t,o){let n=t[t.length-1],l=(e||n).getBoundingClientRect();if(o){let d;if(e){let a=t[t.indexOf(e)-1];d=a?(a.getBoundingClientRect().right+l.left)/2:l.left-2}else d=l.right+2;Object.assign(this.indicator.style,{display:"block",left:d-1.5+"px",top:l.top+"px",width:"3px",height:l.height+"px"})}else{let d;if(e){let a=t[t.indexOf(e)-1];d=a?(a.getBoundingClientRect().bottom+l.top)/2:l.top-2}else d=l.bottom+2;Object.assign(this.indicator.style,{display:"block",left:l.left+"px",top:d-1.5+"px",width:l.width+"px",height:"3px"})}}_up(){var t;document.removeEventListener("mousemove",this._move,!0),document.removeEventListener("mouseup",this._up,!0),this.indicator.style.display="none",document.documentElement.style.cursor="";let e=this.dragging;if(this.armed=!1,this.dragging=!1,e){let o=c.get().selectedEl,n=this.ref;if(o&&n!==void 0&&n!==o&&n!==o.nextElementSibling){let l=o.parentElement,d=o.nextElementSibling;Ce.has(o)||Ce.set(o,Me(o)),l.insertBefore(o,n||null);let a=o.getAttribute("data-inspect-id");Me(o)===Ce.get(o)?je(a):z({type:"move",id:a,to:"reordered",label:V(o),selector:j(o),position:jt(o)}),S({undo:()=>l.insertBefore(o,d),redo:()=>l.insertBefore(o,n||null)})}c.set({dragging:!1}),this.ref=void 0;let i=l=>{l.stopPropagation(),l.preventDefault(),document.removeEventListener("click",i,!0)};document.addEventListener("click",i,!0),(t=this.onReorder)==null||t.call(this,o)}this._sync()}};var oe=class{constructor(){this.active=!1,this.width=0,this.handleR=this._makeHandle(),this.handleL=this._makeHandle(),this.label=s("div",{"data-inspect-ui":"",style:{position:"fixed",top:"10px",left:"50%",transform:"translateX(-50%)",zIndex:"2147483645",display:"none",background:"rgba(0,0,0,0.82)",color:"#fff",font:"500 12px 'Quicksand', -apple-system, sans-serif",padding:"4px 10px",borderRadius:"8px",border:"1px solid rgba(255,255,255,0.14)",pointerEvents:"none"}}),document.documentElement.append(this.handleR,this.handleL,this.label),this._down=this._down.bind(this),this._move=this._move.bind(this),this._up=this._up.bind(this),this._reposition=this._reposition.bind(this),this.handleR.addEventListener("mousedown",this._down),this.handleL.addEventListener("mousedown",this._down)}_makeHandle(){let e=s("div",{"data-inspect-ui":"",style:{position:"fixed",top:"0",bottom:"0",width:"12px",cursor:"ew-resize",zIndex:"2147483645",display:"none"}});return e.appendChild(s("div",{style:{position:"absolute",top:"50%",left:"50%",transform:"translate(-50%,-50%)",width:"6px",height:"54px",borderRadius:"4px",background:"#58aeff",boxShadow:"0 0 8px rgba(88,174,255,.7)"}})),e}toggle(){return this.active?this.disable():this.enable(),this.active}enable(){this.active=!0,this.width=Math.min(1024,window.innerWidth-40),this._apply(),this.handleR.style.display="block",this.handleL.style.display="block",this.label.style.display="block",window.addEventListener("resize",this._reposition)}disable(){this.active=!1;let e=document.documentElement;e.style.width="",e.style.margin="",e.style.transition="",this.handleR.style.display="none",this.handleL.style.display="none",this.label.style.display="none",window.removeEventListener("resize",this._reposition)}_apply(){let e=document.documentElement;e.style.width=this.width+"px",e.style.margin="0 auto",this._reposition()}_reposition(){let e=(window.innerWidth+this.width)/2,t=(window.innerWidth-this.width)/2;this.handleR.style.left=e-6+"px",this.handleL.style.left=t-6+"px",this.label.textContent=Math.round(this.width)+" px"}_down(e){e.preventDefault(),this.dragging=!0,document.addEventListener("mousemove",this._move,!0),document.addEventListener("mouseup",this._up,!0),document.documentElement.style.userSelect="none"}_move(e){if(!this.dragging)return;let t=2*Math.abs(e.clientX-window.innerWidth/2);this.width=Math.max(320,Math.min(t,window.innerWidth)),this._apply()}_up(){this.dragging=!1,document.removeEventListener("mousemove",this._move,!0),document.removeEventListener("mouseup",this._up,!0),document.documentElement.style.userSelect=""}destroy(){this.disable(),this.handleR.remove(),this.handleL.remove(),this.label.remove()}};var re=`@font-face {
...
`;var Ve=class{constructor(){this.host=document.createElement("div"),this.host.setAttribute("data-inspect-ui",""),this.host.style.cssText="all: initial; position: static;";let e=this.host.attachShadow({mode:"open"}),t=document.createElement("style");t.textContent=De;let o=document.createElement("div");o.className="wrap",e.append(t,o),document.documentElement.appendChild(this.host),this.fontStyle=document.createElement("style"),this.fontStyle.setAttribute("data-inspect-ui",""),this.fontStyle.textContent=re,document.head.appendChild(this.fontStyle),this.overlay=new F(document.documentElement),this.panel=new J(o,{hover:n=>this.overlay.highlight(n),unhover:()=>{c.get().active||this.overlay.hideHover()},pick:n=>this.select(n)}),this.tooltip=new $(o),this.toolbar=new _(o,{undo:()=>{he(),this._afterHistory()},redo:()=>{D(),this._afterHistory()},selectParent:()=>this.selectRelative("parent"),selectChild:()=>this.selectRelative("child"),toggleResponsive:()=>this.toggleResponsive()}),this.inspector=new G(this.overlay,n=>this.select(n)),this.textEditor=new ee(()=>this.panel.render()),this.dragMove=new te(n=>{n&&(this.overlay.select(n),this.panel.render())}),this.responsive=new oe,this.textEditor.start(),this.dragMove.start(),this._prevView=c.get().view,this._prevCollapsed=c.get().collapsed,this._prevDocked=c.get().docked,this.unsub=c.subscribe(n=>this.onState(n)),this._track=()=>{this._raf||(this._raf=requestAnimationFrame(()=>{this._raf=0;let n=c.get();n.hoverEl&&this.overlay.highlight(n.hoverEl),n.selectedEl&&this.overlay.select(n.selectedEl)}))},window.addEventListener("scroll",this._track,!0),window.addEventListener("resize",this._track,!0),this._keyHandler=n=>this._onKey(n),window.addEventListener("keydown",this._keyHandler,!0),c.set({active:!0}),this.panel.render()}select(e){c.set({selectedEl:e,collapsed:!1,view:"design"}),this.overlay.select(e),this.panel.set(e)}_afterHistory(){let e=c.get();e.selectedEl&&document.contains(e.selectedEl)?this.overlay.select(e.selectedEl):(this.overlay.hideSelected(),c.set({selectedEl:null})),this.panel.render()}_onKey(e){if(c.get().editing)return;let t=(e.target.tagName||"").toLowerCase();t==="input"||t==="textarea"||e.target.isContentEditable||((e.ctrlKey||e.metaKey)&&e.key.toLowerCase()==="z"?(e.preventDefault(),e.shiftKey?D():he(),this._afterHistory()):(e.ctrlKey||e.metaKey)&&e.key.toLowerCase()==="y"&&(e.preventDefault(),D(),this._afterHistory()))}selectRelative(e){let t=c.get().selectedEl;if(!t)return;let o=null;if(e==="parent"){if(o=t.parentElement,!o||o===document.documentElement||o===document.body)return}else if(o=[...t.children].find(n=>!n.closest("[data-inspect-ui]")),!o)return;c.set({view:"design",collapsed:!1}),this.select(o)}toggleResponsive(){let e=this.responsive.toggle();c.set({responsive:e});let t=c.get();t.selectedEl&&this.overlay.select(t.selectedEl)}onState(e){if(e.active&&!this._picking?(this._picking=!0,this.inspector.start()):!e.active&&this._picking&&(this._picking=!1,this.inspector.stop()),e.selectedEl&&document.contains(e.selectedEl)?this.overlay.select(e.selectedEl):this.overlay.hideSelected(),this.panel.el.classList.toggle("drag-hidden",!!e.dragging),e.docked!==this._prevDocked){this._prevDocked=e.docked,this.panel.el.classList.toggle("docked",e.docked),document.documentElement.style.transition="margin-right .2s ease";let t=Math.round(this.panel.el.getBoundingClientRect().width)||340;document.documentElement.style.marginRight=e.docked?t+"px":"",this.panel.render()}(e.view!==this._prevView||e.collapsed!==this._prevCollapsed)&&(e.view==="assets"&&this._prevView!=="assets"&&(this.panel._assetCache=null),this._prevView=e.view,this._prevCollapsed=e.collapsed,this.panel.render())}destroy(){var t,o;(t=this.unsub)==null||t.call(this),window.removeEventListener("scroll",this._track,!0),window.removeEventListener("resize",this._track,!0),window.removeEventListener("keydown",this._keyHandler,!0),this.textEditor.stop(),this.dragMove.stop(),this.responsive.destroy(),this.inspector.stop(),this.overlay.destroy(),this.host.remove(),(o=this.fontStyle)==null||o.remove(),this.toggleResponsiveOff();let e=document.getElementById("inspect-css-live-styles");e&&e.remove(),delete window.InspectCSS}toggleResponsiveOff(){document.documentElement.style.maxWidth="",document.documentElement.style.margin="",document.documentElement.style.marginRight=""}};function St(){if(window.InspectCSS){window.InspectCSS.destroy();return}let r=new Ve;window.InspectCSS={app:r,destroy:()=>r.destroy(),version:"0.9.0"}}St();})();
